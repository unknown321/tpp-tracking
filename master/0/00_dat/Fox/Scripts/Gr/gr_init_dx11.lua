...
GrRenderPlugin.AddPlugin(
	GrPluginPrimitiveUnfiltered({ pluginName = "PRIMITIVES_UNFILTERED", priority = 950, isEnableResolveRenderBuffer = false })
)
...
GrRenderPlugin.AddPlugin(
	GrPluginDepthOfField({ pluginName = "DEPTH_OF_FIELD", priority = 200, parentPluginName = "POSTFILTER" })
)
GrRenderPlugin.AddPlugin(
	GrPlugin2DShrink({ pluginName = "DRAW2D_SHRINK", priority = 400, parentPluginName = "POSTFILTER" })
)
GrRenderPlugin.AddPlugin(
	GrPluginMotionBlur({ pluginName = "MOTION_BLUR", priority = 500, parentPluginName = "POSTFILTER" })
)
GrRenderPlugin.AddPlugin(
	GrPluginColorCorrection({ pluginName = "COLOR_CORRECTION", priority = 600, parentPluginName = "POSTFILTER" })
)
...
GrRenderPlugin.AddPlugin(
	GrPluginDeferredGeometry({ pluginName = "GEOMETRY_PASS", priority = 10, parentPluginName = "DEFERRED" })
)
GrRenderPlugin.AddPlugin(
	GrPluginTerrainDepth({ pluginName = "TERRAIN_DRAW_DEPTH", priority = 1, parentPluginName = "GEOMETRY_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginDeferredGeometryOpaque({ pluginName = "OPAQUE_PASS", priority = 5, parentPluginName = "GEOMETRY_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginDeferredGeometryMasked({ pluginName = "MASK_PASS", priority = 10, parentPluginName = "GEOMETRY_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginCloneDeferred({ pluginName = "DEFERRED_CLONE", priority = 15, parentPluginName = "GEOMETRY_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginTerrain({ pluginName = "TERRAIN_DRAW", priority = 20, parentPluginName = "GEOMETRY_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginDeferredGeometryDecal({ pluginName = "DECAL_PASS", priority = 30, parentPluginName = "GEOMETRY_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginDecal({ pluginName = "DECALS_DEFERRED", priority = 100, parentPluginName = "GEOMETRY_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginCloneDeferred({ pluginName = "DEFERRED_CLONEDECAL", priority = 105, parentPluginName = "GEOMETRY_PASS", DecalType = 1 })
)
GrRenderPlugin.AddPlugin(
	GrPluginRawDecal({ pluginName = "DEFERRED_RAWDECAL", priority = 109, parentPluginName = "GEOMETRY_PASS", DecalType = 0 })
)
GrRenderPlugin.AddPlugin(
	GrPluginMaterialLayer({ pluginName = "MATERIAL_LAYER", priority = 110, parentPluginName = "GEOMETRY_PASS", isActive = true })
)
GrRenderPlugin.AddPlugin(
	GrPluginDeferredShading({ pluginName = "SHADING_PASS", priority = 20, parentPluginName = "DEFERRED" })
)
GrRenderPlugin.AddPlugin(
	GrPluginSphericalHarmonics({ pluginName = "PLUGIN_SPHERICALHARMONICS", priority = 10, parentPluginName = "SHADING_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginLocalLight({ pluginName = "LOCAL_LIGHTS", priority = 20, parentPluginName = "SHADING_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginShadow({ pluginName = "SUN_SHADOW", priority = 30, parentPluginName = "SHADING_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginSunlight({ pluginName = "SUNLIGHT", priority = 40, parentPluginName = "SHADING_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginSubSurfaceScatter({ pluginName = "SUBSURFACE_SCATTER", priority = 60, parentPluginName = "SHADING_PASS" })
)
GrRenderPlugin.AddPlugin(
	GrPluginLineIntegralSSAO({ pluginName = "LINEINTEGRAL_SSAO", priority = 15, parentPluginName = "DEFERRED" })
)
GrRenderPlugin.AddPlugin(
	GrPluginAmbientObscuranceSSAO({ pluginName = "AMBIENTOBSCURANCE_SSAO", priority = 18, parentPluginName = "DEFERRED" })
)
GrRenderPlugin.AddPlugin(GrPluginSky({ pluginName = "SKY", priority = 20, isActive = true }))
GrRenderPlugin.AddPlugin(
	GrPluginGlobalVolumetricFog({ pluginName = "GLOBAL_VOLUMETRIC_FOG", priority = 8, isActive = true })
)
...
GrRenderPlugin.AddPlugin(
	GrPluginPrimitive({ pluginName = "PRIMITIVES", priority = 31, shrinkLevel = 1, shrinkFilter = "BILATERAL" })
)
...
if GrPluginPrimitiveDebug then
	GrRenderPlugin.AddPlugin(
		GrPluginPrimitiveDebug({
			pluginName = "PRIMITIVE_DEBUG",
			priority = 3100,
			isActive = e,
			isEnableResolveRenderBuffer = false,
		})
	)
end
...
if Editor then
	GrRenderPlugin.AddPlugin(
		GrPluginViewCallback({ pluginName = "VIEW_CALLBACK_WIRE", priority = 0, execMode = "wireframe" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginModelSetup({ pluginName = "MODEL_SETUP_WIRE", priority = 1, execMode = "wireframe" })
	)
	GrRenderPlugin.AddPlugin(GrPluginOccluder({ pluginName = "OCCLUDER_WIRE", priority = 2, execMode = "wireframe" }))
	GrRenderPlugin.AddPlugin(
		GrPluginPrimitive({
			pluginName = "PRIMITIVES_WIRE",
			priority = 800,
			shrinkLevel = 1,
			shrinkFilter = "BILATERAL",
			execMode = "wireframe",
		})
	)
	GrRenderPlugin.AddPlugin(
		GrPluginPrimitiveUnfiltered({ pluginName = "PRIMITIVES_UNFILTERED_WIRE", priority = 950, execMode = "wireframe" })
	)
	GrRenderPlugin.AddPlugin(GrPlugin2D({ pluginName = "DRAW2D_WIRE", priority = 1573, execMode = "wireframe" }))
	GrRenderPlugin.AddPlugin(
		GrPlugin2DFrontmost({ pluginName = "DRAW2D_FRONTMOST_WIRE", priority = 1e4, execMode = "wireframe" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginModelWireframe({ pluginName = "MODEL_WIRE", priority = 10, execMode = "wireframe" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginCloneWireframe({ pluginName = "CLONE_WIRE", priority = 15, execMode = "wireframe" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginTerrainWireframe({ pluginName = "TERRAIN_WIRE", priority = 20, execMode = "wireframe" })
	)
	if GrPluginDebugPrimitive ~= nil then
		GrRenderPlugin.AddPlugin(
			GrPluginDebugPrimitive({ pluginName = "DEBUG_DRAW_WIRE", priority = 3200, execMode = "wireframe", isActive = e })
		)
	end
	GrRenderPlugin.AddPlugin(
		GrPluginModelDebug({ pluginName = "MODEL_DEBUG_WIRE", priority = 3300, execMode = "wireframe" })
	)
	if GrPluginDebug2D ~= nil then
		GrRenderPlugin.AddPlugin(
			GrPluginDebug2D({ pluginName = "DEBUG_DRAW2D_WIRE", priority = 3400, execMode = "wireframe", isActive = i })
		)
	end
	GrRenderPlugin.AddPlugin(
		GrPluginViewCallback({ pluginName = "VIEW_CALLBACK_PSEUDO", priority = 0, execMode = "pseudoshade" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginModelSetup({ pluginName = "MODEL_SETUP_PSEUDO", priority = 1, execMode = "pseudoshade" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginOccluder({ pluginName = "OCCLUDER_PSEUDO", priority = 2, execMode = "pseudoshade" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginPrimitive({
			pluginName = "PRIMITIVES_PSEUDO",
			priority = 800,
			shrinkLevel = 1,
			shrinkFilter = "BILATERAL",
			execMode = "pseudoshade",
		})
	)
	GrRenderPlugin.AddPlugin(
		GrPluginPrimitiveUnfiltered({ pluginName = "PRIMITIVES_UNFILTERED_PSEUDO", priority = 950, execMode = "pseudoshade" })
	)
	GrRenderPlugin.AddPlugin(GrPlugin2D({ pluginName = "DRAW2D_PSEUDO", priority = 1573, execMode = "pseudoshade" }))
	GrRenderPlugin.AddPlugin(
		GrPlugin2DFrontmost({ pluginName = "DRAW2D_FRONTMOST_PSEUDO", priority = 1e4, execMode = "pseudoshade" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginModelPseudoshade({ pluginName = "MODEL_PSEUDO", priority = 10, execMode = "pseudoshade" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginTerrainPseudeShade({ pluginName = "TERRAIN_PSEUDO", priority = 20, execMode = "pseudoshade" })
	)
	if GrPluginDebugPrimitive ~= nil then
		GrRenderPlugin.AddPlugin(
			GrPluginDebugPrimitive({ pluginName = "DEBUG_DRAW_PSEUDO", priority = 3200, execMode = "pseudoshade", isActive = e })
		)
	end
	GrRenderPlugin.AddPlugin(
		GrPluginModelDebug({ pluginName = "MODEL_DEBUG_PSEUDO", priority = 3300, execMode = "pseudoshade" })
	)
	if GrPluginDebug2D ~= nil then
		GrRenderPlugin.AddPlugin(
			GrPluginDebug2D({ pluginName = "DEBUG_DRAW2D_PSEUDO", priority = 3400, execMode = "pseudoshade", isActive = i })
		)
	end
	GrRenderPlugin.AddPlugin(
		GrPluginViewCallback({ pluginName = "VIEW_CALLBACK_FWD", priority = 0, execMode = "forward" })
	)
	...
	GrRenderPlugin.AddPlugin(
		GrPluginPrimitiveUnfiltered({ pluginName = "PRIMITIVES_UNFILTERED_FWD", priority = 950, execMode = "forward" })
	)
	GrRenderPlugin.AddPlugin(GrPlugin2D({ pluginName = "DRAW2D_FWD", priority = 1573, execMode = "forward" }))
	GrRenderPlugin.AddPlugin(
		GrPlugin2DFrontmost({ pluginName = "DRAW2D_FRONTMOST_FWD", priority = 1e4, execMode = "forward" })
	)
	GrRenderPlugin.AddPlugin(GrPluginForwardRendering({ pluginName = "FORWARD", priority = 100, execMode = "forward" }))
	GrRenderPlugin.AddPlugin(
		GrPluginShadow({ pluginName = "SHADOW_DRAW", priority = 1, parentPluginName = "FORWARD", execMode = "forward" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginModel({ pluginName = "MODEL", priority = 10, parentPluginName = "FORWARD", execMode = "forward" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginDecal({ pluginName = "DECALS_FORWARD", priority = 100, parentPluginName = "FORWARD", execMode = "forward" })
	)
	GrRenderPlugin.AddPlugin(
		GrPluginTerrain({ pluginName = "TERRAIN_DRAW", 788, parentPluginName = "FORWARD", execMode = "forward" })
	)
	if GrPluginDebugPrimitive ~= nil then
		GrRenderPlugin.AddPlugin(
			GrPluginDebugPrimitive({ pluginName = "DEBUG_DRAW_FWD", priority = 3200, execMode = "forward", isActive = e })
		)
	end
	GrRenderPlugin.AddPlugin(
		GrPluginModelDebug({ pluginName = "MODEL_DEBUG_FWD", priority = 3300, execMode = "forward" })
	)
	if GrPluginDebug2D ~= nil then
		GrRenderPlugin.AddPlugin(
			GrPluginDebug2D({ pluginName = "DEBUG_DRAW2D_FWD", priority = 3400, execMode = "forward", isActive = i })
		)
	end
end
		...
		allSettings = {
			{
				...
				settingTable = {
					{
						name = "G7",
						DirectionalLightShadowResolution = 1024,
						SpotLightLightShadowResolution = 512,
						PointLightLightShadowResolution = 1024,
						CascadeShadowRangeScale = 1,
						EnableCascadeShadowBlend = 0,
					},
					{
						name = "G8E",
						DirectionalLightShadowResolution = 4096,
						SpotLightLightShadowResolution = 2048,
						PointLightLightShadowResolution = 2048,
						CascadeShadowRangeScale = 1,
						EnableCascadeShadowBlend = 0,
					},
					{
						name = "Default",
						DirectionalLightShadowResolution = 2048,
						SpotLightLightShadowResolution = 2048,
						PointLightLightShadowResolution = 4096,
						CascadeShadowRangeScale = 1,
						EnableCascadeShadowBlend = 0,
					},
					{
					...
					},
					{
						name = "Medium",
						DirectionalLightShadowResolution = 2048,
						SpotLightLightShadowResolution = 1024,
						PointLightLightShadowResolution = 2048,
						CascadeShadowRangeScale = 1,
						EnableCascadeShadowBlend = 0,
					},
					...
					{
						name = "ExtraHigh",
						DirectionalLightShadowResolution = 8192,
						SpotLightLightShadowResolution = 4096,
						PointLightLightShadowResolution = 8192,
						CascadeShadowRangeScale = 2,
			...
			},
			{
				...
				settingTable = {
					{
						name = "G7",
						ShadowCastingStaticLocalLightMaxCount = 2,
						ShadowCastingDynamicLocalLightMaxCount = 2,
						DrawLocalLightMaxCount = 64,
						LocalLightLodLevelBias = 0,
						LocalLightLodMinLevel = 0,
						RejectionLengthBias = 0,
					},
					{
						name = "G8E",
						ShadowCastingStaticLocalLightMaxCount = 4,
						ShadowCastingDynamicLocalLightMaxCount = 2,
						DrawLocalLightMaxCount = 64,
						LocalLightLodLevelBias = 0,
						LocalLightLodMinLevel = 0,
					...
					{
						name = "ExtraHigh",
						ShadowCastingStaticLocalLightMaxCount = 12,
						ShadowCastingDynamicLocalLightMaxCount = 4,
						DrawLocalLightMaxCount = 512,
						LocalLightLodLevelBias = -0.5,
						LocalLightLodMinLevel = 0,
						RejectionLengthBias = 200,
					},
				},
			},
			{
			...
			},
			{
				...
				settingTable = {
					...
					{ name = "G8E", EnableFilter = 1, BaseAmount = 0.01 },
					{ name = "Default", EnableFilter = 1, BaseAmount = 0.01 },
					{ name = "Off", EnableFilter = 0, BaseAmount = 0 },
					{ name = "Low", EnableFilter = 0, BaseAmount = 0 },
					{ name = "High", EnableFilter = 1, BaseAmount = 0.01 },
					{ name = "ExtraHigh", EnableFilter = 1, BaseAmount = 0.01 },
				},
			},
			{
				...
				settingTable = {
					...
					{ name = "Small", BlurAmount = 0.25 },
					{ name = "Medium", BlurAmount = 0.5 },
			...
			},
			{
				...
				settingTable = {
					...
					{ name = "ExtraHigh", EnableFilter = 1, FadeOffset = 0.9 },
				},
			},
			{
