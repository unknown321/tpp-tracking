...
elseif m == "eng" then
	...
	_ = "FontSystem_Slot3"
	p = "/Assets/tpp/font/LatinFont.ffnt"
	i = 1
	t = 3
elseif m == "rus" then
	s = "FontSystem_LatinFont"
...
local _ = UiDaemon.GetInstance()
_.ResetDefaultButtonMap()
_.SetButtonMap("BUTTON_A", fox.PAD_A, fox.KEY_RETURN)
_.SetButtonMap("BUTTON_B", fox.PAD_B, fox.KEY_ESCAPE)
_.SetButtonMap("BUTTON_X", fox.PAD_X, fox.KEY_G)
_.SetButtonMap("BUTTON_Y", fox.PAD_Y, fox.KEY_T)
_.SetButtonMap("BUTTON_UP", fox.PAD_U, fox.KEY_W)
_.SetButtonMap("BUTTON_DOWN", fox.PAD_D, fox.KEY_S)
_.SetButtonMap("BUTTON_LEFT", fox.PAD_L, fox.KEY_A)
_.SetButtonMap("BUTTON_RIGHT", fox.PAD_R, fox.KEY_D)
_.SetButtonMap("STATUS_UP", fox.PAD_U + 4, fox.KEY_UP)
_.SetButtonMap("STATUS_DOWN", fox.PAD_D + 4, fox.KEY_DOWN)
_.SetButtonMap("STATUS_LEFT", fox.PAD_L + 4, fox.KEY_LEFT)
_.SetButtonMap("STATUS_RIGHT", fox.PAD_R + 4, fox.KEY_RIGHT)
_.SetButtonMap("BUTTON_LT", fox.PAD_L2, fox.KEY_1)
_.SetButtonMap("BUTTON_RT", fox.PAD_R2, fox.KEY_3)
_.SetButtonMap("BUTTON_LB", fox.PAD_L1, fox.KEY_1)
_.SetButtonMap("BUTTON_RB", fox.PAD_R1, fox.KEY_3)
_.SetButtonDecideMap("UI_DECIDE", fox.KEY_SPACE)
_.SetButtonCancelMap("UI_CANCEL", fox.KEY_ESCAPE)
_.SetButtonDecideMap("DECISION", fox.KEY_SPACE)
_.SetButtonCancelMap("CANCEL", fox.KEY_ESCAPE)
_.SetButtonDecideMap("UI_MOUSE_DECIDE", fox.MOUSE_CODE_LEFT)
_.SetButtonCancelMap("UI_MOUSE_CANCEL", fox.MOUSE_CODE_RIGHT)
_.SetButtonMap("UI_DETAIL", fox.PAD_Y, fox.KEY_T)
_.SetButtonMap("UI_CHECK", fox.PAD_X, fox.KEY_G)
_.SetButtonMap("UI_SELECT", fox.PAD_SELECT, fox.KEY_ESCAPE)
_.SetButtonMap("UI_START", fox.PAD_START, fox.KEY_TAB)
_.SetButtonMap("UI_UP", fox.PAD_U, fox.KEY_W)
_.SetButtonMap("UI_DOWN", fox.PAD_D, fox.KEY_S)
_.SetButtonMap("UI_LEFT", fox.PAD_L, fox.KEY_A)
_.SetButtonMap("UI_RIGHT", fox.PAD_R, fox.KEY_D)
_.SetButtonMap("UI_LT", fox.PAD_L2, fox.KEY_Q)
_.SetButtonMap("UI_RT", fox.PAD_R2, fox.KEY_E)
_.SetButtonMap("UI_LB", fox.PAD_L1, fox.KEY_1)
_.SetButtonMap("UI_RB", fox.PAD_R1, fox.KEY_3)
_.SetButtonMap("UI_LEFTSTICK_PUSH", fox.PAD_L3, fox.KEY_SHIFT)
_.SetButtonMap("UI_RIGHTSTICK_PUSH", fox.PAD_R3, fox.KEY_V)
_.SetButtonMap("UI_LB_PAGE_UP", fox.PAD_L1, fox.KEY_PAGEUP)
_.SetButtonMap("UI_RB_PAGE_DOWN", fox.PAD_R1, fox.KEY_PAGEDOWN)
_.SetButtonMap("UI_KBD_SHIFT", fox.GK_PAD_NO_BUTTON, fox.KEY_SHIFT)
_.SetButtonMap("UI_KBD_ALT", fox.GK_PAD_NO_BUTTON, fox.KEY_ALT)
_.SetButtonMap("UI_KBD_CTRL", fox.GK_PAD_NO_BUTTON, fox.KEY_CTRL)
_.SetButtonMap("UI_KBD_BS", fox.GK_PAD_NO_BUTTON, fox.KEY_BS)
_.SetButtonMap("UI_KBD_RETURN", fox.GK_PAD_NO_BUTTON, fox.KEY_RETURN)
_.SetButtonMap("UI_KBD_1", fox.GK_PAD_NO_BUTTON, fox.KEY_1)
_.SetButtonMap("UI_KBD_2", fox.GK_PAD_NO_BUTTON, fox.KEY_2)
_.SetButtonMap("UI_KBD_3", fox.GK_PAD_NO_BUTTON, fox.KEY_3)
_.SetButtonMap("UI_KBD_4", fox.GK_PAD_NO_BUTTON, fox.KEY_4)
_.SetButtonMap("UI_KBD_5", fox.GK_PAD_NO_BUTTON, fox.KEY_5)
_.SetButtonMap("UI_KBD_6", fox.GK_PAD_NO_BUTTON, fox.KEY_6)
_.SetButtonMap("UI_KBD_7", fox.GK_PAD_NO_BUTTON, fox.KEY_7)
_.SetButtonMap("UI_KBD_8", fox.GK_PAD_NO_BUTTON, fox.KEY_8)
_.SetButtonMap("UI_KBD_9", fox.GK_PAD_NO_BUTTON, fox.KEY_9)
_.SetButtonMap("UI_KBD_0", fox.GK_PAD_NO_BUTTON, fox.KEY_0)
_.SetButtonMap("UI_KBD_X", fox.GK_PAD_NO_BUTTON, fox.KEY_G)
_.SetButtonMap("UI_KBD_Y", fox.GK_PAD_NO_BUTTON, fox.KEY_T)
_.SetButtonMap("UI_KBD_UP", fox.GK_PAD_NO_BUTTON, fox.KEY_UP)
_.SetButtonMap("UI_KBD_DOWN", fox.GK_PAD_NO_BUTTON, fox.KEY_DOWN)
_.SetButtonMap("UI_KBD_LEFT", fox.GK_PAD_NO_BUTTON, fox.KEY_LEFT)
_.SetButtonMap("UI_KBD_RIGHT", fox.GK_PAD_NO_BUTTON, fox.KEY_RIGHT)
_.SetButtonMap("UI_KBD_PAGE_UP", fox.GK_PAD_NO_BUTTON, fox.KEY_PAGEUP)
_.SetButtonMap("UI_KBD_PAGE_DOWN", fox.GK_PAD_NO_BUTTON, fox.KEY_PAGEDOWN)
_.SetButtonMap("UI_EQUIP_PRIMARY", fox.GK_PAD_NO_BUTTON, fox.KEY_1)
_.SetButtonMap("UI_EQUIP_SECONDARY", fox.GK_PAD_NO_BUTTON, fox.KEY_2)
_.SetButtonMap("UI_EQUIP_SUPPORT", fox.GK_PAD_NO_BUTTON, fox.KEY_3)
_.SetButtonMap("UI_EQUIP_ITEM", fox.GK_PAD_NO_BUTTON, fox.KEY_4)
_.SetButtonMap("UI_EQUIP_UP", fox.GK_PAD_NO_BUTTON, fox.KEY_UP)
_.SetButtonMap("UI_EQUIP_DOWN", fox.GK_PAD_NO_BUTTON, fox.KEY_DOWN)
_.SetButtonMap("UI_EQUIP_LEFT", fox.GK_PAD_NO_BUTTON, fox.KEY_LEFT)
_.SetButtonMap("UI_EQUIP_RIGHT", fox.GK_PAD_NO_BUTTON, fox.KEY_RIGHT)
_.SetButtonMap("UI_EQUIP_OP_1", fox.PAD_X, fox.KEY_G)
_.SetButtonMap("UI_EQUIP_OP_2", fox.PAD_Y, fox.KEY_T)
_.SetButtonMap("UI_PAGE_UP", fox.PAD_L, fox.KEY_PAGEUP)
_.SetButtonMap("UI_PAGE_DOWN", fox.PAD_R, fox.KEY_PAGEDOWN)
_.SetButtonMap("UI_MOVE_UP", fox.PAD_R2, fox.KEY_W)
_.SetButtonMap("UI_MOVE_DOWN", fox.PAD_L2, fox.KEY_S)
_.SetButtonMap("UI_MOVE_LEFT", fox.GK_PAD_NO_BUTTON, fox.KEY_A)
_.SetButtonMap("UI_MOVE_RIGHT", fox.GK_PAD_NO_BUTTON, fox.KEY_D)
_.SetButtonMap("UI_STANCE", fox.GK_PAD_NO_BUTTON, fox.KEY_C)
_.SetButtonMap("UI_ACTION", fox.GK_PAD_NO_BUTTON, fox.KEY_E)
_.SetButtonMap("UI_SUBJECT", fox.GK_PAD_NO_BUTTON, fox.KEY_F)
_.SetButtonMap("UI_EVADE", fox.GK_PAD_NO_BUTTON, fox.KEY_SPACE)
_.SetButtonMap("UI_RELOAD", fox.GK_PAD_NO_BUTTON, fox.KEY_R)
_.SetButtonMap("UI_RADIO", fox.GK_PAD_NO_BUTTON, fox.KEY_Q)
_.SetButtonMap("UI_HOLD", fox.GK_PAD_NO_BUTTON, fox.MOUSE_CODE_RIGHT)
_.SetButtonMap("UI_SHOT", fox.GK_PAD_NO_BUTTON, fox.MOUSE_CODE_LEFT)
_.SetButtonMap("UI_STOCK", fox.PAD_R3, fox.KEY_V)
_.SetButtonMap("UI_CQC", fox.GK_PAD_NO_BUTTON, fox.MOUSE_CODE_LEFT)
_.SetButtonMap("UI_SIDE_ROLL", fox.GK_PAD_NO_BUTTON, fox.KEY_SHIFT)
_.SetButtonMap("UI_LIGHT_SWITCH", fox.PAD_R, fox.KEY_X)
_.SetButtonMap("UI_VEHICLE_FIRE", fox.PAD_L1, fox.MOUSE_CODE_LEFT)
_.SetButtonMap("UI_VEHICLE_CALL", fox.GK_PAD_NO_BUTTON, fox.KEY_Q)
_.SetButtonMap("UI_VEHICLE_DASH", fox.GK_PAD_NO_BUTTON, fox.KEY_W)
_.SetButtonMap("UI_VEHICLE_CAMERA", fox.PAD_R1, fox.KEY_F)
_.SetButtonMap("UI_PLACE_MARKER", fox.PAD_L2, fox.MOUSE_CODE_LEFT)
_.SetButtonMap("UI_MAP_MARKER", fox.GK_PAD_NO_BUTTON, fox.MOUSE_CODE_LEFT)
_.SetButtonMap("UI_SCORES", fox.GK_PAD_NO_BUTTON, fox.KEY_ESCAPE)
_.SetButtonMap("UI_DASH", fox.GK_PAD_NO_BUTTON, fox.KEY_SHIFT)
_.SetButtonMap("UI_WALK", fox.GK_PAD_NO_BUTTON, fox.KEY_CTRL)
_.SetButtonMap("UI_MB_HELP", fox.PAD_SELECT, fox.KEY_H)
_.SetButtonMap("UI_BUDDY_DASH", fox.PAD_X, fox.KEY_SHIFT)
_.SetButtonMap("HUD_DECIDE", fox.PAD_R3, fox.KEY_SPACE)
_.SetButtonMap("UI_PAD_ALL", fox.GK_PAD_NO_BUTTON, fox.EX_CODE_PAD_DIR)
_.SetButtonMap("UI_PAD_KEY_UD", fox.GK_PAD_NO_BUTTON, fox.EX_CODE_KEY_UD)
_.SetButtonMap("UI_PAD_KEY_LR", fox.GK_PAD_NO_BUTTON, fox.EX_CODE_KEY_LR)
_.SetButtonMap("UI_PAD_STICK_L", fox.GK_PAD_NO_BUTTON, fox.EX_CODE_STICK_L)
_.SetButtonMap("UI_PAD_STICK_R", fox.GK_PAD_NO_BUTTON, fox.EX_CODE_STICK_R)
_.SetButtonMap("UI_MOUSE_WHEEL", fox.GK_PAD_NO_BUTTON, fox.EX_CODE_MOUSE_WHEEL)
_.SetButtonMap("UI_MOUSE_MIDDLE", fox.GK_PAD_NO_BUTTON, fox.MOUSE_CODE_MIDDLE)
_.SetButtonMap("UI_EQUIP_STICK", fox.GK_PAD_NO_BUTTON, fox.EX_CODE_MOUSE_WHEEL)
_.SetButtonMap("UI_EQUIP_DIR", fox.GK_PAD_NO_BUTTON, fox.EX_CODE_PAD_DIR)
_.SetButtonMap("UI_BINO_RADIO", fox.GK_PAD_NO_BUTTON, fox.KEY_Q)
_.SetButtonMap("UI_BINO_ZOOM", fox.GK_PAD_NO_BUTTON, fox.KEY_V)
_.SetButtonMap("UI_BINO_MARKER", fox.GK_PAD_NO_BUTTON, fox.MOUSE_CODE_LEFT)
_.SetButtonMap("UI_BINO_CHANGE", fox.GK_PAD_NO_BUTTON, fox.KEY_T)
_.SetButtonMap("UI_BINO_DECIDE", fox.GK_PAD_NO_BUTTON, fox.KEY_RETURN)
_.SetButtonMap("CQC_KNIFE_KILL", fox.GK_PAD_NO_BUTTON, fox.KEY_E)
_.SetButtonMap("CQC_HOLD", fox.GK_PAD_NO_BUTTON, fox.MOUSE_CODE_LEFT)
_.SetButtonMap("CQC_INTERROGATE", fox.GK_PAD_NO_BUTTON, fox.KEY_Q)
_.CreateButtonMap()
_.SetKeyCodeEqual("UI_UP", fox.KEY_UP)
_.SetKeyCodeEqual("UI_DOWN", fox.KEY_DOWN)
_.SetKeyCodeEqual("UI_LEFT", fox.KEY_LEFT)
_.SetKeyCodeEqual("UI_RIGHT", fox.KEY_RIGHT)
_.SetKeyCodeEqual("UI_DECIDE", fox.KEY_RETURN)
_.SetKeyCodeEqual("HUD_DECIDE", fox.KEY_RETURN)
_.SetKeyCodeEqual("UI_STOCK", fox.MOUSE_CODE_MIDDLE)
_.CreateKeyData(128)
