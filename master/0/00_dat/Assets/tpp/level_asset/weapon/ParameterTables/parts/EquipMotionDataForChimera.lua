...
TppEquip.ReloadEquipMotionData2({
	version = 0,
	motions = {
		{ "SKL_001_SLIDE", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.033 },
		{ "SKL_004_HAMMER", TppEquip.AXIS_X_ROT, TppEquip.MOVE_ONEWAY, 0, 0.05, -62 },
		{ "SKL_001_SLIDE", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ONEWAY, 0, 0.05, -0.033 },
		{ "SKL_001_SLIDE", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.037 },
		{ "SKL_001_SLIDE", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ONEWAY, 0, 0.05, -0.037 },
		{ "SKL_002_CYLINDER", TppEquip.AXIS_Z_ROT, TppEquip.MOVE_ONEWAY, 0, 0.1, 60 },
		{ "SKL_006_HAMMER", TppEquip.AXIS_X_ROT, TppEquip.MOVE_ONEWAY, 0, 0.1, -35 },
		{ "SKL_001_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.05, -0.042 },
		{ "SKL_001_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.088 },
		{ "SKL_002_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.092 },
		{ "SKL_001_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.092 },
		{ "SKL_002_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.088 },
		{ "SKL_002_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.216 },
		{ "SKL_005_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.073 },
		{ "SKL_003_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.08 },
		{ "SKL_003_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.088 },
		{ "SKL_003_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.045 },
		{ "SKL_202_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.045 },
		{ "SKL_003_BOLT", TppEquip.AXIS_Z_TRANS, TppEquip.MOVE_ROUND, 0, 0.1, -0.1 },
		{ "SKL_002_AMMO", TppEquip.AXIS_Z_ROT, TppEquip.MOVE_ONEWAY, 0, 0.1, 60 },
	},
	poses = {
		{ "SKL_004_HAMMER", TppEquip.AXIS_X_ROT, -62 },
		{ "SKL_001_SLIDE", TppEquip.AXIS_Z_TRANS, -0.033 },
		{ "SKL_001_SLIDE", TppEquip.AXIS_Z_TRANS, -0.037 },
		{ "SKL_002_HAMMER", TppEquip.AXIS_X_ROT, -54 },
		{ "SKL_001_BOLT", TppEquip.AXIS_Z_TRANS, -0.042 },
		{ "SKL_001_BOLT", TppEquip.AXIS_Z_TRANS, -0.088 },
		{ "SKL_002_BOLT", TppEquip.AXIS_Z_TRANS, -0.092 },
		{ "SKL_002_BOLT", TppEquip.AXIS_Z_TRANS, -0.088 },
		{ "SKL_003_BOLT", TppEquip.AXIS_Z_TRANS, -0.045 },
		{ "SKL_202_BOLT", TppEquip.AXIS_Z_TRANS, -0.045 },
		{ "SKL_003_BOLT", TppEquip.AXIS_Z_TRANS, -0.1 },
	},
	mtars = {
