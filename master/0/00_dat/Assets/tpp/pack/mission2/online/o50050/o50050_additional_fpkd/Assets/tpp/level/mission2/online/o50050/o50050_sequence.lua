...
local PlayerDisableActionFlagMtbsDefault = PlayerDisableAction.CQC_KNIFE_KILL
...
this.saveVarsList = {
	...
	isGameStartWithDefence = {
		name = "isGameStartWithDefence",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	timeLimitforNonAbort = {
		name = "timeLimitforNonAbort",
		type = TppScriptVars.TYPE_UINT32,
		value = this.TIME_LIMIT.NON_ABORT,
		save = true,
		sync = true,
		wait = true,
		category = TppScriptVars.CATEGORY_MISSION,
	},
	fobIsAllResultSVarsSynced = {
		name = "fobIsAllResultSVarsSynced",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobCaptureHostageCount = {
		name = "fobCaptureHostageCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
		wait = true,
	...
	fobCaptureHostageCompensationCount = {
		name = "fobCaptureHostageCompensationCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobCaptureSoldierOwnerCount = {
		name = "fobCaptureSoldierOwnerCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobCaptureSoldierSupporterCount = {
		name = "fobCaptureSoldierSupporterCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobCaptureSoldierCompensationCount = {
		name = "fobCaptureSoldierCompensationCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobCaptureBiologicalResourceCount = {
		name = "fobCaptureBiologicalResourceCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobCaptureCommonMetalCount = {
		name = "fobCaptureCommonMetalCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobCaptureMinorMetalCount = {
		name = "fobCaptureMinorMetalCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobCapturePreciousMetalCount = {
		name = "fobCapturePreciousMetalCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobRewardStaffBaseRank = {
		name = "fobRewardStaffBaseRank",
		type = TppScriptVars.TYPE_UINT32,
		value = 0,
		save = true,
		sync = true,
	...
	fobStaffDeadOwnerCount = {
		name = "fobStaffDeadOwnerCount",
		type = TppScriptVars.TYPE_UINT32,
		value = 0,
		save = true,
		sync = true,
	...
	fobStaffDeadSupporterCount = {
		name = "fobStaffDeadSupporterCount",
		type = TppScriptVars.TYPE_UINT32,
		value = 0,
		save = true,
		sync = true,
	...
	fobStaffInjuryOwnerCount = {
		name = "fobStaffInjuryOwnerCount",
		type = TppScriptVars.TYPE_UINT32,
		value = 0,
		save = true,
		sync = true,
	...
	fobStaffInjurySupporterCount = {
		name = "fobStaffInjurySupporterCount",
		type = TppScriptVars.TYPE_UINT32,
		value = 0,
		save = true,
		sync = true,
	...
	numFultonedSnakeCount_OF = {
		name = "numFultonedSnakeCount_OF",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	numFultonedDDCount_OF = {
		name = "numFultonedDDCount_OF",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	numFultonedSnakeCount_DF = {
		name = "numFultonedSnakeCount_DF",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	numFultonedDDCount_DF = {
		name = "numFultonedDDCount_DF",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	numDeadSnakeCount_OF = {
		name = "numDeadSnakeCount_OF",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	numDeadSnakeCount_DF = {
		name = "numDeadSnakeCount_DF",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobIsEnableOpenWormhole = {
		name = "fobIsEnableOpenWormhole",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobRevengePointTotal = {
		name = "fobRevengePointTotal",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	posAbortWarmhole_x = {
		name = "posAbortWarmhole_x",
		type = TppScriptVars.TYPE_FLOAT,
		value = 0,
		save = true,
		sync = true,
		wait = true,
	...
	fobCaptureHostageRankCount = {
		name = "fobCaptureHostageRankCount",
		arraySize = TppMotherBaseManagementConst.STAFF_SECTION_RANK_COUNT_MAX,
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobCaptureSoldierOwnerRankCount = {
		name = "fobCaptureSoldierOwnerRankCount",
		arraySize = TppMotherBaseManagementConst.STAFF_SECTION_RANK_COUNT_MAX,
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
	...
	fobCaptureSoldierSupporterRankCount = {
		name = "fobCaptureSoldierSupporterRankCount",
		arraySize = TppMotherBaseManagementConst.STAFF_SECTION_RANK_COUNT_MAX,
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
	...
	fobCaptureSoldierCompensationRankCount = {
		name = "fobCaptureSoldierCompensationRankCount",
		arraySize = TppMotherBaseManagementConst.STAFF_SECTION_RANK_COUNT_MAX,
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
	...
	fobRescueStaffRankCount = {
		name = "fobRescueStaffRankCount",
		arraySize = TppMotherBaseManagementConst.STAFF_SECTION_RANK_COUNT_MAX,
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
	...
	fobStaffDeadOwnerRankCount = {
		name = "fobStaffDeadOwnerRankCount",
		arraySize = TppMotherBaseManagementConst.STAFF_SECTION_RANK_COUNT_MAX,
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
	...
	fobStaffDeadSupporterRankCount = {
		name = "fobStaffDeadSupporterRankCount",
		arraySize = TppMotherBaseManagementConst.STAFF_SECTION_RANK_COUNT_MAX,
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
	...
	fobStaffInjuryOwnerRankCount = {
		name = "fobStaffInjuryOwnerRankCount",
		arraySize = TppMotherBaseManagementConst.STAFF_SECTION_RANK_COUNT_MAX,
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
	...
	fobStaffInjurySupporterRankCount = {
		name = "fobStaffInjurySupporterRankCount",
		arraySize = TppMotherBaseManagementConst.STAFF_SECTION_RANK_COUNT_MAX,
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
	...
	espt_of_goal_on_versus = {
		name = "espt_of_goal_on_versus",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	espt_df_mark_ofp_count = {
		name = "espt_df_mark_ofp_count",
		type = TppScriptVars.TYPE_UINT8,
		value = 0,
		save = true,
		sync = true,
	...
	espt_df_fultoned_cntn_nclr = {
		name = "espt_df_fultoned_cntn_nclr",
		type = TppScriptVars.TYPE_INT32,
		value = 0,
		save = true,
		sync = true,
	...
	fobIsESPBonusSneakOnNight = {
		name = "fobIsESPBonusSneakOnNight",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobNumESPBonusSneakOnNight = {
		name = "fobNumESPBonusSneakOnNight",
		type = TppScriptVars.TYPE_FLOAT,
		value = 0,
		save = true,
		sync = true,
	...
	espt_df_total_battle = {
		name = "espt_df_total_battle",
		type = TppScriptVars.TYPE_INT32,
		value = 0,
		save = true,
		sync = true,
	...
	espt_of_total_collect_max = {
		name = "espt_of_total_collect_max",
		type = TppScriptVars.TYPE_UINT32,
		value = 200000,
		save = false,
		sync = false,
	...
	espt_of_total_destroy_max = {
		name = "espt_of_total_destroy_max",
		type = TppScriptVars.TYPE_UINT32,
		value = 200000,
		save = false,
		sync = false,
	...
	espt_df_total_defense_max = {
		name = "espt_df_total_defense_max",
		type = TppScriptVars.TYPE_UINT32,
		value = 200000,
		save = false,
		sync = false,
	...
	espt_of_total_collect_min = {
		name = "espt_of_total_collect_min",
		type = TppScriptVars.TYPE_INT32,
		value = -100000,
		save = false,
		sync = false,
	...
	espt_of_total_destroy_min = {
		name = "espt_of_total_destroy_min",
		type = TppScriptVars.TYPE_INT32,
		value = -100000,
		save = false,
		sync = false,
	...
	espt_df_total_defense_min = {
		name = "espt_df_total_defense_min",
		type = TppScriptVars.TYPE_INT32,
		value = -100000,
		save = false,
		sync = false,
	...
	fobIsThereRecoverStaff = {
		name = "fobIsThereRecoverStaff",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	timeLimitforVisiting = {
		name = "timeLimitforVisiting",
		type = TppScriptVars.TYPE_UINT32,
		value = this.TIME_LIMIT.VISITING,
		save = true,
		sync = true,
		wait = true,
		category = TppScriptVars.CATEGORY_MISSION,
	...
	fobRecoverBiologicalResourceCount = {
		name = "fobRecoverBiologicalResourceCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobRecoverCommonMetalCount = {
		name = "fobRecoverCommonMetalCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobRecoverMinorMetalCount = {
		name = "fobRecoverMinorMetalCount",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobRecoverPreciousMetalCo = {
		name = "fobRecoverPreciousMetalCo",
		type = TppScriptVars.TYPE_UINT16,
		value = 0,
		save = true,
		sync = true,
	...
	fobWepShortIsNokillMode = {
		name = "fobWepShortIsNokillMode",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobWepMidIsNokillMode = {
		name = "fobWepMidIsNokillMode",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobWepLonIsNokillMode = {
		name = "fobWepLonIsNokillMode",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobSecCameraIsNokillMode = {
		name = "fobSecCameraIsNokillMode",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobSecUavIsNokillMode = {
		name = "fobSecUavIsNokillMode",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobIsSneakForSupporter = {
		name = "fobIsSneakForSupporter",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobIsThereStolenStaff = {
		name = "fobIsThereStolenStaff",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	fobCaptureNuclearCount = {
		name = "fobCaptureNuclearCount",
		type = TppScriptVars.TYPE_UINT8,
		value = 0,
		save = true,
		sync = true,
	...
	fobUsingStaffIndexList = {
		name = "fobUsingStaffIndexList",
		arraySize = this.SOLDIER_INSTANCE_NUM,
		type = TppScriptVars.TYPE_UINT32,
		value = 0,
		save = true,
		sync = true,
	...
	defenceEventTaskValue = {
		name = "defenceEventTaskValue",
		arraySize = 8,
		type = TppScriptVars.TYPE_INT32,
		value = 0,
		save = true,
	...
	fobIsSendNoticeSneaking = {
		name = "fobIsSendNoticeSneaking",
		type = TppScriptVars.TYPE_BOOL,
		value = false,
		save = true,
		sync = true,
	...
	tacticalActionPointClient = {
		name = "tacticalActionPointClient",
		type = TppScriptVars.TYPE_UINT32,
		value = 0,
		save = true,
		sync = true,
	...
	this.CLST_PARAM = {
		{
			...
			GOAL_MARKER = string.format(
				"ly%03d_cl%02d_sequence0000|cl%02dpl%01d_uq_%04d_startpoint|Marker_Goal",
				numLayout,
				clstId,
				clstId,
				0,
			...
			GOAL = string.format(
				"ly%03d_cl%02d_sequence0000|cl%02dpl%01d_uq_%04d_startpoint|trap_Goal",
				numLayout,
				clstId,
				clstId,
				0,
			...
			CP_NAME = string.format(
				"ly%03d_cl%02d_npc0000|cl%02dpl%01d_uq_%04d_npc|%s",
				numLayout,
				clstId,
				clstId,
				0,
				clstId * 10,
				this.CP_NAME[clstId + 1]
			),
			GT_NAME = string.format(
				"ly%03d_cl%02d_combat0000|cl%02dpl%01d_uq_%04d_cbtlct|gt_0000",
				numLayout,
				clstId,
				clstId,
				0,
			...
			GT_NAME_01 = string.format(
				"ly%03d_cl%02d_combat0000|cl%02dpl%01d_mb_fndt_plnt_cbtlct|gt_plnt",
				numLayout,
				clstId,
				clstId,
				1
			...
			CHECK_POINTS = {
				plnt1 = string.format(
					"ly%03d_cl%02d_sequence0000|cl%02dpl%01d_mb_brdg_plnt_chkpnt|trap_CHK_brdg_plnt",
					numLayout,
					clstId,
					clstId,
					1
...
function this.OnUpdate()
	...
	if DebugMenu then
		...
		if mvars.fobDebug.forceGameOverOutOfMissionArea then
			...
			TppMission.ReserveGameOver(
				TppDefine.GAME_OVER_TYPE.OUTSIDE_OF_MISSION_AREA,
				TppDefine.GAME_OVER_RADIO.OUT_OF_MISSION_AREA
			)
		end
		...
		if mvars.fobDebug.forceGameOverTimeOut then
			...
			TppMission.ReserveGameOver(
				TppDefine.GAME_OVER_TYPE.FOB_TIME_OVER,
				TppDefine.GAME_OVER_RADIO.OUT_OF_MISSION_AREA
			)
		end
		...
		if mvars.fobDebug.forceGameOverFultoned then
			...
			TppMission.ReserveGameOver(
				TppDefine.GAME_OVER_TYPE.FOB_FULTONED,
				TppDefine.GAME_OVER_RADIO.OUT_OF_MISSION_AREA
			)
		end
		...
		if mvars.fob_enteredGoalArea then
			DebugText.Print(
				DebugText.NewContext(),
				{ 0.5, 0.5, 1.0 },
				"mvars.fob_enteredGoalArea : waiting equip server check."
			)
		end
...
function this.OnGameOverHost(gameOverType)
	...
	this.SwitchExecByIsGameMode(function()
		...
		if
			TppMission.CheckGameOverDemo(TppDefine.GAME_OVER_TYPE.FOB_TIME_OVER)
			or TppMission.CheckGameOverDemo(TppDefine.GAME_OVER_TYPE.PLAYER_DEAD)
			or TppMission.CheckGameOverDemo(TppDefine.GAME_OVER_TYPE.PLAYER_FALL_DEAD)
			or TppMission.CheckGameOverDemo(TppDefine.GAME_OVER_TYPE.FOB_FULTONED)
		then
...
function this.PlayerManualPlacementModeSetting()
	...
	this.playerInitialItemTable =
		{ "EQP_None", "EQP_None", "EQP_None", "EQP_None", "EQP_None", "EQP_None", "EQP_None", "EQP_None" }
...
function this.MissionPrepare()
	...
	this.currentClusterSetting.strEscapeWormholes =
		this.CLST_PARAM[this.currentClusterSetting.numClstId].ESCAPE_WORMHOLE
	...
	this.missionObjectiveDefine.clst_goalOfCurrentCluster_test = {
		gameObjectName = this.currentClusterSetting.strGoalMarker,
		viewType = "all",
		visibleArea = 0,
		randomRange = 0,
		setNew = false,
	...
	local systemCallbackTable = {
		...
		OnEndMissionReward = function()
			...
			local isSyncDefMissionClear, isSyncMissionClearType, isSyncDefGameOver, isSyncGameOverType =
				TppMission.GetSyncMissionStatus()
			if isSyncDefMissionClear then
				this.SwitchExecByIsHost(function()
					TppMission.MissionFinalize({ isNoFade = true })
				end, TppMission.ReturnToMission)
			else
				this.SwitchExecByIsHost(TppMission.GameOverAbortMission, function()
		...
		OnMissionGameEndFadeOutFinish = function()
			...
			this.SwitchExecByIsHost(function()
				this.SwitchExecByIsGameMode(function() end, function()
		...
		OnOutOfMissionArea = function()
			...
			this.SwitchExecByIsHost(hostOnOutOfMissionArea, TppMission.ShowGameOverMenu)
		end,
		...
		OnFobDefenceGameOver = function(fobDefenceGameOverType)
			...
			this.SwitchExecByIsGameMode(vsCommonFunc, vsCommonFunc, function() end, fobDefenceGameOverType)
		end,
		nil,
	}
	...
	if DebugMenu then
		...
		mvars.fobDebug.forceGameOverOutOfMissionArea = false
		DebugMenu.AddDebugMenu(
			"FobLua",
			"GameOverOutOfMissionArea",
			"bool",
			mvars.fobDebug,
			"forceGameOverOutOfMissionArea"
		)
		mvars.fobDebug.forceGameOverTimeOut = false
		...
		DebugMenu.AddDebugMenu(
			"FobLua",
			"setTimeLimitForNonAbortLastSecond",
			"bool",
			mvars.fobDebug,
			"setTimeLimitForNonAbortLastSecond"
		)
...
function this.OnEndMissionPrepareSequence()
	...
	this.SwitchExecByIsGameMode(function() end, function()
		...
		this.SwitchExecByIsHost(function() end, function()
...
function this.OnRestoreSVars()
	...
	if mineEquipId == nil then
		Fox.Log(
			"o50050_sequence.OnRestoreSVars : TppPlaced.SetFobFreePositionMineId is nil. Set default TppEquip.EQP_SWP_DMine"
		)
...
this.AddUniqueMapIconText = function()
	...
	this.SwitchExecByIsHost(function()
		TppUiCommand.RegisterIconUniqueInformation({
			markerId = GameObject.GetGameObjectId(markerId),
			langId = "marker_fob_goal",
		})
	end, function()
		TppUiCommand.RegisterIconUniqueInformation({
			markerId = GameObject.GetGameObjectId(markerId),
			...
			},
			{
				...
				func = function(neutralizedGameObjectId, attackerGameObjectId, neutralizeType, neutralizeCause)
					if neutralizedGameObjectId == OF_PLAYER_ID then
						Fox.Log("***************************************************************************")
						Fox.Log(
							"NeutralizeSneakPlayer:NeutralizeFob:::arg1:"
								.. neutralizedGameObjectId
								.. "::arg2:"
						...
						elseif
							neutralizeCause == NeutralizeFobCause.SNIPER_RIFLE
							or neutralizeCause == NeutralizeFobCause.ANTIMATERIAL_RIFLE
						then
						...
						elseif
							neutralizeCause == NeutralizeFobCause.CQC
					...
					elseif neutralizedGameObjectId == DF_PLAYER_ID then
						Fox.Log("***************************************************************************")
						Fox.Log(
							"NeutralizeDefencePlayer:NeutralizeFob:::arg1:"
								.. neutralizedGameObjectId
								.. "::arg2:"
								.. attackerGameObjectId
								.. "::arg3:"
...

			{
				...
				func = function(gameObjectId, attackId, attackerObjectId, flag)
					if Tpp.IsSoldier(gameObjectId) and attackerObjectId == OF_PLAYER_ID then
						Fox.Log(
							"#### HeadShot :: gameObjectId = "
								.. tostring(gameObjectId)
								.. " attackerObjectId = "
								.. tostring(attackerObjectId)
								.. " attackId = "
								.. tostring(attackId)
								.. " flag = "
								.. tostring(flag)
		...
		Nt = {
			{
				...
				func = function()
					...
					this.SwitchExecByIsGameMode(function() end, function() end, function()
		...
		Mission = {
			...
			},
			{
				...
				func = function(gameObjectId, tacticalTakeDownType)
					Fox.Log(
						"#### OnAddTacticalActionPoint :: gameObjectId = "
							.. tostring(gameObjectId)
							.. " tacticalTakeDownType = "
							.. tacticalTakeDownType
					)
...
this.OnDamageInVisit = function(gameObjectId, attackId, attackerId)
	...
	if attackerId == OF_PLAYER_ID then
		if isSafeActiveAttack(attackId) == false and TppDamage.IsActiveByAttackId(attackId) then
...
this.CheckEventTaskOnGoal = function()
	...
	if not TppPlayer.IsCurrentPlayerOcelot() and not TppPlayer.IsCurrentPlayerQuiet() then
...
this.SetLooseRewardClient = function() end
...
this.HostExecuteRestart = function()
	...
	TppSave.VarSave()
	Fox.Log(
		"######## HostExecuteRestart ######## gvars.sav_varRestoreForContinue = "
			.. tostring(gvars.sav_varRestoreForContinue)
	)
...
this.EnterStartSneaknigFromHeli = function()
	...
	if mvars.isDoneWarpToHeli == false then
		...
		GameObject.SendCommand(
			...
			{ id = "CreateWormhole", isEnter = true }
		)
	else
...
this.EndStartSneaknigFromHeli = function()
	...
	GameObject.SendCommand(
		{ type = "TppPlayer2", index = PlayerInfo.GetLocalPlayerIndex() },
		{ id = "CreateWormhole", isEnter = false }
	)
...
this.UpdateStartPosition = function(param)
	...
	local key = "player_locator_clst"
		.. (this.currentClusterSetting.numClstId - 1)
		.. "_plnt"
		.. numClusterGrade
		.. "_of"
		.. mvars.numStartPoint
	...
	Player.SetWarpToPositionToWormholeFilter(
		Vector3(mvars.warpPlayerPos[1], mvars.warpPlayerPos[2], mvars.warpPlayerPos[3])
	)
end
...
this.ShowRespawnMenu = function()
	...
	TppUiCommand.StartRespawnMenuSetRecord({
		wait = mvars.numDisableRespawnTime,
		record = numRspPoints,
		respawnPoints = rspPoints,
	})
...
function this.GetAbortWarmHolePosition()
	...
	local pos = GameObject.SendCommand(
		{ type = "TppPlayer2", index = PlayerInfo.GetLocalPlayerIndex(0) },
		{ id = "GetWormholePosition" }
	)
	local trans = {}
...
function this.SetAbortWarmHole()
	...
	GameObject.SendCommand(
		{ type = "TppPlayer2", index = PlayerInfo.GetLocalPlayerIndex() },
		{
			id = "SetWormholePosition",
			position = Vector3({ svars.posAbortWarmhole_x, svars.posAbortWarmhole_y, svars.posAbortWarmhole_z }),
		}
	)

	GameObject.SendCommand(
		{ type = "TppPlayer2", index = PlayerInfo.GetLocalPlayerIndex() },
		{ id = "SetWormhole", disp = true }
	)
end
...
function this.OpenAbortWarmhole()
	...
	GameObject.SendCommand(
		{ type = "TppPlayer2", index = PlayerInfo.GetLocalPlayerIndex() },
		{ id = "SetWormholeIcon", enable = true }
	)
end
...
function this.PermitAbort()
	...
	if TppServerManager.FobIsSneak() then
		GameObject.SendCommand(
			{ type = "TppPlayer2", index = PlayerInfo.GetLocalPlayerIndex() },
			{ id = "SetWormholeIconType", enable = true }
		)
	end
...
function this.DisableAbort(param)
	...
	GameObject.SendCommand(
		{ type = "TppPlayer2", index = PlayerInfo.GetLocalPlayerIndex() },
		{ id = "SetWormholeIconType", enable = false }
	)
end
...
this.AddTempClash = function(gameObjectId, locatorNameHash, dataSetNameHash, AttackerId)
	if TppGameSequence.GetPatchVersion() >= PATCH_VERSION_DAY1 then
		...
		if
			(vars.fobSneakMode == FobMode.MODE_ACTUAL or vars.fobSneakMode == FobMode.MODE_VISIT)
		...
		then
			if this.IsAirGun(gameObjectId) then
				...
				if isWest == true then
					TppMotherBaseManagement.AddTempClashedPlacementCount({
						resourceId = TppMotherBaseManagementConst.RESOURCE_ID_ANTI_AIR_GATLING_GUN_WEST,
					})
				elseif isWest == false then
					TppMotherBaseManagement.AddTempClashedPlacementCount({
						resourceId = TppMotherBaseManagementConst.RESOURCE_ID_ANTI_AIR_GATLING_GUN_EAST,
					})
				end
			end
			...
			if this.IsMachineGun(gameObjectId) then
				...
				if isWest == true then
					TppMotherBaseManagement.AddTempClashedPlacementCount({
						resourceId = TppMotherBaseManagementConst.RESOURCE_ID_EMPLACEMENT_GUN_WEST,
					})
				elseif isWest == false then
					TppMotherBaseManagement.AddTempClashedPlacementCount({
						resourceId = TppMotherBaseManagementConst.RESOURCE_ID_EMPLACEMENT_GUN_EAST,
					})
				end
			end
			...
			if this.IsMortar(gameObjectId) then
				...
				TppMotherBaseManagement.AddTempClashedPlacementCount({
					resourceId = TppMotherBaseManagementConst.RESOURCE_ID_MORTAR_NORMAL,
				})
			end
		else
...
function this.SwitchGoalAreaSpot(switch, clstId)
	...
	if switch == true then
		...
		local posSpotList, rotSpotY =
			mtbs_cluster.GetPosAndRotY_FOB(TppDefine.CLUSTER_NAME[clstId + 1], "plnt0", pos, rot)
		local posSpot = Vector3(posSpotList[1], posSpotList[2] + 0.0001, posSpotList[3])
		Fox.Log(
			"### SwitchGoalAreaSpot ### :: posSpot "
				.. tostring(posSpot)
				.. " rot = "
				.. rot
				.. " rotSpotY = "
...
this.IsNonPermitLost = function(playerId, staffId)
	Fox.Log(
		"### IsNonPermitLost ###  :: vars.returnStaffHeader = "
			.. tostring(vars.returnStaffHeader)
			.. ", vars.returnStaffSeeds = "
			.. tostring(vars.returnStaffSeeds)
	)
	...
	local fnc_lostDefencePlayer = function(PlayerId)
		...
		if this.IsNonPermitLost(PlayerId) == false then
			...
			if TppGameSequence.GetPatchVersion() >= PATCH_VERSION_DAY1 then
				...
				TppMotherBaseManagement.KillTempStaffFob({
					staffId = staffId,
					gameObjectId = PlayerId,
					isFobSupporter = isDefenderEqualSupporter,
					isFobPlayer = true,
				})
			else
...
this.AddRevengePoint = function(revengeLabel)
	...
	if vars.fobIsSecurity == 1 then
		...
		if not permitAddRevengeInSecurity[revengeLabel] then
			Fox.Log(
				"### AddRevengePoint :: add revenge skip because now in security. revengeLabel = "
					.. tostring(revengeLabel)
			)
			return
		end
	end
...
this.AddHeroPointForResultOffence = function(addPointTable)
	...
	Fox.Log(
		"### AddHeroPointForResultOffence :: addPointHero = "
			.. tostring(hPoint)
			.. "addPointOrg = "
			.. tostring(oPoint)
	)
...
this.AddHeroPointForResultDefence = function(addPointTable)
	...
	Fox.Log(
		"### AddHeroPointForResultDefence :: addPointHero = "
			.. tostring(hPoint)
			.. "addPointOrg = "
			.. tostring(oPoint)
	)
...
this.FultonDefencePlayer = function(playerId, staffId, fultonExecuteId, espParam)
	...
	local function AddTempStaffOnDefencePlayerFultoned(playerId, staffId)
		Fox.Log(
			" ### Fultoned Defence Player :: can Flton : AddTempStaffOnDefencePlayerFultoned ### playerId = "
				.. playerId
				.. "::staffId = "
				.. staffId
		)
...
this.CalculateEspionageTotal = function(numClearType)
	...
	svars.espt_of_total_result =
		fnc_SetESPTotal(resultTotal, svars.espt_of_total_result_min, svars.espt_of_total_result_max)
	...
	svars.espt_of_total_sneak =
		fnc_SetESPTotal(sneakTotal, svars.espt_of_total_sneak_min, svars.espt_of_total_sneak_max)
	...
	svars.espt_of_total_collect =
		fnc_SetESPTotal(collectTotal, svars.espt_of_total_collect_min, svars.espt_of_total_collect_max)
	...
	svars.espt_of_total_destroy =
		fnc_SetESPTotal(destroyTotal, svars.espt_of_total_destroy_min, svars.espt_of_total_destroy_max)
	...
	svars.espt_df_total_result =
		fnc_SetESPTotal(resultTotalDF, svars.espt_df_total_result_min, svars.espt_df_total_result_max)
	...
	svars.espt_df_total_defense =
		fnc_SetESPTotal(collectTotalDF, svars.espt_df_total_defense_min, svars.espt_df_total_defense_max)
...
this.CalculateResult = function(numClearType)
	...
	local numTotalSecurityGadjetCount = (
		mvars.mbMine_placedCountTotal
		+ mvars.mbDecoy_placedCountTotal
		+ mvars.mbSecCam_placedCountTotal
		+ mvars.mbUav_placedCountTotal
		+ mvars.mbIrSensor_placedCountTotal
		+ mvars.mbStolenAlarm_placedCountTotal
	)
	local numTotalContainerCount = mvars.mbContainer_placedCountTotal + mvars.mbNuclearContainer_placedCountTotal
	local numTotalPutWeaponCount = mvars.mbMortar_placedCountTotal
		+ mvars.mbEastTurret_placedCountTotal
		+ mvars.mbWestTurret_placedCountTotal
		+ mvars.mbEastAAG_placedCountTotal
		+ mvars.mbWestAAG_placedCountTotal
	...
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		elseif numClearType == CLEAR_TYPE_RESULT_GOAL then
			local espParm_goal =
				this.GetESPUnitValue_OFUp(baseDiffOF, 1, GetServerParameter("ESPIONAGE_POINT_OFFENSE_GOAL"))
			svars.espt_of_goal = svars.espt_of_goal + espParm_goal
		elseif numClearType == CLEAR_TYPE_RESULT_DEAD then
			local espParm_lose =
				this.GetESPUnitValue_OFDown(baseDiffOF, GetServerParameter("ESPIONAGE_POINT_OFFENSE_LOSE"))
			svars.espt_of_lose = svars.espt_of_lose + espParm_lose
		elseif numClearType == CLEAR_TYPE_RESULT_FULTONED then
			local espParm_fultoned =
				this.GetESPUnitValue_OFDown(baseDiffOF, GetServerParameter("ESPIONAGE_POINT_OFFENSE_FULTONED"))
		...
		elseif numClearType == CLEAR_TYPE_RESULT_ESCAPE then
			local espParm_escape =
				this.GetESPUnitValue_OFDown(baseDiffOF, GetServerParameter("ESPIONAGE_POINT_OFFENSE_ESCAPE"))
		...
		if svars.alertCount == 0 then
			local espParm_noalrt =
				this.GetESPUnitValue_OFUp(baseDiffOF, 1, GetServerParameter("ESPIONAGE_POINT_OFFENSE_NO_ALERT"))
			svars.espt_of_no_alert = svars.espt_of_no_alert + espParm_noalrt
		end

		if svars.cnt_kill_dds == 0 and svars.cnt_kill_dfp == 0 then
			local espParm_nokill = this.GetESPUnitValue_OFUp(
				baseDiffOF,
				GetServerParameter("ESPIONAGE_POINT_COEFFICIENT_OFFENSE_NO_KILL"),
				GetServerParameter("ESPIONAGE_POINT_OFFENSE_NO_KILL")
			)
			svars.espt_of_no_kill = svars.espt_of_no_kill + espParm_nokill
		end

		if svars.reflexCount == 0 then
			local espParm_norflx =
				this.GetESPUnitValue_OFUp(baseDiffOF, 1, GetServerParameter("ESPIONAGE_POINT_OFFENSE_NO_REFLEX"))
			svars.espt_of_no_reflex = svars.espt_of_no_reflex + espParm_norflx
		end

		if svars.alertCount == 0 and svars.cnt_kill_dds == 0 and svars.cnt_kill_dfp == 0 and svars.reflexCount == 0 then
...
this.CalculateRansomeResult = function()
	...
	svars.fobGmpSubtract_OF = (gmp_ForRansomOF * svars.numFultonedSnakeCount_OF * 1.5)
		+ (gmp_ForRansomOF * svars.numDeadSnakeCount_OF)
...
function this.GetEspSubtractionRate_Offence()
	...
	Fox.Log(
		"*** GetEspSubtractionRate_Offence:OffenceFobGrade::"
			.. (TppServerManager.GetFobGrade() + 1)
			.. ":Rate::"
			.. rate
	)
	if rate == 0 then
...
function this.GetEspSubtractionRate_Deffense()
	...
	Fox.Log(
		"*** GetEspSubtractionRate_Deffense:DefenseFobGrade::"
			.. (TppNetworkUtil.GetClientFobGrade() + 1)
			.. ":Rate::"
			.. rate
	)
	if rate == 0 then
...
this.SetAnnounceEspPoint = function(AnnounceParam)
	Fox.Log(
		"### SetAnnounceEspPoint :: upPoint = "
			.. tostring(AnnounceParam.upPoint)
			.. "downPoint = "
			.. tostring(AnnounceParam.downPoint)
			.. "   downLangId = "
			.. tostring(AnnounceParam.downLangId)
			.. "   upLangId = "
			.. tostring(AnnounceParam.upLangId)
	)
...
function this.SetAndAnnounceEspPoint_FultonCntn()
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		local baseDiffOF, baseDiffDF = this.GetCurrentBaseDifficulty()
		local param_of = this.GetESPUnitValue_OFUp(
			baseDiffOF,
			GetServerParameter("ESPIONAGE_POINT_COEFFICIENT_OFFENSE_FULTON_CNTN"),
			GetServerParameter("ESPIONAGE_POINT_OFFENSE_FULTON_CNTN")
		)
		local param_df =
			this.GetESPUnitValue_DFDown(baseDiffDF, GetServerParameter("ESPIONAGE_POINT_DEFENSE_SAVE_CNTN"))

		this.SwitchExecByIsHost(function()
			svars.espt_of_fluton_cntn = svars.espt_of_fluton_cntn + param_of

			this.SetAnnounceEspPoint({
				upPoint = param_of,
				sbj = "cmmn_name_container",
				upLangId = "espFultonContainer_a",
			})
			...
			this.SetAnnounceEspPoint({
				downPoint = -param_df,
				sbj = "cmmn_name_container",
				downLangId = "espFultonContainer_d",
			})
		end)
	end
end
...
function this.SetAndAnnounceEspPoint_FultonNClerCntn()
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		local param_of = this.GetESPUnitValue_OFUp(
			baseDiffOF,
			GetServerParameter("ESPIONAGE_POINT_COEFFICIENT_OFFENSE_FULTON_NUCLEAR"),
			GetServerParameter("ESPIONAGE_POINT_OFFENSE_FULTON_NUCLEAR")
		)
		local param_df =
			this.GetESPUnitValue_DFDown(baseDiffDF, GetServerParameter("ESPIONAGE_POINT_DEFENSE_FULTONED_NUCLEAR"))
...
function this.SetAndAnnounceEspPoint_FultonPtwp(strFultoned)
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		local param_of = this.GetESPUnitValue_OFUp(
			baseDiffOF,
			GetServerParameter("ESPIONAGE_POINT_COEFFICIENT_OFFENSE_FULTON_PTWP"),
			GetServerParameter("ESPIONAGE_POINT_OFFENSE_FULTON_PTWP")
		)
		local param_df =
			this.GetESPUnitValue_DFDown(baseDiffDF, GetServerParameter("ESPIONAGE_POINT_DEFENSE_FULTONED_PTWP"))
...
function this.SetAndAnnounceEspPoint_FultonDds(gameObjectId)
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		local param_of = this.GetESPUnitValue_OFUp(
			baseDiffOF,
			GetServerParameter("ESPIONAGE_POINT_COEFFICIENT_OFFENSE_FULTON_DDS"),
			GetServerParameter("ESPIONAGE_POINT_OFFENSE_FULTON_DDS")
		)
		local param_df =
			this.GetESPUnitValue_DFDown(baseDiffDF, GetServerParameter("ESPIONAGE_POINT_DEFENSE_FULTONED_DDS"))
...
function this.SetAndAnnounceEspPoint_DestroyPtwp(strDestoryed)
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		local param_of = this.GetESPUnitValue_OFUp(
			baseDiffOF,
			GetServerParameter("ESPIONAGE_POINT_COEFFICIENT_OFFENSE_DESTROY_PTWP"),
			GetServerParameter("ESPIONAGE_POINT_OFFENSE_DESTROY_PTWP")
		)
		local param_df =
			this.GetESPUnitValue_DFDown(baseDiffDF, GetServerParameter("ESPIONAGE_POINT_DEFENSE_DESTROYED_PTWP"))
...
function this.SetAndAnnounceEspPoint_DestroyScgj(strDestoryed)
	...
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		this.SwitchExecByIsHost(function()
			...
			local param = this.GetESPUnitValue_OFUp(
				baseDiffOF,
				GetServerParameter("ESPIONAGE_POINT_COEFFICIENT_OFFENSE_DESTROY_SCGJ"),
				GetServerParameter("ESPIONAGE_POINT_OFFENSE_DESTROY_SCGJ")
			)
...
function this.SetAndAnnounceEspPoint_KillDds(gameObjectId)
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		local param_of = this.GetESPUnitValue_OFUp(
			baseDiffOF,
			GetServerParameter("ESPIONAGE_POINT_COEFFICIENT_OFFENSE_KILL_DDS"),
			GetServerParameter("ESPIONAGE_POINT_OFFENSE_KILL_DDS")
		)
		local param_df =
			this.GetESPUnitValue_DFDown(baseDiffDF, GetServerParameter("ESPIONAGE_POINT_DEFENSE_KILLED_DDS"))
		local statusFlag = GameObject.SendCommand(gameObjectId, { id = "GetStateFlag" })
...
function this.SetAndAnnounceEspPoint_FultonDF()
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		local baseDiffOF, baseDiffDF = this.GetCurrentBaseDifficulty()
		local param_of =
			this.GetESPUnitValue_OFUp(baseDiffOF, 1, GetServerParameter("ESPIONAGE_POINT_OFFENSE_FULTON_DFP"))
...
function this.SetAndAnnounceEspPoint_EliminateDF()
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		this.SwitchExecByIsHost(function()
			local baseDiffOF, baseDiffDF = this.GetCurrentBaseDifficulty()
			local param =
				this.GetESPUnitValue_OFUp(baseDiffOF, 1, GetServerParameter("ESPIONAGE_POINT_OFFENSE_KILL_DFP"))
...
function this.SetAndAnnounceEspPoint_HeadShotDDS(gameObjectId)
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		this.SwitchExecByIsHost(function()
			local baseDiffOF, baseDiffDF = this.GetCurrentBaseDifficulty()
			local param =
				this.GetESPUnitValue_OFUp(baseDiffOF, 1, GetServerParameter("ESPIONAGE_POINT_OFFENSE_HEADSHOT_DDS"))
			local statusFlag = GameObject.SendCommand(gameObjectId, { id = "GetStateFlag" })
...
function this.SetAndAnnounceEspPoint_HeadShotDF(gameObjectId, attackId, attackerObjectId, flag)
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		this.SwitchExecByIsHost(function()
			...
			local baseDiffOF, baseDiffDF = this.GetCurrentBaseDifficulty()
			local param =
				this.GetESPUnitValue_OFUp(baseDiffOF, 1, GetServerParameter("ESPIONAGE_POINT_OFFENSE_HEADSHOT_DFP"))
...
function this.SetAndAnnounceEspPoint_HeadShotOF(gameObjectId, attackId, attackerObjectId, flag)
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		local function GetESPValue_HeadShotOF()
			local baseDiffOF, baseDiffDF = this.GetCurrentBaseDifficulty()
			local param =
				this.GetESPUnitValue_DFUp(baseDiffOF, GetServerParameter("ESPIONAGE_POINT_DEFENSE_HEADSHOT_OFP"))
			return param
		end
...
function this.OnPlayerStaminaOut(playerId, value)
	if vars.fobSneakMode == FobMode.MODE_ACTUAL then
		...
		if playerId == OF_PLAYER_ID then
			local baseDiffOF, baseDiffDF = this.GetCurrentBaseDifficulty()
			local param_of =
				this.GetESPUnitValue_OFDown(baseDiffOF, GetServerParameter("ESPIONAGE_POINT_OFFENSE_DOWNED"))
			local param_df =
				this.GetESPUnitValue_DFUp(baseDiffDF, GetServerParameter("ESPIONAGE_POINT_DEFENSE_DOWN_OFP"))
	...
	if TppServerManager.FobIsSneak() and (playerId == OF_PLAYER_ID) then
...
this.TimerStartTimeLimit = function(timerName)
	...
	Fox.Log(
		"___________ TimeSec : "
			.. tostring(this.TIME_LIMIT_LIST[timerName].TimeSec)
			.. " HostTimeCountLang : "
			.. tostring(this.TIME_LIMIT_LIST[timerName].HostTimeCountLang)
			.. " ClientTimeCountLang: "
			.. tostring(this.TIME_LIMIT_LIST[timerName].ClientTimeCountLang)
	)
...
this.SetCameraEscapeFromWH = function(gameObjectId, timerName, announceLog)
	...
	Fox.Log(
		"TppPlayer.StartGameOverCamera : gameObjectId = "
			.. tostring(gameObjectId)
			.. ", timerName = "
			.. tostring(timerName)
	)
					...
					if DebugText then
						if TppNetworkUtil.GetSessionMemberCount() ~= 1 then
							DebugText.Print(
								DebugText.NewContext(),
								{ 0.5, 0.5, 1.0 },
								"[Seq_Demo_SyncGameStart] Host : wait sync game start."
							)
						end
					end
				end
				...
				elseif svars.fob_isHostGameStart and Gimmick.IsJoinNewClientSynced() then
					...
					if DebugText then
						DebugText.Print(
							DebugText.NewContext(),
							{ 0.5, 0.5, 1.0 },
							"[Seq_Demo_SyncGameStart] Client : wait host game start."
						)
					end
				end
			end
...
sequences.Seq_Game_FOB = {
		...
		local messageTable = {
			...
			Player = {
				{
					...
					func = function(deadPlayerIndex, AttackerId)
						Fox.Log(
							"DeadInFOB ::: deadPlayerIndex ="
								.. tostring(deadPlayerIndex)
								.. "AttackerId = "
								.. tostring(AttackerId)
						)
						local baseDiffOF, baseDiffDF = this.GetCurrentBaseDifficulty()
						if deadPlayerIndex == OF_PLAYER_ID then
							local param_df = this.GetESPUnitValue_DFUp(
								baseDiffDF,
								GetServerParameter("ESPIONAGE_POINT_DEFENSE_KILL_OFP")
							)
						...
						if deadPlayerIndex == DF_PLAYER_ID then
							local param_df = this.GetESPUnitValue_DFDown(
								baseDiffDF,
								GetServerParameter("ESPIONAGE_POINT_DEFENSE_DEAD")
							)
							this.SwitchExecByIsHost(
				...
				},
				{
					...
					func = function(HitObjId, AttackId, AttackerObjId)
						...
						elseif (HitObjId == DF_PLAYER_ID) and (AttackerObjId == OF_PLAYER_ID) then
							this.SwitchExecByIsHost(this.OnPlayerDamagedDefence, function()
					...
					func = function(fultonedPlayerId, staffId, isSuccess, fultonExecuteId)
						...
						if fultonedPlayerId == OF_PLAYER_ID then
							if mvars.isClientSessionStart ~= true then
								local param_df = this.GetESPUnitValue_DFUp(
									baseDiffDF,
									GetServerParameter("ESPIONAGE_POINT_DEFENSE_FULTON_OFP")
								)
								this.SwitchExecByIsHost(
						...
						elseif fultonedPlayerId == DF_PLAYER_ID then
							local param_df = this.GetESPUnitValue_DFDown(
								baseDiffDF,
								GetServerParameter("ESPIONAGE_POINT_DEFENSE_FULTONED")
							)
				...
				},
				{
					...
					func = function(AttackPlayerId, ReceivePlayerId)
						Fox.Log(
							"#### CqcHoldStart : #### AttackPlayerId = "
								.. tostring(AttackPlayerId)
								.. "ReceivePlayerId = "
								.. ReceivePlayerId
						)
				...
				},
				{
					...
					func = function(gameObjectId, attackerObjectId, attackId, flag)
						Fox.Log(
							"#### Player::::PlayerTapHeadShot :: gameObjectId = "
								.. tostring(gameObjectId)
								.. " attackerObjectId = "
								.. tostring(attackerObjectId)
								.. " attackId = "
						...
						if
							bit.band(flag, HeadshotMessageFlag.NEUTRALIZE_DONE) ~= HeadshotMessageFlag.NEUTRALIZE_DONE
						then
				...
				},
				{
					...
					func = function(gameObjectId, attackerObjectId, flag)
						Fox.Log(
							"#### Player::::PlayerTapHeadShotFar :: gameObjectId = "
								.. tostring(gameObjectId)
								.. " attackerObjectId = "
								.. tostring(attackerObjectId)
								.. " flag = "
						...
						if
							(gameObjectId == OF_PLAYER_ID and svars.espt_df_ttd_pl ~= 0)
							or (gameObjectId == DF_PLAYER_ID and svars.espt_of_ttd_pl_done)
						then
				...
				},
				{
					...
					func = function(gameObjectId, attackerObjectId, flag)
						Fox.Log(
							"#### Player::::PlayerTapRocketArm :: gameObjectId = "
								.. tostring(gameObjectId)
								.. " attackerObjectId = "
								.. tostring(attackerObjectId)
								.. " flag = "
				...
				},
				{
					...
					func = function(gameObjectId, attackerObjectId, flag)
						Fox.Log(
							"#### Player::::PlayerTapCqc :: gameObjectId = "
								.. tostring(gameObjectId)
								.. " attackerObjectId = "
								.. tostring(attackerObjectId)
								.. " flag = "
			...
			GameObject = {
				...
				},
				{
					...
					func = function(gameObjectId, fultonedPlayer)
						Fox.Log(
							"### FultonInfo gameObjectId = "
								.. tostring(gameObjectId)
								.. "fultonedPlayer = "
								.. tostring(fultonedPlayer)
						)
						...
						if fultonedPlayer == OF_PLAYER_ID then
							...
							if Tpp.IsFultonContainer(gameObjectId) then
								if this.IsExistNuclearContainer() and Gimmick.IsNuclearTypeContainer(gameObjectId) then
								...
								this.SwitchExecByIsGameMode(function()
									if
										Gimmick.CallBurglarAlarm(
											gameObjectId,
											mvars.numBurglarAlarmRange,
											mvars.numBurglarAlarmTime
										) == true
									then
										Fox.Log(
											"___________o50050_sequence.Seq_Game_FOB.Gimmick.CallBurglarAlarm / Fulton"
										)
				...
				{
					msg = "ChangePhase",
					sender = mtbs_enemy.cpNameDefine,
							...
							if vars.fobSneakMode == FobMode.MODE_ACTUAL then
								this.SwitchExecByIsHost(function()
									if TppHero.IsHero() == true then
										TppHero.SetAndAnnounceHeroicOgrePoint(
											TppHero.STARTED_COMBAT_ON_FOB_HERO,
											"fobFound",
											nil
										)
									else
										TppHero.SetAndAnnounceHeroicOgrePoint(
											TppHero.STARTED_COMBAT_ON_FOB,
											"fobFound",
											nil
										)
									end
									...
									local baseDiffOF, baseDiffDF = this.GetCurrentBaseDifficulty()
									local param = this.GetESPUnitValue_OFDown(
										baseDiffOF,
										GetServerParameter("ESPIONAGE_POINT_OFFENSE_ALERT_COUNT")
									)
			...
			UI = {
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"#### DisplayTimerTimeUp:: svars.timeLimitforSneaking = ####" .. svars.timeLimitforSneaking
						)
	...
	OnEnter = function(self)
		...
		if vars.fobIsPlaceMode == 1 then
			...
			if not gvars.isFinishFobManualPlacementTutorial then
				mvars.fobManualPlacementModeTutorialCoroutine =
					coroutine.create(self.fobManualPlacementModeTutorialCoroutine)
			end
		end
	...
	OnUpdate = function(self)
		...
		if mvars.fobManualPlacementModeTutorialCoroutine then
			...
			if (coroutine.status(mvars.fobManualPlacementModeTutorialCoroutine) == "dead") or not status then
...
sequences.Seq_ShowMissionClearDemo = {
	...
	Messages = function(self)
		return StrCode32Table({
			Timer = {
				{
					...
					func = function()
						Fox.Log("#### ResultDelay ####")
						this.SwitchExecByIsHost(TppMission.MissionGameEnd, TppMission.MissionGameEnd)
					end,
					option = { isExecMissionClear = true },
				},
				{
					msg = "Finish",
					sender = "Timer_HostWin",
					func = function()
			...
			UI = {
				{
					msg = "EndFadeOut",
					sender = "EndFadeOut_StartTargetEscapeCamera",
	...
	OnEnter = function(self)
		...
		Fox.Log(
			" _____________o50050_sequence.sequences.Seq_ShowMissionClearDemo onEnter / missionClearType : "
				.. tostring(svars.mis_missionClearType)
				.. " isHostWin: "
				.. tostring(svars.fobIsHostWin)
		)
		...
		this.SwitchExecByIsGameMode(function()
			...
			this.SwitchExecByIsHost(self.HostVisitEnd, self.ClientVisitEnd)
		end)
	end,
...
sequences.Seq_ShowGameOverResult = {
	...
	OnEnter = function(self)
		...
		Fox.Log(
			" _____________o50050_sequence.sequences.Seq_ShowGameOverResult onEnter / gameOverType : "
				.. tostring(svars.mis_gameOverType)
				.. " isHostWin: "
				.. tostring(svars.fobIsHostWin)
		)
	...
	ClientWin = function()
		...
		if
			TppMission.CheckGameOverDemo(TppDefine.GAME_OVER_TYPE.PLAYER_DEAD)
			or TppMission.CheckGameOverDemo(TppDefine.GAME_OVER_TYPE.OUTSIDE_OF_MISSION_AREA)
		then
			...
			if select == Popup.SELECT_OK then
				if TppGameMode.GetUserMode() == TppGameMode.U_KONAMI_LOGIN then
					...
					TppSequence.SetNextSequence(
						"Seq_ErrorDialogOnRetryPractice",
						{ isExecGameOver = true, isExecMissionClear = true }
					)
				end
			else
				this.RetrySelectCancel()
...
sequences.Seq_ConfirmManualPlacementSetting = {
	...
	GoNextSequence = function(self)
		TppSequence.SetNextSequence(
			mvars.fob_afterConfirmManualPlacementSettingsequenceName,
			{ isExecMissionClear = true, isExecGameOver = true }
		)
	end,
...
sequences.Seq_StartSendCurrentRevengePoint = {
	OnEnter = function()
		if not mvars.fob_isNeedWaitWormholeResult then
			TppSequence.SetNextSequence(
				mvars.fob_wormholeResultedSequenceName,
				{ isExecMissionClear = true, isExecGameOver = true }
			)
			return
		end
		...
		if not isSendSuccess then
			if DebugText then
				DebugText.Print(
					DebugText.NewContext(),
					{ 0.5, 0.5, 1.0 },
					"[Seq_StartSendCurrentRevengePoint] send current revenge point failed."
				)
			end
			return
		end
		...
		if TppServerManager.IsOpenWormholeBusy() then
			if DebugText then
				DebugText.Print(
					DebugText.NewContext(),
					{ 0.5, 0.5, 1.0 },
					"[Seq_WaitOpenWormholeResult] TppServerManager.IsOpenWormholeBusy() is false."
				)
			end
			return
		end
...
function this._SetupPazRoom(clusterId)
	...
	do
		local doorName = "ly0"
			.. tostring(numLayout)
			.. "_cl04_item0000|cl04pl0_uq_0040_gimmick2|mtbs_door006_door001_gim_n0002|srt_mtbs_door006_door001"
		local dataSetPath = "/Assets/tpp/level/location/mtbs/block_area/ly0"
			.. tostring(layoutCode)
			.. "/cl04/mtbs_ly0"
			.. tostring(layoutCode)
			.. "_cl04_item.fox2"
	...
	do
		local dataSetName = "/Assets/tpp/level/location/mtbs/block_area/ly0"
			.. tostring(layoutCode)
			.. "/cl04/mtbs_ly0"
			.. tostring(layoutCode)
			.. "_cl04_item.fox2"
		local switchOnLeavePazRoom = "ly0"
			.. tostring(numLayout)
			.. "_cl04_item0000|cl04pl0_uq_0040_gimmick2|gntn_swtc001_vrtn001_gim_n0001|srt_gntn_swtc001_vrtn001"

		Gimmick.InvisibleGimmick(
			TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
			switchOnLeavePazRoom,
			dataSetName,
			true
		)
	end
...
function this._SetupGoalDoor_OnSpEvent()
	...
	local gimName = "ly0"
		...
		.. "pl0_uq_00"
		.. tostring(clusterId)
		.. "0_gimmick2|mtbs_door006_"
		.. tostring(doorName)
		.. "_gim_n0000|srt_mtbs_door006_"
		.. tostring(doorName)
	local dataSetPath = "/Assets/tpp/level/location/mtbs/block_area/ly0"
		.. tostring(layoutCode)
		.. "/cl0"
