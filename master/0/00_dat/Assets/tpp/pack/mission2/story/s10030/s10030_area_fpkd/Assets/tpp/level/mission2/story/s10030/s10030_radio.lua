...
this.radioList = {
	...
	TOMB1000_101010_0_ocelot = {
		"(dbg)「ボス、大事な話がある。基地（マザーベース）の運営についてだ」",
	},
	...
	TOMB3000_161010_0_ocelot = {
		"(dbg)「死体は回収できない。うちで働いてもらうには手遅れだ」",
	},
	TOMB3000_171010_0_ocelot = {
		"(dbg)「あんたが？回収したスタッフは、その能力が最も活かせる班に配属される」",
	},
	TOMB3000_181010_0_ocelot = { "(dbg)「確認しよう。端末を開いてくれ」" },
	TOMB3000_1a1010_0_ocelot = { "(dbg)「今のスタッフは、『研究開発班』に配属されたな」" },
	TOMB3000_1b1010_0_ocelot = {
		"(dbg)「研究開発班では、あんたのミッションでも役立つ様々な武器やアイテムを開発する」",
	},
	...
	TOMB3000_1f1010_0_ocelot = {
		"(dbg)「何に使うかわからんが、ミラーがあんたのために準備していたらしい」",
	},
	TOMB3000_1g1010_0_ocelot = { "(dbg)「潜入用に特化した「こだわりの逸品」……」" },
	TOMB3000_1h1010_0_ocelot = {
		"(dbg)「うむ、おかげで、こいつを開発するにはまだ人手が足りていないようだ 」",
	},
	TOMB3000_1i1010_0_ocelot = {
		"(dbg)「スタッフを補充しよう。あと何人かフルトン回収してくれ」",
	},
	TOMB4000_101010_0_ocelot = {
		"(dbg)「フルトン回収は『気絶』した相手にも行うことができる」",
	},
	...
	TOMB3000_141010_0_ocelot = { "(dbg)「回収成功だ」" },
	TOMB4000_1m1010_0_ocelot = {
		"(dbg)「ただし、いいか、フルトン回収は必ずしも成功するとは限らない」",
	},
	TOMB4000_1n1010_0_ocelot = {
		"(dbg)「負傷者は回収時の衝撃に耐えられず『死亡』する可能性もあるし」",
	},
	TOMB4000_1o1010_0_ocelot = { "(dbg)「天候が悪ければ、『行方不明』になる可能性もある」" },
	TOMB4000_1p1010_0_ocelot = {
		"(dbg)「フルトン回収の『成功率』は、対象に近づけば、おのずと見極めることができるだろう。」",
	},
	TOMB4000_1q1010_0_ocelot = {
		"(dbg)「確実に回収したい対象は、自分で担いでヘリまで運ぶんだ」",
	},
	...
	TOMB5000_101010_0_ocelot = {
		"(dbg)「ボス、人手が集まったおかげで『研究開発班』のレベルが上がった 」",
	},
	TOMB5000_111010_0_ocelot = {
		"(dbg)「これで『ダンボール箱』が開発できるんじゃないか？」",
	},
	TOMB5000_121010_0_ocelot = { "(dbg)「端末を開けてみろ」" },
	TOMB5000_131010_0_ocelot = {
		"(dbg)「よし、『ダンボール箱』を選んで、開発を実行するんだ」",
	},
	TOMB5000_141010_0_ocelot = {
		"(dbg)「ただし開発には『｛資金→GMP｝』が必要になる。赤字には気をつけろ」",
	},
	TOMB5000_151010_0_ocelot = { "(dbg)「開発の成果だ」" },
	TOMB5000_161010_0_ocelot = {
		"(dbg)「使い道はよくわからんが……ミラーは「ボスならわかる」と」",
	},
	TOMB5000_171010_0_ocelot = { "(dbg)「試してみてくれ」" },
	TOMB5000_181010_0_ocelot = {
		"(dbg)「それから、今回回収したスタッフは、すべて研究開発班に配属されたが、これはミラーによる判断だ」",
	},
	TOMB5000_191010_0_ocelot = { "(dbg)「あんたが気に入らなければ自分で再配置してもいい」" },
	TOMB5000_1a1010_0_ocelot = { "(dbg)「さて、説明は以上だ」" },
	TOMB5000_1b1010_0_ocelot = {
		"(dbg)「GMPを稼ぐにも、人を集めるにも、ここにいては始まらん」",
	},
	ocelot_570 = { "(dbg)「ミッションに出る覚悟が出来たら、ヘリに乗ってくれ」" },
	ocelot_580 = {
		"(dbg)「端末から｛ランディングゾーン←LZ｝を指定すれば、そこに支援ヘリを呼ぶことができる」 ",
	},
	ocelot_590 = {
		"(dbg)「あんたがまだ投げ足りなければ、しばらくここ（マザーベース）でスタッフに稽古をつけてもいいぞ」",
	},
	...
	ocelot_760 = {
		"(dbg)「あんたが隙を見せない限り、相手は『無力化』したまま。もう抵抗はできないはずだ」",
	},
	TOMB7000_1g1010_0_ocelot = {
		"(dbg)「近くに複数の相手がいるなら、立て続けにCQCをかけてやれ。」",
	},
...
this.PlaySpeech_Ocelot = function(speechLabel, delayTime)
	...
	if GkEventTimerManager.IsTimerActive("speechStartTimer") == true then
		return
	end
