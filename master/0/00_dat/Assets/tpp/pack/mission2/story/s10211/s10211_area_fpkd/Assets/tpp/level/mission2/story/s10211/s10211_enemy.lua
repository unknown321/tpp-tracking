...
this.SetUpEnemy = function()
	...
	this.SetNpcStaffParameter(
		this.ENEMY_NAME.TARGET,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_TRAFFICKER,
		{ staffTypeId = 56, randomRangeId = 4, skill = "TroublemakerHarassment" }
	)
	this.SetNpcStaffParameter(
		this.ENEMY_NAME.FOLLOWER01,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_BODYGUARD_01,
		{ staffTypeId = 2, randomRangeId = 6, skill = "Grappler" }
	)
	this.SetNpcStaffParameter(
		this.ENEMY_NAME.FOLLOWER02,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_BODYGUARD_04,
		{ staffTypeId = 60, randomRangeId = 4, skill = nil }
	)
	this.SetNpcStaffParameter(
		this.ENEMY_NAME.FOLLOWER03,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_BODYGUARD_02,
		{ staffTypeId = 52, randomRangeId = 4, skill = nil }
	)
	this.SetNpcStaffParameter(
		this.ENEMY_NAME.FOLLOWER04,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_BODYGUARD_03,
		{ staffTypeId = 51, randomRangeId = 4, skill = nil }
	)
	this.SetNpcStaffParameter(
		this.ENEMY_NAME.FOLLOWER05,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_BODYGUARD_05,
		{ staffTypeId = 57, randomRangeId = 4, skill = nil }
	)

	this.SetNpcStaffParameter(
		this.BONUS_HOSTAGE_NAME.HOSTAGE_00,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_HOSTAGE_A,
		{ staffTypeId = 3, randomRangeId = 6, skill = "MonitorEngineer" }
	)
	this.SetNpcStaffParameter(
		this.BONUS_HOSTAGE_NAME.HOSTAGE_01,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_HOSTAGE_B,
		{ staffTypeId = 62, randomRangeId = 4, skill = "Surgeon" }
	)
	this.SetNpcStaffParameter(
		this.BONUS_HOSTAGE_NAME.HOSTAGE_02,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_HOSTAGE_C,
		{ staffTypeId = 50, randomRangeId = 4, skill = nil }
	)
	this.SetNpcStaffParameter(
		this.BONUS_HOSTAGE_NAME.HOSTAGE_03,
		TppDefine.UNIQUE_STAFF_TYPE_ID.S10211_HOSTAGE_D,
		{ staffTypeId = 53, randomRangeId = 4, skill = nil }
	)
...
this.SetRelativeVehicle = function(soldierName, vehicleName)
	Fox.Log(
		"#### s10070_enemy02.SetRelativeVehicle #### soldierName = "
	...
	if svars.isReserve_03 == false then
		...
		for index, enemyName in pairs(MiSSION_TARGET_GROUP) do
			...
			if TppEnemy.IsEliminated(this.ENEMY_NAME.TARGET) == false then
				if
					TppEnemy.GetLifeStatus(this.ENEMY_NAME.TARGET) == TppEnemy.LIFE_STATUS.NORMAL
					and TppEnemy.GetStatus(this.ENEMY_NAME.TARGET) == EnemyState.NORMAL
				then
