	...
	TppDemo.Play("Demo_PandemicConverge", {
		onStart = function()
			TppDataUtility.SetVisibleDataFromIdentifier(
				"uq_0020_demo_hide_AssetIdentifier",
				"p41_060255_off",
				false,
				false
			)
...
this.SetStateAfterDemo_Parasite = function()
	...
	GameObject.SendCommand(
		{ type = "TppParasite2", index = 0 },
		{ id = "SetStateAfterDemo", realize = true, harden = true }
	)
	GameObject.SendCommand(
		{ type = "TppParasite2", index = 1 },
		{ id = "SetStateAfterDemo", realize = true, harden = true }
	)
	GameObject.SendCommand(
		{ type = "TppParasite2", index = 2 },
		{ id = "SetStateAfterDemo", realize = true, harden = true }
	)
	GameObject.SendCommand(
		{ type = "TppParasite2", index = 3 },
		{ id = "SetStateAfterDemo", realize = true, harden = true }
	)
end
