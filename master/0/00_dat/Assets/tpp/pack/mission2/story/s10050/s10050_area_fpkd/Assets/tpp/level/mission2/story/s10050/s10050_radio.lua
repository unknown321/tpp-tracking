...
this.CallHeli = function()
	...
	TppRadio.Play(
		{ "s0050_rtrg3040", "s0050_rtrg3050", "s0050_rtrg3060", "s0050_rtrg3070", "s0050_rtrg3080" },
		{ delayTime = "short" }
	)
end
...
this.WhyDoNotYouKillQuiet = function()
	Fox.Log(
		"#### s10050_radio.WhyDoNotYouKillQuiet #### isQuietDown = "
...
this.AvoidQuiet = function()
	...
	if
		TppQuest.IsOpen("sovietBase_q99020")
		and not (TppQuest.IsCleard("sovietBase_q99020"))
		and not svars.isQuietDown
	then
...
this.SetRadioFromSituation = function()
	Fox.Log(
		"#### s10050_radio.SetRadioFromSituation #### isUseDeathBullet ["
