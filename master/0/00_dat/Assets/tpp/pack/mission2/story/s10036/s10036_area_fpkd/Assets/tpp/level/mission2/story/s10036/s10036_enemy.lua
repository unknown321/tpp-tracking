...
this.resetRouteSetsVIP = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", TORIMAKI_NAME_TABLE[1]),
		{ id = "SetCommandPost", cp = "afgh_field_cp" }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", TORIMAKI_NAME_TABLE[2]),
		{ id = "SetCommandPost", cp = "afgh_field_cp" }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", TORIMAKI_NAME_TABLE[3]),
		{ id = "SetCommandPost", cp = "afgh_field_cp" }
	)
