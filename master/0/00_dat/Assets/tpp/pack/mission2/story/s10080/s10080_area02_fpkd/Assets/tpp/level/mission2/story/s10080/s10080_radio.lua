...
this.SetRadio_EnableEspionageTeacherDemo = function()
	TppRadioCommand.SetEnableEspionageRadioTarget({ name = { "erl_teacherDemo" }, enable = true })
end

this.SetRadio_DisableEspionageTeacherDemo = function()
	TppRadioCommand.SetEnableEspionageRadioTarget({ name = { "erl_teacherDemo" }, enable = false })
end
