...
this.missionObjectiveDefine = {
	...
	default_area_flowStation = {
		gameObjectName = MARKER_NAME_AREA_FLOWSTATION,
		visibleArea = 5,
		viewType = "all",
		randomRange = 0,
		setNew = false,
	...
	default_area_targetTank = {
		gameObjectName = MARKER_NAME_AREA_TANK,
		visibleArea = 1,
		goalType = "attack",
		viewType = "all",
		randomRange = 0,
	...
	default_area_targetPump = {
		gameObjectName = MARKER_NAME_AREA_SWITCHAREA,
		visibleArea = 1,
		goalType = "attack",
		viewType = "all",
		randomRange = 1,
		setNew = false,
		langId = "marker_info_mission_targetArea",
		mapRadioName = "s0080_mprg1010",
	},
	default_area_targetPump_intel = {
		gameObjectName = MARKER_NAME_AREA_SWITCH,
		visibleArea = 1,
		goalType = "attack",
		viewType = "all",
		setNew = true,
	...
	default_area_container = {
		gameObjectName = MARKER_NAME_AREA_CONTAINER,
		visibleArea = 1,
...
function this.Messages()
	return StrCode32Table({
		...
		Radio = {
			{
				msg = "Finish",
				sender = "s0080_esrg1030",
				func = function()
					s10080_radio.SetRadio_ChangeIntelRadio_enemy()
				end,
			},
		},
		Marker = {
		...
		Timer = {
			...
			{
				msg = "Finish",
				sender = "timer_JingleCharred0000",
				func = function()
					local checkInCamera = Player.AddSearchTarget({
...
this.FuncFlowStationModelChange = function()
	if svars.isBreakedTank == false then
		...
		Gimmick.ForceIndelibleClear(
			TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
			"mafr_tank005_gim_n0001|srt_mafr_tank005",
			FLOWSTATION_GIMMICK_PATH
		)
		Gimmick.ForceIndelibleClear(
			TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
			"mafr_tank003_gim_n0000|srt_mafr_tank003",
			FLOWSTATION_GIMMICK_PATH
		)
		Gimmick.ForceIndelibleClear(
			TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
			"mafr_tank003_gim_n0001|srt_mafr_tank003",
			FLOWSTATION_GIMMICK_PATH
		)
		Gimmick.ForceIndelibleClear(
			TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
			"mafr_tank003_gim_n0002|srt_mafr_tank003",
			FLOWSTATION_GIMMICK_PATH
		)
		Gimmick.ForceIndelibleClear(
			TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
			"mafr_tank005_vrtn006_gim_n0001|srt_mafr_tank005_vrtn006",
			FLOWSTATION_GIMMICK_PATH
		)
...
this.FuncRoutePoint = function(gameObjectId, routeId, routeNodeIndex, messageId)
	Fox.Log(
		"s10080_sequence.FuncRoutePoint( gameObjectId:"
...
this.FuncOnMarkingWalkerGear = function(GameObjectInstanceName, MalkerTypeId, GameObjectId, MalkerById)
	if MalkerById == StrCode32("Player") then
		if
			GameObjectInstanceName == StrCode32("wkr_s10080_0000")
			or GameObjectInstanceName == StrCode32("wkr_s10080_0001")
			or GameObjectInstanceName == StrCode32("wkr_s10080_0002")
			or GameObjectInstanceName == StrCode32("wkr_s10080_0003")
		then
			s10080_radio.LookatWalkerGear()
		elseif
			GameObjectInstanceName == StrCode32("sol_child_0000")
			or GameObjectInstanceName == StrCode32("sol_child_0001")
			or GameObjectInstanceName == StrCode32("sol_child_0002")
			or GameObjectInstanceName == StrCode32("sol_child_0003")
		then
...
this.FuncRideOnHeli = function(gameObjectId, VehicleId)
	...
	if
		gameObjectId == s10080_enemy.CHILD_NAME.CHILD1
		or s10080_enemy.CHILD_NAME.CHILD2
		or s10080_enemy.CHILD_NAME.CHILD3
		or s10080_enemy.CHILD_NAME.CHILD4
	then
...
sequences.Seq_Demo_InAfrica = {
			...
			Demo = {
				{
					...
					func = function()
						GameObject.SendCommand(
							...
							{ id = "SetDemoToSendEnabled", enabled = true, route = "rts_drproute_outland_S_0001" }
						)
					end,
	...
	OnEndMissionTelop = function()
		...
		local endfunc = function()
			...
			TppSequence.SetNextSequence("Seq_Game_Opening", { isExecDemoPlaying = true })
		end
		local skipfunc = function() end
...
sequences.Seq_Demo_Opening = {
	OnEnter = function()
		GameObject.SendCommand(
			{ type = "TppHeli2", index = 0 },
			{ id = "SetDemoToAfterDropEnabled", enabled = true, route = "rts_drproute_outland_S_0002" }
		)
...
sequences.Seq_Game_StopFlowStation = {
		...
		return StrCode32Table({
			...
			GameObject = {

				{
					msg = "Dead",
					sender = {
						s10080_enemy.ENEMY_NAME.TEACHER1,
						s10080_enemy.ENEMY_NAME.TEACHER2,
						s10080_enemy.CHILD_NAME.CHILD1,
						s10080_enemy.CHILD_NAME.CHILD2,
						s10080_enemy.CHILD_NAME.CHILD3,
						s10080_enemy.CHILD_NAME.CHILD4,
					},
			...
			Trap = {
				...
				{
					msg = "Enter",
					sender = "trap_ApproachFlowStation_radio",
					func = self.FuncApproachFlowStation_radio,
				},
				...
				{
					msg = "Exit",
					sender = "trap_ApproachTank",
					func = function()
						svars.isAroundTank = false
					end,
				},
				...
				{
					msg = "Enter",
					sender = "trap_ApproachScorchedearthVillage",
					func = self.FuncApproachScorchedearthVillage,
				},
				...
				{
					msg = "Enter",
					sender = "trap_ApproachScorchedearthCorpse",
					func = function()
				...
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Under1",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UNDER1
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Under2",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UNDER2
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Under3",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UNDER3
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Under4",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UNDER4
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Under5",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UNDER5
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Under6",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UNDER6
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Under7",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UNDER7
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Under8",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UNDER8
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Upper1",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UPPER1
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Upper2",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UPPER2
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Upper3",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UPPER3
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Upper4",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UPPER4
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Upper5",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UPPER5
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Upper6",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UPPER6
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Upper7",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UPPER7
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Upper8",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UPPER8
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Upper9",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_UPPER9
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside1",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE1
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside2",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE2
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside3",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE3
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside4",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE4
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside5",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE5
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside6",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE6
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside7",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE7
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside8",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE8
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside9",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE9
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside10",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE10
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Tank_Outside11",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.TANK_OUTSIDE11
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump1",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP1
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump2",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP2
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump3",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP3
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump4",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP4
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump5",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP5
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump6",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP6
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump7",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP7
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump8",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP8
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump9",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP9
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump10",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP10
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump11",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP11
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Under1",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UNDER1
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Under2",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UNDER2
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Under3",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UNDER3
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Under4",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UNDER4
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Under5",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UNDER5
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Under6",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UNDER6
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Upper1",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UPPER1
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Upper2",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UPPER2
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Upper3",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UPPER3
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Upper4",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UPPER4
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Upper5",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UPPER5
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Pump_Upper6",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.PUMP_UPPER6
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road1",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD1
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road2",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD2
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road3",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD3
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road4",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD4
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road5",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD5
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road6",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD6
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road7",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD7
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road8",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD8
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road9",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD9
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road10",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD10
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Road11",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.ROAD11
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Other1",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.OTHER1
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Other2",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.OTHER2
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Other3",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.OTHER3
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Other4",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.OTHER4
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Other5",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.OTHER5
					end,
				},
				{
					msg = "Enter",
					sender = "trap_CHK_FlowStation_Other6",
					func = function()
						svars.isFultoned_child1 = this.FLOWSTATIONAREA_STATUS.OTHER6
					end,
				},
			},
			Timer = {
				...
				{
					msg = "Finish",
					sender = "explosionDeray",
					func = function()
						this.FuncMissionReload()
					end,
				},
			},
			Radio = {
				...
				{
					msg = "Finish",
					sender = "LG_s0080_0150",
					func = function()
						svars.isSNARradio = true
					end,
				},
				{
					msg = "Finish",
					sender = "s0080_rtrg1035",
					func = function()
	...
	FuncPutC4 = function(playerIndex, equipId)
		if
			equipId == TppEquip.EQP_SWP_C4
			or equipId == TppEquip.EQP_SWP_C4_G01
			or equipId == TppEquip.EQP_SWP_C4_G02
			or equipId == TppEquip.EQP_SWP_C4_G03
			or equipId == TppEquip.EQP_SWP_C4_G04
		then
	...
	FuncBreakedTank = function(gameObjectId, instanceName, name)
		if svars.isLoadedFlowStation == true then
			...
			if
				breakedgimmickId == TANK_ID_NAME1
				or breakedgimmickId == TANK_ID_NAME2
				or breakedgimmickId == TANK_ID_NAME3
				or breakedgimmickId == TANK_ID_NAME4
			then
				if svars.isBreakedTank == false then
				...
				Player.SetPadMask({
					settingName = "breakedTank",
					except = true,
					buttons = PlayerPad.STOCK,
					sticks = PlayerPad.STICK_R + PlayerPad.STICK_L,
				})
				...
				if breakedgimmickId == TANK_ID_NAME1 then
					...
					Gimmick.BreakGimmick(
						...
						identifierParam.locatorName,
						identifierParam.dataSetName,
						false
					)
				end

				if
					TppGimmick.IsBroken({ gimmickId = TANK_ID_NAME1 }) == true
					and TppGimmick.IsBroken({ gimmickId = TANK_ID_NAME2 }) == true
					and TppGimmick.IsBroken({ gimmickId = TANK_ID_NAME3 }) == true
					and TppGimmick.IsBroken({ gimmickId = TANK_ID_NAME4 }) == true
				then
	...
	Messages = function(self)
		return StrCode32Table({
			Trap = {
				...
				{
					msg = "Enter",
					sender = "trap_RoadBlocked_1",
					func = function()
						s10080_radio.RoadBlocked_1()
					end,
				},
				{
					msg = "Enter",
					sender = "trap_RoadBlocked_2",
					func = function()
						s10080_radio.RoadBlocked_2()
					end,
				},
			},
			GameObject = {},
