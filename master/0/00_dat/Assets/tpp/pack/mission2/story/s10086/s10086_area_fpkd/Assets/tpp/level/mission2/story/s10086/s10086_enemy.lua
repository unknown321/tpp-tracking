...
s10086_enemy.FAKE_TARGETS =
	{ s10086_enemy.FAKE_TARGET1_NAME, s10086_enemy.FAKE_TARGET2_NAME, s10086_enemy.FAKE_TARGET3_NAME }
...
s10086_enemy.CallConversation = function(speakerGameObjectId, friendGameObjectId, speechLabel)
	Fox.Log(
		"s10086_enemy.CallConversation(): speakerGameObjectId:"
			.. tostring(speakerGameObjectId)
			.. ", friendGameObjectId:"
			.. tostring(friendGameObjectId)
			.. ", speechLabel:"
...
s10086_enemy.CallMonologue = function(speakerId, speechLabel, friendId)
	Fox.Log(
		"s10086_enemy.CallMonologue(): speakerId:"
			.. tostring(speakerId)
			.. ", speechLabel:"
			.. tostring(speechLabel)
			.. ", friendId:"
...
s10086_enemy.SetVehicleRelativity = function(vehicleName, npcName, rideFromBeginning, isMust)
	...
	local command =
		{ id = "SetRelativeVehicle", targetId = vehicleId, rideFromBeginning = rideFromBeginning, isMust = isMust }
...
s10086_enemy.ChangeVipRouteToMorning = function()
	...
	local routeTables = {
		[s10086_enemy.INTERPRETER_NAME] = {
			sneakRouteId = "rts_interpreter_to_fake_target1_0000",
			cautionRouteId = "rts_interpreter_to_fake_target1_c_0000",
		},
		[s10086_enemy.INTERROGATOR_NAME] = {
			sneakRouteId = "rts_interrogator_to_fake_target1_0000",
			cautionRouteId = "rts_interrogator_to_fake_target1_c_0000",
		},
		[s10086_enemy.GUARD2_NAME] = {
			sneakRouteId = "rts_guard2_wait_0000",
			cautionRouteId = "rts_guard2_wait_c_0000",
		},
		[s10086_enemy.GUARD3_NAME] = {
			sneakRouteId = "rts_guard3_wait_0000",
			cautionRouteId = "rts_guard3_wait_c_0000",
		},
		[s10086_enemy.GUARD4_NAME] = {
			sneakRouteId = "rts_guard4_wait_0000",
			cautionRouteId = "rts_guard4_wait_c_0000",
		},
	}
...
s10086_enemy.ChangeInterrogatorsRoute = function()
	...
	local routeTables = {
		[s10086_enemy.INTERPRETER_NAME] = {
			sneakRouteId = "rts_interpreter_to_fake_target4_0000",
			sneakRouteNodeIndex = svars.reservedNumber0000,
			cautionRouteId = "rts_interpreter_to_fake_target4_c_0000",
		},
		[s10086_enemy.INTERROGATOR_NAME] = {
			sneakRouteId = "rts_interpreter_to_fake_target4_0000",
			sneakRouteNodeIndex = svars.reservedNumber0000,
...
s10086_enemy.ChangeVipRouteToNight = function()
	...
	local soldierOnSneakRouteList = GameObject.SendCommand(
		{ type = "TppSoldier2" },
		{ id = "GetGameObjectIdUsingRoute", route = "rts_interpreter_to_fake_target3_0000" }
	)
	local soldierOnCautionRouteList = GameObject.SendCommand(
		{ type = "TppSoldier2" },
		{ id = "GetGameObjectIdUsingRoute", route = "rts_interpreter_to_fake_target3_c_0000" }
	)
	...
	local noticeState =
		GameObject.SendCommand(GameObject.GetGameObjectId(s10086_enemy.TARGET_NAME), { id = "GetNoticeState" })
...
s10086_enemy.SetCautionPhase = function() end
...
s10086_enemy.SetCautionRoute = function(gameObjectId, routeName, routeNodeIndex)
	Fox.Log(
		"s10086_enemy.SetCautionRoute(): gameObjectId:"
