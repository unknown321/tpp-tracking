...
this.FogSetting = function(fogLv)
	...
	if fogLv == s10140_sequence.fogLvTable[1] then
		Fox.Log(
			"#### s10140_enemy.FogSetting #### Execute Weather Control : " .. tostring(s10140_sequence.fogLvTable[1])
		)
		TppWeather.CancelForceRequestWeather(TppDefine.WEATHER.SUNNY, 5)
	elseif fogLv == s10140_sequence.fogLvTable[2] then
		Fox.Log(
			"#### s10140_enemy.FogSetting #### Execute Weather Control : " .. tostring(s10140_sequence.fogLvTable[2])
		)
	elseif fogLv == s10140_sequence.fogLvTable[3] then
		Fox.Log(
			"#### s10140_enemy.FogSetting #### Execute Weather Control : " .. tostring(s10140_sequence.fogLvTable[3])
		)
