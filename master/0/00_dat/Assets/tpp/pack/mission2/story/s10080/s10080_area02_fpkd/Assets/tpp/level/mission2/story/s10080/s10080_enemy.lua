...
this.HighInterrogation = function()
	...
	TppInterrogation.AddHighInterrogation(GameObject.GetGameObjectId("mafr_flowStation_cp"), {})
end
...
this.childDemoRouteCheck = function()
	local isOnRoute_CHILD1 = GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", this.CHILD_NAME.CHILD1),
		{ id = "IsOnRoute", route = "rts_outland_d_0002" }
	)
	local isOnRoute_CHILD2 = GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", this.CHILD_NAME.CHILD2),
		{ id = "IsOnRoute", route = "rts_outland_d_0003" }
	)
	local isOnRoute_CHILD3 = GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", this.CHILD_NAME.CHILD3),
		{ id = "IsOnRoute", route = "rts_outland_d_0004" }
	)
	local isOnRoute_CHILD4 = GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", this.CHILD_NAME.CHILD4),
		{ id = "IsOnRoute", route = "rts_outland_d_0005" }
	)
	local isOnRoute_TEACHER1 = GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", this.ENEMY_NAME.TEACHER1),
		{ id = "IsOnRoute", route = "rts_outland_d_0000" }
	)
	local isOnRoute_TEACHER2 = GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", this.ENEMY_NAME.TEACHER2),
		{ id = "IsOnRoute", route = "rts_outland_d_0001" }
	)

	if
		isOnRoute_CHILD1
		and isOnRoute_CHILD2
		and isOnRoute_CHILD3
		and isOnRoute_CHILD4
		and isOnRoute_TEACHER1
		and isOnRoute_TEACHER2
	then
		return true
	else
		return false
