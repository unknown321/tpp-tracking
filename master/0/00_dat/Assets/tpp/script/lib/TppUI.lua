		...
		UI = {
			...
			},
			{
				...
				func = function()
					...
					if
						TppSave.IsSavingWithFileName(TppDefine.CONFIG_SAVE_FILE_NAME)
						or TppSave.HasQueue(TppDefine.CONFIG_SAVE_FILE_NAME)
					then
						return
					end
...
function e.FadeOut(s, o, p, n)
	...
	if a then
		...
		if
			(not TppSoundDaemon.CheckCurrentMuteIs("Pause")) and (not TppSoundDaemon.CheckCurrentMuteMoreThan("Outro"))
		then
...
function e.ShowColorAnnounceLog(t, i, a, n)
	if gvars.ini_isTitleMode then
		return
	end
...
function e.ShowJoinAnnounceLog(i, a, t, o, n)
	if gvars.ini_isTitleMode then
		return
	end
...
function e.ShowColorJoinAnnounceLog(i, o, t, a, n)
	if gvars.ini_isTitleMode then
		return
	end
	local i = e.ANNOUNCE_LOG_TYPE[i]
...
function e.ShowEmergencyAnnounceLog(n)
	...
	if
		not (
			TppUiStatusManager.CheckStatus("AnnounceLog", "INVALID_LOG")
			or TppUiStatusManager.CheckStatus("AnnounceLog", "SUSPEND_LOG")
		)
	then
		if n == true then
...
function e.EnableMissionPhoto(i, e, n, a, t)
...
function e.StartMissionTelop(e, n, i)
...
function e.EnableMissionTask(a, t)
	...
	if n.isComplete then
		...
		local a = e.GetTaskCompletedNumber(n)
		local i = e.GetMaxMissionTask(n)
		if i == nil then
			return
		end
		if t then
			if a > o then
				e.ShowAnnounceLog("task_complete", a, i)
			end
		end
...
function e.StartLyricOkb(e)
	...
	TppUiCommand.LyricTexture("disp", "okb_lyric_16", 6, 0.23)
	TppUiCommand.LyricTexture("disp", "okb_lyric_17", 6.75, 0.38)
	TppUiCommand.LyricTexture("disp", "okb_lyric_18", 2.47, 0.17)
	TppUiCommand.LyricTexture("disp", "okb_lyric_19", 7.2, 0.33)
	TppUiCommand.LyricTexture("disp", "okb_lyric_20", 7.03, 2.02)
	TppUiCommand.LyricTexture("disp", "okb_lyric_21", 4.12, 0.17)
	TppUiCommand.LyricTexture("disp", "okb_lyric_22", 3.4, 0.27)
	TppUiCommand.LyricTexture("disp", "okb_lyric_23", 3.2, 0.3)
	TppUiCommand.LyricTexture("disp", "okb_lyric_24", 3.03, 0.3)
	TppUiCommand.LyricTexture("disp", "okb_lyric_25", 6.9, 0.07)
	TppUiCommand.LyricTexture("disp", "okb_lyric_26", 7.33, 6.23)
	TppUiCommand.LyricTexture("disp", "okb_lyric_27", 6.43, 0.2)
	TppUiCommand.LyricTexture("disp", "okb_lyric_28", 3.73, 0)
	TppUiCommand.LyricTexture("start", e)
end
function e.StartLyricEnding(e)
	TppUiCommand.LyricTexture("disp", "okb_lyric_01", 5.83, 0.53)
	TppUiCommand.LyricTexture("disp", "okb_lyric_02", 6.43, 0.47)
	TppUiCommand.LyricTexture("disp", "okb_lyric_03", 6.73, 0.33)
	TppUiCommand.LyricTexture("disp", "okb_lyric_04", 7.9, (2.57 + 101.85))
	TppUiCommand.LyricTexture("disp", "okb_lyric_19", 6.8, 0.3)
	TppUiCommand.LyricTexture("disp", "okb_lyric_10", 6.23, 0.33)
	TppUiCommand.LyricTexture("disp", "okb_lyric_11", 6.47, 0.27)
	TppUiCommand.LyricTexture("disp", "okb_lyric_12", 2.9, 0.23)
	TppUiCommand.LyricTexture("disp", "okb_lyric_13", 3.5, 0.33)
...
function e.StartLyricQuiet(e)
	...
	TppUiCommand.LyricTexture("disp", "quiet_lyric_03", 2.8, 0.8)
	...
	TppUiCommand.LyricTexture("disp", "quiet_lyric_13", 2.53, 0.2)
	...
	TppUiCommand.LyricTexture("disp", "quiet_lyric_18", 4.23, 0.25)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_19", 4.02, 0.37)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_20", 4.93, 0.2)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_21", 4.73, 0.2)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_22", 4.4, 0.37)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_23", 4.63, 0.03)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_24", 3.13, 1.53)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_25", 4.73, 0.33)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_26", 4.23, 0.67)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_27", 4.53, 0.1)
	TppUiCommand.LyricTexture("disp", "quiet_lyric_28", 6.63, 0)
	TppUiCommand.LyricTexture("start", e)
end
function e.StartLyricCyprus(e)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_01", 7.87, 0.57)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_02", 7.93, 0.53)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_03", 7.5, 0)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_04", 8.47, 2.07)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_05", 3.7, 0.53)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_06", 3.7, 0.43)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_07", 3.8, 0.43)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_08", 4, 12.03)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_09", 7.4, 1.13)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_10", 7.93, 0.53)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_11", 7.3, 0)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_12", 8.6, 2)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_13", 3.73, 0.57)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_14", 3.6, 0.5)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_15", 3.83, 0.43)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_16", 4.73, 5.93)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_17", 3.73, 0.6)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_18", 3.63, 0.4)
	TppUiCommand.LyricTexture("disp", "cyprus_lyric_19", 3.83, 0.43)
...
function e.OnMessage(t, o, a, p, s, n, i)
	Tpp.DoMessage(e.messageExecTable, TppMission.CheckMessageOption, t, o, a, p, s, n, i)
end
function e.OnChangeSVars(i, n)
