...
e.SHOW_EXECPTION_DIALOG = {
	...
	[e.TYPE.DISCONNECT_FROM_PSN] = function()
		return TppDefine.ERROR_ID.DISCONNECT_FROM_PSN
	end,
	[e.TYPE.DISCONNECT_FROM_KONAMI] = function()
		return TppDefine.ERROR_ID.DISCONNECT_FROM_KONAMI
	end,
	[e.TYPE.DISCONNECT_FROM_NETWORK] = function()
		return TppDefine.ERROR_ID.DISCONNECT_FROM_NETWORK
	end,
	[e.TYPE.SESSION_DISCONNECT_FROM_HOST] = function()
		if e.GetCurrentGameMode() == "TPP" then
			return
		end
		return TppDefine.ERROR_ID.SESSION_DISCONNECT_FROM_HOST
	end,
	[e.TYPE.SIGNIN_USER_CHANGED] = function()
		return TppDefine.ERROR_ID.SIGNIN_USER_CHANGED
	end,
	[e.TYPE.INVITATION_PATCH_DLC_CHECKING] = function()
		return 5100, false, "POPUP_TYPE_NO_BUTTON_NO_EFFECT", nil
	end,
	[e.TYPE.INVITATION_PATCH_DLC_ERROR] = function()
		return 5103
	end,
	[e.TYPE.INVITATION_ACCEPT_BY_OTHER] = function()
		return 5005
	end,
	[e.TYPE.INVITATION_ACCEPT_WITHOUT_SIGNIN] = function()
		return 5012
	end,
	[e.TYPE.WAIT_MGO_CHUNK_INSTALLATION] = function()
...
function e.OnEndExceptionDialogForSignInUserChange()
	...
	TppUI.FadeOut(
		TppUI.FADE_SPEED.FADE_MOMENT,
		"FadeOutOnEndExceptionDialogForSignInUserChange",
		nil,
		{ setMute = true }
	)
...
function e.CancelMgoInvitation()
...
e.POPUP_CLOSE_CHECK_FUNC = {
	[e.TYPE.INVITATION_ACCEPT] = e.UpdateMgoInvitationAccept,
	[e.TYPE.INVITATION_PATCH_DLC_CHECKING] = e.UpdateMgoPatchDlcCheckingPopup,
	[e.TYPE.WAIT_MGO_CHUNK_INSTALLATION] = e.UpdateMgoChunkInstallingPopup,
}
e.TPP_ON_END_EXECPTION_DIALOG = {
	[e.TYPE.INVITATION_ACCEPT] = e.OnEndExceptionDialogForMgoInvitationAccept,
	[e.TYPE.DISCONNECT_FROM_PSN] = e.NoProcessOnEndExceptionDialog,
	[e.TYPE.DISCONNECT_FROM_KONAMI] = e.NoProcessOnEndExceptionDialog,
	[e.TYPE.DISCONNECT_FROM_NETWORK] = e.NoProcessOnEndExceptionDialog,
	[e.TYPE.SESSION_DISCONNECT_FROM_HOST] = e.NoProcessOnEndExceptionDialog,
	[e.TYPE.SIGNIN_USER_CHANGED] = e.OnEndExceptionDialogForSignInUserChange,
	[e.TYPE.INVITATION_PATCH_DLC_CHECKING] = e.OnEndExceptionDialogForPatchDlcCheck,
	[e.TYPE.INVITATION_PATCH_DLC_ERROR] = e.OnEndExceptionDialogForPatchDlcError,
...
e.TPP_FOB_ON_END_EXECPTION_DIALOG = {
	[e.TYPE.INVITATION_ACCEPT] = e.OnEndExceptionDialogForMgoInvitationAccept,
	[e.TYPE.DISCONNECT_FROM_PSN] = e.FobMissionEndOnException,
	[e.TYPE.DISCONNECT_FROM_KONAMI] = e.FobMissionEndOnException,
	[e.TYPE.DISCONNECT_FROM_NETWORK] = e.FobMissionEndOnException,
	[e.TYPE.SESSION_DISCONNECT_FROM_HOST] = e.FobMissionEndOnException,
	[e.TYPE.SIGNIN_USER_CHANGED] = e.OnEndExceptionDialogForSignInUserChange,
	[e.TYPE.INVITATION_PATCH_DLC_CHECKING] = e.OnEndExceptionDialogForPatchDlcCheck,
	[e.TYPE.INVITATION_ACCEPT_BY_OTHER] = e.OnEndExceptionDialogForInvitationAcceptFromOther,
	[e.TYPE.INVITATION_ACCEPT_WITHOUT_SIGNIN] = e.OnEndExceptionDialogForInvitationAcceptWithoutSignIn,
...
function e.StartProcess(t, n)
	...
	local o = {
		...
		[e.TYPE.INVITATION_ACCEPT_BY_OTHER] = true,
		[e.TYPE.INVITATION_ACCEPT_WITHOUT_SIGNIN] = true,
