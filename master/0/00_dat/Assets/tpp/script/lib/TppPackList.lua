...
function e.AddFOBLayoutPack(n)
	...
	if (n == 50050) or (n == 10115) then
		local i = "/Assets/tpp/pack/mission2/"
			.. (s .. ("/" .. (i .. ("/" .. (i .. string.format("_area_ly%03d", vars.mbLayoutCode))))))
		local a = i .. ".fpk"
		local s = vars.mbClusterId
		if n == 10115 then
		...
		e.AddMissionPack(n)
	elseif n == 30050 then
		local n = "/Assets/tpp/pack/mission2/"
			.. (s .. ("/" .. (i .. ("/" .. (i .. string.format("_ly%03d", vars.mbLayoutCode))))))
		local n = n .. ".fpk"
		e.AddMissionPack(n)
	end
end
