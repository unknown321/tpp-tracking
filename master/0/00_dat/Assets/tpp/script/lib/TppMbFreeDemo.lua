...
e.demoBlockList = {
	...
	SnakeHasBadSmell_001 = { "/Assets/tpp/pack/mission2/free/f30050/f30050_d022.fpk", b },
...
e.demoOptions = {
	EntrustDdog = {
		OnEnd = function()
			TppStory.StartElapsedMissionEvent(
				TppDefine.ELAPSED_MISSION_EVENT.D_DOG_COME_TO_GET,
				TppDefine.INIT_ELAPSED_MISSION_COUNT.D_DOG_COME_TO_GET
			)
			TppStory.StartElapsedMissionEvent(
				TppDefine.ELAPSED_MISSION_EVENT.D_DOG_GO_WITH_ME,
				TppDefine.INIT_ELAPSED_MISSION_COUNT.D_DOG_GO_WITH_ME
			)
		end,
		time = "10:20:00",
		weather = TppDefine.WEATHER.SUNNY,
	...
	LongTimeNoSee_DdogLowLikability = {
		time = "12:00:00",
		weather = TppDefine.WEATHER.CLOUDY,
		heliEnableAfterDemo = true,
		OnEnd = function()
			gvars.elapsedTimeSinceLastPlay = 0
		end,
		...
		isUseGrassOcelot = true,
		loadBuddyBlock = true,
		forceEnableBuddyType = BuddyType.DOG,
	},
	LongTimeNoSee_DdogHighLikability = {
		time = "12:00:00",
		weather = TppDefine.WEATHER.SUNNY,
	...
	MoraleOfMBIsLow = {
		time = "20:00:00",
		weather = TppDefine.WEATHER.RAINY,
		heliEnableAfterDemo = true,
		OnEnter = function()
			TppPlayer.Refresh()
	...
	HappyBirthDayWithQuiet = {
		...
		OnEnter = function()
			local e =
				"ly003_cl00_item0000|cl00pl0mb_fndt_plnt_gimmick2_nowep0000|mtbs_cran001_vrtn002_gim_n0000|srt_mtbs_cran001_vrtn002"
			local t = "/Assets/tpp/level/location/mtbs/block_area/ly00"
				.. (
					tostring(vars.mbLayoutCode) .. (
						"/cl00/mtbs_ly00" .. (tostring(vars.mbLayoutCode) .. "_cl00_item.fox2")
					)
				)
	...
	QuietOnHeliInRain = {
		...
		OnEnd = function()
			local t =
				"ly003_cl00_item0000|cl00pl0mb_fndt_plnt_gimmick2_nowep0000|mtbs_cran001_vrtn002_gim_n0000|srt_mtbs_cran001_vrtn002"
			local e = "/Assets/tpp/level/location/mtbs/block_area/ly00"
				.. (
					tostring(vars.mbLayoutCode) .. (
						"/cl00/mtbs_ly00" .. (tostring(vars.mbLayoutCode) .. "_cl00_item.fox2")
					)
	...
	QuietHasFriendshipWithChild = {
		...
		OnPrevPlayRequest = function()
			...
			svars.isCollect_ShortAflo =
				gvars.quietHasFriendshipWithChildFlag[TppDefine.S10100_BOY_ENUM.Collect_ShortAflo]
			svars.isCollect_BlackCoat =
				gvars.quietHasFriendshipWithChildFlag[TppDefine.S10100_BOY_ENUM.Collect_BlackCoat]
		end,
		OnEnd = function()
			TppBuddyService.QuietHospitalized()
			local t = { 8.647, 0.8, -28.748 }
			local e = -25
	...
	GoToMotherBaseAfterQuietBattle = {
		...
		OnEnter = function()
			...
			TppEffectUtility.SetOceanDisplacementStrength(0.001)
			TppEffectUtility.SetOceanWaveAmplitude(0.5)
			TppEffectUtility.SetOceanWindDirection(-0.04, -0.1)
		end,
		OnEnd = function()
			TppEffectUtility.RestoreOceanParameters()
		end,
		loadBuddyBlock = true,
		telopLangIdList = { "area_demo_quiet_01", "area_demo_quiet_02" },
	},
	ArrivedMotherBaseAfterQuietBattle = {
		...
		OnEnd = function()
			...
			local e = TppMotherBaseManagement.GenerateStaffParameter({
				staffType = "Unique",
				uniqueTypeId = TppMotherBaseManagementConst.STAFF_UNIQUE_TYPE_ID_QUIET,
			})
	...
	TheGreatEscapeLiquid = {
		...
		OnEnd = function()
			TppStory.StartElapsedMissionEvent(
				TppDefine.ELAPSED_MISSION_EVENT.THE_GREAT_ESCAPE_LIQUID,
				TppDefine.INIT_ELAPSED_MISSION_COUNT.THE_GREAT_ESCAPE_LIQUID
			)
	...
	DecisionHuey = {
		OnEnter = function()
			...
			TppEffectUtility.SetOceanDisplacementStrength(0.0115)
			TppEffectUtility.SetOceanWindDirection(-0.8, 0.5)
			TppEffectUtility.SetOceanWaveAmplitude(0.4)
		end,
		OnEnd = function()
			...
			TppCassette.Acquire({
				cassetteList = { "tp_m_10190_05", "tp_m_10190_06", "tp_m_10240_03", "tp_m_10240_04" },
				pushReward = true,
			})
	...
	PazPhantomPain4 = e._PazPhantomPain4Settings,
	PazPhantomPain4_jp = e._PazPhantomPain4Settings,
}
function e.PlayMtbsEventDemo(o)
	...
	local t = {
		onInit = function()
			...
			if S then
				...
				local e, l = e.GetDemoPlayCluster(l)
				n, t = mtbs_cluster.GetDemoCenter(e, l)
			end
			...
			if not c then
				if T then
					GameObject.SendCommand(
						...
						{
							id = "SetDemoToAfterDropEnabled",
							enabled = true,
							route = "ly003_cl00_30050_heli0000|cl00pl0_mb_fndt_plnt_heli_30050|rt_tkof",
							isTakeOff = true,
						}
					)
				else
	...
	local n = {
		...
		finishFadeOut = E,
		startNoFadeIn = true,
		exceptGameStatus = o.exceptGameStatus,
		waitBlockLoadEndOnDemoSkip = h,
	}
...
function e.GetPackListForStorySequence()
	...
	elseif t == TppDefine.CLUSTER_DEFINE.Develop then
		if TppStory.CanArrivalSahelanInMB() then
			local t = "/Assets/tpp/pack/mission2/free/f30050/f30050_ly00"
				.. (tostring(vars.mbLayoutCode) .. "_sahelan.fpk")
			table.insert(e, t)
		end
		if TppStory.CanArrivalAIPodInMB() then
			local t = "/Assets/tpp/pack/mission2/free/f30050/f30050_ly00"
				.. (tostring(vars.mbLayoutCode) .. "_aipod.fpk")
			table.insert(e, t)
		end
