...
e.FIRE_KILL_SOLDIER_FOB_SNEAK =
	{ heroicPoint = "HEROIC_POINT_FIRE_KILL_SOLDIER_FOB_SNEAK", ogrePoint = "OGRE_POINT_FIRE_KILL_SOLDIER_FOB_SNEAK" }
e.KILL_SOLDIER = { heroicPoint = 0, ogrePoint = 60 }
e.KILL_SOLDIER_FOB_SNEAK =
	{ heroicPoint = "HEROIC_POINT_KILL_SOLDIER_FOB_SNEAK", ogrePoint = "OGRE_POINT_KILL_SOLDIER_FOB_SNEAK" }
...
e.BREAK_PTW_MACHINEGUN =
	{ heroicPoint = "HEROIC_POINT_BREAK_PTW_MACHINEGUN", ogrePoint = "OGRE_POINT_BREAK_PTW_MACHINEGUN" }
...
e.FULTON_SUPPORTER_CONTAINER =
	{ heroicPoint = "HEROIC_POINT_FULTON_CONTAINER", ogrePoint = "OGRE_POINT_FULTON_CONTAINER" }
