...
a.BUDDY_FRIENDLY_MAX = { [BuddyFriendlyType.HORSE] = 26, [BuddyFriendlyType.DOG] = 27, [BuddyFriendlyType.QUIET] = 28 }
local _ = {
	afgh = {
		"afgh_field_cp",
		"afgh_remnants_cp",
...
a.DOMINATION_TARGET_CP_COUNT = { afgh = #_.afgh, mafr = #_.mafr }
a.DOMINATION_TARGET_CP_NAME_LIST = {}
...
function a.UnlockOnAllQuestClear()
	a.Unlock(17)
end
return a
