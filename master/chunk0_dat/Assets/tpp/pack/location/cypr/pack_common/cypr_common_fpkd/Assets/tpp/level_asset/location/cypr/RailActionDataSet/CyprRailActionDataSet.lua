CyprRailActionDataSet = {
	...
	Init = function(data)
		...
		data:AddMotionObjectData(
			"stateRailCircleChair",
			"CircleChairWillBeOverturned",
			"/Assets/tpp/motion/SI_game/fani/props/char/charp21/charp21_4_wk_cir.gani"
		)
		data:AddMotionObjectData(
			"stateRailWagon",
			"EquipmentOnTheCart",
			"/Assets/tpp/motion/SI_demo/fani/p21_mdeq004/skl/bodies/vrtn09/p21_mdeq004_vrtn009_an_a_B.gani"
		)
		data:AddMotionObjectData(
			"stateRailWagonIdle",
			"EquipmentOnTheCart",
			"/Assets/tpp/motion/SI_demo/fani/p21_mdeq004/skl/bodies/vrtn09/p21_mdeq004_vrtn009_an_b_B.gani"
		)
		data:AddMotionObjectData(
			"stateRailWagonEnd",
			"EquipmentOnTheCart",
			"/Assets/tpp/motion/SI_demo/fani/p21_mdeq004/skl/bodies/vrtn09/p21_mdeq004_vrtn009_an_c_B.gani"
		)
		...
		data:AddContinuityMoveData(
			"DlBenchSet",
			1,
			"stateRailDlBenchEnd",
			"stateRailIdle",
			9,
			"stateRailDlBenchEndSmallWalk"
		)
		...
		data:AddContinuityMoveData(
			"DislocationSquatSet",
			0,
			"stateRailMoveForward1",
			"stateRailIdle",
			0,
			"stateRailMoveForward2"
		)
		data:AddContinuityMoveData(
			"DislocationSquatSet",
			1,
