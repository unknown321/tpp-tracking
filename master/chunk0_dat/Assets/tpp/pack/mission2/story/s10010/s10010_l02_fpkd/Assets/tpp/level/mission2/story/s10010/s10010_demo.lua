...
s10010_demo.PlayOpeningDemo = function(functionTable)
	...
	TppDemo.Play(
		"opening",
		functionTable,
		{ isInGame = true, startNoFadeIn = true, finishFadeOut = true, enableSkipMenu = true }
	)
end
...
s10010_demo.PlayPassportPhotographDemo = function(functionTable)
	...
	TppDemo.Play(
		"passportPhotograph",
		functionTable,
		{ isExecMissionClear = true, startNoFadeIn = true, finishFadeOut = true, enableSkipMenu = true }
	)
end
...
s10010_demo.PlayFireWhaleTruthDemo = function(functionTable)
	...
	TppDemo.Play(
		"fireWhaleTruth",
		functionTable,
		{ isExecMissionClear = true, finishFadeOut = true, enableSkipMenu = true }
	)
end
