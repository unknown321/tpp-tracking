...
s10010_sequence.CreateOffsetVector3 = function(x, y, z)
	Fox.Log(
		"s10010_sequence.CreateOffsetVector3(): x:" .. tostring(x) .. ", y:" .. tostring(y) .. ", z:" .. tostring(z)
	)
...
local routeChangeTableRoot = {
	...
	[Fox.StrCode32("end_of_ish0non_q_pnt22_d2g_02")] = {
		...
		{
			func = function()
				s10010_sequence.SetModelVisibility(
					{
						identifier = "cypr_l01_other_DataIdentifier",
						key = "p21_010410_cypr_grat001_door001_open",
						visible = true,
					},
					true,
					false
	...
	[Fox.StrCode32("end_of_ish0non_q_pnt26_to_pnt27")] = {
		...
		{
			func = function()
				s10010_sequence.OnEventFinished("enter2F")
			end,
		},
	},
	[Fox.StrCode32("end_of_rts_skull_2F_0003")] = {
		{
			func = function()
				...
				GameObject.SendCommand(
					GameObject.GetGameObjectId("ishmael"),
					{
						id = "SetTargetId",
						targetId = GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010490_0000"),
						headShot = true,
					}
				)
			end,
	...
	[Fox.StrCode32("end_of_ish0non_q_pnt30_to_pnt31")] = {
		...
		},
		{
			func = function()
				...
				GameObject.SendCommand(
					GameObject.GetGameObjectId("ishmael"),
					{ id = "CallMonologue", label = "ISHM_072" }
				)
			end,
		},
	},
...
function s10010_sequence.MissionPrepare()
	...
	title_sequence.RegisterGameStatusFunction(
	...
	TppMission.RegisterMissionSystemCallback({
		OnGameOver = function(gameOverType)
			...
			if
				TppMission.CheckGameOverDemo(TppDefine.GAME_OVER_TYPE.PLAYER_DEAD)
				and s10010_sequence.DoesSequenceNeedGameOverDemo(TppSequence.GetCurrentSequenceName())
			then
...
function s10010_sequence.OnRestoreSVars()
	...
	if mvars.initialEffectCreation then
		for effectName, creation in pairs(mvars.initialEffectCreation) do
			if creation then
				s10010_sequence.CreateEffect(
					{ func = s10010_sequence.CreateEffect, effectName = effectName },
					true,
					false
				)
			end
	...
	if
		sequenceIndex >= TppSequence.GetSequenceIndex("Seq_Game_GunTutorial")
		and sequenceIndex <= TppSequence.GetSequenceIndex("Seq_Demo_EscapeFromEntrance")
	then
...
function s10010_sequence.OnEndMissionPrepareSequence()
	...
	if
		vars.weapons[0] == TppEquip.EQP_None
		and vars.weapons[1] == TppEquip.EQP_None
		and vars.weapons[2] == TppEquip.EQP_None
		and mvars.doesEquipInitialize
		and mvars.initialEquipTable
	then
		Player.ChangeEquip({
	...
	if mvars.initialHeliSoundRequested then
		GameObject.SendCommand(
			GameObject.GetGameObjectId("WestHeli"),
			{ id = "CallSound", eventName = "sfx_m_cypr_heli" }
		)
	end

	if s10010_sequence.DoesIdentifierExist("cypr_l01_other_DataIdentifier") then
		Gimmick.ResetGimmickData(
			"cypr_char005_gim_i0000|TppSharedGimmick_cypr_char005",
			"/Assets/tpp/level/location/cypr/block_large/block_l_stage_01/cypr_l_stage_01_env.fox2"
		)
	end
	if s10010_sequence.DoesIdentifierExist("cypr_s01_other_DataIdentifier") then
		Gimmick.ResetGimmickData(
			"cypr_wndw001_glas001_gim_i0000|TppSharedGimmick_cypr_wndw001_glas001",
			"/Assets/tpp/level/location/cypr/block_small/01/cypr_01_asset.fox2"
		)
		Gimmick.ResetGimmickData(
			"cypr_wndw001_glas002_gim_i0000|TppSharedGimmick_cypr_wndw001_glas002",
			"/Assets/tpp/level/location/cypr/block_small/01/cypr_01_asset.fox2"
		)
		Gimmick.ResetGimmickData(
			"cypr_wndw001_glas003_gim_i0000|TppSharedGimmick_cypr_wndw001_glas003",
			"/Assets/tpp/level/location/cypr/block_small/01/cypr_01_asset.fox2"
		)
		Gimmick.ResetGimmickData(
			"cypr_wndw001_glas004_gim_i0000|TppSharedGimmick_cypr_wndw001_glas004",
			"/Assets/tpp/level/location/cypr/block_small/01/cypr_01_asset.fox2"
		)
	end
...
function s10010_sequence.OnTerminate()
	...
	GrTools.SetDofControll({
		enableScatter = false,
		nearCocLimitSize = 256.0,
		farCocLimitSize = 256.0,
...
s10010_sequence.IsEventFinished = function(eventName, currentSequence)
	...
	Fox.Log(
		"s10010_sequence.IsEventFinished(): eventName:"
			.. tostring(eventName)
			.. ", currentSequence:"
			.. tostring(currentSequence)
			.. ", currentSequenceIndex:"
			.. tostring(currentSequenceIndex)
			.. ", eventSequenceIndex:"
			.. tostring(eventSequenceIndex)
	)
		...
		GameObject = {
			...
			},
			{
				...
				func = function(gameObjectId, actionId)
					Fox.Log(
						"s10010_sequence.Messages(): GameObject:SpecialActionEnd: gameObjectId:"
							.. tostring(gameObjectId)
							.. ", actionId:"
							.. tostring(actionId)
					)
					...
					if locatorName then
						...
						if mvars.motionList[locatorName] and #mvars.motionList[locatorName] > 0 then
							...
							s10010_sequence.OnRoutePoint(
								gameObjectId,
								nil,
								0,
								Fox.StrCode32(mvars.specialActioinName[locatorName])
							)
						end
					end
				end,
			},
			{
				...
				func = function(gameObjectId)
					...
					if
						gameObjectId ~= GameObject.GetGameObjectId("ishmael")
						or TppSequence.GetCurrentSequenceName() == "Seq_Demo_EscapeFromHospital"
					then
						Fox.Log(
							"s10010_sequence.Messages(): ignore operation because current sequence is Seq_Demo_EscapeFromHospital."
						)
						return
					end
					...
					GameObject.SendCommand(
						GameObject.GetGameObjectId("ishmael"),
						{ id = "CallMonologue", label = "ISHM_094" }
					)

					TppMission.ReserveGameOver(
						TppDefine.GAME_OVER_TYPE.TARGET_DEAD,
						TppDefine.GAME_OVER_RADIO.TARGET_DEAD
					)
			...
			},
			{
				...
				func = function(gameObjectId, attackId, attackerGameObjectId)
					Fox.Log(
						"s10010_sequence.Messages(): GameObject: Damage: gameObjectId:"
							.. tostring(gameObjectId)
							.. ", attackId:"
							.. tostring(attackId)
							.. ", attackerGameObjectId"
							.. tostring(attackerGameObjectId)
					)
					...
					if
						(
							attackId == TppDamage.ATK_10001
							or attackId == TppDamage.ATK_10004
							or attackId == TppDamage.ATK_10006
							or attackId == TppDamage.ATK_10015
							or attackId == TppDamage.ATK_10024
							or attackId == TppDamage.ATK_10035
							or attackId == TppDamage.ATK_20002
							or attackId == TppDamage.ATK_20006
							or attackId == TppDamage.ATK_20015
						) and Tpp.IsPlayer(attackerGameObjectId)
					then
						s10010_sequence.PlayMotion({
							locatorName = "ishmael",
							motionPath = "/Assets/tpp/motion/SI_game/fani/bodies/snap/snapdam/snapdam_s_die_idl_l.gani",
				...
				func = function(demoId)
					...
					if s10010_sequence.eventTableRoot[eventName] then
						for subEventName, subEventTable in pairs(s10010_sequence.eventTableRoot[eventName]) do
							if
								(
									not mvars.executedSubEvent[eventName]
									or not mvars.executedSubEvent[eventName][subEventName]
								) and (subEventName ~= "before" and subEventName ~= "after")
							then
		...
		Player = {
			{
				...
				func = function(gameObjectId, actionType)
					...
					Fox.Log(
						"s10010_sequence.Messages(): Player.NotifyChangedPlayerRailAction: gameObjectId:"
							.. tostring(gameObjectId)
							.. ", actionType:"
							.. actionType
							.. ", railIndex:"
					...
					Fox.Log(
						"s10010_sequence.Messages(): Player.NotifyChangedPlayerRailAction: eventName:"
							.. tostring(eventName)
					)
					if eventName then
			...
			},
			{
				...
				func = function()
					...
					if
						TppSequence.GetCurrentSequenceName() ~= "Seq_Demo_EscapeFromHospital"
						and not svars.reservedBoolean0004
					then
						TppUI.ShowTipsGuide({
							contentName = "RELOAD",
							isOnce = false,
		...
		Trap = {
			{
				...
				func = function(trapName, gameObjectId)
					Fox.Log(
						"s10010_sequence.Messages(): Trap: Enter: trapName:"
							.. tostring(trapName)
							.. ", gameObjectId:"
							.. tostring(gameObjectId)
					)
			...
			},
			{
				...
				func = function(trapName, gameObjectId)
					Fox.Log(
						"s10010_sequence.Messages(): Trap: Exit: trapName:"
							.. tostring(trapName)
							.. ", gameObjectId:"
							.. tostring(gameObjectId)
					)
			...
			},
			{
				...
				func = function(trapName, gameObjectId)
					Fox.Log(
						"s10010_sequence.Messages(): Trap: Enter: trap_Curtain_: trapName:"
							.. tostring(trapName)
							.. ", gameObjectId:"
							.. tostring(gameObjectId)
					)
			...
			},
			{
				...
				func = function(trapName, gameObjectId)
					Fox.Log(
						"s10010_sequence.Messages(): Trap: Exit: trap_Curtain_: trapName:"
							.. tostring(trapName)
							.. ", gameObjectId:"
							.. tostring(gameObjectId)
					)
		...
		Timer = {
			...
			},
			{
				...
				func = function()
					...
					GameObject.SendCommand(
						{ type = "TppPlayerHorse2forVr", group = 0, index = 0 },
						{ id = "RequestHandsGunToPlayer" }
					)
					s10010_sequence.ChangePlayerEquip(
						{
							equipId = "EQP_WP_Volgin_sg_010",
							stock = 100,
							ammo = 6,
					...
					GameObject.SendCommand(
						GameObject.GetGameObjectId("ocelot"),
						{ id = "CallMonologue", label = "OCLT_001" }
					)
					GameObject.SendCommand(
						GameObject.GetGameObjectId("ocelot"),
						{ id = "CallMonologue", label = "OCLT_003" }
					)
					GameObject.SendCommand(
						GameObject.GetGameObjectId("ocelot"),
						{ id = "CallMonologue", label = "OCLT_004" }
					)
			...
			},
			{
				...
				func = function()
					...
					if svars.reservedNumber0001 and svars.reservedNumber0001 ~= 0 then
						local locationTelopLangId, baseTelopLangId =
							s10010_sequence.GetLocationTelopLangId(svars.reservedNumber0001)
			...
			for subEventName, subEventTable in pairs(eventTable) do
				if subEventName ~= "before" and subEventName ~= "after" then
					...
					table.insert(messageTable.Demo, {
						...
						func = function(demoId)
							Fox.Log(
								"s10010_sequence.Messages(): Demo: received sub event message: subEventName:"
									.. tostring(subEventName)
							)
							local demoName = s10010_demo.GetDemoNameFromDemoId(demoId)
...
s10010_sequence.OnGameObjectEnterTrap = function(trapName, gameObjectId)
	Fox.Log(
		"s10010_sequence.OnGameObjectEnterTrap(): trapName"
			.. tostring(trapName)
			.. ", gameObjectId:"
			.. tostring(gameObjectId)
	)
...
s10010_sequence.OnGameObjectExitTrap = function(trapName, gameObjectId)
	Fox.Log(
		"s10010_sequence.OnGameObjectExitTrap(): trapName"
			.. tostring(trapName)
			.. ", gameObjectId:"
			.. tostring(gameObjectId)
	)
...
s10010_sequence.CallRestraintMonologue = function()
	...
	local label =
		s10010_sequence.restraintMonologueLabelList[mvars.restraintMonologueCount % #s10010_sequence.restraintMonologueLabelList + 1]
...
s10010_sequence.SetModelVisibility = function(subEventTable, executed, skipped)
	...
	if s10010_sequence.DoesIdentifierExist(subEventTable.identifier) then
		Fox.Log(
			"s10010_sequence.SetModelVisibility(): identifier:"
				.. tostring(subEventTable.identifier)
				.. ", key:"
				.. tostring(subEventTable.key)
				.. ", visible:"
...
s10010_sequence.SetMeshVisibility = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetMeshVisibility(): ididentifier"
			.. tostring(subEventTable.identifier)
			.. ", key:"
			.. tostring(subEventTable.key)
			.. ", meshName:"
			.. tostring(subEventTable.meshName)
			.. ", visible:"
			.. tostring(subEventTable.visible)
	)
	...
	if s10010_sequence.DoesIdentifierExist(subEventTable.identifier) then
		...
		if visible then
			TppDataUtility.VisibleMeshFromIdentifier(
				subEventTable.identifier,
				subEventTable.key,
				subEventTable.meshName
			)
		else
			TppDataUtility.InvisibleMeshFromIdentifier(
				subEventTable.identifier,
				subEventTable.key,
				subEventTable.meshName
			)
...
s10010_sequence.SetGimmickVisibility = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetGimmickVisibility(): identifier:"
			.. tostring(subEventTable.identifier)
			.. ", type:"
			.. tostring(subEventTable.type)
			.. ", datasetName:"
			.. tostring(subEventTable.datasetName)
			.. ", locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", visible:"
			.. tostring(subEventTable.visible)
	)
...
s10010_sequence.SetSharedGimmickVisibility = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetGimmickVisibility(): identifier:"
			...
			.. tostring(subEventTable.datasetName)
			.. ", iReferencePath:"
			.. tostring(subEventTable.iReferencePath)
			.. ", nReferencePath:"
			.. tostring(subEventTable.nReferencePath)
			.. ", visible:"
			.. tostring(subEventTable.visible)
	)
...
s10010_sequence.EnableEnemy = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.EnableEnemy(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", enable:"
			.. tostring(subEventTable.enable)
	)
	...
	if executed then
		...
		if subEventTable.locatorName == "ishmael" then
			if enable == true then
				...
				GameObject.SendCommand(
					gameObjectId,
					{ id = "SetHostage2Flag", flag = "disableDamageReaction", on = true }
				)
				...
				TppRadio.SetGameOverRadio(
					TppDefine.GAME_OVER_RADIO.PLAYER_DEAD,
					TppRadio.COMMON_GAME_OVER_RADIO_LIST[TppDefine.GAME_OVER_RADIO.PLAYER_DEAD]
				)
			end
		elseif Tpp.IsSoldier(gameObjectId) then
			...
			if enable then
				...
				GameObject.SendCommand(
					gameObjectId,
					{ id = "SetGunLightSwitch", isOn = light, useCastShadow = castShadow }
				)
...
s10010_sequence.ChangeEnemyRoute = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.ChangeEnemyRoute(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", sneakRouteName:"
			.. tostring(subEventTable.sneakRouteName)
			.. ", cautionRouteName:"
			.. tostring(subEventTable.cautionRouteName)
	)
...
s10010_sequence.ChangeHeliRoute = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.ChangeHeliRoute(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", routeName:"
...
s10010_sequence.ChangeHorseRoute = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.ChangeHorseRoute(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", routeName:"
			.. tostring(subEventTable.routeName)
	)
...
s10010_sequence.SetEffectVisibility = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetEffectVisibility(): effectName:"
			.. tostring(subEventTable.effectName)
			.. ", visible:"
			.. tostring(subEventTable.visible)
	)
...
s10010_sequence.SetEffectSize = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetEffectSize(): effectName:"
			.. tostring(subEventTable.effectName)
			.. ", size:"
			.. tostring(subEventTable.size)
	)

	if not TppDataUtility.IsReadyEffectFromGroupId(subEventTable.effectName) then
		Fox.Log(
			"s10010_sequence.SetEffectSize(): ignore operation because effect does not exist. effectName:"
				.. tostring(subEventTable.effectName)
		)
		return
	end
	...
	if executed then
		TppDataUtility.SetVector4EffectFromGroupId(
			subEventTable.effectName,
			"Size",
			subEventTable.size[1],
			subEventTable.size[2],
			subEventTable.size[3],
			subEventTable.size[4]
		)
	end
end
...
s10010_sequence.CreateEffect = function(subEventTable, executed, skipped)
	...
	if not TppDataUtility.IsReadyEffectFromGroupId(subEventTable.effectName) then
		Fox.Log(
			"s10010_sequence.CreateEffect(): ignore operation because effect does not exist. effectName:"
				.. tostring(subEventTable.effectName)
		)
		return
	end
...
s10010_sequence.DestroyEffect = function(subEventTable, executed, skipped)
	...
	if not TppDataUtility.IsReadyEffectFromGroupId(subEventTable.effectName) then
		Fox.Log(
			"s10010_sequence.DestroyEffect(): ignore operation because effect does not exist. effectName:"
				.. tostring(subEventTable.effectName)
		)
		return
	end
...
s10010_sequence.EnableUI = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.EnableUI(): uiName:"
			.. tostring(subEventTable.uiName)
			.. ", enable:"
			.. tostring(subEventTable.enable)
	)
...
s10010_sequence.EnableDataBody = function(subEventTable, executed, skipped)
	...
	if s10010_sequence.DoesIdentifierExist(subEventTable.identifier) then
		...
		Fox.Log(
			"s10010_sequence.EnableDataBody(): identifier:"
				.. tostring(subEventTable.identifier)
				.. ", key:"
				.. tostring(subEventTable.key)
				.. ", enable:"
...
s10010_sequence.StartVolginRide = function(subEventTable, executed, skipped)
	...
	if executed then
		if immediately and cypr_player_volgin_ride.Init() then
			...
			GameObject.SendCommand(
				gameObjectId,
				{ id = "SetDemoToRideHorse", horseId = GameObject.GetGameObjectId("ocelot_horse") }
			)
		end
...
s10010_sequence.SetNextSequence = function(subEventTable, executed, skipped)
	...
	if
		not skipped
		and executed
		and TppSequence.GetCurrentSequenceIndex() < TppSequence.GetSequenceIndex(subEventTable.sequenceName)
	then
...
s10010_sequence.ChangeNpcRoute = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.ChangeNpcRoute(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", routeName:"
			.. tostring(subEventTable.routeName)
			.. ", moveMotionPath:"
			.. tostring(subEventTable.moveMotionPath)
	)
...
s10010_sequence.PushMotion = function(motionTable)
	...
	if motionTable.locatorName and (motionTable.motionPath or motionTable.state) then
		...
		elseif
			not mvars.motionPlaying[motionTable.locatorName] and not next(mvars.motionList[motionTable.locatorName])
		then
			s10010_sequence.PlayMotion(motionTable)
		else
...
s10010_sequence.PlayMotion = function(inMotionTable)
	Fox.Log(
		"s10010_sequence.PlayMotion(): locatorName:"
			.. tostring(inMotionTable.locatorName)
			.. ", motionPath:"
			.. tostring(inMotionTable.motionPath)
			.. ", specialActionName:"
			.. tostring(inMotionTable.specialActionName)
			.. ", position:"
			.. tostring(inMotionTable.position)
			.. ", rotationY:"
			.. tostring(inMotionTable.rotationY)
			.. ", idle:"
			.. tostring(inMotionTable.idle)
			.. ", enableGunFire:"
			.. tostring(inMotionTable.enableGunFire)
	)

	local motionTable = inMotionTable
	if not motionTable or not motionTable.locatorName then
		Fox.Error(
			"s10010_sequence.PlayMotion(): inMotionTable or inMotionTable.locatorName is nil! This function cannot continue operation!"
		)
		return
	end
	...
	if not motionTable.motionPath and not motionTable.state then
		if
			mvars.motionList
			and mvars.motionList[motionTable.locatorName]
			and mvars.motionList[motionTable.locatorName][1]
		then
	...
	if position or rotationY then
		if gameObjectId ~= GameObject.NULL_ID then
			GameObject.SendCommand(
				...
				{
					id = "Warp",
					degRotationY = rotationY,
					position = position,
					demoEnd = true,
					interpTime = 0.1,
					control = charaControl,
				}
			)
		end
	else
...
s10010_sequence.PushMotionOnSubEvent = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.PushMotionOnSubEvent(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", motionPath:"
			.. tostring(subEventTable.motionPath)
			.. ", specialActionName:"
			.. tostring(subEventTable.specialActionName)
	)
...
s10010_sequence.EnableMob = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.EnableMob(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", enable:"
			.. tostring(subEventTable.enable)
	)
...
s10010_sequence.ChangePlayerEquip = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.ChangePlayerEquip(): equipId:"
			.. tostring(subEventTable.equipId)
			.. ", stock:"
			.. tostring(subEventTable.stock)
			.. ", ammo:"
			.. tostring(subEventTable.ammo)
			.. ", isSuppressorOn:"
			.. tostring(subEventTable.isSuppressorOn)
			.. ", suppressorLife:"
			.. tostring(subEventTable.suppressorLife)
			.. ", toActive:"
			.. tostring(subEventTable.toActive)
	)
...
s10010_sequence.WarpVolgin = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.WarpVolgin(): identifier:"
			.. tostring(subEventTable.identifier)
			.. ", key:"
			.. tostring(subEventTable.key)
	)
	...
	if executed and gameObjectId ~= GameObject.NULL_ID then
		...
		GameObject.SendCommand(
			gameObjectId,
			{ id = "Warp", position = translation, rotationY = Tpp.GetRotationY(rotQuat) }
		)
	end
end
...
s10010_sequence.SetEnemyPuppet = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetEnemyPuppet(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", puppet:"
...
s10010_sequence.SetPlayerMotionSpeed = function(subEventTable, executed, skipped)
	...
	if not s10010_sequence.DoesIdentifierExist("s10010_l01_sequence_DataIdentifier") then
		Fox.Log(
			"s10010_sequence.ChangePlayerFova(): ignore operation because player instance does not exist in this sequence."
		)
		return
	end
	...
	if executed then
		if skipped then
			...
			GameObject.SendCommand(
				GameObject.GetGameObjectId("Player"),
				{ id = "SetBaseMotionSpeedRate", speedRate = subEventTable.motionSpeed }
			)
		end
	end
end
...
s10010_sequence.BreakGimmick = function(subEventTable, executed, skipped, demoSkipped)
	Fox.Log(
		"s10010_sequence.BreakGimmick(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", datasetPath:"
			.. tostring(subEventTable.datasetPath)
			.. ", executed:"
			.. tostring(executed)
			.. ", skipped:"
			.. tostring(skipped)
			.. ", demoSkipped:"
			.. tostring(demoSkipped)
	)

	if executed and not skipped and not demoSkipped then
		Gimmick.BreakGimmick(
			TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
			subEventTable.locatorName,
			subEventTable.datasetPath,
			false
		)
	end
end
...
s10010_sequence.StartVolginShooting = function(subEventTable, executed, skipped)
	...
	if executed and not skipped then
		GameObject.SendCommand(
			GameObject.GetGameObjectId("Player"),
			{ id = "SetSpecialAttackMode", enabled = true, type = "AttackVolgin" }
		)
		Player.ChangeEquip({
...
s10010_sequence.StopVolginShooting = function(subEventTable, executed, skipped)
	...
	if executed and not skipped then
		GameObject.SendCommand(
			...
			{ id = "SetSpecialAttackMode", enabled = false, type = "AttackVolgin" }
		)
	end
end
...
s10010_sequence.RespawnVehicle = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.RespawnVehicle(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", respawn:"
			.. tostring(subEventTable.respawn)
	)
...
s10010_sequence.SetNpcEquipId = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetNpcEquipId(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", primaryEquipId:"
			.. tostring(subEventTable.primaryEquipId)
	)
	...
	if executed then
		...
		if gameObjectId and gameObjectId ~= GameObject.NULL_ID then
			GameObject.SendCommand(
				gameObjectId,
				{ id = "SetEquipId", primary = TppEquip[subEventTable.primaryEquipId] }
			)
		else
			Fox.Warning(
				"s10010_sequence.SetNpcEquipId(): gameObjectId is not found. locatorName:"
					.. tostring(subEventTable.locatorName)
					.. ", primaryEquipId:"
					.. tostring(subEventTable.primaryEquipId)
			)
...
s10010_sequence.EnableCorpse = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.EnableCorpse(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", enable:"
			.. tostring(subEventTable.enable)
	)
...
s10010_sequence.PlaySoundEffect = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.PlaySoundEffect(): soundSourceName:"
			.. tostring(subEventTable.soundSourceName)
			.. ", eventName:"
			.. tostring(subEventTable.eventName)
			.. ", singleShot:"
			.. tostring(subEventTable.singleShot)
	)
...
s10010_sequence.StopSoundEffect = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.StopSoundEffect(): soundSourceName:"
			.. tostring(subEventTable.soundSourceName)
			.. ", eventName:"
			.. tostring(subEventTable.eventName)
			.. ", explicitly:"
			.. tostring(subEventTable.explicitly)
	)
...
s10010_sequence.WarpPlayer = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.WarpPlayer(): position:"
			.. tostring(subEventTable.position)
			.. ", rotationY:"
			.. tostring(subEventTable.rotationY)
	)
	...
	if executed and not skipped then
		...
		GameObject.SendCommand(
			gameObjectId,
			{ id = "Warp", pos = subEventTable.position, rotY = TppMath.DegreeToRadian(subEventTable.rotationY) }
		)
	end
end
...
s10010_sequence.SetScatterDofEnabled = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetScatterDofEnabled(): enabled:"
			.. tostring(subEventTable.enabled)
			.. ", ignoreGen7:"
			.. tostring(subEventTable.ignoreGen7)
	)
	...
	if executed then
		GrTools.SetDofControll({
			enableScatter = subEventTable.enabled,
			nearCocLimitSize = 4.0,
			gen7MaxFarOnlyModeParam = gen7MaxFarOnlyModeParam,
		})
	end
end
...
s10010_sequence.CallMonologue = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.CallMonologue(): locatorName:"
			.. tostring(subEventTable.locatorName)
			.. ", voiceId:"
			.. tostring(subEventTable.label)
	)

	if executed and not skipped then
		GameObject.SendCommand(
			GameObject.GetGameObjectId(subEventTable.locatorName),
			{ id = "CallMonologue", label = subEventTable.label }
		)
	end
end
...
s10010_sequence.SetWeatherTag = function(subEventTable, executed, skipped)
	...
	Fox.Log(
		"s10010_sequence.SetWeatherTag(): tag:"
			.. tostring(subEventTable.tag)
			.. ", interpTime:"
			.. tostring(subEventTable.interpTime)
	)
...
s10010_sequence.SetInitialCameraRotation = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetInitialCameraRotation(): rotationX:"
			.. tostring(subEventTable.rotationX)
			.. ", rotationY:"
			.. tostring(subEventTable.rotationY)
	)
...
s10010_sequence.SetBloodStain = function(subEventTable, executed, skipped)
	...
	if executed then
		if not skipped then
			if
				mvars.mobEnabled
				and Tpp.IsTypeTable(mvars.mobEnabled)
				and mvars.mobEnabled[subEventTable.locatorName]
			then
				local gameObjectId = GameObject.GetGameObjectId(subEventTable.locatorName)
				if gameObjectId and gameObjectId ~= GameObject.NULL_ID then
...
s10010_sequence.SetLocationTelopLangId = function(subEventTable, executed, skipped)
	Fox.Log(
		"s10010_sequence.SetLocationTelopLangId(): locationTelopIndex:" .. tostring(subEventTable.locationTelopIndex)
	)

	if
		executed
		and not skipped
		and subEventTable.locationTelopIndex
		and Tpp.IsTypeNumber(subEventTable.locationTelopIndex)
	then
...
s10010_sequence.ExecSubEvent = function(eventName, subEventName, executed, skipped, demoSkipped)
	Fox.Log(
		"s10010_sequence.ExecSubEvent(): eventName:"
			.. tostring(eventName)
			.. ", subEventName:"
			.. tostring(subEventName)
			.. ", executed:"
...
s10010_sequence.OnRoutePoint = function(gameObjectId, routeId, routeNodeIndex, messageId)
	Fox.Log(
		"s10010_sequence.OnRoutePoint( gameObjectId:"
			.. tostring(gameObjectId)
			.. ", routeId:"
			.. tostring(routeId)
			.. ", routeNodeIndex:"
			.. tostring(routeNodeIndex)
			.. ", messageId:"
			.. tostring(messageId)
			.. " )"
	)
	...
	if routeChangeTables then
		for i, routeChangeTable in ipairs(routeChangeTables) do
			...
			local routeCheck = not routeChangeTable.locatorNameOnTheRoute
				or GameObject.GetGameObjectId(routeChangeTable.locatorNameOnTheRoute) == gameObjectId
			if funcCheck and routeCheck then
				...
				if
					routeChangeTable.locatorName
					and routeChangeTable.motionPath
					and routeChangeTable.specialActionName
				then
...
s10010_sequence.StopPlayerAndStartNearCamera = function(
	enabled,
	targetLocatorName,
	identifierName,
	keyName,
	...
	Fox.Log(
		"s10010_sequence.StopPlayerAndStartNearCamera(): enabled:"
			.. tostring(enabled)
			.. ", targetLocatorName:"
			.. tostring(targetLocatorName)
			.. ", identifierName:"
...
s10010_sequence.MakeLoadSequenceTable = function(
	demoTrapName,
	demoSequenceName,
	step,
	nextSequenceName,
	...
	Fox.Log(
		"s10010_sequence.MakeLoadSequenceTable(): demoTrapName:"
			.. tostring(demoTrapName)
			.. ", demoSequenceName:"
			.. tostring(demoSequenceName)
			.. ", step:"
			.. tostring(step)
			.. ", nextSequenceName:"
			.. tostring(nextSequenceName)
			.. ", checkPointName:"
			.. tostring(checkPointName)
			.. ", option:"
			.. tostring(option)
			.. ", inMessageTable:"
			.. tostring(inMessageTable)
	)
...
s10010_sequence.SetEffectVisiblityLazily = function(instanceName, visibility, immediately)
	Fox.Log(
		"s10010_sequence.SetEffectVisiblityLazily(): instanceName:"
			.. tostring(instanceName)
			.. ", visibility:"
			.. tostring(visibility)
			.. ", immediately:"
			.. tostring(immediately)
	)

	if not TppDataUtility.IsReadyEffectFromGroupId(instanceName) then
		Fox.Log(
			"s10010_sequence.SetEffectVisiblityLazily(): ignore operation because effect does not exist. effectName:"
				.. tostring(instanceName)
		)
		return
	end
...
s10010_sequence.MergeMessageTable = function(lhsTable, rhsTable)
	Fox.Log(
		"s10010_sequence.MergeMessageTable(): lhsTable:" .. tostring(lhsTable) .. ", rhsTable:" .. tostring(rhsTable)
	)
...
s10010_sequence.IsPlayerAndSoldierInSameTrap = function()
	...
	for trapName, gameObjectIdTable in pairs(mvars.gameObjectIdInTrap) do
		...
		for gameObjectId, inTrap in pairs(gameObjectIdTable) do
			Fox.Log(
				"s10010_sequence.IsPlayerAndSoldierInSameTrap(): gameObjectId:"
					.. tostring(gameObjectId)
					.. ", inTrap:"
					.. tostring(inTrap)
			)
...
s10010_sequence.IsAnyStickDown = function()
	return math.abs(PlayerVars.leftStickXDirect) > 0.1
		or math.abs(PlayerVars.leftStickYDirect) > 0.1
		or math.abs(PlayerVars.rightStickXDirect) > 0.1
		or math.abs(PlayerVars.rightStickYDirect) > 0.1
end
...
s10010_sequence.SetNextGameOverSequence = function(nextSequenceName, option)
	Fox.Log(
		"s10010_sequence.SetNextGameOverSequence(): nextSequenceName:"
			.. tostring(nextSequenceName)
			.. ", option:"
			.. tostring(option)
	)
...
sequences.Seq_Demo_Flashback = {
	...
	OnEnter = function(self)
		...
		elseif missionName == "s10280" then
			s10010_demo.PlayFlashBackDemo({
				onEnd = function()
					TppSequence.SetNextSequence("Seq_Game_Load21")
				end,
			})
		end
	end,
...
sequences.Seq_Game_Load21 =
	s10010_sequence.MakeLoadSequenceTable(nil, "Seq_Demo_Opening", 21, "Seq_Demo_Opening", "CHK_AfterAwakeRoom")
...
function s10010_sequence.TitleModeOnEnterFunction()
	...
	s10010_sequence.OnEnterOpeningDemo(sequences.Seq_Demo_Opening, function()
...
sequences.Seq_Demo_Opening = {
	...
	uncommonMessageTable = {
		Timer = {
			...
			},
			{
				...
				func = function()
					Fox.Log(
						"sequences.Seq_Demo_Opening.uncommonMessageTable: Timer: Finish: Timer_PlayBeforeOpeningDemo"
					)
		...
		Demo = {
			...
			},
			{
				...
				func = function()
					Fox.Log(
						"sequences.Seq_Demo_Opening.uncommonMessageTable: msg: p21_010000_cyprtitle_on: sender: p21_010000"
					)
	...
	OnEnter = function(self)
		...
		s10010_sequence.OnEnterOpeningDemo(self, function()
			s10010_sequence.StartTimer("Timer_ChangeSequence", 3)
		end)
...
s10010_sequence.GetLeftStickDirection = function(self)
	...
	return s10010_sequence.GetStickDirection(
		self,
		s10010_sequence.leftStickXHistory,
		s10010_sequence.leftStickYHistory,
		false,
...
s10010_sequence.GetRightStickDirection = function(self)
	...
	return s10010_sequence.GetStickDirection(
		...
		s10010_sequence.rightStickXHistory,
		s10010_sequence.rightStickYHistory,
		GameConfig.GetCameraLRIsReversed(),
		GameConfig.GetCameraUDIsReversed()
	)
end
		...
		Timer = {
			{
				...
				func = function(timerName)
					if self.OnStickUpdated then
						local leftStickDown, leftStickUp, leftStickLeft, leftStickRight =
							s10010_sequence.GetLeftStickDirection()
						local rightStickDown, rightStickUp, rightStickLeft, rightStickRight =
							s10010_sequence.GetRightStickDirection()

						Fox.Log(
							"s10010_sequence.MakeStickObservatioinSequenceMessage(): Timer: rightStickDown:"
								.. tostring(rightStickDown)
								.. ", rightStickUp:"
								.. tostring(rightStickUp)
						)
...
sequences.Seq_Game_FewDaysLater0 = {
	...
	uncommonMessageTable = {
		Timer = {
			...
			},
			{
				...
				func = function(timerName)
					Fox.Log(
						"sequences.Seq_Game_FewDaysLater1.uncommonMessageTable: Timer: Finish: Timer_PlayerOperationEnabled"
					)
	...
	OnStickUpdated = function(
		...
		if
			(rightStickDown > 0.5 or rightStickUp > 0.5 or rightStickLeft > 0.5 or rightStickRight > 0.5)
			or mvars.stickCheckSucceeded
		then
			if
				not s10010_sequence.IsDemoPlaying({
					"fewDaysLater0",
					"fewDaysLater1_NG0",
					"fewDaysLater1_NG1",
					"fewDaysLater1_NG2",
	...
	uncommonMessageTable = {
		Timer = {
			...
			},
			{
				...
				func = function(timerName)
					Fox.Log(
						"sequences.Seq_Game_FewDaysLater1.uncommonMessageTable: Timer: Finish: Timer_ChangeSequence"
					)
			...
			},
			{
				...
				func = function(timerName)
					Fox.Log(
						"sequences.Seq_Game_FewDaysLater1.uncommonMessageTable: Timer: Finish: Timer_ChangeSequence_NG0"
					)
					local sequenceName
	...
	OnStickUpdated = function(
		...
		elseif
			not s10010_sequence.IsDemoPlaying({
				...
				"fewDaysLater2_NG2",
				"fewDaysLater1_NG1",
			}) and (rightStickDown > 0.5 or rightStickLeft > 0.5 or rightStickRight > 0.5)
		then
			s10010_sequence.StartTimer("Timer_ChangeSequence_NG", 1.0)
			s10010_sequence.SetPadMaskCamera(true)
			mvars.ngCount = mvars.ngCount + 1
...
sequences.Seq_Demo_FewDaysLater2 = {
	...
	OnEnter = function(self)
		...
		local missionName = TppMission.GetMissionName()
		if missionName == "s10010" then
			s10010_demo.PlayFewDaysLater2({
				onEnd = function()
					TppSequence.SetNextSequence("Seq_Game_FewDaysLater2")
				end,
			})
		elseif missionName == "s10280" then
			s10010_demo.PlayFewDaysLater2_Truth({
				onEnd = function()
...
sequences.Seq_Demo_FewDaysLater3 = {
	...
	OnEnter = function(self)
		...
		local missionName = TppMission.GetMissionName()
		if missionName == "s10010" then
			s10010_demo.PlayFewDaysLater3({
				onEnd = function()
					TppSequence.SetNextSequence("Seq_Demo_OneWeekLater")
				end,
			})
			TppUI.FadeIn(TppUI.FADE_SPEED.FADE_HIGHESTSPEED)
		elseif missionName == "s10280" then
			s10010_demo.PlayFewDaysLater3_Truth({
				onEnd = function()
					TppSequence.SetNextSequence("Seq_Demo_OneWeekLater")
				end,
			})
...
sequences.Seq_Demo_OneWeekLater = {
	...
	timerTable = {
		[Fox.StrCode32("OneWeekLater_before")] = {
			name = "OneWeekLater_before",
			time = 1,
			Func = function()
		...
		[Fox.StrCode32("OneWeekLater_open")] = { name = "OneWeekLater_open", time = 3, Func = function() end },
		[Fox.StrCode32("OneWeekLater_eyelid")] = {
			name = "OneWeekLater_eyelid",
			time = 10,
			Func = function() end,
		},
		[Fox.StrCode32("OneWeekLater_open2")] = {
			name = "OneWeekLater_open2",
			time = 12,
			Func = function()
...
sequences.Seq_Demo_TwoWeekLater = {
	...
	timerTable = {
		[Fox.StrCode32("TwoWeekLater_before")] = {
			name = "TwoWeekLater_before",
			time = 1,
			Func = function()
				cypr_player_bed_and_corridor.SetFocusDistanceLimit(MAX_FOCUS_DISTANCE_LIMIT / 2, 1)
				cypr_player_bed_and_corridor.SetCameraRotationSpeedRate(MAX_CAMERA_RATE / 1.5)
		...
		[Fox.StrCode32("TwoWeekLater_open")] = { name = "TwoWeekLater_open", time = 3, Func = function() end },
		[Fox.StrCode32("TwoWeekLater_eyelid")] = {
			name = "TwoWeekLater_eyelid",
			time = 10,
			Func = function() end,
		},
		[Fox.StrCode32("TwoWeekLater_open2")] = {
			name = "TwoWeekLater_open2",
			time = 12,
			Func = function()
				cypr_player_bed_and_corridor.SetAperture(MAX_APERTURE / 2, 1)
				cypr_player_bed_and_corridor.SetFocusDistanceLimit(MAX_FOCUS_DISTANCE_LIMIT / 2, 1)
	...
	OnEnter = function(self)
		...
		local missionName = TppMission.GetMissionName()
		if missionName == "s10010" then
			s10010_demo.PlayTwoWeekLaterDemo({
				onEnd = function()
					TppSequence.SetNextSequence("Seq_Game_Load13")
				end,
			})
		elseif missionName == "s10280" then
			s10010_demo.PlayTwoWeekLaterDemo_Truth({
				onEnd = function()
					TppSequence.SetNextSequence("Seq_Game_Load34")
				end,
			})
...
sequences.Seq_Game_Load13 = s10010_sequence.MakeLoadSequenceTable(
	nil,
	"Seq_Game_LoadAvatarPlayer1",
	13,
	"Seq_Game_LoadAvatarPlayer1",
...
sequences.Seq_Game_Load34 = s10010_sequence.MakeLoadSequenceTable(
	nil,
	"Seq_Game_LoadAvatarPlayer1",
	34,
	"Seq_Game_LoadAvatarPlayer1",
...
sequences.Seq_Game_LoadAvatarPlayer1 = {
	...
	OnEnter = function(self)
		...
		if missionName == "s10010" then
			...
			GameObject.SendCommand(
				GameObject.GetGameObjectId("TppPlayer2", "Player"),
				{ id = "Warp", pos = position, rotY = rotationY }
			)
	...
	OnUpdate = function(self)
		if mvars.playerCheckCount > 3 then
			if PlayerInfo.OrCheckStatus and PlayerInfo.OrCheckStatus({ PlayerStatus.PARTS_ACTIVE }) then
				Fox.Log(
					"sequences.Seq_Game_LoadAvatarPlayer.OnUpdate(): Finish PlayerInfo.OrCheckStatus{ PlayerStatus.PARTS_ACTIVE, }"
				)
...
sequences.Seq_Demo_SouvenirPhotograph = {
	...
	OnEnter = function(self)
		...
		s10010_sequence.SetEffectVisibility(
			{ effectName = "FxLocatorGroup_fx_tpp_cldcypInside", visible = false },
			true,
			false
		)
	...
	OnLeave = function(self)
		...
		s10010_sequence.SetEffectVisibility(
			{ effectName = "FxLocatorGroup_fx_tpp_cldcypInside", visible = true },
			true,
			false
		)
	end,
...
sequences.Seq_Demo_LoadAvatarPlayer2 = {
	...
	OnUpdate = function(self)
		if mvars.playerCheckCount > 3 then
			if PlayerInfo.OrCheckStatus and PlayerInfo.OrCheckStatus({ PlayerStatus.PARTS_ACTIVE }) then
				Fox.Log(
					"sequences.Seq_Demo_LoadAvatarPlayer2.OnUpdate(): Finish PlayerInfo.OrCheckStatus{ PlayerStatus.PARTS_ACTIVE "
				)
				local missionName = TppMission.GetMissionName()
				if missionName == "s10010" then
...
sequences.Seq_Game_Load1 = s10010_sequence.MakeLoadSequenceTable(
	nil,
	"Seq_Demo_PrepareBeforeQuietAppear",
	1,
	"Seq_Demo_PrepareBeforeQuietAppear",
...
sequences.Seq_Game_Load21_2 = s10010_sequence.MakeLoadSequenceTable(
	nil,
	"Seq_Game_WaitCreatingBlendTexture1",
	21,
	"Seq_Game_WaitCreatingBlendTexture1",
...
sequences.Seq_Demo_QuietAppear = {
	...
	OnEnter = function(self)
		...
		local missionName = TppMission.GetMissionName()
		if missionName == "s10010" then
			s10010_demo.PlayQuietAppearDemo({
				onEnd = function()
					TppSequence.SetNextSequence("Seq_Demo_IshmaelAppear")
				end,
			})
		elseif missionName == "s10280" then
			s10010_demo.PlayQuietAppearTruthDemo({
				onEnd = function()
					TppSequence.SetNextSequence("Seq_Demo_IshmaelAppear")
				end,
			})
...
sequences.Seq_Demo_IshmaelAppear = {
	...
	OnEnter = function()
		...
		s10010_demo.PlayIshmaelAppearDemo({
			onEnd = function()
				s10010_sequence.StartTimer("Timer_QuietExit", 3)
			end,
		})
...
sequences.Seq_Game_Load2 = s10010_sequence.MakeLoadSequenceTable(
	"trap_HeliDemo",
	"Seq_Demo_Heli",
	2,
	"Seq_Game_EscapeFromAwakeRoom",
			...
			Player = {
				{
					...
					func = function(gameObjectId, motionEventName)
						Fox.Log(
							"sequences.Seq_Game_EscapeFromAwakeRoom.Messages(): Player: NotifyCyprusMotionEvent: gameObjectId:"
								.. tostring(gameObjectId)
								.. ", motionEventName:"
								.. tostring(motionEventName)
						)
						if motionEventName == Fox.StrCode32("MTEV_RAIL_ACTION_KNOCK_THE_CART_OVER") then
							Fox.Log(
								"sequences.Seq_Game_EscapeFromAwakeRoom.Messages(): Player: NotifyCyprusMotionEvent: MTEV_RAIL_ACTION_KNOCK_THE_CART_OVER"
							)
							s10010_sequence.PushMotion({
								locatorName = "ishmael",
						...
						elseif motionEventName == Fox.StrCode32("MTEV_RAIL_ACTION_KNOCK_THE_CHAIR_OVER") then
							Fox.Log(
								"sequences.Seq_Game_EscapeFromAwakeRoom.Messages(): Player: NotifyCyprusMotionEvent: MTEV_RAIL_ACTION_KNOCK_THE_CHAIR_OVER"
							)
							s10010_sequence.PushMotion({
								locatorName = "ishmael",
			...
			Timer = {
				...
				},
				{
					...
					func = function()
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_001" }
						)
					end,
				},
			},
...
sequences.Seq_Demo_Heli = {
	...
	PlayDemo = function()
		s10010_demo.PlayHeliDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_AfterHeliDemo")
			end,
		})
			...
			Player = {
				{
					...
					func = function(gameObjectId, motionEventName)
						Fox.Log(
							"sequences.Seq_Game_AfterHeliDemo.Messages(): Player: NotifyCyprusMotionEvent: gameObjectId:"
								.. tostring(gameObjectId)
								.. ", motionEventName:"
								.. tostring(motionEventName)
						)
			...
			Timer = {
				{
					...
					func = function()
						Fox.Log(
							"sequences.Seq_Game_AfterHeliDemo.Messages(): Timer: Finish: Timer_StopAfterAshtrayDown"
						)
						s10010_sequence.ProhibitMove(false)
					end,
				},
...
sequences.Seq_Demo_Volgin = {
	...
	OnEnter = function(self)
		...
		s10010_demo.PlayVolginDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_Load3")
			end,
		})
	end,
...
sequences.Seq_Game_Load3 = s10010_sequence.MakeLoadSequenceTable(
	"trap_Cure",
	"Seq_Demo_Cure",
	3,
	"Seq_Game_AfterVolginDemo",
			...
			Player = {
				{
					...
					func = function(gameObjectId, motionEventName)
						Fox.Log(
							"sequences.Seq_Game_AfterVolginDemo.Messages(): Player: NotifyCyprusMotionEvent: gameObjectId:"
								.. tostring(gameObjectId)
								.. ", motionEventName:"
								.. tostring(motionEventName)
						)
						...
						elseif motionEventName == Fox.StrCode32("MTEV_TO_DEMO") then
							Fox.Log(
								"sequences.Seq_Game_AfterVolginDemo.Messages(): Player: NotifyCyprusMotionEvent: MTEV_to_DEMO"
							)
			...
			Timer = {
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_089" }
						)
					end,
				},
				{
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"sequences.Seq_Game_AfterVolginDemo.Messages(): Timer: Finish: Timer_IshmaelMonologue0000"
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_019" }
						)
					end,
				},
			},
...
sequences.Seq_Demo_Cure = {
	...
	OnEnter = function()
		s10010_demo.PlayCureDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_EnterSmokeRoom")
			end,
		})
	end,
...
sequences.Seq_Game_EnterSmokeRoom = {
			...
			Trap = {
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_EnterSmokeRoom.Messages(): Trap: Enter: trapName:"
								.. tostring(trapName)
								.. ", gameObjectId:"
								.. tostring(gameObjectId)
						)
						...
						if mvars.smokeRoomDoorClosed then
							Fox.Log(
								"s10010_sequence.sequences.Seq_Game_EnterSmokeRoom.Messages(): ignore operation because mvars.smokeRoomDoorClosed is true."
							)
						else
							s10010_sequence.OnGameObjectEnterTrap(trapName, gameObjectId)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_EnterSmokeRoom.Messages(): Trap: Enter: trap_IshmaelRouteChange_SmokeRoom_0000"
						)
						if Tpp.IsPlayer(gameObjectId) then
							s10010_sequence.PushMotion({
								locatorName = "ishmael",
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_EnterSmokeRoom.Messages(): Trap: Enter: trap_CancelProhibitingPlayerMove: gameObjectId:"
								.. tostring(gameObjectId)
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_EnterSmokeRoom.Messages(): Trap: Enter: trap_IshmaelMonologue0000: gameObjectId:"
								.. tostring(gameObjectId)
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_020" }
						)
					end,
				},
			},
			Timer = {
				{
					...
					func = function()
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_005" }
						)
					end,
				},
				{
					...
					func = function()
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_027" }
						)
					end,
				},
				{
					...
					func = function()
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_026" }
						)
					end,
				},
				{
					...
					func = function()
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_025" }
						)
					end,
				},
			},
	...
	OnEnter = function(self)
		...
		for i, enemyName in ipairs(self.enemyList) do
			s10010_sequence.OnGameObjectEnterTrap(
				Fox.StrCode32("trap_BeforeSmokeRoom_0000"),
				GameObject.GetGameObjectId(enemyName)
			)
		end
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_BeforeSmokeRoom_0001"),
			GameObject.GetGameObjectId("Player")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_BeforeSmokeRoom_0006"),
			GameObject.GetGameObjectId("Player")
		)
	...
	OnUpdate = function(self)
		if
			mvars.needToCheck
			and mvars.permitToCancelProhibitingPlayerMove
			and PlayerInfo.AndCheckStatus({ PlayerStatus.CRAWL })
		then
			s10010_sequence.ProhibitMove(false)
			...
			return StrCode32Table({
				Timer = {
					...
					},
					{
						...
						func = function()
							Fox.Log(
								"s10010_sequence.MakeGameOverSequenceTable(): Messages(): Timer: Finish: Timer_GameOver_Before"
							)
							...
							if Tpp.IsSoldier(gameObjectId) then
								GameObject.SendCommand(
									gameObjectId,
									{ id = "SetCommandAi", commandType = CommandAi.FORCE_SHOOT }
								)
							end
				...
				Player = {
					{
						...
						func = function(gameObjectId, attackId, offenceGameObjectId)
							Fox.Log(
								"s10010_sequence.MakeGameOverSequenceTable(): Messages(): Player: PlayerDamaged: gameObjectId:"
									.. tostring(gameObjectId)
									.. ", attackId:"
									.. tostring(attackId)
									.. ", offenceGameObjectId:"
									.. tostring(offenceGameObjectId)
							)
							Player.OnPlayerDeath()
						end,
					},
		...
		OnEnter = function(self)
			...
			for i, enemyName in ipairs(enemyList) do
				...
				if Tpp.IsSoldier(gameObjectId) then
					...
					GameObject.SendCommand(
						gameObjectId,
						{ id = "SetDisableDamage", life = true, faint = true, sleep = true }
					)
				end
			end
			...
			if position then
				local degree = TppMath.RadianToDegree(
					math.atan2(position:GetX() - vars.playerPosX, position:GetZ() - vars.playerPosZ)
				)
				local degreeX
				if gameObjectId == GameObject.GetGameObjectId("WestHeli") then
					TppSoundDaemon.PostEvent3D("sfx_s_bikkuri", position)

					degreeX = -TppMath.RadianToDegree(
						math.atan2(position:GetY() - vars.playerPosY, position:GetZ() - vars.playerPosZ)
					)
				else
					degreeX = 5
				end
...
sequences.Seq_Game_GameOverBeforeSmokeRoom =
	s10010_sequence.MakeGameOverSequenceTable(sequences.Seq_Game_EnterSmokeRoom.enemyList)

sequences.Seq_Demo_UnderBed = {

	OnEnter = function()
		s10010_demo.PlayUnderBedDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_UnderBed")
			end,
		})
		s10010_sequence.ProhibitMove(true)
		s10010_sequence.SetPadMaskCamera(true)
...
sequences.Seq_Game_UnderBed = {
	...
	OnLeftStickDown = function(self, leftStickX, leftStickY)
		Fox.Log(
			"s10010_sequence.sequences.Seq_Game_UnderBed.OnLeftStickDown(): leftStickX:"
				.. tostring(leftStickX)
				.. ", leftStickY:"
				.. tostring(leftStickY)
		)
...
sequences.Seq_Game_Load4 = s10010_sequence.MakeLoadSequenceTable(
	"trap_HeliKillMob",
	"Seq_Demo_HeliKillMob",
	4,
	"Seq_Game_EscapeFromSmokeRoom",
...
sequences.Seq_Game_EscapeFromSmokeRoom = {
		...
		return StrCode32Table({
			Trap = {
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_EscapeFromSmokeRoom.Messages(): Trap: Enter: trapName:"
								.. tostring(trapName)
								.. ", gameObjectId:"
								.. tostring(gameObjectId)
						)
	...
	OnEnter = function(self)
		...
		for i, enemyName in ipairs(self.enemyList) do
			s10010_sequence.OnGameObjectEnterTrap(
				Fox.StrCode32("trap_SmokeRoom_0000"),
				GameObject.GetGameObjectId(enemyName)
			)
			s10010_sequence.OnGameObjectEnterTrap(
				Fox.StrCode32("trap_SmokeRoom_0001"),
				GameObject.GetGameObjectId(enemyName)
			)
		end
	end,
...
sequences.Seq_Game_GameOverSmokeRoom =
	s10010_sequence.MakeGameOverSequenceTable(sequences.Seq_Game_EscapeFromSmokeRoom.enemyList)
...
sequences.Seq_Demo_HeliKillMob = {
	...
	OnEnter = function(self)
		...
		s10010_demo.PlayHeliKillMobDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_AfterHeliKillMobDemo")
			end,
		})
		s10010_sequence.ProhibitMove(true)
			...
			GameObject = {
				{
					...
					func = function(heliGameObjectId, targetGameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterHeliKillMobDemo.Messages(): GameObject: InSight: heliGameObjectId:"
								.. tostring(heliGameObjectId)
								.. ", targetGameObjectId:"
								.. tostring(targetGameObjectId)
						)
				...
				},
				{
					...
					func = function(gameObjectId, routeId, routeNodeIndex, messageId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterHeliKillMobDemo.Messages(): GameObject: RoutePoint2: WestHeli"
						)
			...
			Trap = {
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							gameObjectId,
							{ id = "Warp", position = Vector3(-54.026, 105.376, -1684.387), control = charaControl }
						)
				...
				},
				{
					...
					func = function()
						s10010_sequence.EnableDataBody(
							{
								identifier = "cypr_common_light_DataIdentifier",
								key = "Light_4F_B_isolate",
								enable = false,
							},
							true,
							false
				...
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_037" }
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterHeliKillMobDemo.Messages(): Trap: Enter: trap_IshmaelMonologue"
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_028" }
						)
					end,
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterHeliKillMobDemo.Messages(): Trap: Enter: trap_IshmaelMonologue0001"
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_029" }
						)
					end,
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterHeliKillMobDemo.Messages(): Trap: Enter: trap_IshmaelMonologue0002"
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_030" }
						)
					end,
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_EscapeFromHeli.Messages(): Trap: Enter: trapName:"
								.. tostring(trapName)
								.. ", gameObjectId:"
								.. tostring(gameObjectId)
						)
			...
			Timer = {
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterHeliKillMobDemo.Messages(): Timer: Finish: Timer_IshmaelMonologue0005"
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_033" }
						)
					end,
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_034" }
						)
					end,
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_035" }
						)
					end,
				},
				{
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterHeliKillMobDemo.Messages(): Timer: Finish: Timer_ResumeIshmaelPush"
						)
						Player.SetCyprPlayerPushedId({ targetId = GameObject.GetGameObjectId("ishmael"), isOn = 1 })
					end,
				},
...
sequences.Seq_Game_GameOver_AfterSmokeRoom =
	s10010_sequence.MakeGameOverSequenceTable(sequences.Seq_Game_AfterHeliKillMobDemo.enemyList)
			...
			Demo = {
				{
					...
					func = function(demoId)
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_044" }
						)
						s10010_sequence.ProhibitMove(false)
...
sequences.Seq_Game_EscapeFromHeli = {
			...
			GameObject = {
				{
					...
					func = function(heliGameObjectId, targetGameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_EscapeFromHeli.Messages(): GameObject: InSight: heliGameObjectId:"
								.. tostring(heliGameObjectId)
								.. ", targetGameObjectId:"
								.. tostring(targetGameObjectId)
						)
	...
	OnEnter = function(self)
		for i, enemyName in ipairs(self.enemyList) do
			s10010_sequence.OnGameObjectEnterTrap(
				Fox.StrCode32("trap_GameOver_AfterSmokeRoom_0001"),
				GameObject.GetGameObjectId(enemyName)
			)
		end
	...
	OnContinue = function(self)
		...
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_AfterSmokeRoom_0010"),
			GameObject.GetGameObjectId("Player")
		)
...
sequences.Seq_Game_GameOver_HeliCorridor =
	s10010_sequence.MakeGameOverSequenceTable(sequences.Seq_Game_EscapeFromHeli.enemyList)

sequences.Seq_Demo_Stairway = {

	Messages = function(self)
		return StrCode32Table(s10010_sequence.stairwayMessageTable)
	end,
	...
	OnEnter = function(self)
		...
		s10010_demo.PlayStairwayDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_Load5")
			end,
		})
		s10010_sequence.ProhibitMove(true)
	end,
	...
	Trap = {
		{
			...
			func = function(trapName, gameObjectId)
				Fox.Log(
					"s10010_sequence.sequences.Seq_Game_Stairway.Messages(): Trap: Enter: trapName:"
						.. tostring(trapName)
						.. ", gameObjectId:"
						.. tostring(gameObjectId)
				)
				...
				if
					s10010_sequence.IsPlayerAndSoldierInSameTrap()
					and mvars.gameObjectIdDiscoveryingPlayer ~= GameObject.GetGameObjectId(
						"TppSoldier2",
						"sol_p21_010370_0000"
					)
					and mvars.gameObjectIdDiscoveryingPlayer
						~= GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010370_0001")
				then
					s10010_sequence.SetNextGameOverSequence("Seq_Game_GameOver_Stairway")
				else
					Fox.Log(
						"s10010_sequence.stairwayMessageTable.Trap: mvars.gameObjectIdDiscoveryingPlayer:"
							.. tostring(mvars.gameObjectIdDiscoveryingPlayer)
					)
				end
			end,
			option = { isExecDemoPlaying = true },
		},
		{
			...
			func = function(trapName, gameObjectId)
				Fox.Log(
					"s10010_sequence.sequences.Seq_Game_Stairway.Messages(): Trap: Enter: trap_IshmaelRouteChange_Stairway_0000: gameObjectId:"
						.. tostring(gameObjectId)
				)
		...
		},
		{
			...
			func = function(trapName, gameObjectId)
				Fox.Log(
					"s10010_sequence.sequences.Seq_Game_Stairway.Messages(): Trap: Enter: trap_IshmaelRouteChange_Stairway_0001: gameObjectId:"
						.. tostring(gameObjectId)
				)
		...
		},
		{
			...
			func = function(trapName, gameObjectId)
				Fox.Log(
					"s10010_sequence.sequences.Seq_Game_Stairway.Messages(): Trap: Enter: trap_Corridor: gameObjectId:"
						.. tostring(gameObjectId)
				)
		...
		},
		{
			...
			func = function(trapName, gameObjectId)
				Fox.Log(
					"s10010_sequence.sequences.Seq_Game_Stairway.Messages(): Trap: Exit: trap_Corridor: gameObjectId:"
						.. tostring(gameObjectId)
				)
		...
		},
		{
			...
			func = function(trapName, gameObjectId)
				Fox.Log(
					"s10010_sequence.sequences.Seq_Game_Stairway.Messages(): Trap: Enter: trap_DoctorMonologue_0000: gameObjectId:"
						.. tostring(gameObjectId)
				)
	...
	Timer = {
		{
			...
			func = function()
				Fox.Log(
					"s10010_sequence.sequences.Seq_Game_Stairway.Messages(): Timer: Finish: Timer_IshmaelMonologue0011"
				)
				GameObject.SendCommand(
					GameObject.GetGameObjectId("ishmael"),
					{ id = "CallMonologue", label = "ISHM_010" }
				)
			end,
			option = { isExecDemoPlaying = true },
		},
		{
			...
			func = function()
				Fox.Log(
					"s10010_sequence.sequences.Seq_Game_Stairway.Messages(): Timer: Finish: Timer_IshmaelToCorridor0000"
				)
				s10010_sequence.PushMotion({
					locatorName = "dct_p21_010410_0000",
...
sequences.Seq_Game_Load5 = s10010_sequence.MakeLoadSequenceTable(
	nil,
	"Seq_Demo_Corridor0",
	5,
	"Seq_Game_Stairway",
...
sequences.Seq_Game_Stairway = {
	...
	OnEnter = function(self)
		...
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Stairway_0015"),
			GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010380_0000")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Stairway_0015"),
			GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010380_0001")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Stairway_0000"),
			GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010380_0002")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Stairway_0000"),
			GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010380_0003")
		)
	...
	OnContinue = function(self)
		...
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Stairway_0012"),
			GameObject.GetGameObjectId("TppPlayer2", "Player")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Stairway_0019"),
			GameObject.GetGameObjectId("TppPlayer2", "Player")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Stairway_0021"),
			GameObject.GetGameObjectId("TppPlayer2", "Player")
		)
...
sequences.Seq_Game_GameOver_Stairway = s10010_sequence.MakeGameOverSequenceTable({
	"sol_p21_010380_0000",
	"sol_p21_010380_0001",
	"sol_p21_010380_0002",
	"sol_p21_010380_0003",
...
sequences.Seq_Demo_Corridor0 = {
	...
	OnEnter = function()
		...
		s10010_demo.PlayCorridor0Demo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_Corridor1")
			end,
		})
...
sequences.Seq_Game_Corridor1 = {
	...
	OnLeftStickDown = function(self, leftStickX, leftStickY)
		Fox.Log(
			"s10010_sequence.sequences.Seq_Game_Corridor1.OnLeftStickDown(): leftStickX:"
				.. tostring(leftStickX)
				.. ", leftStickY:"
				.. tostring(leftStickY)
		)
...
s10010_sequence.MakeCorridorSequence = function(
	PlayDemo,
	sequenceDemoId,
			...
			Demo = {
				{
					...
					func = function(demoId)
						Fox.Log(
							"s10010_sequence.MakeCorridorSequence(): Message Received:"
								.. tostring(demoInterruptionMessage)
						)
...
sequences.Seq_Demo_Corridor1 = s10010_sequence.MakeCorridorSequence(
	s10010_demo.PlayCorridor1Demo,
	"p21_010410_001",
	"p21_010410_001_Interruption",
	"p21_010410_002",
	"Seq_Demo_Corridor2"
)
...
sequences.Seq_Game_Corridor2 = {
	...
	OnLeftStickDown = function(self, leftStickX, leftStickY)
		Fox.Log(
			"s10010_sequence.sequences.Seq_Game_Corridor2.OnLeftStickDown(): leftStickX:"
				.. tostring(leftStickX)
				.. ", leftStickY:"
				.. tostring(leftStickY)
		)
...
sequences.Seq_Demo_Corridor2 = s10010_sequence.MakeCorridorSequence(
	s10010_demo.PlayCorridor2Demo,
	"p21_010410_002",
	"p21_010410_002_Interruption",
	"p21_010410_003",
	"Seq_Demo_Corridor3"
)
...
sequences.Seq_Game_Corridor3 = {
	...
	OnLeftStickDown = function(self, leftStickX, leftStickY)
		Fox.Log(
			"s10010_sequence.sequences.Seq_Game_Corridor3.OnLeftStickDown(): leftStickX:"
				.. tostring(leftStickX)
				.. ", leftStickY:"
				.. tostring(leftStickY)
		)
...
sequences.Seq_Demo_Corridor3 = s10010_sequence.MakeCorridorSequence(
	s10010_demo.PlayCorridor3Demo,
	"p21_010410_003",
	"p21_010410_003_Interruption",
	"p21_010410_004",
	"Seq_Demo_Corridor4"
)
...
sequences.Seq_Game_Corridor4 = {
	...
	OnLeftStickDown = function(self, leftStickX, leftStickY)
		Fox.Log(
			"s10010_sequence.sequences.Seq_Game_Corridor4.OnLeftStickDown(): leftStickX:"
				.. tostring(leftStickX)
				.. ", leftStickY:"
				.. tostring(leftStickY)
		)
...
sequences.Seq_Demo_Corridor4 = s10010_sequence.MakeCorridorSequence(
	s10010_demo.PlayCorridor4Demo,
	"p21_010410_004",
	"p21_010410_004_Interruption",
	"p21_010410_005",
	"Seq_Demo_Corridor5"
)
...
sequences.Seq_Game_Corridor5 = {
	...
	OnLeftStickDown = function(self, leftStickX, leftStickY)
		Fox.Log(
			"s10010_sequence.sequences.Seq_Game_Corridor5.OnLeftStickDown(): leftStickX:"
				.. tostring(leftStickX)
				.. ", leftStickY:"
				.. tostring(leftStickY)
		)
...
sequences.Seq_Demo_Corridor5 = s10010_sequence.MakeCorridorSequence(
	s10010_demo.PlayCorridor5Demo,
	"p21_010410_005",
	"p21_010410_005_Interruption",
	"p21_010410_006",
	"Seq_Demo_Corridor6"
)
...
sequences.Seq_Demo_Corridor6 = {
	...
	OnEnter = function(self)
		...
		s10010_demo.PlayCorridor6Demo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Demo_Corridor7")
			end,
		})
		...
		local gameObjectId = GameObject.GetGameObjectId("ishmael")
		local result, targetId = Gimmick.GetGameObjectId(
			TppGameObject.GAME_OBJECT_TYPE_DOOR,
			"cypr_crtn001_vrtn015_gim_n0001|srt_cypr_crtn001_vrtn015",
			"/Assets/tpp/level/location/cypr/block_small/02/cypr_02_asset.fox2"
		)
...
sequences.Seq_Demo_Corridor7 = {
	...
	OnEnter = function(self)
		...
		s10010_demo.PlayCorridor7Demo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_Load6")
			end,
		})
...
sequences.Seq_Game_Load6 = s10010_sequence.MakeLoadSequenceTable(
	"trap_CurtainRoom",
	"Seq_Demo_CurtainRoom",
	6,
	"Seq_Game_CurtainRoom",
...
sequences.Seq_Game_CurtainRoom = {
			...
			Trap = {
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_CurtainRoom.Messages(): Trap: Enter: trapName:"
								.. tostring(trapName)
								.. ", gameObjectId:"
								.. tostring(gameObjectId)
						)
						...
						if s10010_sequence.IsPlayerAndSoldierInSameTrap() then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010420_0000"),
								{ id = "SpecialAction", isDisable = true }
							)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_CurtainRoom.Messages(): Trap: Enter: trap_IshmaelMonologue_0000"
						)
						if not mvars.ISHISHM_055_Finished then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("ishmael"),
								{ id = "CallMonologue", label = "ISHM_055" }
							)
			...
			GameObject = {
				{
					...
					func = function(gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_CurtainRoom.Messages(): GameObject: Damage: gameObjectId:"
								.. tostring(gameObjectId)
						)
	...
	OnEnter = function(self)
		...
		for i, enemyName in ipairs(self.enemyList) do
			s10010_sequence.OnGameObjectEnterTrap(
				Fox.StrCode32("trap_GameOver_CurtainRoom_0000"),
				GameObject.GetGameObjectId(enemyName)
			)
			s10010_sequence.OnGameObjectEnterTrap(
				Fox.StrCode32("trap_GameOver_CurtainRoom_0009"),
				GameObject.GetGameObjectId(enemyName)
			)
		end
	...
	OnContinue = function(self)
		...
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_CurtainRoom_0008"),
			GameObject.GetGameObjectId("Player")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_DemoCurtain_0003"),
			GameObject.GetGameObjectId("Player")
		)
	end,
	...
	OnUpdate = function(self)
		if
			mvars.curtainRoomEnabled
			and (not PlayerStatus.CURTAIN or not PlayerInfo.OrCheckStatus({ PlayerStatus.CURTAIN }))
		then
...
sequences.Seq_Game_GameOverCurtainRoom =
	s10010_sequence.MakeGameOverSequenceTable(sequences.Seq_Game_CurtainRoom.enemyList)
...
sequences.Seq_Demo_CurtainRoom = {
			...
			Demo = {
				{
					...
					func = function(demoId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Demo_CurtainRoom.Messages(): Demo: PlayInit: demoId:"
								.. tostring(demoId)
						)
						...
						if mvars.targetWarpPointName then
							Fox.Log(
								"s10010_sequence.sequences.Seq_Demo_CurtainRoom.Messages(): PlayInit: Play: TppDemoUtility.AddSubjectMapping"
							)
				...
				},
				{
					...
					func = function(demoId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Demo_CurtainRoom.Messages(): Demo: Play: demoId:"
								.. tostring(demoId)
						)
				...
				},
				{
					...
					func = function(demoId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Demo_CurtainRoom.Messages(): Demo: p21_010420_playercrawling"
						)

						if mvars.targetWarpPointName then
							local position, rotationY =
								Tpp.GetLocator("CheckPointIdentifier", mvars.targetWarpPointName)
							rotationY = TppMath.DegreeToRadian(rotationY)
							GameObject.SendCommand(
								GameObject.GetGameObjectId("TppPlayer2", "Player"),
								{ id = "Warp", pos = position, rotY = rotationY }
				...
				},
				{
					...
					func = function(demoId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Demo_CurtainRoom.Messages(): Demo: FinishMotion: demoId:"
								.. tostring(demoId)
						)
				...
				},
				{
					...
					func = function(demoId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Demo_CurtainRoom.Messages(): Demo: Skip: demoId:"
								.. tostring(demoId)
						)
					end,
					option = { isExecDemoPlaying = true },
	...
	OnEnter = function()
		...
		s10010_demo.PlayCurtainRoomDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Demo_CurtainRoom2")
			end,
		})
	end,
...
sequences.Seq_Demo_CurtainRoom2 = {
			...
			Trap = {
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Demo_CurtainRoom2.Messages(): Trap: Enter: trap_IshmaelRouteChange_CurtainRoom_0000: gameObjectId:"
								.. tostring(gameObjectId)
						)
			...
			Demo = {
				{
					...
					func = function(demoId)
						...
						local playerGameObjectId = GameObject.GetGameObjectId("Player")
						if
							s10010_sequence.IsGameObjectInTrap(
								playerGameObjectId,
								Fox.StrCode32("trap_DemoCurtain_0004")
							)
						then
							local position, rotationY =
								Tpp.GetLocator("CheckPointIdentifier", "warp_CurtainRoomDemo_0004")
							local rotationYRadian = TppMath.DegreeToRadian(rotationY)
							GameObject.SendCommand(
								GameObject.GetGameObjectId("TppPlayer2", "Player"),
								{ id = "Warp", pos = position, rotY = rotationYRadian }
							)
	...
	OnEnter = function()
		...
		s10010_demo.PlayCurtainRoomDemo2({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_AfterCurtainRoom")
			end,
		})
	end,
...
sequences.Seq_Game_AfterCurtainRoom = {
	...
	OnStickUpdated = function(
		...
		Fox.Log(
			"s10010_sequence.sequences.Seq_Game_AfterCurtainRoom.OnLeftStickDown(): leftStickX:"
				.. tostring(leftStickX)
				.. ", leftStickY:"
				.. tostring(leftStickY)
		)
		...
		if
			mvars.corpseCorridorStart
			and (leftStickDown > 0.33 or leftStickUp > 0.33 or leftStickLeft > 0.33 or leftStickRight > 0.33)
		then
			if not mvars.ishmaelVoiceCount then
				mvars.ishmaelVoiceCount = 0
			end
			...
			elseif mvars.ishmaelVoiceCount > 0 then
				GameObject.SendCommand(
					...
					{
						id = "CallMonologue",
						label = self.ishmaelVoiceLabelList[mvars.ishmaelVoiceCount % #self.ishmaelVoiceLabelList + 1],
					}
				)
			end
			mvars.ishmaelVoiceCount = mvars.ishmaelVoiceCount + 1
		...
		Trap = {
			{
				...
				func = function()
					if not mvars.corpseCorridorStart then
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_061" }
						)
			...
			},
			{
				...
				func = function(trapName, gameObjectId)
					Fox.Log(
						"s10010_sequence.sequences.Seq_Game_AfterCurtainRoom.Messages(): Trap: Enter: trap_IshmaelRouteChange_CurtainRoom_0000: gameObjectId:"
							.. tostring(gameObjectId)
					)
					...
					if not mvars.corpseCorridorStart then
						if not mvars.ishmaelCorridorRouteStarted then
							...
							GameObject.SendCommand(
								GameObject.GetGameObjectId("ishmael"),
								{ id = "CallMonologue", label = "ISHM_058" }
							)
							GameObject.SendCommand(
								GameObject.GetGameObjectId("ishmael"),
								{ id = "CallMonologue", label = "ISHM_027" }
						...
						if not mvars.curtainSoldierStarted then
							...
							GameObject.SendCommand(
								GameObject.GetGameObjectId("sol_p21_010420_0000"),
								{ id = "SetGunLightSwitch", isOn = false, useCastShadow = false }
							)
							GameObject.SendCommand(
								GameObject.GetGameObjectId("sol_p21_010440_0000"),
								{ id = "SetGunLightSwitch", isOn = true, useCastShadow = true }
							)
			...
			},
			{
				...
				func = function(trapName, gameObjectId)
					Fox.Log(
						"s10010_sequence.sequences.Seq_Game_AfterCurtainRoom.Messages(): Trap: Enter: trap_Corridor0000: gameObjectId:"
							.. tostring(gameObjectId)
					)
			...
			},
			{
				...
				func = function(trapName, gameObjectId)
					Fox.Log(
						"s10010_sequence.sequences.Seq_Game_AfterCurtainRoom.Messages(): Trap: Enter: trapName:"
							.. tostring(trapName)
							.. ", gameObjectId:"
							.. tostring(gameObjectId)
					)
	...
	OnEnterUncommon = function(self)
		...
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Corridor_0000"),
			GameObject.GetGameObjectId("sol_p21_010420_0000")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Corridor_0001"),
			GameObject.GetGameObjectId("sol_p21_010420_0000")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Corridor_0002"),
			GameObject.GetGameObjectId("sol_p21_010420_0000")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Corridor_0000"),
			GameObject.GetGameObjectId("sol_p21_010420_0001")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Corridor_0001"),
			GameObject.GetGameObjectId("sol_p21_010420_0001")
		...
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Corridor_0000"),
			GameObject.GetGameObjectId("sol_p21_010440_0002")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Corridor_0000"),
			GameObject.GetGameObjectId("sol_p21_010440_0003")
		)
	...
	OnContinue = function(self)
		...
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_CurtainRoom_0007"),
			GameObject.GetGameObjectId("Player")
		)
	end,
...
sequences.Seq_Game_GameOverCorridor =
	s10010_sequence.MakeGameOverSequenceTable(sequences.Seq_Game_AfterCurtainRoom.enemyList)
...
sequences.Seq_Demo_VolginVsSkullSoldier = {
	...
	OnEnter = function(self)
		...
		s10010_demo.PlayVolginVsSkullSoldierDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_Load7")
			end,
		})
		s10010_sequence.ProhibitMove(true)
	end,
...
sequences.Seq_Game_Load7 = s10010_sequence.MakeLoadSequenceTable(
	"trap_GetGun",
	"Seq_Demo_GetGun",
	7,
	"Seq_Game_AfterCorridor",
...
sequences.Seq_Game_AfterCorridor = {
		...
		return StrCode32Table({
			Trap = {
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Trap: Enter: trap_IshmaelRouteChange_AfterCorridor_0000"
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Trap: Enter: trap_IshmaelRouteChange_AfterCorridor_0001"
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Trap: Enter: trap_IshmaelRouteChange_AfterCorridor_0002"
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Trap: Enter: trap_IshmaelRouteChange_AfterCorridor_0003"
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Trap: Exit: trap_IshmaelRouteChange_AfterCorridor_0003"
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Trap: Enter: trap_IshmaelRouteChange_AfterCorridor_0005"
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Trap: Enter: trap_BgmChange_AfterCorridor_0000"
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Trap: Enter: trapName:"
								.. tostring(trapName)
								.. ", gameObjectId:"
								.. tostring(gameObjectId)
						)
			...
			Player = {
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Player: PlayerCureComplete"
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_AfterCorridor.Messages(): Player: PlayerCureCompleteMotEnd"
						)
			...
			Timer = {
				...
				},
				{
					...
					func = function()
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_067" }
						)
					end,
				},
			},
			TppSystem = {
				{
					...
					func = function(targetName)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_EscapeFromEntrance.Messages(): TppSystem: NotifyCyprusTargetHit"
						)

						if
							targetName == Fox.StrCode32("offenceTarget_3f_0000")
							or targetName == Fox.StrCode32("offenceTarget_1f_0003")
						then
							vars.playerLife = 0
						end
					end,
	...
	OnEnter = function(self)
		...
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_2F_0004"),
			GameObject.GetGameObjectId("sol_p21_010490_0000")
		)
		s10010_sequence.OnGameObjectEnterTrap(
			Fox.StrCode32("trap_GameOver_Stairway_0012"),
			GameObject.GetGameObjectId("sol_p21_010490_0003")
		)

		for i, offenceTargetName in ipairs(self.offenceTargetTable) do
			local dataBody =
				DataIdentifier.GetDataBodyWithIdentifier("s10010_l01_sequence_DataIdentifier", offenceTargetName)
	...
	OnEnter2F = function()
		...
		if
			not mvars.enter2fFinished
			and mvars.playerEnter["trap_IshmaelRouteChange_AfterCorridor_0003"]
			and mvars.ishmaelEnter["trap_IshmaelRouteChange_AfterCorridor_0003"]
			and mvars.cureFinished
		then
...
sequences.Seq_Game_GameOverAfterCorridor =
	s10010_sequence.MakeGameOverSequenceTable(sequences.Seq_Game_AfterCorridor.enemyList)
...
sequences.Seq_Game_Load8 = s10010_sequence.MakeLoadSequenceTable(
	"trap_Entrance",
	"Seq_Demo_BeforeEntrance",
	8,
	"Seq_Game_GunTutorial",
...
sequences.Seq_Game_GunTutorial = {
		...
		return StrCode32Table({
			Trap = {
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Trap: Enter: trap_IshmaelRouteChange_AfterGetGun_0000"
						)
						self.MoveIshmael()
					end,
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Trap: Enter: trap_IshmaelRouteChange_AfterGetGun_0001"
						)
						if not mvars.trap_IshmaelRouteChange_AfterGetGun_0001_Finished then
							...
							GameObject.SendCommand(
								GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010490_0001"),
								{ id = "SetCommandAi", commandType = CommandAi.SHOOT_PRACTICE, commandIndex = 0 }
							)
							GameObject.SendCommand(
								GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010490_0002"),
								{ id = "SetCommandAi", commandType = CommandAi.SHOOT_PRACTICE, commandIndex = 1 }
							)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Trap: Enter: trap_CameraChangeTutorial_0000"
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Trap: Enter: trap_IshmaelRouteChange_AfterGetGun_0002"
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Trap: Enter: trap_IshmaelRouteChange_AfterGetGun_0003"
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Trap: Enter: trapName: trap_StopPlayer_0000"
						)
						if mvars.playerStop2f0000 then
							...
							s10010_sequence.SetModelVisibility(
								{
									identifier = "cypr_s03_other_DataIdentifier",
									key = "cypr_door001_door002_close_geom_0000",
									visible = true,
								},
								true,
								false
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Trap: Enter: trapName: trap_IshmaelMonologue0003"
						)
						if not mvars.ISHM_075Finished then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("ishmael"),
								{ id = "CallMonologue", label = "ISHM_075" }
							)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Trap: Enter: trapName: trap_IshmaelMonologue0004"
						)
						if not mvars.ISHM_076Finished then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("ishmael"),
								{ id = "CallMonologue", label = "ISHM_076" }
							)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Trap: Enter: trapName:"
								.. tostring(trapName)
								.. ", gameObjectId:"
								.. tostring(gameObjectId)
						)
			...
			GameObject = {
				{
					...
					func = function(gameObjectId, offenceGameObjectId)
						if
							gameObjectId ~= GameObject.GetGameObjectId("sol_p21_010490_0001")
							and gameObjectId ~= GameObject.GetGameObjectId("sol_p21_010490_0002")
						then
							return
						end

						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): GameObject: Dead: gameObjectId:"
								.. tostring(gameObjectId)
						)

						local alive = false
						for i, enemyName in ipairs(self.enemyList) do
							local lifeState = GameObject.SendCommand(
								GameObject.GetGameObjectId("TppSoldier2", enemyName),
								{ id = "GetLifeStatus" }
							)
							if lifeState ~= TppGameObject.NPC_LIFE_STATE_DEAD then
								alive = true
						...
						if not alive then
							...
							if offenceGameObjectId == GameObject.GetGameObjectId("Player") then
								GameObject.SendCommand(
									GameObject.GetGameObjectId("ishmael"),
									{ id = "CallMonologue", label = "ISHM_073" }
								)
							end
						end
					end,
				},
				{
					...
					func = function(gameObjectId, locatorName, upperLocatorName)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): GameObject: BreakGimmick: gameObjectId:"
								.. tostring(gameObjectId)
								.. ", locatorName:"
								.. tostring(locatorName)
								.. ", upperLocatorName:"
								.. tostring(upperLocatorName)
						)
						...
						for i, fireTable in ipairs(self.fireList) do
							if fireTable and Fox.StrCode32(fireTable.extinguisherName) == locatorName then
								if Tpp.IsTypeTable(fireTable.fireEffectList) then
									...
									local position, rotationY =
										Tpp.GetLocator("s10010_l01_sequence_DataIdentifier", "extinguisher")
									TppSoundDaemon.PostEvent3D(
										"sfx_m_cypr_2F_fire_off",
								...
								if Tpp.IsTypeTable(fireTable.offenceTargetTable) then
									for offenceTargetName, offenceTargetTable in pairs(fireTable.offenceTargetTable) do
										CyprusMissionController.SendCommand({
											id = "InactiveOffenseTraget",
											name = offenceTargetName,
										})
										CyprusMissionController.SendCommand({
											id = "UngisterOffenseTraget",
											name = offenceTargetName,
										})
									end
								end
								...
								if Tpp.IsTypeTable(fireTable.timerTable) then
									if
										fireTable.timerTable.timerName
										and GkEventTimerManager.IsTimerActive(fireTable.timerTable.timerName)
									then
			...
			TppSystem = {
				{
					...
					func = function(targetName)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): TppSystem: NotifyCyprusTargetHit: targetName:"
								.. tostring(targetName)
						)
						...
						for i, fireTable in ipairs(self.fireList) do
							if Tpp.IsTypeTable(fireTable.offenceTargetTable) then
								for offenceTargetName, offenceTargetTable in pairs(fireTable.offenceTargetTable) do
									if
										Fox.StrCode32(offenceTargetName) == targetName
										and offenceTargetTable.instantDeath
									then
										vars.playerLife = 1
									end
								end
			...
			Timer = {
				{
					...
					func = function(timerName)
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName:"
								.. tostring(timerName)
						)

						for i, fireTable in ipairs(self.fireList) do
							if
								Tpp.IsTypeTable(fireTable.timerTable)
								and Fox.StrCode32(fireTable.timerTable.timerName) == timerName
							then
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName: Timer_StartPlayer0000"
						)
						self.StartPlayer()
					end,
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName: Timer_StartPlayer0001"
						)
						s10010_sequence.ProhibitMove(false)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName: Timer_StartPlayer0002"
						)
						s10010_sequence.ProhibitMove(false)
						mvars.playerStop2f0002 = false
					end,
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName: Timer_StartPlayer0003"
						)
						s10010_sequence.ProhibitMove(false)
						mvars.playerStop2f0003 = false
					end,
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName: Timer_IshmaelFire0000"
						)
						local targetName
						for i, enemyName in ipairs(self.enemyList) do
							local lifeState = GameObject.SendCommand(
						...
						if targetName then
							GameObject.SendCommand(
								...
								{
									id = "SetTargetId",
									targetId = GameObject.GetGameObjectId(targetName),
									headShot = true,
								}
							)
							s10010_sequence.PushMotion({
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName: Timer_IshmaelMonologue0012"
						)
						local label =
							self.ishmaelShootingLoopVoiceList[mvars.ishmaelShootingLoopVoiceCount % #self.ishmaelShootingLoopVoiceList]
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = label }
						)
				...
				},
				{
					...
					func = function()
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ishmael"),
							{ id = "CallMonologue", label = "ISHM_074" }
						)
					end,
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName: Timer_EnableMarker"
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName: Timer_StartCamera"
						)
						...
						s10010_sequence.StopPlayerAndStartNearCamera(
							true,
							nil,
							"s10010_l01_sequence_DataIdentifier",
							"extinguisher",
							3,
							24
						)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"s10010_sequence.sequences.Seq_Game_GunTutorial.Messages(): Timer: Finish: timerName: Timer_StartCamera0001"
						)
	...
	OnEnter = function(self)
		...
		for i, enemyName in ipairs(self.enemyList) do
			s10010_sequence.OnGameObjectEnterTrap(
				Fox.StrCode32("trap_GameOver_2F_0003"),
				GameObject.GetGameObjectId(enemyName)
			)
		end
		...
		for i, fireTable in ipairs(self.fireList) do
			if fireTable.offenceTargetTable and Tpp.IsTypeTable(fireTable.offenceTargetTable) then
				...
				elseif
					Tpp.IsTypeString(fireTable.timerTable.timerName)
					and Tpp.IsTypeNumber(fireTable.timerTable.timerCount)
				then
	...
	ActivateFire = function(fireTable, executedByTimer)
		...
		for offenceTargetName, offenceTargetTable in pairs(fireTable.offenceTargetTable) do
			local dataBody =
				DataIdentifier.GetDataBodyWithIdentifier(offenceTargetTable.identifierId, offenceTargetTable.key)
			local translation = dataBody.data.transform.translation
			local scale = dataBody.data.transform.scale
			CyprusMissionController.SendCommand({
				id = "RegisterOffenseTraget",
...
sequences.Seq_Game_GameOverGunTutorial =
	s10010_sequence.MakeGameOverSequenceTable(sequences.Seq_Game_GunTutorial.enemyList)
...
sequences.Seq_Demo_BeforeEntrance = {
	...
	OnEnter = function(self)
		...
		s10010_sequence.ProhibitMove(true)
		s10010_demo.PlayBeforeEntranceDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Demo_Entrance")
			end,
		})
	end,
...
sequences.Seq_Demo_Entrance = {
	...
	OnEnter = function(self)
		...
		s10010_demo.PlayEntranceDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_Load9")
			end,
		})
	end,
...
sequences.Seq_Game_Load9 = s10010_sequence.MakeLoadSequenceTable(
...
sequences.Seq_Game_Entrance = {
			...
			Trap = {
				{
					...
					func = function()
						s10010_sequence.OnRoutePoint(
							GameObject.GetGameObjectId("TppSoldier2", "sol_p21_010500_0009"),
							Fox.StrCode32("rts_skull_after_p21_010500_d_0003"),
							0,
							Fox.StrCode32("trap_Entrance_fall")
						)
					end,
	...
	OnLeave = function(self)
		...
		for i, enemyName in ipairs(self.enemyList) do
			local lifeState =
				GameObject.SendCommand(GameObject.GetGameObjectId("TppSoldier2", enemyName), { id = "GetLifeStatus" })
...
sequences.Seq_Demo_HijackAmbulance = {
	...
	OnEnter = function(self)
		...
		s10010_demo.PlayVolginInEntranceDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_VolginInEntrance")
			end,
		})
			...
			GameObject = {
				{
					...
					func = function()
						Fox.Log(
							"sequences.Seq_Game_VolginInEntrance.Messages(): GameObject: VolginGameOverAttackSuccess"
						)
...
sequences.Seq_Demo_HeliRotor = {
	...
	OnEnter = function()
		...
		TppBullet.ClearBulletMark()
		s10010_demo.PlayHeliRotorDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Demo_VolginVsTank")
			end,
		})
	end,
...
sequences.Seq_Demo_VolginVsTank = {
	...
	OnEnter = function()
		...
		s10010_demo.PlayTankDemo({
			onStart = function()
				TppSequence.SetNextSequence("Seq_Game_EscapeFromEntrance")
			end,
		})
	end,
			...
			TppSystem = {
				{
					...
					func = function(targetName)
						...
						if
							targetName == Fox.StrCode32("offenceTarget_1f_0000")
							or targetName == Fox.StrCode32("offenceTarget_1f_0004")
							or targetName == Fox.StrCode32("offenceTarget_1f_0006")
						then
							vars.playerLife = 1
						end
					end,
...
sequences.Seq_Demo_EscapeFromEntrance = {
	...
	OnEnter = function()
		...
		s10010_demo.PlayEscapeFromEntranceDemo({
			onEnd = function()
...
sequences.Seq_Game_Load10 =
	s10010_sequence.MakeLoadSequenceTable(nil, nil, 10, "Seq_Demo_EscapeFromHospital", "CHK_AfterEntrance")
...
sequences.Seq_Demo_EscapeFromHospital = {
	...
	OnEnter = function(self)
		...
		s10010_demo.PlayEscapeFromHospital({
			onEnd = function()
				local missionName = TppMission.GetMissionName()
				if missionName == "s10010" then
					TppSoundDaemon.SetMuteInstant("Loading")
	...
	OnUpdate = function()
		if
			mvars.doesShowDemoKeyHelp
			and bit.band(PlayerVars.scannedButtonsDirect, PlayerPad.FIRE) == PlayerPad.FIRE
		then
			TppUiCommand.HideDemoKeyHelp()
			mvars.doesShowDemoKeyHelp = nil
		end
...
sequences.Seq_Game_Load35 = s10010_sequence.MakeLoadSequenceTable(
	nil,
	nil,
	35,
	"Seq_Game_LoadAvatarPlayerBeforePassport",
...
sequences.Seq_Game_LoadAvatarPlayerBeforePassport = {
	...
	OnUpdate = function(self)
		if mvars.playerCheckCount > 3 then
			if PlayerInfo.OrCheckStatus and PlayerInfo.OrCheckStatus({ PlayerStatus.PARTS_ACTIVE }) then
				Fox.Log(
					"sequences.Seq_Game_LoadAvatarPlayerBeforePassport.OnUpdate(): Finish PlayerInfo.OrCheckStatus{ PlayerStatus.PARTS_ACTIVE "
				)
...
sequences.Seq_Demo_TakePassportPhotograph = {
	...
	OnEnter = function()
		...
		s10010_demo.PlayPassportPhotographDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_LoadAvatarPlayerAfterPassport", { isExecMissionClear = true })
			end,
		})
	end,
...
sequences.Seq_Game_LoadAvatarPlayerAfterPassport = {
	...
	OnUpdate = function(self)
		if mvars.playerCheckCount > 3 then
			if PlayerInfo.OrCheckStatus and PlayerInfo.OrCheckStatus({ PlayerStatus.PARTS_ACTIVE }) then
				Fox.Log(
					"sequences.Seq_Game_LoadAvatarPlayerAfterPassport.OnUpdate(): Finish PlayerInfo.OrCheckStatus{ PlayerStatus.PARTS_ACTIVE "
				)
...
sequences.Seq_Game_Load31 = s10010_sequence.MakeLoadSequenceTable(
	nil,
	nil,
	31,
	"Seq_Game_WaitCreatingBlendTexture2",
...
sequences.Seq_Demo_FireWhale = {
	...
	OnEnter = function()
		...
		s10010_demo.PlayFireWhaleDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_VolginRide")
			end,
		})
	end,
...
sequences.Seq_Demo_FireWhaleTruth = {
	...
	OnEnter = function()
		...
		s10010_demo.PlayFireWhaleTruthDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_Load32", { isExecMissionClear = true })
			end,
		})
...
sequences.Seq_Game_VolginRide = {
		...
		return StrCode32Table({
			Trap = {
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_BgmChange0000, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if Tpp.IsPlayer(gameObjectId) then
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_VolginRideVanish, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if gameObjectId == GameObject.GetGameObjectId("ocelot_horse") then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("volgin_horse"),
								{ id = "SetRoute", route = "rts_volgin_vanish", warp = 1 }
							)
							GameObject.SendCommand(
								GameObject.GetGameObjectId("ocelot"),
								{ id = "CallMonologue", label = "OCLT_006" }
							)
							s10010_sequence.StartTimer("Timer_OCLT_07", 4)
						else
							Fox.Log(
								"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trap_VolginRideVanish: gameObjectId is not volgin_horse"
							)
						end
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_VolginRideAppear, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if gameObjectId == GameObject.GetGameObjectId("ocelot_horse") then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("volgin_horse"),
								{ id = "SetRoute", route = "rts_volgin_appear", warp = 1 }
							)
							s10010_sequence.StartTimer("Timer_OCLT_011", 2)
						else
							Fox.Log(
								"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trap_VolginRideAppear: gameObjectId is not ocelot_horse"
							)
						end
					end,
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_VolginSe0000, gameObjectId:"
								.. tostring(gameObjectId)
						)
						...
						if gameObjectId == GameObject.GetGameObjectId("ocelot_horse") then
							...
							Fox.Log(
								"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trap_VolginSe0000: gameObjectId is not ocelot_horse"
							)
						end
					end,
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_VolginAttack1, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if Tpp.IsPlayer(gameObjectId) then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("volgin_vr"),
								{ id = "RequestAttack", attackType = Fox.StrCode32("ChargeAttack") }
							)
						end
					end,
				},
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_DisableChargeAttack0000, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if Tpp.IsPlayer(gameObjectId) then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("volgin_vr"),
								{ id = "SetEnableAiAttacking", enable = false }
							)
						end
					end,
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_EnableChargeAttack0000, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if Tpp.IsPlayer(gameObjectId) then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("volgin_vr"),
								{ id = "SetEnableAiAttacking", enable = true }
							)
						end
					end,
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_VolginInvincible, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if Tpp.IsPlayer(gameObjectId) then
							...
							GameObject.SendCommand(
								GameObject.GetGameObjectId("ocelot"),
								{ id = "CallMonologue", label = "OCLT_012" }
							)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_TreeDown0000, gameObjectId:"
								.. tostring(gameObjectId)
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_TreeDown0001, gameObjectId:"
								.. tostring(gameObjectId)
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_TreeDown0002, gameObjectId:"
								.. tostring(gameObjectId)
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_TreeDown0003, gameObjectId:"
								.. tostring(gameObjectId)
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_TreeExplosion0000, gameObjectId:"
								.. tostring(gameObjectId)
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Exit: trapName:trap_TreeExplosion0000, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if gameObjectId == GameObject.GetGameObjectId("volgin_horse") and mvars.treeExplosion[1] then
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_TreeExplosion0001, gameObjectId:"
								.. tostring(gameObjectId)
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Exit: trapName:trap_TreeExplosion0001, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if gameObjectId == GameObject.GetGameObjectId("volgin_horse") and mvars.treeExplosion[2] then
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_TreeExplosion0002, gameObjectId:"
								.. tostring(gameObjectId)
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Exit: trapName:trap_TreeExplosion0002, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if gameObjectId == GameObject.GetGameObjectId("volgin_horse") and mvars.treeExplosion[3] then
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Enter: trapName:trap_TreeExplosion0003, gameObjectId:"
								.. tostring(gameObjectId)
						)
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						Fox.Log(
							"sequences.Seq_Game_VolginRide.Messages(): Trap: Exit: trapName:trap_TreeExplosion0003, gameObjectId:"
								.. tostring(gameObjectId)
						)
						if gameObjectId == GameObject.GetGameObjectId("volgin_horse") and mvars.treeExplosion[4] then
				...
				},
				{
					...
					func = function(trapName, gameObjectId)
						...
						GameObject.SendCommand(
							{ type = "TppVolgin2forVr", group = 0, index = 0 },
							{ id = "EnableFinalScream" }
						)
					end,
				},
			},
			...
			Timer = {
				...
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ocelot"),
							{ id = "CallMonologue", label = "OCLT_007" }
						)
				...
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ocelot"),
							{ id = "CallMonologue", label = "OCLT_011" }
						)
				...
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ocelot"),
							{ id = "CallMonologue", label = "OCLT_010" }
						)
				...
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ocelot"),
							{ id = "CallMonologue", label = "OCLT_009" }
						)
					end,
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ocelot"),
							{ id = "CallMonologue", label = "OCLT_013" }
						)
				...
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ocelot"),
							{ id = "CallMonologue", label = "OCLT_014" }
						)
					end,
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ocelot"),
							{ id = "CallMonologue", label = "OCLT_045" }
						)
				...
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ocelot"),
							{ id = "CallMonologue", label = "OCLT_046" }
						)
				...
				},
				{
					...
					func = function()
						...
						GameObject.SendCommand(
							GameObject.GetGameObjectId("ocelot"),
							{ id = "CallMonologue", label = "OCLT_047" }
						)
			...
			Player = {
				{
					...
					func = function()
						...
						if not mvars.OCLT_005_finished and not mvars.ocelotMonologueDisabled then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("ocelot"),
								{ id = "CallMonologue", label = "OCLT_005" }
							)
	...
	AttackByFireWall = function(fireWallInfo)
		...
		GameObject.SendCommand(
			volginGameObjectId,
			{ id = "RequestAttack", attackType = Fox.StrCode32("FirewallAttack") }
		)
	end,
...
sequences.Seq_Game_Load11_2 =
	s10010_sequence.MakeLoadSequenceTable(nil, nil, 11, "Seq_Demo_Bridge2", nil, { isExecMissionClear = true })
...
sequences.Seq_Demo_Bridge2 = {
	...
	OnEnter = function()
		s10010_demo.PlayBridgeDemo2({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_LoadMovie", { isExecMissionClear = true })
			end,
		})
	end,
}

sequences.Seq_Game_Load32 = s10010_sequence.MakeLoadSequenceTable(
	nil,
	nil,
	32,
	"Seq_Game_PrepareBeforeMirrorPlayerLoad",
...
sequences.Seq_Demo_TwoBigBoss = {
	...
	OnEnter = function(self)
		...
		TppPlayer.Refresh()
		s10010_demo.PlayTwoBigBossDemo({
			onEnd = function()
				TppSequence.SetNextSequence("Seq_Game_EndRoll", { isExecMissionClear = true })
			end,
		})
...
sequences.Seq_Game_BlackTelephone = {
	...
	OnEnter = function(self)
		...
		TppUiCommand.ShowTextureLogo(
			"/Assets/tpp/ui/ModelAsset/sys_logo/Pictures/common_title_logo_clp_nmp.ftex",
			0.0,
			"full"
		)
	...
	OnUpdate = function(self)
		if
			mvars.blackTelephoneCount > 5
			and not TppSoundDaemon.IsEventPlaying("Play_endroll03_04", mvars.blackTelephoneHandle)
		then
...
s10010_sequence.eventTableRoot = {
	flashback = {
		before = {
			...
			{
				func = s10010_sequence.SetSceneReflectionParameter,
				texturePath = "/Assets/tpp/common_source/cubemap/environ/cyprus/cm_cypr_cb_room001/sourceimages/cm_cypr_cb_room001_cbm.ftex",
			},
			...
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
				key = "Light_1F_Entr_isolate",
				enable = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
				key = "Light_2F_All_isolate",
				enable = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
			...
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
				key = "Light_Minato_Isolate",
				enable = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
				key = "Light_4F_StartNight",
				enable = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
				key = "Light_4F_StartNight_Sub",
				enable = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
			...
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
				key = "Light_4F_SunShadow",
				enable = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
				key = "Light_4F_StartSun_Isolate",
				enable = true,
			},
			{
				func = s10010_sequence.EnableDataBody,
			...
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
				key = "Light_3F_OutDark",
				enable = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
				key = "Light_4F_OutDark",
				enable = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
			...
			{
				func = s10010_sequence.SetEffectVisibility,
				effectName = "FxLocatorGroup_fx_tpp_dstwhtviw01_s2VD",
				visible = true,
			},
			{
				func = s10010_sequence.SetEffectVisibility,
				effectName = "FxLocatorGroup_fx_tpp_dstwhtviw01_s2VD_Turbulence",
				visible = false,
			},
			{
			...
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010050_cypr_cart001",
				visible = false,
			},
		},
	...
	opening = {
		before = {
			...
			},
			{
				...
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_room001_vrtn001_0000",
				meshName = "MESH_Sunlight_IV",
				visible = true,
			},
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_pstr003_vrtn001",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_pstr003_vrtn002",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_flrs001_arousal_room_on_day",
				visible = true,
			},
			...
			{
				func = s10010_sequence.SetEffectSize,
				effectName = "FxLocatorGroup_TitleDust",
		...
		p21_010000_cyprtitle_on = {
...

			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_flrs001_vrtn002_title",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_crtn001_vrtn005_title",
				visible = false,
			},
			{
				func = s10010_sequence.SetGimmickVisibility,
	...
	oneWeekLater = {
		before = {
			...
			{
				func = s10010_sequence.SetSceneReflectionParameter,
				texturePath = "/Assets/tpp/common_source/cubemap/environ/cyprus/cm_cypr_cb_room002/sourceimages/cm_cypr_cb_room002_cbm.ftex",
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_pstr003_vrtn004",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "curtain_rail_shadow",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_flrs001_arousal_room_off",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "curtain_rail_noshadow",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_flrs001_arousal_room_on",
				visible = true,
			},
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_flrs003_arousal_room",
				meshName = "MESH_on_IV",
				visible = true,
			},
			{
	...
	quietExit = {
		before = {
			{
				...
				type = TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
				datasetName = "/Assets/tpp/level/location/cypr/block_small/01/cypr_01_asset.fox2",
				locatorName = "cypr_char001_vrtn001_gim_n0000|srt_cypr_char001_vrtn001",
				visible = true,
			},
		},
		p21_010250_windowbreak02 = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010250_cypr_wndw003_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010250_cypr_wndw003_vrtn001_after",
				visible = true,
			},
		},
		p21_010250_gim_cartON = {
			...
			},
			{
				...
				type = TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
				datasetName = "/Assets/tpp/level/location/cypr/block_small/01/cypr_01_asset.fox2",
				locatorName = "cypr_cart001_gim_n0000|srt_cypr_cart001",
				visible = true,
			},
			{
				func = s10010_sequence.SetGimmickVisibility,
				...
				type = TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
				datasetName = "/Assets/tpp/level/location/cypr/block_small/01/cypr_01_asset.fox2",
				locatorName = "cypr_mdeq004_vrtn009_gim_n0000|srt_cypr_mdeq004_vrtn009",
				visible = true,
			},
		},
		p21_010250_ishstart = {
		...
		after = {
			...
			{
				func = s10010_sequence.PlaySoundEffect,
				soundSourceName = "SS_4FHeli",
				eventName = "sfx_m_cypr_heli_far",
			},
			...
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 12.871343612671,
				rotationY = -59.464687347412,
			},
		},
	},
	load2 = {
	...
	volgin = {
		before = {
			{ func = s10010_sequence.ProhibitMoveOnSubEvent, enable = false },
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_door003_door001_arousal_room_open",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_door003_door001_arousal_room_close",
				visible = true,
			},
			{
				func = s10010_sequence.SetEffectVisibility,
				effectName = "Effect_4F_AwakeToVolginDemo",
				visible = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
		...
		p21_010270_elvtdef_off = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010270_cypr_elvt001_door001",
				visible = false,
			},
		},
		p21_010270_elvtdoor = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010270_cypr_door001_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010270_cypr_door001_after",
				visible = true,
			},
		},
		p21_010270_envbreak = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010270_light_on",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010270_light_off",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010270_passage_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010270_passage_after",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010270_rubble",
				visible = true,
			},
			{
				func = s10010_sequence.SetGimmickVisibility,
		...
		p21_010270_emergencybell = {
			{
				func = s10010_sequence.PlaySoundEffect,
				soundSourceName = "SS_4FFA",
				eventName = "sfx_m_cypr_fire_siren",
				singleShot = false,
				onlyIfSkipped = true,
			},
		},
		after = {
			...
			{
				func = s10010_sequence.PlaySoundEffect,
				eventName = "sfx_m_cypr_6_int",
				singleShot = false,
				onlyIfSkipped = true,
			},
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 5.0513000488281,
				rotationY = 84.002403259277,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "outside_window_4f",
				visible = true,
			},
	...
	cure = {
		before = {
			...
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010310_0000",
				sneakRouteName = "rts_skull_after_p21_010310_0000",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010310_0001",
				sneakRouteName = "rts_skull_after_p21_010310_0001",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010310_0002",
				sneakRouteName = "rts_skull_after_p21_010310_0002",
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_door003_door001_smoke_room_close",
				visible = false,
			},
		...
		after = {
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_door003_door001_smoke_room_open",
				visible = true,
			},
			{ func = s10010_sequence.ProhibitMoveOnSubEvent, enable = false },
			...
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 1.7429848909378,
				rotationY = -3.6800100803375,
			},
		},
	},
	enterSmokeRoom = {
		before = {
			...
			{
				func = s10010_sequence.PlaySoundEffect,
				soundSourceName = "SS_DOOR1",
				eventName = "sfx_m_cypr_door1",
				singleShot = true,
			},
		},
		after = {
	...
	underBed = {
		...
		after = {
			...
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010340_0000",
				sneakRouteName = "rts_skull_after_p21_010340_0000",
			},
		},
	},
	underBed2 = {
		...
		p21_010360_window_brk01 = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas001_b_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas001_b_after",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas002_b_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas002_b_after",
				visible = true,
			},
		...
		p21_010360_window_brk02 = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas003_b_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas003_b_after",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas004_b_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas004_b_after",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_vrtn004_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_vrtn004_gm_after",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_pssg001_flor001",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_pssg001_flor001_br",
				visible = true,
			},
		},
		p21_010360_window_brk03 = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas005_b_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas005_b_after",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas006_b_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "p21_010360_cypr_wndw001_glas006_b_after",
				visible = true,
			},
		},
		after = {
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_door004_door001_smoke_room_open",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s01_other_DataIdentifier",
				key = "cypr_door004_door001_smoke_room_close",
				visible = true,
			},
			{
				func = s10010_sequence.SetDisabledPlayerAction,
			...
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = -4.82004737854,
				rotationY = -6.5339770317078,
			},
	...
	soldierKillMob = {
		...
		after = {
			...
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010370_0000",
				sneakRouteName = "rts_skull_after_p21_010370_0000",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010370_0001",
				sneakRouteName = "rts_skull_after_p21_010370_0001",
			},
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 1.4404321908951,
				rotationY = 95.598915100098,
			},
			{ func = s10010_sequence.EnableEnemy, locatorName = "WestHeli", enable = false },
			{
				func = s10010_sequence.SetModelVisibility,
	...
	stairway = {
		before = {
			...
			{ func = s10010_sequence.ProhibitMoveOnSubEvent, enable = true },
			{
				...
				key = "p21_010420_door003_door001_a_open",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010420_door003_door001_a_halfopen",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010420_door003_door001_a_close",
				visible = false,
			},
			{ func = s10010_sequence.StopSceneBGM },
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_l01_other_DataIdentifier",
				key = "p21_010410_cypr_grat001_door001_close",
				visible = true,
			},
		...
		Play = {
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010380_0000",
				sneakRouteName = "rts_skull_stairway_0000",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010380_0001",
				sneakRouteName = "rts_skull_stairway_0001",
			},
		},
		p21_010380dooroff = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_l01_other_DataIdentifier",
				key = "p21_010380_cypr_door002_open",
				visible = false,
			},
		},
		p21_010380_ish = {
			...
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010380_0002",
				sneakRouteName = "rts_skull_stairway_0004",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010380_0003",
				sneakRouteName = "rts_skull_stairway_0005",
			},
		},
		p21_010380_door = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_l01_other_DataIdentifier",
				key = "p21_010380_cypr_door002_close",
				visible = true,
			},
		},
		p21_010380_padon = {
		...
		after = {
			...
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 0.61394309997559,
				rotationY = -85.114204406738,
			},

			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas001_a_before",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas001_a_after",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas001_b_before",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas001_b_after",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas002_b_before",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas002_b_after",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas003_b_before",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas003_b_after",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas004_b_before",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas004_b_after",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas005_b_before",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas005_b_after",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas006_b_before",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_wndw001_glas006_b_after",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_l01_other_DataIdentifier",
				key = "p21_010380_cypr_door001_door002_close_geom",
				visible = false,
			},
		},
	},
	...
	corridor6 = {
		...
		after = {
			...
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "s10010_l01_sequence_DataIdentifier",
				key = "GeoTriggerTrap0002",
				enable = false,
			},
			...
			{
				func = s10010_sequence.PlaySoundEffect,
				eventName = "sfx_m_cypr_walla_kill_int",
				singleShot = false,
				onlyIfSkipped = true,
			},
			{
	...
	corridor7 = {
		Play = {
			...
			{ func = s10010_sequence.EnableEnemy, locatorName = "sol_p21_010420_0001", enable = true },
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010420_0000",
				sneakRouteName = "rts_skull_curtain_0015",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010420_0001",
				sneakRouteName = "rts_skull_curtain_0016",
			},
		},
		...
		after = {
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 11.770016670227,
				rotationY = -82.149932861328,
			},
		},
	},
	load6 = {
		...
		p21_010420_breakcurtainon = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010420_cypr_crtn001_vrtn016_an",
				visible = true,
			},
		},
		after = {
	...
	curtainRoom2 = {
		...
		p21_010420_padon = {
			{ func = s10010_sequence.ProhibitMoveOnSubEvent, enable = false },
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010420_door003_door001_b_open",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010420_door003_door001_b_close",
				visible = false,
			},
			{ func = s10010_sequence.StopSceneBGM },
		...
		after = {
			...
			{ func = s10010_sequence.EnableEnemy, locatorName = "sol_p21_010440_0003", enable = true },
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010420_0000",
				sneakRouteName = "rts_skull_curtain_0017",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010420_0001",
				sneakRouteName = "rts_skull_curtain_0018",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010440_0000",
				sneakRouteName = "rts_skull_corridor_0010",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010440_0001",
				sneakRouteName = "rts_skull_corridor_0011",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010440_0002",
				sneakRouteName = "rts_skull_corridor_0008",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010440_0003",
				sneakRouteName = "rts_skull_corridor_0009",
			},
			{
				func = s10010_sequence.PushMotionOnSubEvent,
				locatorName = "ishmael",
			...
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = -2.6158754825592,
				rotationY = 40.947296142578,
			},
		},
	},
	enterCorridor = {
	...
	volginVsSkullSoldier = {
		...
		p21_010440_volginattack = {
			{
				...
				identifier = "cypr_s02_other_DataIdentifier",
				key = "cypr_pssg001_vrtn023_0000",
				meshName = "MESH_bullet_after_IV",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_afgh_pctr001_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_afgh_pctr001_after",
				visible = true,
			},
			{
				func = s10010_sequence.SetMeshVisibility,
		...
		p21_010440_heliattack01 = {
			...
			},
			{
				...
				identifier = "cypr_s02_other_DataIdentifier",
				key = "cypr_pssg001_vrtn031_0000",
				meshName = "MESH_bullet_a_after_IV",
				visible = true,
			},
		},
		p21_010440_heliattack02 = {
			...
			},
			{
				...
				identifier = "cypr_s02_other_DataIdentifier",
				key = "cypr_pssg001_vrtn031_0000",
				meshName = "MESH_bullet_b_after_IV",
				visible = true,
			},
		},
		p21_010440_heliattack03 = {
			...
			},
			{
				...
				identifier = "cypr_s02_other_DataIdentifier",
				key = "cypr_pssg001_vrtn031_0000",
				meshName = "MESH_bullet_c_after_IV",
				visible = true,
			},
		},
		p21_010440_heliattack04 = {
			...
			},
			{
				...
				identifier = "cypr_s02_other_DataIdentifier",
				key = "cypr_pssg001_vrtn031_0000",
				meshName = "MESH_bullet_d_after_IV",
				visible = true,
			},
		},
		p21_010440_breakwall = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_common_other_DataIdentifier",
				key = "p21_010440_cypr_buld001_wall004_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_passage_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_passage_after",
				visible = true,
			},
		...
		p21_010440_breakspkr = {
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_pipe001_sprk001",
				meshName = "MESH_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetMeshVisibility,
		...
		after = {
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s02_other_DataIdentifier",
				key = "p21_010440_cypr_grat001_door001_close_coll",
				visible = true,
			},
			{
				func = s10010_sequence.PlaySoundEffect,
				eventName = "sfx_m_cypr_8_int",
				singleShot = false,
				onlyIfSkipped = true,
			},
			{
			...
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 12.619423866272,
				rotationY = 13.540781021118,
			},
		},
	},
	load7 = {
		after = {
			...
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010490_0000",
				sneakRouteName = "rts_skull_2F_0000",
			},
			{ func = s10010_sequence.EnableEnemy, locatorName = "sol_p21_010490_0003", enable = true },
			{
				func = s10010_sequence.ChangeEnemyRoute,
				locatorName = "sol_p21_010490_0003",
				sneakRouteName = "rts_skull_2F_0006",
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
		...
		before = {
			...
			},
			{
				...
				OnStart = function()
					...
					s10010_sequence.PlaySoundEffect(
						{
							func = s10010_sequence.PlaySoundEffect,
							soundSourceName = "SS_DOOR4",
							eventName = "sfx_m_cypr_door4",
							singleShot = true,
						},
						true,
						false
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_l01_other_DataIdentifier",
				key = "p21_010480_cypr_door001_door002_close",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_l01_other_DataIdentifier",
				key = "p21_010480_cypr_door001_door002_close_geom",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_l01_other_DataIdentifier",
				key = "p21_010480_cypr_door001_door002_open",
				visible = true,
			},
		},
		after = {
	...
	getGun = {
		...
		after = {
			...
			{
				func = s10010_sequence.ChangePlayerEquip,
				equipId = "EQP_WP_West_hg_020",
				stock = 63,
				ammo = 7,
				isSuppressorOn = true,
				suppressorLife = 100,
			...
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 0.12678594887257,
				rotationY = 0.61936151981354,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s03_other_DataIdentifier",
				key = "cypr_door001_door002_close_geom_0001",
				visible = false,
			},
		},
	},
	load8 = {
		after = {
			...
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_2F_0004",
				locatorName = "sol_p21_010490_0001",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_2F_0005",
				locatorName = "sol_p21_010490_0002",
			},
			{ func = s10010_sequence.EnableCorpse, locatorName = "corpse_0000", enable = true },
	...
	twoEnemyAppear = {
		before = {
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_2F_0001",
				locatorName = "sol_p21_010490_0001",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_2F_0002",
				locatorName = "sol_p21_010490_0002",
			},
			{
				func = s10010_sequence.PushMotionOnSubEvent,
	...
	entrance = {
		before = {
			...
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_after_p21_010500_d_0000",
				cautionRouteName = "rts_skull_after_p21_010500_c_0000",
				locatorName = "sol_p21_010500_0006",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_after_p21_010500_d_0001",
				cautionRouteName = "rts_skull_after_p21_010500_c_0001",
				locatorName = "sol_p21_010500_0007",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_after_p21_010500_d_0002",
				cautionRouteName = "rts_skull_after_p21_010500_c_0002",
				locatorName = "sol_p21_010500_0008",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_after_p21_010500_d_0003",
				cautionRouteName = "rts_skull_after_p21_010500_c_0003",
				locatorName = "sol_p21_010500_0009",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_after_p21_010500_d_0004",
				cautionRouteName = "rts_skull_after_p21_010500_c_0004",
				locatorName = "sol_p21_010500_0010",
			},
			{
				func = s10010_sequence.ChangeEnemyRoute,
				sneakRouteName = "rts_skull_after_p21_010500_d_0005",
				cautionRouteName = "rts_skull_after_p21_010500_c_0005",
				locatorName = "sol_p21_010500_0011",
			},
			...
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_uth0_geom",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010520_uth0_geom",
				visible = false,
			},
			{
				func = s10010_sequence.EnableDataBody,
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_cypr_wndw002_before",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_cypr_wndw002_after",
				visible = false,
			},
		...
		after = {
			...
			{ func = s10010_sequence.EnablePadMaskCombatOnSubEvent, enable = true },
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010500_cypr_door002_open",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010500_cypr_door002_close",
				visible = true,
			},
			...
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 23.748027801514,
				rotationY = 77.340042114258,
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
	...
	ambulance = {
		before = {
			{ func = s10010_sequence.RealizeVolgin, realize = true },
			{
				func = s10010_sequence.WarpVolgin,
				identifier = "CheckPointIdentifier",
				key = "warp_volginInEntrance0001",
			},
		...
		p21_010510_BreakExit = {
			{
				func = s10010_sequence.BreakGimmick,
				locatorName = "cypr_entr001_rbbl001_gim_n0000|srt_cypr_entr001_rbbl001",
				datasetPath = "/Assets/tpp/level/location/cypr/block_small/04/cypr_04_asset.fox2",
			},
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_common_other_DataIdentifier",
				key = "p21_010510_cypr_entr001_vrtn001",
				meshName = "MESH_before",
				visible = false,
			},
			{
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_cypr_entr001_vrtn002",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_after",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_add_rubble",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_entrance_recoil_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_entrance_recoil_after",
				visible = true,
			},
		},
		p21_010510_BreakDoor = {
			{
				func = s10010_sequence.BreakGimmick,
				locatorName = "cypr_door006_rbbl001_gim_n0000|srt_cypr_door006_rbbl001",
				datasetPath = "/Assets/tpp/level/location/cypr/block_small/04/cypr_04_asset.fox2",
			},
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_common_other_DataIdentifier",
				key = "p21_010510_cypr_door006_drfr001",
				meshName = "MESH_before",
				visible = false,
			},
			{
		...
		after = {
			...
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 2.8415968418121,
				rotationY = 137.22998046875,
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
	...
	heliRotor = {
		...
		p21_010520_breakhelioff = {
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_pillar_recoil_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_pillar_recoil_after",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
		...
		p21_010520_BreakPillar = {
			...
			},
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_cypr_wndw002_vrtn001_gm",
				meshName = "MESH_before",
				visible = false,
			},
			{
			...
			},
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_cypr_wndw002_vrtn002_gm",
				meshName = "MESH_before",
				visible = false,
			},
			{
			...
			},
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_cypr_hall001_pllr021",
				meshName = "MESH_before",
				visible = false,
			},
			{
			...
			},
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_cypr_hall001_pllr011",
				meshName = "MESH_before",
				visible = false,
			},
			{
		...
		after = {
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_cypr_hall001_pllr012",
				visible = true,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s04_other_DataIdentifier",
				key = "p21_010510_cypr_hall001_pllr022",
				visible = true,
			},
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 2.2590324878693,
				rotationY = 115.59019470215,
			},
			{
				func = s10010_sequence.EnableDataBody,
				identifier = "cypr_common_light_DataIdentifier",
	...
	load10 = {
		before = {
			...
			{
				func = s10010_sequence.SetEffectVisibility,
				effectName = "FxLocatorGroup_fx_tpp_cldcypInside",
				visible = false,
			},
			{
				func = s10010_sequence.SetEffectVisibility,
				effectName = "FxLocatorGroup_fx_tpp_cldcypOutside",
				visible = true,
			},
		},
	},
	escapeFromHospital = {
		before = {
			{ func = s10010_sequence.EnableEnemy, locatorName = "ishmael", enable = true },
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_common_other_DataIdentifier",
				key = "p21_010550_cypr_hall001_marg001",
				visible = true,
			},
		...
		p21_020010_hospwall_brk_on = {
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_common_other_DataIdentifier",
				key = "p21_010550_buld001_wall_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_common_other_DataIdentifier",
				key = "p21_010550_buld001_wall_after",
				visible = true,
			},
		},
		p21_020010_breakTunnel = {
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_s06_other_DataIdentifier",
				key = "cypr_tnnl001_0000",
				meshName = "MESH_before",
				visible = false,
			},
			{
			...
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s05_other_DataIdentifier",
				key = "p21_020010_tunnel_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_s05_other_DataIdentifier",
				key = "p21_020010_tunnel_after",
				visible = true,
			},
		},
		after = {
	...
	load11 = {
		...
		after = {
			{
				func = s10010_sequence.SetSceneReflectionParameter,
				texturePath = "/Assets/tpp/common_source/cubemap/environ/cyprus/cm_cypr_cb_road001/sourceimages/cm_cypr_cb_road001_cbm.ftex",
			},
		},
	},
	fireWhale = {
		...
		p21_020030_ChangeGameMotVol = {
			{
				func = s10010_sequence.ChangeHorseRoute,
				locatorName = "volgin_horse",
				routeName = "rts_volgin_start",
				warp = false,
			},
		},
		p21_020030_ChangeGameMot = {
			...
			{
				func = s10010_sequence.ChangeHorseRoute,
				locatorName = "ocelot_horse",
				routeName = "rts_ocelotHorce",
				warp = false,
			},
		},
		after = {
			...
			{ func = s10010_sequence.SetSceneBGMSwitch, switchName = "Set_Switch_bgm_s10010_sw_02" },
			{
				func = s10010_sequence.SetModelVisibility,
				identifier = "cypr_common_other_DataIdentifier",
				key = "p21_010550_cypr_window004_before",
				visible = false,
			},
			{
				func = s10010_sequence.SetInitialCameraRotation,
				rotationX = 13.529998779297,
				rotationY = 150.38847351074,
			},
	...
	twoBigBoss = {
		before = {
			{
				func = s10010_sequence.SetSceneReflectionParameter,
				texturePath = "/Assets/tpp/common_source/cubemap/environ/mother_base/cm_mtbs_room002/sourceimages/cm_mtbs_room002_cbm.ftex",
			},
		},
	},
	volginRideStart = {
		before = {
			{
				func = s10010_sequence.SetMeshVisibility,
				identifier = "cypr_s08_other_DataIdentifier",
				key = "cypr_brdg001_0000",
				meshName = "MESH_before_IV",
				visible = true,
			},
		},
	},
