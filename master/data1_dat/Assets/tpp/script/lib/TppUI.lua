...
function e.ShowColorAnnounceLog(i, a, t, n)
	if gvars.ini_isTitleMode then
		return
	end
	...
	if e then
		...
		TppUiCommand.AnnounceLogViewLangId(e, a, t, 0, 0, true)
	end
end
function e.ShowJoinAnnounceLog(i, a, o, t, n)
	if gvars.ini_isTitleMode then
		return
	end
	...
	if i and e then
		...
		TppUiCommand.AnnounceLogViewJoinLangId(i, e, o, t)
	end
end
...
function e.ShowSavingIcon()
	TppUiCommand.CallSaveMessage()
end
...
function e.OnMessage(p, s, a, o, t, i, n)
	Tpp.DoMessage(e.messageExecTable, TppMission.CheckMessageOption, p, s, a, o, t, i, n)
end
