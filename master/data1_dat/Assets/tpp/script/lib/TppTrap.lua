...
function a.DebugUpdate()
	...
	if a.debug.showTrapStatus and a.trp_variableTrapList then
		t(r, { 0.5, 0.5, 1 }, "LuaSystem TRP.trapStatus")
		local e = 1
		...
		for a, n in ipairs(a.trp_variableTrapList) do
			if a >= e then
				...
				t(r, { 0.5, 0.5, 1 }, "trapName = " .. (tostring(e) .. (", status = " .. tostring(a))))
			end
		end
	end
end
...
function a.Enable(e)
	a.ChangeTrapState(e, true)
end
function a.Disable(e)
	a.ChangeTrapState(e, false)
end
...
function a.ChangeTriggerTrapState(e, a)
