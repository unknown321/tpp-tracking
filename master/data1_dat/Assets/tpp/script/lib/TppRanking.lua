...
e.SHOW_ANNOUNCE_LOG = {
	e.ANNOUNCE_LOG_TYPE.NONE,
	e.ANNOUNCE_LOG_TYPE.TIME,
	e.ANNOUNCE_LOG_TYPE.TIME,
	e.ANNOUNCE_LOG_TYPE.TIME,
	e.ANNOUNCE_LOG_TYPE.TIME,
	e.ANNOUNCE_LOG_TYPE.DISTANCE,
	e.ANNOUNCE_LOG_TYPE.NONE,
	e.ANNOUNCE_LOG_TYPE.DISTANCE,
	e.ANNOUNCE_LOG_TYPE.TIME,
	e.ANNOUNCE_LOG_TYPE.TIME,
	e.ANNOUNCE_LOG_TYPE.NUMBER,
	e.ANNOUNCE_LOG_TYPE.NUMBER,
	e.ANNOUNCE_LOG_TYPE.NONE,
	e.ANNOUNCE_LOG_TYPE.TIME,
	e.ANNOUNCE_LOG_TYPE.TIME,
...
function e.UpdateScore(t, a, i)
	...
	if (svars.rnk_isUpdated[n] == false) or (r == false) then
		...
		if t then
			if i then
				e.ShowUpdateScoreAnnounceLog(n, i)
			else
				e.ShowUpdateScoreAnnounceLog(n, a)
			end
			gvars[o] = a
		end
	else
...
function e._ShowScoreTimeAnnounceLog(e)
	local n = math.floor(e / 60)
	local a = math.floor(e - n * 60)
	local e = (e - math.floor(e)) * 1e3
		...
		if (((e == 11) or (e == 12)) or (e == 13)) and not t then
			if n then
				TppReward.Push({
					...
					langId = "dummy",
					rewardType = TppReward.TYPE.RANKING,
					arg1 = e,
				})
			end
		end
...
function e.UpdateScoreTime(n)
	e.UpdateScore(n, svars.scoreTime / 1e3)
end
function e.UpdateShootingPracticeClearTime(a, n)
	local t = n / 1e3
	e.UpdateScore(a, n, t)
end
function e.Messages()
	return Tpp.StrCode32Table({
		Player = { { msg = "CBoxSlideEnd", func = e.OnCBoxSlideEnd } },
		GameObject = { { msg = "Neutralize", func = e.OnNeutralize }, { msg = "HeadShot", func = e.OnHeadShot } },
	})
end
function e.Init(n)
...
function e.OnMessage(a, s, r, n, i, o, t)
	Tpp.DoMessage(e.messageExecTable, TppMission.CheckMessageOption, a, s, r, n, i, o, t)
end
...
function e.DeclareSVars()
	return {
		{
			name = "rnk_isUpdated",
			arraySize = TppDefine.RANKING_MAX,
