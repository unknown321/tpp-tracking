...
local E = {
	Combat = { DispatchSoldier = t.SECTION_FUNC_ID_COMBAT_DEPLOY, DispatchFobDefence = t.SECTION_FUNC_ID_COMBAT_DEFENCE },
	Develop = {
		Weapon = t.SECTION_FUNC_ID_DEVELOP_WEAPON,
		SupportHelicopter = t.SECTION_FUNC_ID_DEVELOP_HELI,
		Quiet = t.SECTION_FUNC_ID_DEVELOP_QUIET,
		D_Dog = t.SECTION_FUNC_ID_DEVELOP_D_DOG,
		D_Horse = t.SECTION_FUNC_ID_DEVELOP_D_HORSE,
		D_Walker = t.SECTION_FUNC_ID_DEVELOP_D_WALKER,
		BattleGear = t.SECTION_FUNC_ID_DEVELOP_BATTLE_GEAR,
		SecurityDevice = t.SECTION_FUNC_ID_DEVELOP_SECURITY_DEVICE,
	},
	BaseDev = {
		Mining = t.SECTION_FUNC_ID_BASE_DEV_RESOURCE_MINING,
		Processing = t.SECTION_FUNC_ID_BASE_DEV_RESOURCE_PROCESSING,
	...
	Support = {
		Fulton = t.SECTION_FUNC_ID_SUPPORT_FULTON,
		Supply = t.SECTION_FUNC_ID_SUPPORT_SUPPLY,
		Battle = t.SECTION_FUNC_ID_SUPPORT_BATTLE,
		BattleArtillery = t.SECTION_FUNC_ID_SUPPORT_STRIKE,
		BattleSmoke = t.SECTION_FUNC_ID_SUPPORT_SMOKE,
		BattleSleepGas = t.SECTION_FUNC_ID_SUPPORT_SLEEP_GAS,
		BattleChaff = t.SECTION_FUNC_ID_SUPPORT_CHAFF,
		BattleWeather = t.SECTION_FUNC_ID_SUPPORT_WEATHER,
		...
		TranslationKikongo = t.SECTION_FUNC_ID_SUPPORT_KIKONGO_TRANSLATE,
		TranslationPashto = t.SECTION_FUNC_ID_SUPPORT_PASHTO_TRANSLATE,
	},
	Spy = {
		Information = t.SECTION_FUNC_ID_SPY_MISSION_INFO_COLLECTING,
		Scouting = t.SECTION_FUNC_ID_SPY_ENEMY_SEARCH,
		SearchResource = t.SECTION_FUNC_ID_SPY_RESOURCE_SEARCH,
		WeatherInformation = t.SECTION_FUNC_ID_SPY_WEATHER_INFO,
	},
	Medical = {
	...
	Security = {
		...
		MachineDefence = t.SECTION_FUNC_ID_SECURITY_BASE_DEFENCE_MACHINE,
		BaseBlockade = t.SECTION_FUNC_ID_SECURITY_BASE_BLOCKADE,
		SecurityInfo = t.SECTION_FUNC_ID_SPY_SECURITY_INFO,
	},
}
e.setUpMenuList = {}
e.MBDVCMENU = {
...
e.BLUE_PRINT_LOCATOR_TABLE = {
	col_develop_Revolver_Shotgun = t.DESIGN_2002,
	col_develop_Highprecision_SMG = t.DESIGN_2006,
	col_develop_HighprecisionAR = t.DESIGN_2007,
	col_develop_HighprecisionAR_s10033_0000 = t.DESIGN_2007,
	col_develop_BullpupAR = t.DESIGN_2008,
	col_develop_LongtubeShotgun = t.DESIGN_2009,
	col_develop_RevolverGrenade0001 = t.DESIGN_2011,
	col_develop_RevolverGrenade0002 = t.DESIGN_2011,
	col_develop_RevolverGrenade0003 = t.DESIGN_2011,
	col_develop_RevolverGrenade0004 = t.DESIGN_2011,
	col_develop_Semiauto_SR = t.DESIGN_2013,
	col_develop_Semiauto_SR_s10070_0000 = t.DESIGN_2013,
	col_develop_Antimaterial = t.DESIGN_2015,
	col_develop_EuropeSMG0001 = t.DESIGN_2016,
	col_develop_EuropeSMG0002 = t.DESIGN_2016,
	col_develop_EuropeSMG0003 = t.DESIGN_2016,
	col_develop_EuropeSMG0004 = t.DESIGN_2016,
	col_develop_Stungrenade = t.DESIGN_2019,
	col_develop_Stungun = t.DESIGN_2020,
	col_develop_Infraredsensor = t.DESIGN_2021,
	col_develop_Theftprotection = t.DESIGN_2022,
	col_develop_Emergencyrescue = t.DESIGN_3001,
	col_develop_FLamethrower = t.DESIGN_2026,
	col_develop_Shield = t.DESIGN_2025,
	col_develop_Shield0000 = t.DESIGN_2025,
	col_develop_Shield0001 = t.DESIGN_2025,
	col_develop_Shield0002 = t.DESIGN_2025,
	col_develop_GunCamera = t.DESIGN_2023,
	col_develop_UAV = t.DESIGN_2024,
	col_develop_q60115 = t.DESIGN_2027,
}
e.BLUE_PRINT_LANG_ID = {
	[t.DESIGN_2002] = "key_bprint_2002",
	[t.DESIGN_2006] = "key_bprint_2006",
	[t.DESIGN_2007] = "key_bprint_2007",
	[t.DESIGN_2008] = "key_bprint_2008",
	[t.DESIGN_2009] = "key_bprint_2009",
	[t.DESIGN_2011] = "key_bprint_2011",
	[t.DESIGN_2013] = "key_bprint_2013",
	[t.DESIGN_2015] = "key_bprint_2015",
	[t.DESIGN_2016] = "key_bprint_2016",
	[t.DESIGN_2019] = "key_bprint_2019",
	[t.DESIGN_2020] = "key_bprint_2020",
	[t.DESIGN_2021] = "key_bprint_2021",
	[t.DESIGN_2022] = "key_bprint_2022",
	[t.DESIGN_2023] = "key_bprint_2023",
	[t.DESIGN_2024] = "key_bprint_2024",
	[t.DESIGN_2025] = "key_bprint_2025",
	[t.DESIGN_2026] = "key_bprint_2026",
	[t.DESIGN_2027] = "key_bprint_2027",
	[t.DESIGN_3001] = "key_item_3001",
}
...
if TppDefine.GMP_COST_TYPE then
	n[TppDefine.GMP_COST_TYPE.FULTON] = "gmpCostFulton"
	n[TppDefine.GMP_COST_TYPE.SUPPORT_SUPPLY] = "gmpCostSupply"
	n[TppDefine.GMP_COST_TYPE.SUPPORT_ATTACK] = "gmpCostAttack"
	n[TppDefine.GMP_COST_TYPE.CALL_HELLI] = "gmpCostHeli"
	n[TppDefine.GMP_COST_TYPE.BUDDY] = "gmpCostOps"
	n[TppDefine.GMP_COST_TYPE.CLEAR_SIDE_OPS] = "gmpGet"
	n[TppDefine.GMP_COST_TYPE.DESTROY_SUPPORT_HELI] = "add_alt_machine"
end
...
function e.AddStaffsFromTempBuffer(t, n)
	...
	local o = TppMotherBaseManagement.IsExistTempStaff({ skill = "TranslateRussian" })
		...
		elseif n then
			...
			if e then
				TppReward.Push({
					...
					langId = e,
					rewardType = TppReward.TYPE.KEY_ITEM,
				})
			end
		end
	end
...
local r = {
	GROUP_A = {
		...
		proceedCount = 1,
		privilegeNameList = {
			"RESCUE_HOSTAGE_E20010_001",
			"RESCUE_HOSTAGE_E20010_002",
			"RESCUE_HOSTAGE_E20010_003",
			"RESCUE_HOSTAGE_E20010_004",
			"RESCUE_FRIENDMAN",
		},
	...
	GROUP_B = {
		...
		privilegeNameList = {
			"RESCUE_SP_HOSTAGE",
			"RESCUE_HOSTAGE_E20020_000",
			"RESCUE_HOSTAGE_E20020_001",
			"RESCUE_ENEMY_US_MISSION_TARGET_CENTER000",
			"RESCUE_ENEMY_US_MISSION_TARGET_SQUAD000",
		},
	...
	GROUP_C = {
		...
		proceedCount = 2,
		privilegeNameList = {
			"RESCUE_HOSTAGE_E20030_000",
			"RESCUE_HOSTAGE_E20030_001",
			"RESCUE_HOSTAGE_E20030_002",
			"RESCUE_E20030_BETRAYER",
			"RESCUE_E20030_MASTERMIND",
		},
	...
	GROUP_D = {
		...
		privilegeNameList = {
			...
			"RESCUE_HOSTAGE_E20050_001",
			"RESCUE_HOSTAGE_E20050_002",
			"RESCUE_HOSTAGE_E20050_003",
			"RESCUE_GENOME_SOILDER_SAVE",
		},
...
local n = {
	[t.STAFF_UNIQUE_TYPE_ID_OCELOT] = TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE,
	[t.STAFF_UNIQUE_TYPE_ID_MILLER] = TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE,
	[t.STAFF_UNIQUE_TYPE_ID_HEUY] = TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_HUEY,
		...
		MotherBaseManagement = {
			{
				msg = "AssignedStaff",
				func = function(n, e)
					if (n == t.SECTION_SEPARATION) and (e > 0) then
						gvars.trm_doneIsolateByManual = true
						if
							(
								TppMission.IsFreeMission(vars.missionCode)
								or TppMission.IsHelicopterSpace(vars.missionCode)
							) and TppRadio.IsRadioPlayable()
						then
...
function e.OnMessage(M, _, o, r, n, a, t)
	Tpp.DoMessage(e.messageExecTable, TppMission.CheckMessageOption, M, _, o, r, n, a, t)
end
function e.OnFultonMessage(e, a, n, t)
	mvars.trm_fultonInfo = mvars.trm_fultonInfo or {}
	mvars.trm_fultonInfo[e] = { e, a, n, t }
end
function e.OnFultonInfoMessage(n, a)
	mvars.trm_fultonInfo = mvars.trm_fultonInfo or {}
	local t = mvars.trm_fultonInfo[n]
	if t then
		e.OnFulton(t[1], t[2], t[3], t[4], nil, nil, a)
...
function e.SetUp()
	...
	if e.IsReleaseSection("Combat") then
		e.EnableDvcMenuByList({ { menu = e.MBDVCMENU.MBM_COMBAT, active = true } })
	end
...
function e.SetUpCustomWeaponMBDVCMenu()
	...
	do
		e.EnableDvcMenuByList({ { menu = e.MBDVCMENU.MBM_CUSTOM_WEAPON, active = true } })
	end
end
function e.SetUpBuddyMBDVCMenu()
	...
	e.EnableDvcMenuByList({ { menu = e.MBDVCMENU.MSN_BUDDY, active = true } })
	e.EnableDvcMenuByList({ { menu = e.MBDVCMENU.MSN_BUDDY_EQUIP, active = true } })
	local t = {
		HORSE = BuddyType.HORSE,
		DDOG = BuddyType.DOG,
		QUIET = BuddyType.QUIET,
		WALKER_GEAR = BuddyType.WALKER_GEAR,
		BATTLE_GEAR = BuddyType.BATTLE_GEAR,
	}
	for n, t in pairs(t) do
...
function e.OnFulton(t, a, n, o, _, M, r)
	if M then
		mvars.trm_needHeliSoundOnAddStaffsFromTempBuffer = true
	end
	TppEnemy.SetRecovered(t)
	TppEnemy.ExecuteOnRecoveredCallback(t, a, n, o, _, M, r)
	if Tpp.IsLocalPlayer(r) then
		TppEnemy._OnFulton(t, a, n, o)
	end
	e.DoFuncByFultonTypeSwitch(
		...
		e.OnFultonVehicle,
		e.OnFultonContainer,
		e.OnFultonGimmickCommon,
		e.OnFultonBuddy,
		e.OnFultonEnemyWalkerGear,
		e.OnFultonAnimal,
		e.OnFultonBossQuiet,
		e.OnFultonParasiteSquad
	)
end
function e.IncrementFultonCount()
...
function e.OnFultonHostage(t, n, n, a, r, o)
	local M = TppMotherBaseManagement.GetTempStaffStatusFromGameObject({ gameObjectId = t })
	local n
	if a then
		n = a
	...
	if Tpp.IsLocalPlayer(o) then
		...
		Tpp.IncrementPlayData("totalRescueCount")
		local e = GameObject.SendCommand(t, { id = "IsFemale" })
		if e then
			TppTrophy.Unlock(31)
		end
	end
...
function e.OnFultonVehicle(a, a, a, t, a, n)
	if mvars.trm_isSkipAddResourceToTempBuffer then
		return
	end
	e.AddTempResource(t, nil, n)
end
function e.OnFultonContainer(a, t, n, o, o, r)
	if mvars.trm_isSkipAddResourceToTempBuffer then
		return
	end
	if TppMission.IsFOBMission(vars.missionCode) then
		...
		local e = TppGimmick.GetGimmickID(a, t, n)
		if not e then
			e = "commFacility_cntn001"
		end
		Gimmick.CallFindContainerResourceLog(e)
		TppMotherBaseManagement.AddTempGimmickResource({ gimmickName = e })
	end
end
e.GIMMICK_RESOURCE_ID_TABLE = {
	[1845465265] = t.RESOURCE_ID_EMPLACEMENT_GUN_EAST,
	[2207998916] = t.RESOURCE_ID_EMPLACEMENT_GUN_WEST,
...
function e.OnFultonAnimal(a, n)
	...
	e.AddTempDataBaseAnimal(n, tostring(mvars.animalBlockAreaName))
end
					...
					(
						(
							(
								(
									(
										TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1900 })
										or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1901 })
									) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1902 })
								) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1903 })
							)
							and (
								(
									(
										TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1910 })
										or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1911 })
									) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1912 })
								) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1913 })
							)
						)
						and (
							(
								(
									TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1920 })
									or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1921 })
								) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1922 })
							) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1923 })
						)
					)
					and (
						(
							(
								TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1930 })
								or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1931 })
							) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1932 })
						) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1933 })
					)
				)
				and (
					(
						(
							(
								(
									(
										(
											TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1940 })
											or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1941 })
										) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1942 })
									) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1943 })
								) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1944 })
							) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1945 })
						) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1946 })
					) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1947 })
				)
			)
			and (
				(
					(
						(
							(
								(
									(
										TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1950 })
										or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1951 })
									) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1952 })
								) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1953 })
							) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1954 })
						) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1955 })
					) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1956 })
				) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1957 })
			)
		)
		and (
			(
				(
					(
						(
							(
								(
									TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1960 })
									or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1961 })
								) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1962 })
							) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1963 })
						) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1964 })
					) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1965 })
				) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1966 })
			) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1967 })
		)
	)
		and (
			(
				(
					(
						(
							(
								(
									TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1970 })
									or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1971 })
								) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1972 })
							) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1973 })
						) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1974 })
					) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1975 })
				) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1976 })
			) or TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_1977 })
		)
end
function e.IsRecoveredCompleatedHorse()
	return (
		TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_200 })
		and TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_210 })
	) and TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_220 })
end
function e.IsRecoveredCompleatedDog()
	return (
		TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_100 })
		and TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_110 })
	) and TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_120 })
end
function e.IsRecoveredCompleatedBear()
	return TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_600 })
		and TppMotherBaseManagement.IsGotDataBase({ dataBaseId = t.ANIMAL_610 })
end
function e.GetAnimalTypeCountFromRecoveredHistory(n)
	local e = 0
...
function e.OnFultonBossQuiet(t, t, t, t)
	local t = i({ type = "TppBossQuiet2" }, { id = "GetQuietType" })
...
function e.AddTempResource(t, a, n)
	local n = n or 0
...
function e.AddTempDataBaseAnimal(e, t)
...
function e.AddPickedUpResourceToTempBuffer(t, a)
	...
	if TppCollection.IsHerbByType(t) then
		local t = Player.GetRateOfGettingHarb()
		e = e * t
...
function e.TerminalVoiceWeatherForecast(t)
	local n = {
		[TppDefine.WEATHER.SUNNY] = "VOICE_WEATHER_CLAER",
		[TppDefine.WEATHER.CLOUDY] = nil,
		[TppDefine.WEATHER.RAINY] = nil,
		[TppDefine.WEATHER.SANDSTORM] = "VOICE_WEATHER_SANDSTORM",
		[TppDefine.WEATHER.FOGGY] = nil,
	}
	local a = {
		[TppDefine.WEATHER.SUNNY] = "weather_sunny",
		[TppDefine.WEATHER.CLOUDY] = "weather_cloudy",
		[TppDefine.WEATHER.RAINY] = "weather_rainy",
		[TppDefine.WEATHER.SANDSTORM] = "weather_sandstorm",
		[TppDefine.WEATHER.FOGGY] = "weather_foggy",
	}
	local n = n[t]
	local t = a[t]
	if n then
...
function e.TerminalVoiceOnSunSet()
	...
	e.PlayTerminalVoice("VOICE_SUN_SET")
...
function e.TerminalVoiceOnSunRise()
	...
	e.PlayTerminalVoice("VOICE_SUN_RISE")
...
e.SectionOpenCondition = {
	...
	Medical = e.IsReleaseMedicalSection,
	Security = function()
...
function e.OnEstablishMissionClear()
	...
	if e.IsBuiltAnimalPlatform() and not gvars.trm_isPushRewardAnimalPlatform then
		...
		TppReward.Push({
			category = TppScriptVars.CATEGORY_MB_MANAGEMENT,
			langId = "reward_107",
			rewardType = TppReward.TYPE.COMMON,
		})
	end
	if e.IsReleaseSection("Security") then
	...
	if n >= TppDefine.STORY_SEQUENCE.CLEARD_FIND_THE_SECRET_WEAPON then
		local t = {
			t.DEPLOY_MISSION_ID_SEQ_1001,
			t.DEPLOY_MISSION_ID_SEQ_1002,
			t.DEPLOY_MISSION_ID_SEQ_1003,
			t.DEPLOY_MISSION_ID_SEQ_1004,
			t.DEPLOY_MISSION_ID_SEQ_1005,
			t.DEPLOY_MISSION_ID_SEQ_1006,
			t.DEPLOY_MISSION_ID_SEQ_1007,
		}
		e.OpenDeployMission(t)
	end
	if n >= TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_HUEY then
		local t = {
			t.DEPLOY_MISSION_ID_SEQ_1008,
			t.DEPLOY_MISSION_ID_SEQ_1009,
			t.DEPLOY_MISSION_ID_SEQ_1010,
			t.DEPLOY_MISSION_ID_SEQ_1011,
		}
		e.OpenDeployMission(t)
	end
	...
	if n >= TppDefine.STORY_SEQUENCE.CLEARD_OKB_ZERO then
		local t = {
			t.DEPLOY_MISSION_ID_SEQ_1015,
			t.DEPLOY_MISSION_ID_SEQ_1016,
			t.DEPLOY_MISSION_ID_SEQ_1017,
			t.DEPLOY_MISSION_ID_SEQ_1018,
			t.DEPLOY_MISSION_ID_SEQ_1019,
			t.DEPLOY_MISSION_ID_SEQ_1020,
		}
		e.OpenDeployMission(t)
	end
	if n >= TppDefine.STORY_SEQUENCE.CLEARD_OKB_ZERO then
...
function e._AddUniqueVolunteerStaff(t, n)
	if TppMotherBaseManagement.IsExistStaff({ uniqueTypeId = t }) then
		return
	end
	local e = false
	if n ~= nil then
	...
	local t = TppMotherBaseManagement.GenerateStaffParameter({ staffType = "Unique", uniqueTypeId = t })
	TppMotherBaseManagement.DirectAddStaff({ staffId = t, section = "Wait", isNew = true, specialContract = e })
	TppUiCommand.ShowBonusPopupStaff(t, n)
	return true
end
...
function e.PushRewardOnMbSectionOpen()
	for n, a in ipairs(e.MOTHER_BASE_SECTION_LIST) do
		local t = e.RewardLangIdTable[a]
		local e = e.IsReleaseSection(a)
		if e ~= nil and t then
			if e then
...
e.SectionFuncOpenCondition = {
	Combat = { DispatchSoldier = true, DispatchFobDefence = e.IsCleardRetakeThePlatform },
	Develop = {
		Weapon = true,
		SupportHelicopter = e.IsOpenMBDvcArmsMenu,
		Quiet = function()
		...
		SecurityDevice = e.IsConstructedFirstFob,
	},
	BaseDev = {
		Mining = true,
		Processing = true,
		Extention = true,
		Construct = e.IsCleardRetakeThePlatform,
		NuclearDevelop = e.IsReleaseFunctionNuclearDevelop,
	},
	Support = {
		Fulton = true,
		Supply = true,
		Battle = e.IsReleaseFunctionBattle,
		BattleArtillery = e.IsReleaseFunctionBattle,
		BattleSmoke = e.IsReleaseFunctionBattle,
		BattleSleepGas = e.IsReleaseFunctionBattle,
		BattleChaff = e.IsReleaseFunctionBattle,
	...
	Security = {
		...
		BaseBlockade = e.IsConstructedFirstFob,
		SecurityInfo = e.IsConstructedFirstFob,
	},
}
	...
	for n, t in pairs(E) do
		for o, r in pairs(t) do
			...
			if e.SectionFuncOpenCondition[n] then
				t = e.SectionFuncOpenCondition[n][o]
			end
			if t == true then
				a({ sectionFuncId = r, opened = true })
			elseif t then
				if t(n) then
					a({ sectionFuncId = r, opened = true })
				else
					a({ sectionFuncId = r, opened = false })
				end
			end
		end
	end
...
function e.InitializeBluePrintLocatorIdTable()
	...
	for t, e in pairs(e.BLUE_PRINT_LOCATOR_TABLE) do
		local t = TppCollection.GetUniqueIdByLocatorName(t)
		mvars.trm_bluePrintLocatorIdTable[t] = e
	end
end
