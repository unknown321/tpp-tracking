...
e.ResultRankJingle[TppDefine.MISSION_CLEAR_RANK.NOT_DEFINED] = "Set_Switch_bgm_jingle_result_cd"
e.afghCommonEsacapeBgm =
	{ bgm_escape = { start = "Play_bgm_afgh_mission_escape", finish = "Stop_bgm_afgh_mission_escape" } }
e.mafrCommonEsacapeBgm =
	{ bgm_escape = { start = "Play_bgm_mafr_mission_escape", finish = "Stop_bgm_mafr_mission_escape" } }
...
function e.PostEventForFultonRecover()
	...
	if
		(
			e == TppDefine.MISSION_START_RECOVER_DEMO_TYPE.WALKER_GEAR
			or e == TppDefine.MISSION_START_RECOVER_DEMO_TYPE.VEHICLE
		) or e == TppDefine.MISSION_START_RECOVER_DEMO_TYPE.NONE
	then
