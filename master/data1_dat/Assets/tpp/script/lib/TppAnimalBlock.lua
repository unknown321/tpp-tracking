...
local m = 5
e.CLOCK_MESSAGE_AT_NIGHT_FORMAT = "AnimalRouteChangeAtNight%02d"
e.CLOCK_MESSAGE_AT_MORNING_FORMAT = "AnimalRouteChangeAtMorning%02d"
e.weatherTable = {}
local l = 0
local o = 0
...
function e._InitializeCommonAnimalSetting(o, a, t)
	...
	local i = TppClock.GetTime("number")
	local n = 0
...
function e._AddClockMessage(n, t, a, r)
	...
	for a = r, m - 1 do
		...
		e._RegisterClockMessage(e.CLOCK_MESSAGE_AT_MORNING_FORMAT, i, t, false, a)
		o = o + 1
	end
end
...
function e.OnAllocate(a)
	...
	e._UpdateActiveAnimalBlock(t, a)
	function mvars.animalBlockScript.OnMessage(e, e, e, e, e, e, e) end
end
function e.OnTerminate()
	if mvars.animalBlockScript.DidInitialized then
		for a = 0, o - 1 do
			...
			t = string.format(e.CLOCK_MESSAGE_AT_MORNING_FORMAT, a)
			TppClock.UnregisterClockMessage(t)
		end
	end
	local e = d()
