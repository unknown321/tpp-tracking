	...
	for e, r in pairs(e) do
		...
		for r, l in pairs(r) do
			...
			elseif i(l) and f(l[d]) then
				r = a(l[T])
				local n = {}
				if (t(l[c]) == "string") or (t(l[c]) == "number") then
					n[1] = l[c]
				elseif i(l[c]) then
					n = l[c]
				end
			...
			if u then
				...
				if next(s) ~= nil then
					for l, t in pairs(s) do
						n[e][r].sender = n[e][r].sender or {}
						n[e][r].senderOption = n[e][r].senderOption or {}
...
function e.DoMessage(n, a, p, i, t, r, l, o, s)
	if not n then
		return
	end
	local n = n[p]
	...
	local i = true
	e.DoMessageAct(n, a, t, r, l, o, s, i)
end
function e.DoMessageAct(e, a, n, l, r, i, t)
	if e.func then
		if a(e.option) then
			e.func(n, l, r, i)
		end
...
function e.GetLocator(t, n)
	local n, t = e.GetLocatorByTransform(t, n)
	if n ~= nil then
...
function e.GetDataBodyWithIdentifier(t, e, n)
...
function e.CheckBlockArea(e, n, t)
	local i, l, r, e = e[1], e[2], e[3], e[4]
	if (((n >= i) and (n <= r)) and (t >= l)) and (t <= e) then
		return true
	end
	return false
end
function e.FillBlockArea(e, n, i, l, r, t)
	for n = n, l do
		e[n] = e[n] or {}
		for r = i, r do
			e[n][r] = t
...
function e.DEBUG_DunmpBlockArea(t, r, e)
	local n = "       "
	for e = 1, e do
...
function e.DEBUG_SetPreference(n, t, r)
