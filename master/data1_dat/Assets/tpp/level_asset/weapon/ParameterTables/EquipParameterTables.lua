...
TppEquip.ReloadEquipParameterTables({
	BlastParameter = {
		...
		{ TppEquip.BLA_BombAssist, 1, 20, 30 },
	...
	SupportWeaponParameter = {
		...
		{ TppEquip.SWP_AntitankMine, 4, 0.8, 360, 4 },
		{ TppEquip.SWP_AntitankMine_G01, 8, 0.8, 360, 5 },
		{ TppEquip.SWP_AntitankMine_G02, 12, 0.8, 360, 6 },
		...
		{ TppEquip.SWP_ElectromagneticNetMine, 4, 0.8, 5, 4 },
		{ TppEquip.SWP_ElectromagneticNetMine_G01, 8, 0.8, 10, 5 },
		{ TppEquip.SWP_ElectromagneticNetMine_G02, 12, 0.8, 20, 6 },
		...
		{ TppEquip.SWP_SleepingGusMine, 4, 0.8, 0, 4 },
		{ TppEquip.SWP_SleepingGusMine_G01, 8, 0.8, 0, 5 },
		{ TppEquip.SWP_SleepingGusMine_G02, 12, 0.8, 0, 6 },
