TppPadOperatorUtility = {
	Init = function()
		...
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			...
			masks = { exceptSetting = true, buttonNames = { "MB_DEVICE" } },
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
		...
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			...
			masks = { exceptSetting = false, buttonNames = { "MB_DEVICE" } },
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			registerName = "All",
			masks = { exceptSetting = true, buttonNames = {}, stickNames = {} },
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			registerName = "Hospital_Wait",
			masks = { exceptSetting = false, buttonNames = { "PL_HOLD" }, stickNames = { "PL_STICK_L" } },
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			registerName = "Hospital_DisableLStick_DEMO",
			masks = { exceptSetting = false, stickNames = { "PL_STICK_L" } },
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			registerName = "Hospital_DisableRStick",
			masks = { exceptSetting = false, stickNames = { "PL_STICK_R" } },
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			registerName = "Hospital_IshmaelStopSign",
			masks = { exceptSetting = false, stickNames = { "PL_STICK_L" }, buttonNames = { "PL_HOLD" } },
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			registerName = "CannotSubjectiveCamera",
			masks = { exceptSetting = false, buttonNames = { "PL_SUB_CAMERA" } },
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
		...
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			...
			masks = {
				exceptSetting = true,
				buttonNames = { "PL_SUB_CAMERA", "PL_CALL", "PL_ZOOM_CHANGE", "PL_ZOOM_IN", "PL_ZOOM_OUT" },
				stickNames = { "PL_STICK_R" },
			},
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			registerName = "OpenPresetRadio",
			masks = { exceptSetting = false, buttonNames = { "PL_SQUAT", "PL_ACTION", "PL_RELOAD", "PL_PICKUP_WEAPON" } },
		})
		TppPadOperatorUtility.RegisterPlayerMaskSettings({
			registerName = "CameraOnly",
			masks = { exceptSetting = true, buttonNames = {}, stickNames = { "PL_STICK_R" } },
		})
	end,
