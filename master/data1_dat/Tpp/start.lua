...
if
	(TppSystemUtility.GetCurrentGameMode() ~= "MGO" and TppGameSequence.GetTargetArea() == "Japan")
	and not SignIn.PresetUserIdExists()
then
	local e = SplashScreen.Create(
		"cesa",
		"/Assets/tpp/ui/ModelAsset/sys_logo/Pictures/common_cesa_logo_clp_nmp.ftex",
		1280,
		640
	)
	SplashScreen.Show(e, 0.5, 4, 0.5)
end
...
AssetConfiguration.RegisterExtensionInfo({
	extensions = { "tetl", "tmss", "tmsl", "tlsp", "tmsu", "tmsf", "twpf", "adm", "tevt", "vpc", "ends", "spch", "mbl" },
	categories = { "Target" },
})
...
AssetConfiguration.SetLanguageGroupExtention({
	group = { "Sound" },
	extensions = { "mas", "fsm", "sbp", "wem", "evf", "sani", "sad", "stm" },
})
local e = "jpn"
do
...
if TppSystemUtility.GetCurrentGameMode() ~= "MGO" then
	Player.CreateResidentMotionBlock({ size = ((6 * 1024) * 1024 - 8 * 1024) - (0.55 * 1024) * 1024 })
	Player.CreateResidentPartsBlock({ count = 1, size = (1.45 * 1024) * 1024 + 32 * 1024 })
	Player.RegisterCommonMotionPackagePath(
		"DefaultCommonMotion",
		"/Assets/tpp/pack/player/motion/player2_resident_motion.fpk",
		"/Assets/tpp/motion/motion_graph/player2/TppPlayer2_layers.mog"
	)
	Player.RegisterCommonMtarPath(
		"/Assets/tpp/motion/mtar/player2/player2_resident.mtar",
		"/Assets/tpp/motion/mtar/player2/TppPlayer2Facial.mtar"
	)
else
	...
	if e then
		...
		Player.RegisterCommonMotionPackagePath(
			"DefaultCommonMotion",
			"/Assets/mgo/pack/player/motion/mgo_player_resident_motion.fpk",
			"/Assets/mgo/motion/motion_graph/player/MgoPlayer_layers.mog"
		)
		Player.RegisterCommonMotionPackagePath(
			"MgoCommonMotion",
			"/Assets/mgo/pack/player/motion/mgo_player_resident_motion.fpk",
		...
		Player.RegisterCommonMtarPath(
			"/Assets/mgo/motion/mtar/player/mgoplayer_resident.mtar",
			"/Assets/tpp/motion/mtar/player2/TppPlayer2Facial.mtar"
		)
	end
end
...
if TppSystemUtility.GetCurrentGameMode() ~= "MGO" then
	Player.RegisterPartsPackagePath(
		"PLTypeNormal",
...
if TppSoldier2CommonBlockController then
	...
	TppSoldier2CommonBlockController.SetPackagePathWithPrerequisites({
		path = "/Assets/tpp/pack/soldier/common/Soldier2Common.fpk",
	})
end
if TppSystemUtility.GetCurrentGameMode() == "MGO" then
	...
	TppEquip.CreateResidentBlockGroups({
		commonBlockSize = (1.9 * 1024) * 1024,
		primary1BlockSize = (0.55 * 1024) * 1024,
		primary2BlockSize = (0.55 * 1024) * 1024,
		secondaryBlockSize = (0.34 * 1024) * 1024,
	})
...
if TppSystemUtility.GetCurrentGameMode() == "MGO" and MgoActorBlockControllerService then
	MgoActorBlockControllerService:SetBlockInfo(
		MgoActor.MGO_ACTOR_BLOCK_PARTS,
		"/Assets/mgo/pack/actor/actor_parts.fpk",
		2048
	)
end
if Editor then
...
TppMotherBaseManagement.SetMbsContainerParam({
	commonMetalContainerCount = 12,
	minorMetalContainerCount = 5,
	preciousMetalContainerCount = 9,
	fuelResourceContainerCount = 14,
	bioticResourceCount = 3,
})
TppMotherBaseManagement.SetMbsClusterSecurityParam({
	isNoKillMode = false,
	securitySoldierRank = "C",
	securitySoldierEquipGrade = 5,
	securitySoldierEquipRange = 1,
})
TppMotherBaseManagement.SetMbsPlatformSecurityParam({
	platform = "Special",
	soldierQuantity = "Middle",
	irSensorQuantity = "Small",
	cameraQuantity = "Large",
	decoyQuantity = "Middle",
	mineQuantity = "Large",
	uavQuantity = "Small",
	importantCautionAreas = { false, true, true, false, false, true, true, false },
})
TppMotherBaseManagement.SetMbsPlatformSecurityParam({
	platform = "Common1",
	soldierQuantity = "Middle",
...
t()
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/mission2/story/s10150/s10150_block01.fox2",
	1
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/slopedTown/afgh_slopedTown_gimmick.fox2",
	2
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/fort/afgn_fort_gimmick.fox2",
	17
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
...
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/cliffTown/afgh_cliffTown_gimmick.fox2",
	6
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/powerPlant/afgh_powerPlant_gimmick.fox2",
	7
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/tent/afgh_tent_gimmick.fox2",
	8
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_small/124/124_144/afgh_124_144_gimmick.fox2",
	9
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/remnants/afgh_remnants_gimmick.fox2",
	10
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/enemyBase/afgh_enemyBase_gimmick.fox2",
	11
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/commFacility/afgh_commFacility_gimmick.fox2",
	12
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/village/afgh_village_gimmick.fox2",
	13
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_large/sovietBase/afgh_sovietBase_asset.fox2",
	14
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_large/hill/mafr_hill_gimmick.fox2",
	15
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_large/diamond/mafr_diamond_gimmick.fox2",
	16
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_large/pfCamp/mafr_pfCamp_gimmick.fox2",
	3
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
...
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_large/banana/mafr_banana_gimmick.fox2",
	19
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_large/savannah/mafr_savannah_gimmick.fox2",
	20
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_large/swamp/mafr_swamp_gimmick.fox2",
	30
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_large/flowStation/mafr_flowStation_gimmick.fox2",
	27
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_large/outland/mafr_outland_gimmick.fox2",
	23
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_small/146/146_138/mafr_146_138_gimmick.fox2",
	24
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_small/144/144_127/mafr_144_127_gimmick.fox2",
	25
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mafr/block_small/149/149_116/mafr_149_116_gimmick.fox2",
	26
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_small/141/141_129/afgh_141_129_gimmick.fox2",
	22
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_small/136/136_138/afgh_136_138_gimmick.fox2",
	28
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_small/147/147_123/afgh_147_123_gimmick.fox2",
	29
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/afgh/block_small/141/141_147/afgh_141_147_gimmick.fox2",
	21
)
Gimmick.RegisterCassetteToRadio(
	"afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001",
	"/Assets/tpp/level/location/mtbs/block_large/mtbs_qrntnFacility_gimmick.fox2",
	31
)
t()
