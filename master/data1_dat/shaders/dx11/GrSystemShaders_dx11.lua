...
local x = {
	...
	{ technique = "fox_2d_Basic_LyBL_CenteringScreen", type = "Forward", variation = "", shader = "Draw2D_Ui2_BL_CenteringScreen" },
...
local a = {
	...
	},
	{
		...
		equations = { { index = "0", type = "float", lValue = "Blend_ScreenTex", lSwizzle = "0", rValue = "0.0", rSwizzle = "-1" } },
		conditions = { { conditionFlag = "1", techniqueName = "fox_2d_NoBase_LodLayerScreen" } },
	},
}
