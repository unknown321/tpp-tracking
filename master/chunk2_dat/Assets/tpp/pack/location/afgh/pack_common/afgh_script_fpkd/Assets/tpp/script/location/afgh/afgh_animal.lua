...
afgh_animal.habitatTable = {

	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_100,
				iconPos = Vector3(1572.077, 367.495, 541.622),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1900,
				iconPos = Vector3(1090.559, 343.381, 550.907),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1900,
				iconPos = Vector3(-294.032, 330.505, 294.244),
				radius = 6,
			},
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_500,
				iconPos = Vector3(-309.269, 341.626, 262.416),
				radius = 8,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_600,
				iconPos = Vector3(-342.726, 321.078, 798.033),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1920,
				iconPos = Vector3(588.304, 323.132, 1784.641),
				radius = 7,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1900,
				iconPos = Vector3(-1342.886, 296.001, 1205.265),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1900,
				iconPos = Vector3(1270.328, 352.691, 1227.353),
				radius = 7,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1920,
				iconPos = Vector3(1310.198, 315.216, 1903.136),
				radius = 6,
			},
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_500,
	...
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1900,
				iconPos = Vector3(413.284, 313.532, 178.215),
				radius = 6,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1900,
				iconPos = Vector3(642.958, 345.206, 846.566),
				radius = 5,
			},
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_2240,
				iconPos = Vector3(751.818, 353.351, 929.483),
				radius = 7,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1900,
				iconPos = Vector3(87.549, 326.029, 890.241),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1920,
				iconPos = Vector3(-1740.180, 349.465, -298.084),
				radius = 7,
			},

			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_2241,
				iconPos = Vector3(-1740.180, 349.465, -298.084),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1900,
				iconPos = Vector3(-1108.139, 404.353, -873.506),
				radius = 6,
			},
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1430,
				iconPos = Vector3(-1097.162, 433.826, -985.501),
				radius = 8,
			},
		},
	},
		...
		areaMembers = {
			{
				...
				iconPos = Vector3(1044.528, 461.581, -1415.157),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_100,
				iconPos = Vector3(-1362.906, 543.199, -2548.654),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_600,
				iconPos = Vector3(1481.427, 381.846, -226.986),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_100,
				iconPos = Vector3(371.162, 414.099, -854.827),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_100,
				iconPos = Vector3(-385.796, 478.739, -1078.716),
				radius = 5,
			},
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1430,
				iconPos = Vector3(-433.720, 457.531, -862.648),
				radius = 7,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_100,
				iconPos = Vector3(-1423.140, 494.969, -1871.319),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_100,
				iconPos = Vector3(-1948.141, 432.695, -1162.204),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_100,
				iconPos = Vector3(-173.997, 276.592, 1843.571),
				radius = 6,
			},
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1300,
				iconPos = Vector3(-314.876, 283.115, 1853.356),
				radius = 8,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_200,
				iconPos = Vector3(2046.934, 366.790, -193.515),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_200,
				iconPos = Vector3(2247.978, 394.752, -1154.267),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1900,
				iconPos = Vector3(-1873.381, 326.954, 575.254),
				radius = 5,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1200,
				iconPos = Vector3(832.0, 482.845, -1088.0),
				radius = 5,
			},
		},
	},

	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_510,
				iconPos = Vector3(-1597.404, 382.155, -699.864),
				radius = 4,
			},
		},
	},
	{
		...
		areaMembers = {
			{
				animalGroupId = TppMotherBaseManagementConst.ANIMAL_1310,
				iconPos = Vector3(-1366.199, 311.377, 929.335),
				radius = 4,
			},
		},
	},
		...
		areaMembers = {
			{
				...
				iconPos = Vector3(-1332.182, 400.808, -487.316),
				radius = 4,
			},
		},
	},
...
afgh_animal.animalMaterial = {
	...
	[TppMotherBaseManagementConst.ANIMAL_1430] = {
		CaptureCageMaterial.MTR_ROCK_B,
		CaptureCageMaterial.MTR_SOIL_B,
		CaptureCageMaterial.MTR_GRAV_A,
	},
	[TppMotherBaseManagementConst.ANIMAL_2200] = SOIL_MATERIAL,
	[TppMotherBaseManagementConst.ANIMAL_2240] = {
		CaptureCageMaterial.MTR_SOIL_B,
		CaptureCageMaterial.MTR_SOIL_C,
		CaptureCageMaterial.MTR_GRAV_A,
	},
	...
	[TppMotherBaseManagementConst.ANIMAL_1310] = {
		CaptureCageMaterial.MTR_SOIL_B,
		CaptureCageMaterial.MTR_GRAV_A,
		CaptureCageMaterial.MTR_ROCK_B,
	},
