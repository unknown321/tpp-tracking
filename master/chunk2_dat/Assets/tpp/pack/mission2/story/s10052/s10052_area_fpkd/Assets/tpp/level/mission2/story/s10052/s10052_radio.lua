...
this.ArrivedTent = function()
	Fox.Log(
		"#### s10052_radio.ArrivedTent #### isTargetMarked = "
...
this.CheckSituationAndPlayRadio = function()
	...
	if situationTable.event[5].allow <= svars.eventCount and situationTable.event[5].deny >= svars.eventCount then
	...
	elseif situationTable.event[4].allow <= svars.eventCount and situationTable.event[4].deny >= svars.eventCount then
	...
	elseif situationTable.event[3].allow <= svars.eventCount and situationTable.event[3].deny >= svars.eventCount then
	...
	elseif situationTable.event[2].allow <= svars.eventCount and situationTable.event[2].deny >= svars.eventCount then
	...
	elseif situationTable.event[1].allow <= svars.eventCount and situationTable.event[1].deny >= svars.eventCount then
