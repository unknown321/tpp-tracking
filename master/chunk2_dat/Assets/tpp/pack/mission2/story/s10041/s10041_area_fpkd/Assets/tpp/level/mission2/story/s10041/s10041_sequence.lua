...
function this.AddHighInterrogationAfterMeeting()
	...
	if TppEnemy.IsEliminated(s10041_enemy.ENEMY_NAME.FIELD_VIP) == false and svars.isIdentifiedVillageVip == false then
...
function this.HighInterrogationAbortMeeting()
	...
	if
		TppEnemy.IsEliminated(s10041_enemy.ENEMY_NAME.VILLAGE_VIP) == false
		and svars.isIdentifiedVillageVip == false
	then
		Fox.Log("### AddHighInterrogation positionVillageVip #### ")
...
function this.EliminateThirdTarget(EliminateRadioType)
	...
	elseif
		EliminateRadioType == this.vipKillType.FULLTON_NOT_IDENTIFIED
		or EliminateRadioType == this.vipKillType.HELI_NOT_IDENTIFIED
	then
...
function this.EliminateSecondTarget(EliminateRadioType)
	...
	elseif
		EliminateRadioType == this.vipKillType.FULLTON_IDENTIFIED
		or EliminateRadioType == this.vipKillType.HELI_IDENTIFIED
	then
	...
	if
		TppEnemy.IsEliminated(s10041_enemy.ENEMY_NAME.FIELD_VIP) == true
		and TppEnemy.IsEliminated(s10041_enemy.ENEMY_NAME.ENEMYBASE_VIP) == true
	then
...
StrCode32Table({
		...
		GameObject = {
...

			{
				msg = "Dead",
				sender = {
					s10041_enemy.BONUS_HOSTAGE_NAME.HOSTAGE_00,
...
this.missionObjectiveDefine = {
	s10041_marker_village = {
		gameObjectName = "s10041_marker_village",
		visibleArea = 4,
		randomRange = 0,
		viewType = "all",
		setNew = false,
	...
	marker_meetingPoint = {
		gameObjectName = "s10041_marker_meetingPoint",
		visibleArea = 1,
		randomRange = 0,
		viewType = "all",
		setNew = false,
	...
	marker_meetingPointIntel = {
		gameObjectName = "s10041_marker_meetingPointIntel",
		visibleArea = 1,
		randomRange = 0,
		viewType = "all",
		setNew = true,
	...
	marker_fieldVip = {
		gameObjectName = "s10041_marker_field",
		visibleArea = 5,
		randomRange = 0,
		viewType = "all",
		setNew = false,
	...
	marker_enemyBaseVip = {
		gameObjectName = "s10041_marker_enemyBase",
		visibleArea = 5,
		randomRange = 0,
		viewType = "all",
		setNew = false,
	...
	target_vip_village = {
		gameObjectName = "sol_vip_village",
		goalType = "attack",
	...
	target_vip_enemyBase = {
		gameObjectName = "sol_vip_enemyBase",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = true,
	...
	marker_veh_s10041_VipEnemyBase = {
		gameObjectName = "veh_s10041_VipEnemyBase",
		goalType = "none",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = false,
	...
	marker_veh_s10041_VipField = {
		gameObjectName = "veh_s10041_VipField",
		goalType = "none",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = false,
	...
	route_vip_field_arrival = {
		showEnemyRoutePoints = {
			groupIndex = GROUP_FIELD_VIP_ARRIVAL_ROUTE,
			width = 200.0,
		...
		spySearch = {
			gameObjectName = s10041_enemy.ENEMY_NAME.FIELD_VIP,
			isNew = true,
			langId = "marker_info_mission_target",
		},
	},
	route_vip_field_departure = {
		showEnemyRoutePoints = {
			groupIndex = GROUP_ENEMY_BASE_VIP_ARRIVAL_ROUTE,
			width = 200.0,
			langId = "marker_target_forecast_path",
			radioGroupName = "f1000_mprg0260",
			points = {
	...
	route_vip_enemyBase_arrival = {
		showEnemyRoutePoints = {
			groupIndex = GROUP_ENEMY_BASE_VIP_DEPARTURE_ROUTE,
			width = 200.0,
			langId = "marker_target_forecast_path",
			radioGroupName = "f1000_mprg0260",
			points = {
		...
		spySearch = {
			gameObjectName = s10041_enemy.ENEMY_NAME.ENEMYBASE_VIP,
			isNew = true,
			langId = "marker_info_mission_target",
		},
	},
	...
	Area_marker_SubTarget = {
		gameObjectName = "s10041_marker_SubTarget",
		visibleArea = 4,
		randomRange = 0,
		viewType = "all",
		setNew = false,
...
function this.MissionPrepare()
	...
	TppMarker.SetUpSearchTarget({
		{
			gameObjectName = TARGET_FIELD_VIP_NAME,
			gameObjectType = "TppSoldier2",
			messageName = TARGET_FIELD_VIP_NAME,
			skeletonName = "SKL_004_HEAD",
			func = this.UpdateMarkerFoundFieldVip,
			objectives = { "hud_photo_field" },
		},
		{
			gameObjectName = TARGET_VILLAGE_VIP_NAME,
			gameObjectType = "TppSoldier2",
			messageName = TARGET_VILLAGE_VIP_NAME,
			skeletonName = "SKL_004_HEAD",
			func = this.UpdateMarkerFoundVillageVip,
			objectives = { "hud_photo_village" },
		},
		{
			gameObjectName = TARGET_ENEMYBASE_VIP_NAME,
			gameObjectType = "TppSoldier2",
			messageName = TARGET_ENEMYBASE_VIP_NAME,
			skeletonName = "SKL_004_HEAD",
			func = this.UpdateMarkerFoundenemyBaseVip,
			objectives = { "hud_photo_enemyBase" },
		},
	})
			...
			GameObject = {
...

				{
					...
					func = function(cpGameObjectId, speechLabel, isSuccess)
						Fox.Log(
							"this.Messages(): ConversationEnd Message Received. gameObjectId:"
				...
				},
				{
					...
					func = function(GameObjectId, phaseName)
						if phaseName >= TppEnemy.PHASE.ALERT then
							if
								GameObjectId == GameObject.GetGameObjectId(s10041_enemy.ENEMY_NAME.FIELD_VIP)
								and svars.isCancelMeetingFieldVip == false
							then
								Fox.Log("*** field vip change phase ***")
								s10041_enemy.CancelTravelFieldVip(phaseName)
							elseif
								GameObjectId == GameObject.GetGameObjectId(s10041_enemy.ENEMY_NAME.FIELD_DRIVER)
								and svars.isCancelMeetingFieldVip == false
							then
								Fox.Log("*** field Driver change phase ***")
								s10041_enemy.CancelTravelFieldVip(phaseName)
							elseif
								GameObjectId == GameObject.GetGameObjectId(s10041_enemy.ENEMY_NAME.FIELD_GUARD_00)
								and svars.isCancelMeetingFieldVip == false
							then
								Fox.Log("*** field Guard change phase ***")
								s10041_enemy.CancelTravelFieldVip(phaseName)
							elseif
								GameObjectId == GameObject.GetGameObjectId(s10041_enemy.ENEMY_NAME.ENEMYBASE_VIP)
								and svars.isCancelMeetingEnemyBaseVip == false
							then
								Fox.Log("*** emenybase vip change phase ***")
								s10041_enemy.CancelTravelEnemyBaseVip(phaseName)
							elseif
								GameObjectId
									== GameObject.GetGameObjectId(s10041_enemy.ENEMY_NAME.ENEMYBASE_DRIVER)
								and svars.isCancelMeetingEnemyBaseVip == false
							then
								Fox.Log("*** emenybase vip change phase ***")
								s10041_enemy.CancelTravelEnemyBaseVip(phaseName)
							elseif
								GameObjectId
									== GameObject.GetGameObjectId(s10041_enemy.ENEMY_NAME.ENEMYBASE_GUARD_00)
								and svars.isCancelMeetingEnemyBaseVip == false
							then
								Fox.Log("*** emenybase vip change phase ***")
								s10041_enemy.CancelTravelEnemyBaseVip(phaseName)
			...
			GameObject = {
				{
					...
					func = function(cpGameObjectId, speechLabel, isSuccess)
						...
						if
							speechLabel == s10041_enemy.voiceTable.Cancel.villageVip
							or speechLabel == s10041_enemy.voiceTable.Cancel.fieldVip
							or speechLabel == s10041_enemy.voiceTable.Cancel.enemyBaseVip
						then
...
function this.OnEstablishMissionClear(missionClearType)
	...
	if svars.isRadioHearMeeting == false then
		...
		if svars.isReturn_fieldVip == true or svars.isReturn_enemyBaseVip == true then
