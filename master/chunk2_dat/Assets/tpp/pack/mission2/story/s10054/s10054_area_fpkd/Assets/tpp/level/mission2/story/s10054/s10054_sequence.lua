...
function this.OptRadioControl_Setting()
	...
	if sequence == "Seq_Game_MainGame" then
		if
			svars.isTargrtCount_Clear + svars.isTargetCount_areaOut >= 0
			and svars.isTargrtCount_Clear + svars.isTargetCount_areaOut <= 1
		then
		...
		elseif
			svars.isTargrtCount_Clear + svars.isTargetCount_areaOut >= 3
			and svars.isTargrtCount_Clear + svars.isTargetCount_areaOut <= 4
		then
...
this.missionObjectiveDefine = {
	...
	hostage_remnants = {
		gameObjectName = "hos_s10054_0003",
		goalType = "defend",
		setNew = true,
	...
	hostage_enemyBase = {
		gameObjectName = "hos_s10054_0004",
		goalType = "defend",
		setNew = true,
		viewType = "map_and_world_only_icon",
		announceLog = "updateMap",
	...
	VAGUE_VEHICLE_POS_01 = {
		gameObjectName = "Marker_Target01_vague",
		visibleArea = 5,
		randomRange = 9,
		setNew = false,
		viewType = "all",
		...
		mapRadioName = "f1000_mprg0220",
	},
	VAGUE_VEHICLE_POS_02 = {
		gameObjectName = "Marker_Target02_vague",
		visibleArea = 5,
		randomRange = 9,
		setNew = false,
		viewType = "all",
		announceLog = "updateMap",
		langId = "marker_info_mission_targetArea",
		mapRadioName = "f1000_mprg0230",
	},

	VAGUE_VEHICLE_01 = {
		gameObjectName = TARGET_VEHICLE_01,
		visibleArea = 5,
		randomRange = 9,
		setNew = false,
		viewType = "all",
	...
	VAGUE_VEHICLE_02 = {
		gameObjectName = TARGET_VEHICLE_02,
		visibleArea = 5,
		randomRange = 9,
		setNew = false,
		viewType = "all",
	...
	VAGUE_VEHICLE_04 = {
		gameObjectName = TARGET_VEHICLE_04,
		visibleArea = 5,
		randomRange = 9,
		setNew = true,
		viewType = "all",
	...
	VAGUE_VEHICLE_05 = {
		gameObjectName = TARGET_VEHICLE_05,
		visibleArea = 5,
		randomRange = 9,
		setNew = true,
		viewType = "all",
	...
	VAGUE_VEHICLE_06 = {
		gameObjectName = TARGET_VEHICLE_06,
		visibleArea = 5,
		randomRange = 9,
		setNew = true,
		viewType = "all",
	...
	VAGUE_VEHICLE_07 = {
		gameObjectName = TARGET_VEHICLE_07,
		visibleArea = 5,
		randomRange = 9,
		setNew = true,
		viewType = "all",
	...
	VAGUE_TRUCK_01 = {
		gameObjectName = BULLET_TRUCK_01,
		visibleArea = 5,
		randomRange = 9,
		setNew = true,
		viewType = "all",
	...
	VAGUE_BONUS_04 = {
		gameObjectName = BONUS_HELI,
		visibleArea = 7,
		randomRange = 9,
		setNew = true,
		viewType = "all",
		announceLog = "updateMap",
		langId = "marker_info_heli_battle",
	},
	...
	FIXED_HOSTAGE_VEHICLE = {
		gameObjectName = "hos_s10054_0001",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		setImportant = true,
		announceLog = "updateMap",
	...
	movingHostage_01 = {
		gameObjectName = "Marker_movingHostage_MNT",
		visibleArea = 4,
		randomRange = 0,
		setNew = true,
	...
	movingHostage_02 = {
		gameObjectName = "Marker_movingHostage_RVR",
		visibleArea = 5,
		randomRange = 0,
		setNew = true,
		viewType = "map_only_icon",
	...
	movingHostage_03 = {
		gameObjectName = "Marker_movingHostage_SND",
		visibleArea = 5,
		randomRange = 0,
		setNew = true,
		viewType = "map_only_icon",
	...
	searchEnemy_01 = {
		gameObjectName = "sol_search_0000",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		announceLog = "updateMap",
	},
	searchEnemy_02 = {
		gameObjectName = "sol_search_0001",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		announceLog = "updateMap",
	},
	searchEnemy_03 = {
		gameObjectName = "sol_search_0002",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		announceLog = "updateMap",
	},
	searchEnemy_04 = {
		gameObjectName = "sol_search_0003",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		announceLog = "updateMap",
	},
...
function this.MissionPrepare()
	...
	TppMission.RegisterMissionSystemCallback({
		...
		OnRecovered = function(gameObjectId)
			if
				gameObjectId == GameObject.GetGameObjectId("sol_search_0000")
				or gameObjectId == GameObject.GetGameObjectId("sol_search_0001")
				or gameObjectId == GameObject.GetGameObjectId("sol_search_0002")
				or gameObjectId == GameObject.GetGameObjectId("sol_search_0003")
			then
			...
			elseif
				gameObjectId == GameObject.GetGameObjectId("hos_s10054_0000")
				or gameObjectId == GameObject.GetGameObjectId("hos_s10054_0001")
				or gameObjectId == GameObject.GetGameObjectId("hos_s10054_0002")
				or gameObjectId == GameObject.GetGameObjectId("hos_s10054_0003")
				or gameObjectId == GameObject.GetGameObjectId("hos_s10054_0004")
				or gameObjectId == GameObject.GetGameObjectId("hos_s10054_0005")
			then
				...
				if
					gameObjectId == GameObject.GetGameObjectId("hos_s10054_0001")
					and svars.isTarget03Discovery == false
					and svars.isTargetVehicle_03 == 0
				then
			...
			elseif
				gameObjectId == GameObject.GetGameObjectId("veh_s10054_0010")
				or gameObjectId == GameObject.GetGameObjectId("veh_s10054_0011")
				or gameObjectId == GameObject.GetGameObjectId("veh_s10054_0012")
			then
...
function this.AddMapIconText()
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId("veh_s10054_0006"),
		langId = "marker_info_vehicle_4wd",
	})
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId("veh_s10054_0009"),
		langId = "marker_info_truck",
	})
end
...
function this.targetIconText_Change()
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(TARGET_VEHICLE_01),
		langId = "marker_info_APC",
	})
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(TARGET_VEHICLE_02),
		langId = "marker_info_APC",
	})
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(TARGET_VEHICLE_03),
		langId = "marker_info_APC",
	})
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(TARGET_VEHICLE_04),
		langId = "marker_info_APC",
	})
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(TARGET_VEHICLE_05),
		langId = "marker_info_APC",
	})
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(TARGET_VEHICLE_06),
		langId = "marker_info_APC",
	})
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(TARGET_VEHICLE_07),
		langId = "marker_info_APC",
	})
end

function this.bonusTargetClear_commonAnnounceLog()
	TppUI.ShowAnnounceLog(
		"achieveObjectiveCount",
		svars.isTargrtCount_Clear + svars.isBonusTargetClear_CNT,
		TARGET_VEHICLE_COUNT + BONUS_TARGET_COUNT
	)
end
...
function this.nextVehicle_ON()
	if svars.isTargrtCount_Clear + svars.isTargetCount_areaOut + svars.isNonTargetCount_areaOut == 0 then
		Fox.Log(
			"isTargrtCount_Clear + isTargetCount_areaOut + isNonTargetCount_areaOut == 0 ... No Clear or AreaOut Target Vehicle !!"
		)
...
function this.common_movingCourseCheck()
	...
	if sequence == "Seq_Game_MainGame" then
		...
		if
			...
			or svars.isTargetVehicle_02 == 1
			or svars.isTargetVehicle_03 == 1
			or svars.isTargetVehicle_04 == 1
			or svars.isTargetVehicle_05 == 1
			or svars.isTargetVehicle_06 == 1
			or svars.isTargetVehicle_07 == 1
		then
			TppUiCommand.ShowEnemyRoutePoints({
				groupIndex = 0,
				width = 250.0,
				langId = "marker_target_forecast_path",
				radioGroupName = Fox.StrCode32("f1000_mprg0240"),
				points = {
					Vector3(-1797.1, 0.0, 37.0),
					Vector3(-1917.5, 0.0, 571.9),
					Vector3(-1760.0, 0.0, 750.0),
				},
			})
		else
		...
		if svars.isTargetVehicle_01 == 1 or svars.isTargetVehicle_05 == 1 then
			TppUiCommand.ShowEnemyRoutePoints({
				...
				width = 250.0,
				langId = "marker_target_forecast_path",
				radioGroupName = Fox.StrCode32("f1000_mprg0250"),
				points = {
					Vector3(-1520.0, 0.0, 880.0),
					Vector3(-888.4, 0.0, 964.2),
					Vector3(-550.2, 0.0, 635.0),
				},
			})
		else
		...
		then
			TppUiCommand.ShowEnemyRoutePoints({
				...
				radioGroupName = Fox.StrCode32("f1000_mprg0240"),
				points = {
					Vector3(-1750.0, 0.0, 1000.0),
					Vector3(-1570.0, 0.0, 1170.0),
					Vector3(-1237.9, 0.0, 1200.0),
					Vector3(-970.0, 0.0, 1470.0),
					Vector3(-876.4, 0.0, 1849.5),
				},
			})
		else
		...
		if svars.isTargetVehicle_04 == 1 then
			if svars.isTarget04_D_route == false then
				TppUiCommand.ShowEnemyRoutePoints({
					...
					radioGroupName = Fox.StrCode32("f1000_mprg0250"),
					points = {
						Vector3(-749.5, 0.0, 1476.4),
						Vector3(-187.2, 0.0, 1760.3),
					},
				})
			else
		...
		if svars.isTargetVehicle_05 == 1 then
			if svars.isTarget05_E_route == false then
				TppUiCommand.ShowEnemyRoutePoints({
					...
					radioGroupName = Fox.StrCode32("f1000_mprg0250"),
					points = {
						Vector3(-404.1, 0.0, 856.8),
						Vector3(-105.8, 0.0, 943.8),
						Vector3(30.8, 0.0, 816.1),
					},
				})
			else
...
this.BonusTarget_ON_2 = function()
	if svars.isBonusTarget == true and svars.isNonTargetCount_areaOut >= 2 and svars.isReserveFlag_08 == false then
		...
		GameObject.SendCommand(
			GameObject.GetGameObjectId(BONUS_VEHICLE_DRIVER_03),
...
this.areaOut01_GO = function()
	...
	if svars.isTargetVehicle_04 == 0 then
		...
		GameObject.SendCommand(
			GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_04),
			{ id = "SetEnabled", enabled = true }
		)
...
this.areaOut02_GO = function()
	...
	if svars.isTargetVehicle_05 == 0 then
		...
		GameObject.SendCommand(
			GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_05),
			{ id = "SetEnabled", enabled = true }
		)
...
this.areaOut03_GO = function()
	if (svars.isTargetVehicle_06 == 0) and (svars.isTargetVehicle_07 == 0) then
		...
		GameObject.SendCommand(
			GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_06),
			{ id = "SetEnabled", enabled = true }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_07),
			{ id = "SetEnabled", enabled = true }
		)
...
this.bulletTruck_GO = function()
	...
	if svars.isBulletTruck == 0 then
		...
		GameObject.SendCommand(
			GameObject.GetGameObjectId(BULLET_TRUCK_DRIVER_01),
			{ id = "SetEnabled", enabled = true }
		)
...
this.vehicle_GO = function()
	if svars.isHostageVehicle == 0 then
		...
		local command_vehicleVehicle =
			{ id = "SetRelativeVehicle", targetId = carryVehicleId, rideFromBeginning = true }
		...
		GameObject = {
			{
				...
				func = function(gameObjectId, vehicleType)
					if vehicleType == GameObject.GetGameObjectId(SUPPORT_HELI) then
						if
							gameObjectId == GameObject.GetGameObjectId(BULLET_TRUCK_DRIVER_01)
							or gameObjectId == GameObject.GetGameObjectId(VEHICLE_DRIVER_01)
							or gameObjectId == GameObject.GetGameObjectId(VEHICLE_DRIVER_02)
						then
						...
						elseif gameObjectId == GameObject.GetGameObjectId("hos_s10054_0005") then
							TppInterrogation.RemoveHighInterrogation(
								GameObject.GetGameObjectId("s10054_searchEnemy_cp"),
								{
									{ name = "enqt1000_107027", func = s10054_enemy.InterCall_movingHostage_02 },
								}
							)
			...
			},
			{
				...
				func = function(gameObjectId)
					...
					then
						this.unTargetDriver_clear(gameObjectId)
					elseif
						(gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_01))
						or (gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_02))
						or (gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_03))
						or (gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_04))
						or (gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_05))
						or (gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_06))
						or (gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_07))
					then
						...
						if sequence == "Seq_Game_MainGame" then
							...
							if
								svars.isTargrtCount_Clear == 1
								or svars.isTargrtCount_Clear == 4
								or svars.isTargrtCount_Clear >= TARGET_VEHICLE_COUNT
							then
					...
					then
						if failureType == TppGameObject.FULTON_FAILED_TYPE_ON_FINISHED_RISE then
							...
							if sequence == "Seq_Game_MainGame" then
								if
									svars.isTargrtCount_Clear == 1
									or svars.isTargrtCount_Clear == 3
									or svars.isTargrtCount_Clear == 5
									or svars.isTargrtCount_Clear >= TARGET_VEHICLE_COUNT
								then
									s10054_radio.TargetFulton_failed_01()
								elseif
									svars.isTargrtCount_Clear == 2
									or svars.isTargrtCount_Clear == 4
									or svars.isTargrtCount_Clear == 6
								then
			...
			},
			{
				...
				func = function(gameObjectId, state)
					...
					elseif
						gameObjectId == GameObject.GetGameObjectId(BONUS_TNK_01)
						or gameObjectId == GameObject.GetGameObjectId(BONUS_TNK_02)
						or gameObjectId == GameObject.GetGameObjectId(BONUS_TNK_03)
					then
						if state == StrCode32("End") then
							Fox.Log("VehicleBroken State == end")
							svars.isBonusTargetClear_CNT = svars.isBonusTargetClear_CNT + 1
				...
				func = function(gameObjectId, routeID, nodeNo, msgID)
					...
					if msgID == Fox.StrCode32("target_areaOut") then
						if gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_01) then
							...
							GameObject.SendCommand(
								GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_01),
								{ id = "SetEnabled", enabled = false }
							)
							GameObject.SendCommand(
								{ type = "TppVehicle2" },
								{ id = "Despawn", name = TARGET_VEHICLE_01 }
							)
						elseif gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_02) then
							...
							GameObject.SendCommand(
								GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_02),
								{ id = "SetEnabled", enabled = false }
							)
							GameObject.SendCommand(
								{ type = "TppVehicle2" },
								{ id = "Despawn", name = TARGET_VEHICLE_02 }
							)
						elseif gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_03) then
							...
							GameObject.SendCommand(
								GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_03),
								{ id = "SetEnabled", enabled = false }
							)
							GameObject.SendCommand(
								{ type = "TppVehicle2" },
								{ id = "Despawn", name = TARGET_VEHICLE_03 }
							)
						elseif gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_04) then
							...
							GameObject.SendCommand(
								{ type = "TppVehicle2" },
								{ id = "Despawn", name = TARGET_VEHICLE_04 }
							)
						elseif gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_05) then
							...
							GameObject.SendCommand(
								{ type = "TppVehicle2" },
								{ id = "Despawn", name = TARGET_VEHICLE_05 }
							)
						elseif gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_06) then
							...
							GameObject.SendCommand(
								{ type = "TppVehicle2" },
								{ id = "Despawn", name = TARGET_VEHICLE_06 }
							)
						elseif gameObjectId == GameObject.GetGameObjectId(TARGET_VEHICLE_DRIVER_07) then
							...
							GameObject.SendCommand(
								{ type = "TppVehicle2" },
								{ id = "Despawn", name = TARGET_VEHICLE_07 }
							)
						else
						...
						if sequence == "Seq_Game_MainGame" then
							...
							if
								svars.isTargetCount_areaOut == 1
								or svars.isTargetCount_areaOut == 3
								or svars.isTargetCount_areaOut == 5
								or svars.isTargetCount_areaOut == 7
							then
			...
			},
			{
				...
				func = function(gameObjectId, label)
					...
					local abductHostage_monologue_11 =
						{ id = "CallMonologue", label = "speech054_carry011", carry = true }
					local abductHostage_monologue_12 =
						{ id = "CallMonologue", label = "speech054_carry012", carry = true }
					local abductHostage_monologue_13 =
						{ id = "CallMonologue", label = "speech054_carry013", carry = true }
					local abductHostage_monologue_14 =
						{ id = "CallMonologue", label = "speech054_carry014", carry = true }
					local abductHostage_monologue_15 =
						{ id = "CallMonologue", label = "speech054_carry015", carry = true }
					local abductHostage_monologue_16 =
						{ id = "CallMonologue", label = "speech054_carry016", carry = true }
					local abductHostage_monologue_17 =
						{ id = "CallMonologue", label = "speech054_carry017", carry = true }
					local abductHostage_monologue_18 =
						{ id = "CallMonologue", label = "speech054_carry018", carry = true }

					local escapeHostage_monologue_22 =
						{ id = "CallMonologue", label = "speech054_carry022", carry = true }
					local escapeHostage_monologue_23 =
						{ id = "CallMonologue", label = "speech054_carry023", carry = true }
					local escapeHostage_monologue_24 =
						{ id = "CallMonologue", label = "speech054_carry024", carry = true }
					local escapeHostage_monologue_25 =
						{ id = "CallMonologue", label = "speech054_carry025", carry = true }
					local escapeHostage_monologue_26 =
						{ id = "CallMonologue", label = "speech054_carry026", carry = true }
					local escapeHostage_monologue_27 =
						{ id = "CallMonologue", label = "speech054_carry027", carry = true }
					local escapeHostage_monologue_28 =
						{ id = "CallMonologue", label = "speech054_carry028", carry = true }

					if
						gameObjectId == GameObject.GetGameObjectId("hos_s10054_0001")
						and state_abductHostage == TppGameObject.NPC_STATE_CARRIED
					then
					...
					elseif
						gameObjectId == GameObject.GetGameObjectId("hos_s10054_0005")
						and state_escapeHostage == TppGameObject.NPC_STATE_CARRIED
					then
	...
	Messages = function(self)
		return StrCode32Table({
			...
			Timer = {
				{
					msg = "Finish",
					sender = "timer_openingRadioAfter",
					func = function()
					...
					func = function()
						if svars.isTargrtCount_Clear == 0 then
							...
							TppMission.ReserveGameOver(
								TppDefine.GAME_OVER_TYPE.S10054_TIME_UP,
								TppDefine.GAME_OVER_RADIO.S10054_TIME_UP
							)
						else
							svars.isTimeUp = true
							TppSequence.SetNextSequence("Seq_Game_Escape")
					...
					func = function(RestTime, PassTime)
						...
						elseif RestTime == 450 or RestTime == 445 or RestTime == 440 then
							if svars.isReserveFlag_07 == false then
								...
								elseif
									svars.isTargrtCount_Clear == 1
									or svars.isTargrtCount_Clear == 2
									or svars.isTargrtCount_Clear == 3
								then
									Fox.Log("No Radio ...")
								elseif svars.isTargrtCount_Clear >= 4 then
	...
	Messages = function(self)
		return StrCode32Table({
			...
			Timer = {
				{
					msg = "Finish",
					sender = "timer_radio_AllTargetClear",
					func = function()
						this.BonusTarget_ON()
					end,
				},
				{
					msg = "Finish",
					sender = "timer_BonusPasstimeCheck",
					func = function()
			...
			Radio = {
				{
					msg = "Finish",
					sender = "s0054_rtrg3040",
					func = function()
						TppMission.UpdateObjective({
							objectives = { "FIXED_BONUS_01", "FIXED_BONUS_02", "FIXED_BONUS_04" },
						})
						this.OptRadioControl_Setting()
					end,
				},
