...
local spawnList_normal = {
	{
		id = "Spawn",
		locator = "veh_s10054_0000",
		type = Vehicle.type.EASTERN_WHEELED_ARMORED_VEHICLE,
		class = Vehicle.class.DEFAULT,
	},
	{
		id = "Spawn",
		locator = "veh_s10054_0002",
		type = Vehicle.type.EASTERN_WHEELED_ARMORED_VEHICLE,
		class = Vehicle.class.DEFAULT,
	},
	{
		id = "Spawn",
		locator = "veh_s10054_0003",
		type = Vehicle.type.EASTERN_WHEELED_ARMORED_VEHICLE,
		class = Vehicle.class.DEFAULT,
	},
	{
		id = "Spawn",
		locator = "veh_s10054_0009",
...
local despawnList_normal = {
	...
	{
		id = "Despawn",
		locator = "veh_s10054_0010",
		type = Vehicle.type.EASTERN_TRACKED_TANK,
		class = Vehicle.class.DEFAULT,
	},
	{
		id = "Despawn",
		locator = "veh_s10054_0011",
		type = Vehicle.type.EASTERN_TRACKED_TANK,
		class = Vehicle.class.DEFAULT,
	},
	{
		id = "Despawn",
		locator = "veh_s10054_0012",
		type = Vehicle.type.EASTERN_TRACKED_TANK,
		class = Vehicle.class.DEFAULT,
	},
...
this.enemyBaseTargetVehicle_GO = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0000"),
		{ id = "StartTravel", travelPlan = "travel_enemyBase_to_areaOut_target01", keepInAlert = true }
	)
end
...
this.remnantsTargetVehicle_GO = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0002"),
		{ id = "StartTravel", travelPlan = "travel_remnants_to_areaOut_target02", keepInAlert = true }
	)
end
...
this.hideTargetVehicle_GO = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0005"),
		{ id = "StartTravel", travelPlan = "travel_tent_to_areaOut_target03", keepInAlert = true }
	)
end
...
this.areaOut01_GO = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0003"),
		{ id = "StartTravel", travelPlan = "travel_areaOut_to_areaOut_target04", keepInAlert = true }
	)
end
...
this.areaOut02_GO = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0004"),
		{ id = "StartTravel", travelPlan = "travel_areaOut_to_areaOut_target05", keepInAlert = true }
	)
end
...
this.areaOut03_GO = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0006"),
		{ id = "StartTravel", travelPlan = "travel_areaOut_to_areaOut_target06", keepInAlert = true }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0007"),
		{ id = "StartTravel", travelPlan = "travel_areaOut_to_areaOut_target07", keepInAlert = true }
	)
end
...
this.bonusTarget_GO = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0008"),
		{ id = "StartTravel", travelPlan = "travel_bonusTarget01_00", keepInAlert = false }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0009"),
		{ id = "StartTravel", travelPlan = "travel_bonusTarget02_00", keepInAlert = false }
	)
end
this.bonusTarget_GO_2 = function()
	Fox.Log(" taravelPlan START : bonusTarget_GO_2 ")
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0010"),
		{ id = "StartTravel", travelPlan = "travel_bonusTarget03_00", keepInAlert = false }
	)
end
...
this.bonusTarget01_railChange_to01 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0008"),
		{ id = "StartTravel", travelPlan = "travel_bonusTarget01_01", keepInAlert = false }
	)
end
...
this.bonusTarget01_railChange_to02 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0008"),
		{ id = "StartTravel", travelPlan = "travel_bonusTarget01_02", keepInAlert = false }
	)
end
...
this.bonusTarget02_railChange_to01 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0009"),
		{ id = "StartTravel", travelPlan = "travel_bonusTarget02_01", keepInAlert = false }
	)
end
...
this.bonusTarget02_railChange_to02 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0009"),
		{ id = "StartTravel", travelPlan = "travel_bonusTarget02_02", keepInAlert = false }
	)
end
...
this.bonusTarget03_railChange_to01 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0010"),
		{ id = "StartTravel", travelPlan = "travel_bonusTarget03_01", keepInAlert = false }
	)
end
...
this.bonusTarget03_railChange_to02 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0010"),
		{ id = "StartTravel", travelPlan = "travel_bonusTarget03_02", keepInAlert = false }
	)
end
...
this.bulletTruck_GO = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0001"),
		{ id = "StartTravel", travelPlan = "travel_areaOut_to_areaOut_truck", keepInAlert = true }
	)
end
...
this.vehicle_GO = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0011"),
		{ id = "StartTravel", travelPlan = "travel_enemyBase_to_areaOut_vehicle", keepInAlert = true }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10054_0012"),
		{ id = "StartTravel", travelPlan = "travel_enemyBase_to_areaOut_vehicle", keepInAlert = true }
	)
end
...
this.InterCall_searchEnemy = function(soldier2GameObjectId, cpID, interName)
	TppInterrogation.RemoveHighInterrogation(
		GameObject.GetGameObjectId("afgh_tent_cp"),
	...
	TppInterrogation.RemoveHighInterrogation(
		GameObject.GetGameObjectId("afgh_remnants_cp"),
		{ { name = "enqt1000_107018", func = this.InterCall_searchEnemy } }
	)
	TppInterrogation.RemoveHighInterrogation(
		GameObject.GetGameObjectId("afgh_tentEast_ob"),
		{ { name = "enqt1000_107018", func = this.InterCall_searchEnemy } }
	)
	TppInterrogation.RemoveHighInterrogation(
		GameObject.GetGameObjectId("afgh_tentNorth_ob"),
		{ { name = "enqt1000_107018", func = this.InterCall_searchEnemy } }
	)
	TppInterrogation.RemoveHighInterrogation(
		GameObject.GetGameObjectId("afgh_enemyEast_ob"),
		{ { name = "enqt1000_107018", func = this.InterCall_searchEnemy } }
	)
	TppInterrogation.RemoveHighInterrogation(
		GameObject.GetGameObjectId("afgh_villageWest_ob"),
		{ { name = "enqt1000_107018", func = this.InterCall_searchEnemy } }
	)
	TppInterrogation.RemoveHighInterrogation(
		GameObject.GetGameObjectId("afgh_remnantsNorth_ob"),
		{ { name = "enqt1000_107018", func = this.InterCall_searchEnemy } }
	)
