...
this.ArrivalInAfghanistan = function(funcs)
	TppDemo.Play("Demo_ArrivalInAfghanistan", funcs, { useDemoBlock = true })
end

this.RescueMillerExplanation = function(func)
	TppDemo.Play("Demo_RescueMillerExplanation", {
		onEnd = function()
			func()
		end,
	}, {
...
this.GetIntel_village = function(func)
	...
	}, "GetIntelIdentifier", "GetIntel_village")
end
...
this.GetIntel_commFacility = function(func)
	...
	}, "GetIntelIdentifier", "GetIntel_commFacility")
end

this.RescueMiller = function(func)
	TppDemo.Play("Demo_RescueMiller", { onEnd = func }, { useDemoBlock = true, interpGameToDemo = false })
end

this.TimeOverDeadMiller = function(func)
	TppDemo.Play("Demo_TimeOverDeadMiller", {
		onEnd = function()
			func()
		end,
...
this.EscapeWithMillerOnHeli = function(func)
	TppDemo.Play("Demo_EscapeWithMillerOnHeli", {
		onEnd = function()
			func()
		end,
	}, {
