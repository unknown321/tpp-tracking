...
this.PlayAttackHostage = function(func)
	...
	TppDemo.Play("Demo_AttackHostage1", {
		onEnd = function()
			func()
		end,
	}, {
...
this.PlayRescueHostage = function(func, iden, key, startFunc)
	...
	elseif svars.isDemoArea2 then
		TppDemo.SetDemoTransform("Demo_RescueHostage", {
	...
	TppDemo.Play("Demo_RescueHostage", {
		onEnd = function()
			func()
		end,
		onStart = function()
...
this.PlayMissionCear = function(iden, key, func)
	...
	if key == false then
		...
		TppDemo.SetDemoTransform("Demo_Clear", {
