...
this.InsertORadioBridge = function()
	...
	if svars.isMarkHostage == false and svars.isGetInfoHostage == false then
...
this.InsertORadioFort = function()
	...
	if
		svars.isMarkHostage == false
		and svars.isGetInfoHoneyBee == false
		and svars.isGetInfoHostage == false
		and svars.isDeadHostage == false
	then
		this._InsertORadio("s0040_oprg1060")
	end

	if svars.isGetInfoHoneyBee == false and svars.isGetMissile == false and svars.isDeadHostage == true then
...
this.InsertORadioAllHostage = function()
	...
	if svars.isGetInfoHostage == true and svars.isMarkHostage == false then
...
this.PlayDeadHostage = function(attackerId)
	...
	if svars.isGetInfoHoneyBee == false and svars.isGetMissile == false then
		this.ORadioSet25()
	end
end
