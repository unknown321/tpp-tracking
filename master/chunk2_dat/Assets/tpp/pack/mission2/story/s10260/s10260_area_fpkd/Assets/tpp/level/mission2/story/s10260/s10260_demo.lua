...
this.EncountQuiet = function(func)
	TppDemo.Play(
		"Demo_EncountQuiet",
		{ onEnd = func },
		{ useDemoBlock = true, finishFadeOut = true, isSnakeOnly = false }
	)
end
...
this.SnakeBite_01 = function(func)
	TppDemo.Play(
		"Demo_SnakeBite_01",
		{ onEnd = func },
		{ useDemoBlock = true, finishFadeOut = true, isExecMissionClear = true }
	)
end
...
this.SnakeBite_02 = function(func)
	TppDemo.Play(
		"Demo_SnakeBite_02",
		{ onEnd = func },
		{ useDemoBlock = true, finishFadeOut = true, startNoFadeIn = true, isExecMissionClear = true }
	)
end
...
this.QuietVanishing = function(func)
	TppDemo.Play("Demo_QuietVanishing", {
		onStart = function()
			TppSoundDaemon.ResetMute("Loading")
		end,
		onEnd = func,
	}, { useDemoBlock = true, startNoFadeIn = true, isExecMissionClear = true })
end

this.CameraForLetter = function(func)
	TppDemo.Play(
		"Demo_CameraForLetter",
		{ onEnd = func },
		{ useDemoBlock = true, isExecMissionClear = true, isSnakeOnly = false }
	)
end

this.LetterFromQuiet = function(func)
	TppDemo.Play(
		"Demo_LetterFromQuiet",
		{ onEnd = func },
		{ useDemoBlock = true, finishFadeOut = true, isExecMissionClear = true }
	)
end
...
this.QuietDrifted = function(func)
	TppDemo.Play(
		"Demo_QuietDrifted",
		{ onEnd = func },
		{ useDemoBlock = true, finishFadeOut = true, isExecMissionClear = true, isSnakeOnly = false }
	)
end
