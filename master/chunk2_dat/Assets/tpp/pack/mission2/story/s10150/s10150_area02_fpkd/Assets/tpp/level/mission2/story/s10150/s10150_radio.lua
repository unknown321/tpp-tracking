...
this.FuncSelectNonActiveMenu = function()
	Fox.Log(
		"_____s10150_radio.FuncSelectNonActiveMenu() / CurrentSequenceName is "
			.. tostring(TppSequence.GetCurrentSequenceName())
			.. " / mvars.NgMbCount : "
			.. mvars.NgMbCount
	)
	if
		TppSequence.GetCurrentSequenceName() == "Seq_Game_TalkSkullFace"
		or TppSequence.GetCurrentSequenceName() == "Seq_Game_SkullFaceToPlant"
	then
