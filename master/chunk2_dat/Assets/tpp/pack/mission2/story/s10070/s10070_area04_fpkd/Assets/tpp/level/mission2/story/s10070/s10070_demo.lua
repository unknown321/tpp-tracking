...
this.SahelanHerald01 = function(func)
	TppDemo.Play("Demo_SahelanHerald01", {
		onEnd = function()
			func()
		end,
...
this.SahelanHerald02 = function(func)
	TppDemo.Play("Demo_SahelanHerald02", {
		onEnd = function()
			func()
		end,
...
this.SahelanAttacks = function(func)
	TppDemo.Play("Demo_SahelanAttacks", {
		onEnd = function()
			func()
		end,
	}, {
...
this.BoardingHeli = function(func)
	TppDemo.Play("Demo_BoardingHeli", {
		onEnd = function()
			func()
		end,
	}, { useDemoBlock = true })
...
this.SahelanFalling = function(func)
	TppDemo.Play("Demo_SahelanFalling", {
		onEnd = function()
			func()
		end,
	}, {
