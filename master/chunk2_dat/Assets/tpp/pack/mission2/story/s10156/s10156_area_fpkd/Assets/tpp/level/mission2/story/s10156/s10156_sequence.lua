...
this.missionObjectiveDefine = {
	...
	default_viewPoint = {
		gameObjectName = "10156_marker_viewpoint",
		visibleArea = 1,
		randomRange = 0,
...
function this.Reset10156Gimmick()
	...
	Gimmick.ResetGimmickData(
		...
		"/Assets/tpp/level/mission2/story/s10156/s10156_item.fox2"
	)
	Gimmick.ResetGimmickData(
	...
	Gimmick.ResetGimmickData(
		"hw00_gim_i0000|TppPermanentGimmick_hw00_main0_def",
		"/Assets/tpp/level/mission2/story/s10156/s10156_item.fox2"
	)

	Gimmick.ResetGimmickData(
		"afgh_book001_vrtn003_gim_i0000|TppSharedGimmick_afgh_book001_vrtn003",
		"/Assets/tpp/level/mission2/story/s10156/s10156_animal.fox2"
	)
	Gimmick.ResetGimmickData(
...
function this.Messages()
	return StrCode32Table({
		...
		Timer = {
				...
				func = function()
					...
					if svars.isReinforcement01Start == false then
						GameObject.SendCommand(
							GameObject.GetGameObjectId("sol_Reinforce_0001"),
							{ id = "StartTravel", travelPlan = "Travel_First_Car" }
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("sol_Reinforce_0002"),
							{ id = "StartTravel", travelPlan = "Travel_First_Car" }
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("sol_Reinforce_0003"),
							{ id = "StartTravel", travelPlan = "Travel_First_Car" }
						)
...

			{
				...
				func = function()
					...
					if svars.isReinforcement02Start == false then
						GameObject.SendCommand(
							GameObject.GetGameObjectId("sol_fieldEast_0001"),
							{ id = "StartTravel", travelPlan = "Travel_Second_Car" }
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("sol_fieldEast_0002"),
							{ id = "StartTravel", travelPlan = "Travel_Second_Car" }
						)
			...
			{
				msg = "Finish",
				sender = "Final_Reinforce",
				func = function()
					Fox.Log("TimerFinished_Final_Reinforce!!!!")
					if svars.isReinforcement03Start == false then
						GameObject.SendCommand(
							GameObject.GetGameObjectId("sol_villageEast_0002"),
							{ id = "StartTravel", travelPlan = "Travel_Final_Reinforce" }
						)
						GameObject.SendCommand(
							GameObject.GetGameObjectId("sol_villageEast_0003"),
							{ id = "StartTravel", travelPlan = "Travel_Final_Reinforce" }
						)
							...
							if svars.isCaseFound == false then
								...
								mvars.deadNPCId =
									...
									TppMission.ReserveGameOver(
										...
										TppDefine.GAME_OVER_RADIO.S10156_FILMCASE_DESTROYED
									)
					...
					func = function(gameObjectId, cpGameObjectId, speechLabel, isSuccess)
						...
						if speechLabel == StrCode32("CPRSP030") then
							if svars.isCaseFound == false then
								...
								GameObject.SendCommand(
									gameObjectId,
									{ id = "SetCautionRoute", route = destroyrouteName }
								)
							else
