	...
	ShowEnemyRoute = {
		showEnemyRoutePoints = {
			...
			points = {
				...
				Vector3(2214.7, 0.0, -1554.1),
				Vector3(1961.4, 0.0, -1475.9),
				Vector3(1828.6, 0.0, -1246.9),
				Vector3(1278.3, 0.0, -1322.6),
				Vector3(832.0, 0.0, -1347.5),
				Vector3(711.3, 0.0, -1053.1),
				Vector3(516.4, 0.0, -900.9),
				Vector3(219.1, 0.0, -961.9),
				Vector3(-166.7, 0.0, -449.3),
			},
		},
	},
...
function this.Messages()
	return StrCode32Table({
		...
		GameObject = {
			{
				msg = "RoutePoint2",
				sender = { "sol_enemyNorth_sensha", "sol_enemyNorth_sensha0000", "sol_enemyNorth_lvVIP" },
				func = function(gameObjectId, routeId, routeNode, messageId)
					if messageId == StrCode32("ConvoyArrivedFort") then
						...
						elseif
							gameObjectId == GameObject.GetGameObjectId("TppSoldier2", "sol_enemyNorth_sensha0000")
						then
...

			{
				...
				func = function(nGameObjectId, arg1, arg2, failureType)
					...
					if nGameObjectId == GameObject.GetGameObjectId("TppSoldier2", "sol_enemyNorth_lvVIP") then
						...
						this.InsertcliffTownVipHudPhoto()
					elseif
						nGameObjectId == GameObject.GetGameObjectId("veh_sensha")
						or nGameObjectId == GameObject.GetGameObjectId("veh_sensha0000")
					then
			...
			},
			{
				...
				func = function(nGameObjectId, arg2)
					if
						nGameObjectId == GameObject.GetGameObjectId("TppSoldier2", "sol_enemyNorth_lvVIP")
						and svars.DestroyedConvoyNum >= CONVOY_NUM
						and arg2 == GameObject.GetGameObjectId(SUPPORT_HELI)
					then
			...
			},
			{
				...
				func = function(vid, brokenState)
					...
					if
						vid == GameObject.GetGameObjectId("veh_sensha")
						or vid == GameObject.GetGameObjectId("veh_sensha0000")
					then
...
function this.TargetVIPFound()
	...
	if svars.isOnGetIntel == false and svars.isStartCarRadio == false then
...
sequences.Seq_Game_Information = {
			...
			Trap = {
				{
					...
					msg = "Enter",
					sender = "trap_ApproachIntelAtcliffTown_OnAlert",
					func = self.FuncApproachIntelAtcliffTown,
				},
				{
					msg = "Enter",
					sender = "trap_ld_0000",
				...
				},
				{
					...
					msg = "Exit",
					sender = "trap_help0001",
					func = self.FuncIntelHelp,
				},
			},
			nil,
		})
	...
	FuncTrap0 = function()
		if svars.isStartConvoy == false and svars.isDestroyedConvoy == false then
