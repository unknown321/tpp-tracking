...
local TARGET_SEARCHTARGET_NAME_LIST = {
	ANTN001 = {
		MESSAGE = "missiontarget01",
		FOX2NAME = "/Assets/tpp/level/location/afgh/block_large/commFacility/afgh_commFacility_gimmick.fox2",
	},
	ANTN002 = {
		MESSAGE = "missiontarget02",
		FOX2NAME = "/Assets/tpp/level/location/afgh/block_large/commFacility/afgh_commFacility_gimmick.fox2",
	},
	ANTN003 = {
		MESSAGE = "missiontarget03",
		FOX2NAME = "/Assets/tpp/level/location/afgh/block_large/commFacility/afgh_commFacility_gimmick.fox2",
	},
	CMMN001 = {
		MESSAGE = "missiontarget04",
		FOX2NAME = "/Assets/tpp/level/location/afgh/block_large/commFacility/afgh_commFacility_gimmick.fox2",
	},
}
...
this.missionObjectiveDefine = {
	...
	default_area_commFacility = {
		gameObjectName = MARKER_NAME.AREA_COMMFACILITY,
		visibleArea = 4,
		randomRange = 0,
		viewType = "all",
		setNew = false,
	...
	on_target_s10043_antn001 = {
		gimmickId = GIMMICK_ID_LIST.ANTN001,
		goalType = "attack",
		...
		mapRadioName = "f1000_mprg0140",
	},
	on_target_s10043_antn002 = {
		gimmickId = GIMMICK_ID_LIST.ANTN002,
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = true,
	...
	on_target_s10043_antn003 = {
		gimmickId = GIMMICK_ID_LIST.ANTN003,
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = true,
	...
	on_target_s10043_cmmn001 = {
		gimmickId = GIMMICK_ID_LIST.CMMN001,
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = true,
	...
	default_photo_commFacility = {
		photoId = PHOTO_NAME.COMMFACILITY,
		addFirst = true,
	...
	default_mainTask_search_target = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.MAIN_SEARCH_TARGET,
			isNew = false,
			isComplete = false,
			isFirstHide = false,
		},
	...
	default_mainTask_break_target = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.MAIN_BREAK_TARGET,
			isNew = false,
			isComplete = false,
			isFirstHide = false,
		},
	...
	default_subTask_recovered_hostage = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SUB_RECOVERED_HOSTAGE,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
	...
	default_subTask_recovered_container = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SUB_RECOVERED_CONTAINER,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
	...
	on_itm_s10043_diamond001 = {
		gameObjectName = MARKER_NAME.ITEM_DIAMOND_S001,
		goalType = "none",
		viewType = "map_and_world_only_icon",
		setNew = true,
		announceLog = "updateMap",
	...
	on_s10043_hostage001 = {
		gameObjectName = MARKER_NAME.HOSTAGE001,
		goalType = "none",
		viewType = "map_and_world_only_icon",
		setNew = true,
		announceLog = "updateMap",
	...
	on_s10043_hostage002 = {
		gameObjectName = MARKER_NAME.HOSTAGE002,
		goalType = "none",
		viewType = "map_and_world_only_icon",
		setNew = true,
		announceLog = "updateMap",
...
function this.MissionPrepare()
	...
	TppLocation.RegistMissionAssetInitializeTable(this.s10043_baseOnActiveTable)

	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.T_LRRP_MOVE_START)] = {
		{
			enemyName = s10043_enemy.ENEMY_NAME.LRRP_01,
			routeId_d = "rts_d_ene01_13to34_0000",
			routeId_n = "rts_n_ene01_13to34_0000",
		},
		{
			enemyName = s10043_enemy.ENEMY_NAME.LRRP_02,
			routeId_d = "rts_d_ene02_13to34_0000",
			routeId_n = "rts_n_ene02_13to34_0000",
		},
		{
			func = function()
				TppEnemy.SetEnable(s10043_enemy.ENEMY_NAME.LRRP_01)
			end,
		},
		{
			func = function()
				TppEnemy.SetEnable(s10043_enemy.ENEMY_NAME.LRRP_02)
			end,
		},
	}
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_LRRP_MOVE_CHANGE02)] = {
		{
			travelEnemyNameTable = { s10043_enemy.ENEMY_NAME.LRRP_01, s10043_enemy.ENEMY_NAME.LRRP_02 },
			travelPlanName = "travelCommFacility",
		},
	}
end
...
this.OnEndMissionPrepareSequence = function()
	...
	if TppMission.IsMissionStart() and gvars.s10043_forceMissionClear == true and missionName == "s10043" then
...
function this.IsMissionCompleteCheck()
	if
		(svars.isBreakAntn01 == true and svars.isBreakAntn02 == true and svars.isBreakAntn03 == true)
		or svars.isBreakCmmn == true
	then
		return true
	end
	return false
...
function this.OnTargetMarker(messageName)
	...
	if (chekcMarkingTask >= MAX_COUNT_ANTN or svars.isMarkCmmn == true) and svars.isReserveFlag_01 == false then
