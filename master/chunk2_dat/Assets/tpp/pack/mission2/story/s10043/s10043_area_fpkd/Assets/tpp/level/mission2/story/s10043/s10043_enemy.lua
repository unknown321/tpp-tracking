...
this.VEHICLE_SPAWN_LIST = {
	{
		id = "Spawn",
		locator = this.VEHICLE_NAME.TRUCK,
...
this.HighInterrogation = function()
	...
	TppInterrogation.AddHighInterrogation(GameObject.GetGameObjectId("afgh_ruinsNorth_ob"), {
		{ name = "enqt1000_1i1210", func = this.InterCall_hostage_001 },
		{ name = "enqt1000_1i1310", func = this.InterCall_hostage_002 },
	})
end
...
this.RemoveInterrogationHostage1 = function()
	TppInterrogation.RemoveHighInterrogation(GameObject.GetGameObjectId("afgh_ruinsNorth_ob"), {
		{ name = "enqt1000_1i1210", func = this.InterCall_hostage_001 },
	})
end
...
this.SetRelativeVehicle = function(enemyName, vehicleName, isrideFromBeginning)
	...
	GameObject.SendCommand(
		enemyName,
		{ id = "SetRelativeVehicle", targetId = vehicleName, rideFromBeginning = isrideFromBeginning }
	)
end
