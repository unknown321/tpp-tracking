	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnTerminate = function()
			...
			Gimmick.SetEventDoorLock(
				"mtbs_door006_door005_gim_n0005|srt_mtbs_door006_door005",
				DATASET_PATH_LARGE,
				true,
				0
			)
			Gimmick.SetEventDoorLock(
				"mtbs_door006_door005_gim_n0002|srt_mtbs_door006_door005",
				DATASET_PATH_LARGE,
				true,
				0
			)
			Gimmick.SetEventDoorLock(
				"mtbs_door006_door005_gim_n0006|srt_mtbs_door006_door005",
				DATASET_PATH_LARGE,
				true,
				0
			)
			Gimmick.SetEventDoorLock(
				"mtbs_door006_door005_gim_n0003|srt_mtbs_door006_door005",
				DATASET_PATH_LARGE,
				true,
				0
			)
			Gimmick.SetEventDoorLock(
				"mtbs_door006_door005_gim_n0007|srt_mtbs_door006_door005",
				DATASET_PATH_LARGE,
				true,
				0
			)
			Gimmick.SetEventDoorLock(
				"mtbs_door006_door005_gim_n0004|srt_mtbs_door006_door005",
				DATASET_PATH_LARGE,
				true,
				0
			)
	...
	Messages = function(self)
		return StrCode32Table({
			Trap = {
				...
				{
					msg = "Enter",
					sender = "trap_EnableMarker_AIpodComputer",
					func = function()
...

				{
					...
					func = function(arg0, arg1)
						if
							arg0 == StrCode32("trap_ReptilePod_Demo")
							or arg0 == StrCode32("trap_ReptilePod_Demo_AiPod")
						then
				...
				},
				{
					...
					func = function(targetName, gameObjectId)
						...
						TppDataUtility.SetVisibleDataFromIdentifier(
							"soviet_mission_asset05_DataIdentifier",
							"env_aip0_memo",
							true,
							true
						)
...
function this.SwitchSovietBaseHungerAsset_ReptilePod()
	...
	Gimmick.InvisibleGimmick(
		TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
		"afgh_cmpt002_gim_n0005|srt_afgh_cmpt002",
		DATASET_PATH_ASSET01,
		true
	)
	Gimmick.InvisibleGimmick(
		TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
		"afgh_cmpt002_gim_n0000|srt_afgh_cmpt002",
		DATASET_PATH_ASSET01,
		true
	)
	Gimmick.InvisibleGimmick(
		TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
		"afgh_cmpt002_gim_n0007|srt_afgh_cmpt002",
		DATASET_PATH_ASSET01,
		true
	)
	Gimmick.InvisibleGimmick(
		TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
		"afgh_cmpt002_gim_n0008|srt_afgh_cmpt002",
		DATASET_PATH_ASSET01,
		true
	)
	Gimmick.InvisibleGimmick(
		TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
		"afgh_cmpt002_gim_n0009|srt_afgh_cmpt002",
		DATASET_PATH_ASSET01,
		true
	)
...
function this.AddTrapSettingForAiPodDemo(params)
	...
	Fox.Log(
		"sovietBase_q99030.AddTrapSettingForAiPodDemo. trapName = "
			.. tostring(trapName)
			.. ", direction = "
			.. tostring(direction)
			.. ", directionRange = "
...
function this.AiPod_DemoPlay()
	...
	TppDemo.Play("Demo_RecoverReptilePod", {
