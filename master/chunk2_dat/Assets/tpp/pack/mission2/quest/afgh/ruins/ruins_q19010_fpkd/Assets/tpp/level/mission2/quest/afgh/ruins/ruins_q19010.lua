...
this.QUEST_TABLE = {
	...
	enemyList = {
...

		{
			...
			route_d = "rt_quest_d_ene01_0000",
			route_c = "rt_quest_c_ene01_0000",
...

		{
			...
			route_d = "rt_quest_d_ene02_0000",
			route_c = "rt_quest_c_ene02_0000",
			cpName = "afgh_ruinsNorth_ob",
			powerSetting = {},
		},

		{
			...
			route_d = "rt_quest_d_ene03_0000",
			route_c = "rt_quest_c_ene03_0000",
			cpName = "afgh_ruinsNorth_ob",
			powerSetting = {},
		},
	},
			...
			GameObject = {
				...
				},
				{
					...
					func = function(cpGameObjectId, speechLabel, isSuccess)
						...
						this.SetRouteId({
							beforeRouteId_d = "rt_quest_d_ene01_0000",
							afterRouteId_d = "rt_quest_d_ene01_0001",
						})
						this.SetRouteId({
							beforeRouteId_d = "rt_quest_d_ene02_0001",
							afterRouteId_d = "rt_quest_d_ene02_0000",
						})
					end,
				},
				{
					...
					func = function(gameObjectId, routeId, routeNodeIndex, messageId)
						...
						if messageId == Fox.StrCode32("ConversationStart") then
							this.RouteCallConversation(
								{ "rt_quest_d_ene02_0001" },
								{ "rt_quest_d_ene01_0000" },
								"CT10043_01",
								true
							)
						end
			...
			Trap = {
				{
					...
					func = function()
						...
						if mvars.isConversationStart == false then
							...
							this.SetRouteId({
								beforeRouteId_d = "rt_quest_d_ene02_0000",
								afterRouteId_d = "rt_quest_d_ene02_0001",
							})
						end
					end,
				},
...
this.UniqueInterEnd_sol_interpreter_0000 = function(soldier2GameObjectId, cpID) end
