...
this.SetEscapePoint = function()
	...
	local EscapePosList = {
		...
		{
			idx = EscapeIdx.HillTree,
			pos = hillTreePos,
			link = { EscapeIdx.HillPlane, EscapeIdx.HillBase, EscapeIdx.Start },
		},
		...
		{
			idx = EscapeIdx.TrackRoad,
			pos = trackRoadPos,
			link = { EscapeIdx.ToTrack, EscapeIdx.Track, EscapeIdx.TrackGrass },
		},
	}
