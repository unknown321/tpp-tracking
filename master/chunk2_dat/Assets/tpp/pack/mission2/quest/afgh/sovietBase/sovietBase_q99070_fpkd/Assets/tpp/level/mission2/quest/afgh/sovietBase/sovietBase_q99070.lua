	...
	enemyList = {
		{
			...
			powerSetting = { "SOFT_ARMOR", "MISSILE" },
		},
		{
	...
	hostageList = {
		{
			...
			bodyId = TppDefine.QUEST_BODY_ID_LIST.Q99070,
			faceId = TppDefine.QUEST_FACE_ID_LIST.Q99070,
			uniqueTypeId = TppDefine.UNIQUE_STAFF_TYPE_ID.QUEST_GUNSMITH_02,
			langType = "pashto",
			voiceType = { "hostage_b" },
		},
	},
