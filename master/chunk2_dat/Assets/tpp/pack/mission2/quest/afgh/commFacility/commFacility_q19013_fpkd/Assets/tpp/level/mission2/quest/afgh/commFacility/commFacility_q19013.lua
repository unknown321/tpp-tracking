	...
	hostageList = {
		{
			...
			bodyId = TppDefine.QUEST_BODY_ID_LIST.Q19013,
			faceId = TppDefine.QUEST_FACE_ID_LIST.Q19013,
			uniqueTypeId = TppDefine.UNIQUE_STAFF_TYPE_ID.QUEST_PASHTO,
			langType = "english",
			voiceType = { "hostage_a" },
		},
	},
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnTerminate = function()
			this.SwitchEnableQuestHighIntTable(false, "afgh_bridgeWest_ob", this.questCpInterrogation)
...
quest_step.QStep_Start = {
	OnEnter = function()
		this.SwitchEnableQuestHighIntTable(true, "afgh_bridgeWest_ob", this.questCpInterrogation)
