		...
		return StrCode32Table({
			GameObject = {
				...
				},
				{
					...
					func = function(gameObjectId)
						local isClearType =
							TppEnemy.CheckQuestAllTarget(this.QUEST_TABLE.questType, "Unconscious", gameObjectId)
						TppQuest.ClearWithSave(isClearType)
					end,
				},
				{
			...
			Trap = {
				{
					msg = "Enter",
					sender = "trap_Update_s10070_Open",
					func = function()
				...
				{
					msg = "Enter",
					sender = "trap_s10070_EventDoorSet",
					func = function()
			...
			Timer = {
				{
					msg = "Finish",
					sender = "Timer_PickingSE_02",
					func = function()
						TppMission.ReserveMissionClear({
							nextMissionId = 10070,
							missionClearType = TppDefine.MISSION_CLEAR_TYPE.QUEST_INTRO_RESCUE_EMERICH_END,
						})
					end,
				},
			},
