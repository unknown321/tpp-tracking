	...
	hostageList = {
		{
			...
			bodyId = TppDefine.QUEST_BODY_ID_LIST.Q99072,
			faceId = TppDefine.QUEST_FACE_ID_LIST.Q99072,
			uniqueTypeId = TppDefine.UNIQUE_STAFF_TYPE_ID.QUEST_MASTERGUNSMITH,
			langType = "english",
			voiceType = { "hostage_c" },
		},
	},
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnTerminate = function()
			this.SwitchEnableQuestHighIntTable(false, "afgh_tent_cp", this.questCpInterrogation)
...
quest_step.QStep_Start = {
	OnEnter = function()
		this.SwitchEnableQuestHighIntTable(true, "afgh_tent_cp", this.questCpInterrogation)
