...
this.SetEscapePoint = function()
	...
	local EscapePosList = {
		...
		{
			idx = EscapeIdx.DownGrass,
			pos = downGrassPos,
			link = { EscapeIdx.Start, EscapeIdx.NearBaseE, EscapeIdx.MostDown, EscapeIdx.NearBaseW },
		},
		{
			idx = EscapeIdx.NearBaseE,
			pos = nearBaseEPos,
			link = { EscapeIdx.DownGrass, EscapeIdx.Hill, EscapeIdx.NearBaseW },
		},
