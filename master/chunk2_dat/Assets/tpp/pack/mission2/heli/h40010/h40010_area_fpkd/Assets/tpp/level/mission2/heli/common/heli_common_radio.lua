...
this.SetOptionalRadioFromSituation = function()
	local canSortieAnyBuddy = TppBuddyService.CanSortieBuddyType(BuddyType.DOG)
		or TppBuddyService.CanSortieBuddyType(BuddyType.QUIET)
		or TppBuddyService.CanSortieBuddyType(BuddyType.WALKER_GEAR)
...
this.SetOptionalRadioInEmergency = function()
	Fox.Log(
		"#### heli_common_radio.SetOptionalRadioFromSituation #### In Emergency! Base Optional Radio Replace Special Edition."
	)
