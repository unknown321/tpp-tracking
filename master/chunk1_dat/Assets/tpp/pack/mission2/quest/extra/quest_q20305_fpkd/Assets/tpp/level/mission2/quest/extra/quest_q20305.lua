...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnTerminate = function()
			this.SwitchEnableQuestHighIntTable(false, "mafr_swampSouth_ob", this.questCpInterrogation)
...
quest_step.QStep_Start = {
	OnEnter = function()
		this.SwitchEnableQuestHighIntTable(true, "mafr_swampSouth_ob", this.questCpInterrogation)
