...
this.QUEST_TABLE = {
	...
	enemyList = {

		{
			...
			cpName = "mafr_factoryWest_ob",
			powerSetting = { "HELMET", "SHIELD", "SMG" },
			soldierSubType = "PF_C",
		},
		{
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnTerminate = function()
			this.SwitchEnableQuestHighIntTable(false, "mafr_factoryWest_ob", this.questCpInterrogation)
...
quest_step.QStep_Start = {
	OnEnter = function()
		this.SwitchEnableQuestHighIntTable(true, "mafr_factoryWest_ob", this.questCpInterrogation)
