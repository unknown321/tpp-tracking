...
this.QUEST_TABLE = {
	...
	enemyList = {
		...
		},
		{
			...
			route_d = "rt_sovietBase_snp_0000",
			route_c = "rt_sovietBase_snp_0000c",
			cpName = "afgh_sovietBase_cp",
			powerSetting = { "SNIPER" },
		},
		{
			enemyName = "sol_quest_0003",
			route_d = "rt_sovietBase_d_0011",
			route_c = "rt_sovietBase_c_0011",
			cpName = "afgh_sovietBase_cp",
			powerSetting = { "SOFT_ARMOR", "HELMET", "MISSILE" },
		},
		{
			enemyName = "sol_quest_0004",
			route_d = "rt_sovietBase_d_0016",
			route_c = "rt_quest_c_0005",
			cpName = "afgh_sovietBase_cp",
		...
		},
		{
			...
			route_d = "rt_sovietBase_n_0011",
			route_c = "rt_quest_c_0006",
			cpName = "afgh_sovietBase_cp",
			powerSetting = { "SOFT_ARMOR", "HELMET", "MG" },
		},
		{
			enemyName = "sol_quest_0007",
			route_d = "rt_sovietBase_n_0016",
			route_c = "rt_quest_c_0000",
			cpName = "afgh_sovietBase_cp",
			powerSetting = { "SOFT_ARMOR", "HELMET", "MISSILE" },
		},
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnTerminate = function()
			this.SwitchEnableQuestHighIntTable(false, "afgh_sovietBase_cp", this.questCpInterrogation)
...
quest_step.QStep_Start = {
	OnEnter = function()
		this.SwitchEnableQuestHighIntTable(true, "afgh_sovietBase_cp", this.questCpInterrogation)
