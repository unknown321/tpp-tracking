...
this.questCpInterrogation = {
	...
	{ name = "enqt1000_101527", func = this.InterCall_hostage_pos01 },
}
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnTerminate = function()
			this.SwitchEnableQuestHighIntTable(false, "afgh_cliffTown_cp", this.questCpInterrogation)
...
quest_step.QStep_Start = {
	OnEnter = function()
		this.SwitchEnableQuestHighIntTable(true, "afgh_cliffTown_cp", this.questCpInterrogation)
