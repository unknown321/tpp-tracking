...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnTerminate = function()
			this.SwitchEnableQuestHighIntTable(false, "afgh_bridge_cp", this.questCpInterrogation)
...
quest_step.QStep_Start = {
	OnEnter = function()
		this.SwitchEnableQuestHighIntTable(true, "afgh_bridge_cp", this.questCpInterrogation)
