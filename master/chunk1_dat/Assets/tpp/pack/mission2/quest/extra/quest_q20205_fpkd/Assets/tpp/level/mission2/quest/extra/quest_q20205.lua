	...
	hostageList = {
		{
			...
			voiceType = { "hostage_a" },
			langType = "english",
			uniqueTypeId = TppDefine.UNIQUE_STAFF_TYPE_ID.QUEST_HOSTAGE_R_02,
		},
		{
...
this.SetAllEnemyStaffParam = function()
	TppEnemy.AssignUniqueStaffType({
		...
		uniqueStaffTypeId = TppDefine.UNIQUE_STAFF_TYPE_ID.QUEST_HOSTAGE_R_02,
		alreadyExistParam = { staffTypeId = 3, randomRangeId = 5, skill = nil },
	})
end
