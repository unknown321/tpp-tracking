				...
				},
				{
					...
					func = function()
						...
						if this.isPlayerRideVehicle() then
							...
							Fox.Log(
								"#### qest_bossQuiet_00:QStep_Start::trap_AntiVehicle #### Player not ride vehicle..."
							)
						end
					end,
				},
			...
			Timer = {
				...
				},
				{
					...
					func = function()
						...
						local assetPath =
							"/Assets/tpp/level/location/afgh/block_large/waterway/afgh_waterway_asset.fox2"
...
this.StartTimer = function(timerName, timerTime)
	if not GkEventTimerManager.IsTimerActive(timerName) then
		Fox.Log(
			"#### qest_bossQuiet_00.StartTimer #### timerName = "
				.. tostring(timerName)
				.. ", timerTime = "
				.. tostring(timerTime)
		)
