DebugChangeCameraSitPreset = {
	...
	Exec = function(info)
		if info.trapFlagString == "GEO_TRAP_S_ENTER" then
			...
			info.conditionBodyHandle.DebugChangeCameraSituationPreset_prevName =
				TppCameraUtility.GetCameraSituationPresetName(chara)

			TppCameraUtility.SetCameraSituationPresetName(
				chara,
				info.conditionHandle.DebugChangeCameraSituationPreset_name
			)
