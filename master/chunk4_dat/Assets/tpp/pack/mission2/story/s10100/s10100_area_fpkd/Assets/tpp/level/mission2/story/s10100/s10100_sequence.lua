...
if TppLocation.IsMiddleAfrica() then
	this.VARIABLE_TRAP_SETTING = {
		{
			name = "trap_CHK_s10100_01",
			type = TppDefine.TRAP_TYPE.NORMAL,
			initialState = TppDefine.TRAP_STATE.DISABLE,
		},
		{
			name = "trap_CHK_s10100_02",
			type = TppDefine.TRAP_TYPE.NORMAL,
			initialState = TppDefine.TRAP_STATE.DISABLE,
		},
		{
			name = "trap_CHK_s10100_03",
			type = TppDefine.TRAP_TYPE.NORMAL,
			initialState = TppDefine.TRAP_STATE.DISABLE,
		},
		{
			name = "trap_CHK_s10100_04",
			type = TppDefine.TRAP_TYPE.NORMAL,
			initialState = TppDefine.TRAP_STATE.DISABLE,
		},
		{
			name = "trap_CHK_s10100_05",
			type = TppDefine.TRAP_TYPE.NORMAL,
			initialState = TppDefine.TRAP_STATE.DISABLE,
		},
	}
...
if TppLocation.IsMiddleAfrica() then
	this.missionObjectiveDefine = {
		...
		reduce_area_banana = {
			gameObjectName = "Marker_banana_reduce",
			visibleArea = 2,
			randomRange = 0,
			setNew = false,
			viewType = "all",
		...
		default_boySoldiers = {
			...
			announceLog = "updateMap",
			langId = "marker_info_mission_targetArea",
			mapRadioName = "s0100_mprg0020",
		},
		reduce_boySoldiers = {
			gameObjectName = "Marker_diamond_02",
			visibleArea = 3,
			randomRange = 0,
			setNew = true,
			viewType = "all",
		...
		target_boyHostage01 = {
			gameObjectName = TARGET_INJURY_BOY,
			goalType = "defend",
		...
		target_boyHostage02 = {
			gameObjectName = TARGET_NORMAL_BOY_A,
			goalType = "defend",
			viewType = "map_and_world_only_icon",
			setImportant = true,
			langId = "marker_info_mission_target",
		...
		target_boyHostage03 = {
			gameObjectName = TARGET_NORMAL_BOY_B,
			goalType = "defend",
			viewType = "map_and_world_only_icon",
			setImportant = true,
			langId = "marker_info_mission_target",
		...
		target_boyHostage04 = {
			gameObjectName = TARGET_NORMAL_BOY_C,
			goalType = "defend",
			viewType = "map_and_world_only_icon",
			setImportant = true,
			langId = "marker_info_mission_target",
		...
		target_boyHostage05 = {
			gameObjectName = TARGET_NORMAL_BOY_D,
			goalType = "defend",
			viewType = "map_and_world_only_icon",
			setImportant = true,
			langId = "marker_info_mission_target",
		...
		rv_diamond = {
			gameObjectName = "Marker_diamondRV",
			goalType = "moving",
			viewType = "all",
			announceLog = "updateMap",
			langId = "marker_info_LZ",
			mapRadioName = "s0100_mprg0040",
		},

		default_photo_bananaTarget = {
			photoId = 10,
			addFirst = true,
			photoRadioName = "s0100_mirg1010",
		...
		subTask_ACP01 = {
			gameObjectName = "veh_s10100_0000",
			goalType = "attack",
			viewType = "map_and_world_only_icon",
			setNew = false,
			announceLog = "updateMap",
		...
		subTask_ACP02 = {
			gameObjectName = "veh_s10100_0001",
			goalType = "attack",
			viewType = "map_and_world_only_icon",
			setNew = false,
			announceLog = "updateMap",
		...
		subTask_ACP03 = {
			gameObjectName = "veh_s10100_0002",
			goalType = "attack",
			viewType = "map_and_world_only_icon",
			setNew = false,
			announceLog = "updateMap",
...
function this.AddMapIconText()
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId("veh_s10100_0000"),
		langId = "marker_info_APC",
	})
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId("veh_s10100_0001"),
		langId = "marker_info_APC",
	})
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId("veh_s10100_0002"),
		langId = "marker_info_APC",
	})
end
...
function this.bananaTarget_collect_AnnounceLog()
	...
	if svars.isReserveFlag_16 == true then
		TppMission.UpdateObjective({
			objectives = { "missionTask_1_bananaTarget_clear", "missionTask_4_bananaTarget_collect_clear" },
		})
...
function this.controlGuide_orderChild()
	if
		svars.isCollect_YellowHood == false
		or svars.isCollect_Aflo == false
		or svars.isCollect_ShortAflo == false
		or svars.isCollect_BlackCoat == false
	then
...
function this.pursuersEnemyEnable()
	if svars.isPrisonBreak == true and svars.isPursuersEnemyEnable == false then
		...
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondHill_0000"),
			{ id = "SetEnabled", enabled = true }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondHill_0001"),
			{ id = "SetEnabled", enabled = true }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondHill_0002"),
			{ id = "SetEnabled", enabled = true }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondHill_0003"),
			{ id = "SetEnabled", enabled = true }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondHill_0005"),
			{ id = "SetEnabled", enabled = true }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondHill_0006"),
			{ id = "SetEnabled", enabled = true }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondHill_0008"),
			{ id = "SetEnabled", enabled = true }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondHill_0009"),
			{ id = "SetEnabled", enabled = true }
		)
...
function this.orderCommand_OnOff_2()
	...
	local orderCommand =
		{ id = "SetPlayerDistanceCheck", enabled = true, near = ORDER_ENABLE_RANGE, far = ORDER_IGNORE_RANGE }
...
function this.boyHostages_Enable()
	...
	if sequence == "Seq_Game_BeforeRescueBoy" then
		...
		if svars.isBoyHostages_Enable == false then
			...
			GameObject.SendCommand(
				GameObject.GetGameObjectId("hos_diamond_0000"),
				{ id = "SetEnabled", enabled = true }
			)
			GameObject.SendCommand(
				GameObject.GetGameObjectId("hos_diamond_0001"),
				{ id = "SetEnabled", enabled = true }
			)
			GameObject.SendCommand(
				GameObject.GetGameObjectId("hos_diamond_0002"),
				{ id = "SetEnabled", enabled = true }
			)
			GameObject.SendCommand(
				GameObject.GetGameObjectId("hos_diamond_0003"),
				{ id = "SetEnabled", enabled = true }
			)
			GameObject.SendCommand(
				GameObject.GetGameObjectId("hos_diamond_0004"),
				{ id = "SetEnabled", enabled = true }
			)
		else
		end
...
function this.bananaTargetAttestation(messageName, gameObjectId, msg)
	...
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(TARGET_ENEMY_NAME),
		langId = "marker_info_mission_target",
	})
	...
	elseif msg == "Carried" or msg == "Restraint" then
...
function this.enemyHeliRoute()
	...
	local Caution_AfterRescueBoy_01 =
		{ id = "SetCautionRoute", route = "eneHeli_afterBoysRoute", point = 0, warp = true }
	local Caution_AfterRescueBoy_02 =
		{ id = "SetCautionRoute", route = "eneHeli_SearchHostages", point = 0, warp = true }
...
function this.MissionPrepare()
	...
	TppMission.RegisterMissionSystemCallback({
		...
		OnRecovered = function(gameObjectId)
			...
			elseif gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_A) then
				svars.isCollect_YellowHood = true
				gvars.s10100_boyEscapeCurrentPlay[TppDefine.S10100_BOY_ENUM.Collect_YellowHood] =
					svars.isCollect_YellowHood
				svars.isReserveFlag_CNT_02 = svars.isReserveFlag_CNT_02 + 1
			...
			elseif gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_C) then
				svars.isCollect_ShortAflo = true
				gvars.s10100_boyEscapeCurrentPlay[TppDefine.S10100_BOY_ENUM.Collect_ShortAflo] =
					svars.isCollect_ShortAflo
				svars.isReserveFlag_CNT_02 = svars.isReserveFlag_CNT_02 + 1
			...
			elseif gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_D) then
				svars.isCollect_BlackCoat = true
				gvars.s10100_boyEscapeCurrentPlay[TppDefine.S10100_BOY_ENUM.Collect_BlackCoat] =
					svars.isCollect_BlackCoat
				svars.isReserveFlag_CNT_02 = svars.isReserveFlag_CNT_02 + 1
			...
			elseif
				gameObjectId == GameObject.GetGameObjectId("sol_sniperA_0000")
				or gameObjectId == GameObject.GetGameObjectId("sol_sniperA_0001")
				or gameObjectId == GameObject.GetGameObjectId("sol_sniperA_0002")
				or gameObjectId == GameObject.GetGameObjectId("sol_sniperB_0000")
				or gameObjectId == GameObject.GetGameObjectId("sol_sniperB_0001")
			then
			...
			elseif
				gameObjectId == GameObject.GetGameObjectId("veh_s10100_0000")
				or gameObjectId == GameObject.GetGameObjectId("veh_s10100_0001")
				or gameObjectId == GameObject.GetGameObjectId("veh_s10100_0002")
			then
...
function this.Messages()
	return StrCode32Table({
		...
		GameObject = {
			{
				...
				func = function(gameObjectId)
					...
					if
						phase_diamond == TppEnemy.PHASE.ALERT
						or phase_diamondSwamp == TppEnemy.PHASE.ALERT
						or phase_diamondRiver == TppEnemy.PHASE.ALERT
						or phase_diamondHill == TppEnemy.PHASE.ALERT
					then
				...
				func = function(gameObjectId, cpId, label, succeed)
					if label == Fox.StrCode32("CPR0230") and svars.isPrisonBreak == false then
						...
						if svars.isChaseEnemyCondition == true then
							GameObject.SendCommand(
								GameObject.GetGameObjectId("sol_tracking_A_0000"),
								{ id = "SetEnabled", enabled = true }
							)
							GameObject.SendCommand(
								GameObject.GetGameObjectId("sol_tracking_A_0001"),
								{ id = "SetEnabled", enabled = true }
							)
							GameObject.SendCommand(
								GameObject.GetGameObjectId("sol_tracking_A_0002"),
								{ id = "SetEnabled", enabled = true }
							)
							GameObject.SendCommand(
								GameObject.GetGameObjectId("sol_tracking_A_0003"),
								{ id = "SetEnabled", enabled = true }
							)
			...
			},
			{
				...
				func = function(gameObjectId, gameObjectName, name)
					...
					elseif
						gameObjectName == Fox.StrCode32("afgh_gnrt002_vrtn001_gim_n0000|srt_afgh_gnrt002_vrtn001")
					then
						s10100_radio.ChangeIntelRadio_brokenHATSUDENKI()
					elseif
						gameObjectName == Fox.StrCode32("mafr_fenc005_door004_gim_n0000|srt_mafr_fenc005_door004")
					then
			...
			},
			{
				...
				func = function(GameObjectId)
					if
						GameObjectId == GameObject.GetGameObjectId(DIA_ADD_ENEMY_A)
						or GameObjectId == GameObject.GetGameObjectId(DIA_ADD_ENEMY_B)
						or GameObjectId == GameObject.GetGameObjectId(DIA_ADD_ENEMY_C)
						or GameObjectId == GameObject.GetGameObjectId(DIA_ADD_ENEMY_D)
						or GameObjectId == GameObject.GetGameObjectId(DIA_ADD_ENEMY_E)
						or GameObjectId == GameObject.GetGameObjectId(DIA_ADD_ENEMY_F)
					then
						svars.isAddEnemy_diamondSouth = false
					elseif
						GameObjectId == GameObject.GetGameObjectId("sol_diamond_0000")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0001")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0002")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0003")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0004")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0005")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0006")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0007")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0008")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0009")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0010")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamond_0011")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamondSwamp_0000")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamondSwamp_0001")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamondSwamp_0002")
						or GameObjectId == GameObject.GetGameObjectId("sol_diamondSwamp_0003")
					then
			...
			},
			{
				...
				func = function(gameObjectId, routeID, nodeNo, msgID)
					...
					local DownCommand = {
						id = "ChangeLifeState",
						state = TppGameObject.NPC_LIFE_STATE_FAINT,
					...
					local Caution_SearchHostages =
						{ id = "SetCautionRoute", route = "eneHeli_SearchHostages", point = 0 }
			...
			},
			{
				...
				func = function(gameObjectId, locatorname, locatorNameUpper, failureType)
					...
					elseif
						gameObjectId == GameObject.GetGameObjectId(TARGET_INJURY_BOY)
						or gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_A)
						or gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_B)
						or gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_C)
						or gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_D)
					then
						if failureType == TppGameObject.FULTON_FAILED_TYPE_ON_FINISHED_RISE then
							TppMission.ReserveGameOver(
								TppDefine.GAME_OVER_TYPE.PLAYER_KILL_CHILD_SOLDIER,
								TppDefine.GAME_OVER_RADIO.PLAYER_KILL_CHILD_SOLDIER
							)
						else
							Fox.Log("failureType ~= FULTON_FAILED_TYPE_ON_FINISHED_RISE ... Nothing Done !!")
						end
			...
			},
			{
				...
				func = function(hostageId)
					...
					local lifeStateCommand = { id = "GetLifeStatus" }
					local lifeStatus_A =
						GameObject.SendCommand(GameObject.GetGameObjectId(TARGET_NORMAL_BOY_A), lifeStateCommand)
					local lifeStatus_B =
						GameObject.SendCommand(GameObject.GetGameObjectId(TARGET_NORMAL_BOY_B), lifeStateCommand)
					local lifeStatus_C =
						GameObject.SendCommand(GameObject.GetGameObjectId(TARGET_NORMAL_BOY_C), lifeStateCommand)
					local lifeStatus_D =
						GameObject.SendCommand(GameObject.GetGameObjectId(TARGET_NORMAL_BOY_D), lifeStateCommand)
					local lifeStatus_E =
						GameObject.SendCommand(GameObject.GetGameObjectId(TARGET_INJURY_BOY), lifeStateCommand)
					this.controlGuide_orderChild()
			...
			},
			{
				...
				func = function(gameObjectId)
					...
					local noticeState_A =
						GameObject.SendCommand(GameObject.GetGameObjectId(TARGET_NORMAL_BOY_A), GetNotice_command)
					local noticeState_B =
						GameObject.SendCommand(GameObject.GetGameObjectId(TARGET_NORMAL_BOY_B), GetNotice_command)
					local noticeState_C =
						GameObject.SendCommand(GameObject.GetGameObjectId(TARGET_NORMAL_BOY_C), GetNotice_command)
					local noticeState_D =
						GameObject.SendCommand(GameObject.GetGameObjectId(TARGET_NORMAL_BOY_D), GetNotice_command)

					Fox.Log("lifeState_A is " .. lifeStatus_A .. " !!")
					Fox.Log("isCollect_YellowHood is " .. tostring(svars.isCollect_YellowHood) .. " !!")

					if
						gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_A)
						and lifeStatus_A == TppGameObject.NPC_LIFE_STATE_NORMAL
						and svars.isCollect_YellowHood == false
					then
					...
					if
						gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_B)
						and lifeStatus_B == TppGameObject.NPC_LIFE_STATE_NORMAL
						and svars.isCollect_Aflo == false
					then
						PlayerGetNear_CNT = PlayerGetNear_CNT + 1
					else
					...
					if
						gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_C)
						and lifeStatus_C == TppGameObject.NPC_LIFE_STATE_NORMAL
						and svars.isCollect_ShortAflo == false
					then
						PlayerGetNear_CNT = PlayerGetNear_CNT + 1
					else
					...
					if
						gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_D)
						and lifeStatus_D == TppGameObject.NPC_LIFE_STATE_NORMAL
						and svars.isCollect_BlackCoat == false
					then
						PlayerGetNear_CNT = PlayerGetNear_CNT + 1
					else
			...
			},
			{
				...
				func = function(gameObjectId)
					...
					elseif PlayerGetAway_CNT >= 1 then
						...
						if
							svars.isBoyHostagesProgress == 2
							and svars.isPassPointProgress == 1
							and svars.isBoyHostages_AutoMoveStop_01 == true
						then
							this.boyHostages_to2ndPassPoint()
						elseif
							svars.isBoyHostagesProgress == 6
							and svars.isPassPointProgress == 2
							and svars.isBoyHostages_AutoMoveStop_02 == true
						then
							this.boyHostages_to3rdPassPoint()
						elseif
							svars.isBoyHostagesProgress == 9
							and svars.isPassPointProgress == 3
							and svars.isBoyHostages_AutoMoveStop_03 == true
						then
							this.boyHostages_to4thPassPoint()
						elseif
							svars.isBoyHostagesProgress == 14
							and svars.isPassPointProgress == 4
							and svars.isBoyHostages_AutoMoveStop_04 == true
						then
							this.boyHostages_to5thPassPoint()
						elseif
							svars.isBoyHostagesProgress == 23
							and svars.isPassPointProgress == 5
							and svars.isBoyHostages_AutoMoveStop_05 == true
						then
							this.boyHostages_lastDush()
						else
						end
			...
			},
			{
				...
				func = function(gameObjectId, carriedState)
					local lifeState_TARGET_INJURY_BOY = GameObject.SendCommand(
						GameObject.GetGameObjectId(gameObjectType_boy, TARGET_INJURY_BOY),
						{ id = "GetLifeStatus" }
					)
					local lifeState_TARGET_NORMAL_BOY_A = GameObject.SendCommand(
						GameObject.GetGameObjectId(gameObjectType_boy, TARGET_NORMAL_BOY_A),
						{ id = "GetLifeStatus" }
					)
					local lifeState_TARGET_NORMAL_BOY_B = GameObject.SendCommand(
						GameObject.GetGameObjectId(gameObjectType_boy, TARGET_NORMAL_BOY_B),
						{ id = "GetLifeStatus" }
					)
					local lifeState_TARGET_NORMAL_BOY_C = GameObject.SendCommand(
						GameObject.GetGameObjectId(gameObjectType_boy, TARGET_NORMAL_BOY_C),
						{ id = "GetLifeStatus" }
					)
					local lifeState_TARGET_NORMAL_BOY_D = GameObject.SendCommand(
						GameObject.GetGameObjectId(gameObjectType_boy, TARGET_NORMAL_BOY_D),
						{ id = "GetLifeStatus" }
					)
					...
					then
						...
						elseif carriedState == 2 then
							if gameObjectId == GameObject.GetGameObjectId(TARGET_INJURY_BOY) then
								if
									lifeState_TARGET_INJURY_BOY == TppGameObject.NPC_LIFE_STATE_NORMAL
									and svars.isReserveFlag_CNT_04 == 0
								then
							...
							elseif gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_A) then
								if
									lifeState_TARGET_NORMAL_BOY_A == TppGameObject.NPC_LIFE_STATE_NORMAL
									and svars.isReserveFlag_CNT_04 == 0
								then
									svars.isReserveFlag_CNT_04 = svars.isReserveFlag_CNT_04 + 1
									GameObject.SendCommand(gameObjectId, voice)
							...
							elseif gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_B) then
								if
									lifeState_TARGET_NORMAL_BOY_B == TppGameObject.NPC_LIFE_STATE_NORMAL
									and svars.isReserveFlag_CNT_04 == 0
								then
									svars.isReserveFlag_CNT_04 = svars.isReserveFlag_CNT_04 + 1
									GameObject.SendCommand(gameObjectId, voice)
							...
							elseif gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_C) then
								if
									lifeState_TARGET_NORMAL_BOY_C == TppGameObject.NPC_LIFE_STATE_NORMAL
									and svars.isReserveFlag_CNT_04 == 0
								then
									svars.isReserveFlag_CNT_04 = svars.isReserveFlag_CNT_04 + 1
									GameObject.SendCommand(gameObjectId, voice)
							...
							elseif gameObjectId == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_D) then
								if
									lifeState_TARGET_NORMAL_BOY_D == TppGameObject.NPC_LIFE_STATE_NORMAL
									and svars.isReserveFlag_CNT_04 == 0
								then
									svars.isReserveFlag_CNT_04 = svars.isReserveFlag_CNT_04 + 1
									GameObject.SendCommand(gameObjectId, voice)
		...
		Timer = {
			{
				msg = "Finish",
				sender = "timer_boyHostagesCollect",
				func = function()
					TppMission.UpdateObjective({ objectives = { "missionTask_3_boyHostages_clear" } })
				end,
			},
			{
				msg = "Finish",
				sender = "timer_boyHostagesCollect_2",
				func = function()
					if svars.isPrisonBreak == false then
						TppResult.AcquireSpecialBonus({ second = { isComplete = true } })
						TppMission.UpdateObjective({
			...
			},
			{
				...
				func = function()
					...
					if
						checkInCamera == true
						and Player.GetGameObjectIdIsRiddenToLocal() == 65535
						and Player.IsOnTheLoadingPlatform() == false
						and phase_diamondSwamp == TppEnemy.PHASE.SNEAK
					then
		...
		Trap = {
			{
				...
				func = function()
					...
					if
						sequence ~= "Seq_Game_BeforeRescueBoy"
						and svars.isPassPointProgress == 0
						and caveDoor_state == true
					then
			...
			},
			{
				...
				func = function()
					...
					if
						sequence ~= "Seq_Game_BeforeRescueBoy"
						and svars.isBoyHostagesCount_clear == 0
						and svars.isPrisonBreak == false
					then
			...
			{
				msg = "Enter",
				sender = "trap_intel_mafr_banana_cp",
				func = function()
					Fox.Log("RT-Radio Trap Enter!!")
			...
			{
				msg = "Enter",
				sender = "boyHostages_WaitUnlock01",
				func = function()
			...
			{
				msg = "Enter",
				sender = "boyHostages_WaitUnlock02",
				func = function()
			...
			{
				msg = "Enter",
				sender = "boyHostages_WaitUnlock03",
				func = function()
			...
			{
				msg = "Enter",
				sender = "boyHostages_WaitUnlock04",
				func = function()
			...
			{
				msg = "Enter",
				sender = "boyHostages_WaitUnlock05",
				func = function()
		...
		Player = {
			{
				...
				func = function(arg1, arg2)
					if
						arg2 == GameObject.GetGameObjectId(TARGET_INJURY_BOY)
						or arg2 == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_A)
						or arg2 == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_B)
						or arg2 == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_C)
						or arg2 == GameObject.GetGameObjectId(TARGET_NORMAL_BOY_D)
					then
						...
						elseif svars.isBoyHostagesFLTN_CNT == 2 then
							if
								TppMotherBaseManagement.IsEquipDeveloped({ equipID = TppEquip.EQP_IT_Fulton_Child })
								== true
							then
								s10100_radio.BoyFultonNg_01()
			...
			},
			{
				...
				func = function()
					...
					if
						svars.isTargetClear == true
						and svars.isBoyHostagesCount_clear > 0
						and svars.isBoyHostagesCount_clear < 5
					then
...
sequences.Seq_Game_BeforeRescueBoy = {
			...
			Player = {
				{
					...
					func = function(playerId, doorId)
						...
						local result, checkAlert, checkEnemy =
							TppDemo.CheckEventDemoDoor(doorId, CHECK_ENEMY_POS, CHECK_ENEMY_RANGE)
	...
	OnEnter = function()
		...
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondSwamp_0002"),
			{ id = "SetEnabled", enabled = false }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondSwamp_0003"),
			{ id = "SetEnabled", enabled = false }
		)

		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondRiver_0004"),
			{ id = "SetEnabled", enabled = false }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondRiver_0005"),
			{ id = "SetEnabled", enabled = false }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondRiver_0006"),
			{ id = "SetEnabled", enabled = false }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondRiver_0007"),
			{ id = "SetEnabled", enabled = false }
		)
...
sequences.Seq_Game_AfterRescueBoy = {
	...
	OnEnter = function()
		...
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondSouth_0000"),
			{ id = "SetEnabled", enabled = false }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondSouth_0001"),
			{ id = "SetEnabled", enabled = false }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondSouth_0002"),
			{ id = "SetEnabled", enabled = false }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondSouth_0003"),
			{ id = "SetEnabled", enabled = false }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondSouth_0004"),
			{ id = "SetEnabled", enabled = false }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("sol_diamondSouth_0005"),
			{ id = "SetEnabled", enabled = false }
		)
