...
this.wav0000_GO_01 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10100_0000"),
		{ id = "StartTravel", travelPlan = "travel_diamondWest_to_banana_wav", keepInAlert = false }
	)
end
this.wav0000_GO_02 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10100_0000"),
		{ id = "StartTravel", travelPlan = "travel_banana_to_diamondWest_wav", keepInAlert = false }
	)
end
...
this.wav0001_GO_01 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10100_0001"),
		{ id = "StartTravel", travelPlan = "travel_savannahNorth_to_savannahWest_wav", keepInAlert = false }
	)
end
this.wav0001_GO_02 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10100_0001"),
		{ id = "StartTravel", travelPlan = "travel_savannahWest_to_savannahNorth_wav", keepInAlert = false }
	)
end
...
this.wav0002_GO_01 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10100_0002"),
		{ id = "StartTravel", travelPlan = "travel_diamondNorth_to_diamondSouth_wav", keepInAlert = false }
	)
end
this.wav0002_GO_02 = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("sol_s10100_0002"),
		{ id = "StartTravel", travelPlan = "travel_diamondSouth_to_diamondNorth_wav", keepInAlert = false }
	)
end
...
this.SetUpEnemy = function()
	...
	TppEnemy.SetRescueTargets(
		{ "hos_diamond_0000", "hos_diamond_0001", "hos_diamond_0002", "hos_diamond_0003", "hos_diamond_0004" },
		{ orCheck = true }
	)
