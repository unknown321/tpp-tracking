...
local spawnList = {
	{
		id = "Spawn",
		locator = "Vehs_lvDOp_0000",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "Vehs_lvDW_0000",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "Vehs_lvDW_0001",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "Vehs_truck_0000",
...
this.routeChangeTableRoot[Fox.StrCode32("huntingShift")] = {
...

	{
		...
		afterRouteName = "rts_hunting_B_0000",
	},
	{
		beforeRouteName = {
			"rt_banana_d_0003",
	...
	},
	{
		...
		afterRouteName = "rts_hunting_B_0001",
	},
	{
		beforeRouteName = {
			"rt_banana_d_0006",
...
this.routeChangeTableRoot[Fox.StrCode32("End_hunting_DW_0000_1")] = {
	{
		beforeRouteName = "rts_hunting_DW_0000_1",
		afterRouteName = { "rts_hunting_DW_0000_2A", "rts_hunting_DW_0000_2B" },
	},
}
this.routeChangeTableRoot[Fox.StrCode32("End_hunting_DW_0001_1")] = {
	{
		beforeRouteName = "rts_hunting_DW_0001_1",
		afterRouteName = { "rts_hunting_DW_0001_2A", "rts_hunting_DW_0001_2B" },
	},
}
this.routeChangeTableRoot[Fox.StrCode32("End_hunting_DOp_0000_1")] = {
	{
		beforeRouteName = "rts_hunting_DOp_0000_1",
		afterRouteName = { "rts_hunting_DOp_0000_2A", "rts_hunting_DOp_0000_2B" },
	},
}

this.routeChangeTableRoot[Fox.StrCode32("End_hunting_BE_0000_1")] = {
	{
		beforeRouteName = "rts_hunting_BE_0000_1",
		afterRouteName = { "rts_hunting_BE_0000_2A", "rts_hunting_BE_0000_2B" },
	},
}
this.routeChangeTableRoot[Fox.StrCode32("End_hunting_BE_0001_1")] = {
	{
		beforeRouteName = "rts_hunting_BE_0001_1",
		afterRouteName = { "rts_hunting_BE_0001_2A", "rts_hunting_BE_0001_2B" },
	},
}
this.routeChangeTableRoot[Fox.StrCode32("End_hunting_BE_0002_1")] = {
	{
		beforeRouteName = "rts_hunting_BE_0002_1",
		afterRouteName = { "rts_hunting_BE_0002_2A", "rts_hunting_BE_0002_2B" },
	},
}
...
this.OnRoutePoint = function(gameObjectId, routeId, routeNodeIndex, messageId)
	Fox.Log(
		"s10081_sequence.OnRoutePoint( gameObjectId:"
...
this.SetUpCorpse = function()
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpseGameObjectLocator0000"),
		{ id = "ChangeFovaCorpse", faceId = EnemyFova.INVALID_FOVA_VALUE, bodyId = 90 }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpseGameObjectLocator0001"),
		{ id = "ChangeFovaCorpse", faceId = EnemyFova.INVALID_FOVA_VALUE, bodyId = 91 }
	)
	...
	local cmdInitMotion = {
		id = "SetInitMotion",
		path = "/Assets/tpp/motion/SI_game/fani/bodies/enet/enetzmb/enetzmb_s_rag_ded_p_e.gani",
	}
	...
	local cmdInitMotion2 = {
		id = "SetInitMotion",
		path = "/Assets/tpp/motion/SI_game/fani/bodies/enet/enetzmb/enetzmb_s_rag_ded_p_c.gani",
	}
