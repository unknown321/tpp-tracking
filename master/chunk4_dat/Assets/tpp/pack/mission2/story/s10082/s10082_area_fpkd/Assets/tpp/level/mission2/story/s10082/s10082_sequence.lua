...
this.missionObjectiveDefine = {
	...
	default_area_savannah = {
		gameObjectName = "s10082_marker_savannah",
		visibleArea = 5,
		randomRange = 0,
		viewType = "all",
		setNew = false,
		announceLog = "updateMap",
		mapRadioName = "s0082_mprg2010",
	...
	on_Search_WalkerGear_00 = {
		gameObjectName = "wkr_WalkerGear_0000",
		goalType = "attack",
	...
	on_Search_WalkerGear_01 = {
		gameObjectName = "wkr_WalkerGear_0001",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = true,
	...
	on_Search_WalkerGear_02 = {
		gameObjectName = "wkr_WalkerGear_0002",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = true,
	...
	on_Search_WalkerGear_03 = {
		gameObjectName = "wkr_WalkerGear_0003",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = true,
	...
	on_hostage_00 = {
		gameObjectName = "hos_s10082_0000",
		goalType = "none",
		viewType = "map_and_world_only_icon",
		setNew = true,
		announceLog = "updateMap",
	...
	on_hostage_01 = {
		gameObjectName = "hos_s10082_0001",
		goalType = "none",
		viewType = "map_and_world_only_icon",
		setNew = true,
		announceLog = "updateMap",
	...
	default_specialbonus_recovered_hostage = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SPECIALBONUS_RECOVERED_HOSTAGE,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
	...
	default_specialbonus_recovered_walkergear = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SPECIALBONUS_RECOVERED_WALKERGEAR,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
	...
	default_subTask_recovered_digitalis = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SUB_RECOVERED_DIGITALIS,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
	...
	default_subTask_recovered_truck = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SUB_RECOVERED_TRUCK,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
			...
			if Tpp.IsEnemyWalkerGear(gameObjectId) then
				if _IsTaget(gameObjectId, this.WALKERGEARTABLE) then
					...
					TppUI.ShowAnnounceLog(
						...
						svars.WG_FultonCount + svars.walkerGearBrokenCount,
						MAX_COUNT_RECOVER_WALKERGEAR
					)
					this.WG_Annihilated()
...
sequences.Seq_Game_MainGame = {
	...
	savannahChangePhase = function(cpName, PhaseName)
		...
		elseif TppEnemy.GetPhase("mafr_swampEast_ob") == TppEnemy.PHASE.ALERT and mvars.isInSavannah == false then
			TppRadio.SetOptionalRadio("Set_s0082_oprg0050")
		elseif
			TppEnemy.GetPhase("mafr_savannah_cp") < TppEnemy.PHASE.ALERT
			and svars.WG_FultonCount + svars.walkerGearBrokenCount <= 4
		then
...
sequences.Seq_Game_Escape = {
	...
	OnEnter = function()
		...
		TppMission.UpdateObjective({
			...
			objectives = { "rv_missionClear", "on_subGoal_missionComplete" },
		})
	end,
}
