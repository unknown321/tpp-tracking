...
this.SetUpEnemy = function()
	...
	this.SetEnemyVehicle(
		{ this.INTERROGATOR_SOLDIER_1_NAME, this.INTERROGATOR_SOLDIER_2_NAME },
		HILL_VEHICLE_NAME,
		true
	)
	this.SetEnemyVehicle(
		{ this.CHECKPOINT_REINFORCE_SOLDIER_1_NAME, this.CHECKPOINT_REINFORCE_SOLDIER_2_NAME },
		CHECKPOINT_VEHICLE_NAME,
		false
	)
