...
this.PlayLiquidTest0 = function(func)
	TppDemo.Play("Demo_Liquid_combatcamera", {
		onEnd = function()
			func()
		end,
	}, {
...
this.PlayLiquidTest = function(func)
	TppDemo.Play("Demo_Liquid_combat", {
		onStart = function()
...
this.PlayLiquidTest2 = function(funcs)
	TppDemo.Play("Demo_Liquid_combatEnd", funcs, { useDemoBlock = true })
end

this.PlayLiquidTest3 = function(func)
	Fox.Log("plsy cemo")
	TppDemo.Play("Demo_Liquid_HeliEscape", {
		onEnd = function()
			func()
		end,
	}, {
