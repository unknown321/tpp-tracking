...
this.soldierTypes = {
	CHILD = {
		this.soldierDefine.mafr_outland_cp,
		this.soldierDefine.mafr_outlandNorth_ob,
	},
}
...
this.HighInterrogation = function()
	...
	TppInterrogation.AddHighInterrogation(GameObject.GetGameObjectId("mafr_outland_cp"), {
		{ name = this.INTERROGATE_HOSTAGE[1], func = this.InterCall_Hostage },
	})
end
