...
local spawnList = {
	{
		id = "Spawn",
		locator = "Vehs_lv_dealer_0001",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "Vehs_lv_dealer_0000",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "Vehs_lv_hillNorth_0000",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "Vehs_lv_hillWest_0000",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "Vehs_lv_pfCampNorth_0000",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_1,
	},
	{
		id = "Spawn",
		locator = "Vehs_lv_savannahEast_0000",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_1,
	},
}
...
this.routeChangeTableRoot[Fox.StrCode32("startMeeting")] = {

	{
		func = function()
			...
			if
				isVipStatus == TppGameObject.NPC_STATE_NORMAL
				and isDealerStatus == TppGameObject.NPC_STATE_NORMAL
				and svars.isMeeting == false
			then
...
this.OnRoutePoint = function(gameObjectId, routeId, routeNodeIndex, messageId)
	Fox.Log(
		"s10195_sequence.OnRoutePoint( gameObjectId:"
...
this.FuncRestoreRoute = function() end
...
this.HighInterrogation = function()
	...
	TppInterrogation.AddHighInterrogation(GameObject.GetGameObjectId("mafr_hillNorth_ob"), {
		{ name = "enqt1000_1i1210", func = this.InterCall_Hostage },
	})
end
...
this.SetUpEnemy = function()
	...
	TppEnemy.SetEliminateTargets({ "sol_dealer", "sol_vip" }, { exceptMissionClearCheck = { "sol_vip" } })
