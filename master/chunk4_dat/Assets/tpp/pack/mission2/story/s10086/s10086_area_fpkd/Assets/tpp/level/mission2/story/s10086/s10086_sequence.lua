...
s10086_sequence.missionObjectiveDefine = {
	...
	marker_interpreter1 = {
		...
		setImportant = true,
		setNew = true,
		mapRadioName = "s0086_mprg0010",
		announceLog = "updateMap",
		langId = "marker_enemyarea_trans",
	},
	marker_interpreter_clear = {
		...
		setImportant = true,
		setNew = true,
		langId = "marker_ene_translator",
		hudPhotoId = 20,
		announceLog = "updateMap",
	},
	marker_interrogation = {
		gameObjectName = "marker_interrogation",
		goalType = "moving",
		viewType = "map",
		visibleArea = 0,
		randomRange = 0,
	...
	marker_intel_swamp = {
		gameObjectName = "marker_intel_swamp",
		announceLog = "updateMap",
	},
	...
	photo_interpreter = {
		...
		addFirst = true,
		photoRadioName = "s0086_mirg0010",
	},
	photo_target = {
		photoId = PHOTO_ID_TARGET,
		addFirst = true,
		photoRadioName = "s0086_mirg0020",
	},
...
function s10086_sequence.SetUpRouteChange()
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("start_of_rts_guard1_to_fake_target1_0000")] = {
		{
			func = function()
				s10086_sequence.StartTimer("Timer_WaitGuard1", 120)
			end,
		},
		{
			func = function()
				s10086_enemy.HostageRideVehicle(s10086_enemy.FAKE_TARGET1_NAME, "veh_s10086_0000")
			end,
		},
		{
			func = function()
				svars.reservedNumber0000 = 32
			end,
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("ArriveAtFakeTarget1")] = {
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyName = s10086_enemy.INTERROGATOR_NAME,
			routeId = "rts_interrogator_interrogation1_0000",
			cautionRouteId = "rts_interrogator_interrogation1_0000",
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyName = s10086_enemy.INTERPRETER_NAME,
			routeId = "rts_interpreter_interrogation1_0000",
			cautionRouteId = "rts_interpreter_interrogation1_0000",
		},
		{
			enemyName = s10086_enemy.GUARD1_NAME,
			routeId = "rts_guard1_to_fake_target1_0001",
			cautionRouteId = "rts_guard1_to_fake_target1_0001",
		},
		{
			func = function()
				s10086_enemy.ChangeHostageRoute(
					s10086_enemy.FAKE_TARGET1_NAME,
					"rts_fake_target1_to_fake_target1_0000",
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("end_of_rts_guard1_to_fake_target1_0001")] = {
		{
			enemyName = s10086_enemy.GUARD1_NAME,
			routeId = "rts_guard1_interrogation1_0000",
			cautionRouteId = "rts_guard1_interrogation1_0000",
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("end_of_rts_fake_target1_to_fake_target1_0000")] = {
		{
			func = function()
				s10086_enemy.ChangeHostageRoute(
					s10086_enemy.FAKE_TARGET1_NAME,
					"rts_fake_target1_interrogation_0000",
					s10086_enemy.GUARD1_NAME
				)
			end,
		},
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation1Ready")] = {
		{
			func = function()
				s10086_sequence.StartTimer("Timer_Interrogation1TimeOut", 120)
			end,
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation1Start")] = {

		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			func = function()
				s10086_sequence.CallConversation(s10086_sequence.CONVERSATION_TYPE.SWAMP_WEST_NEAR)
			end,
		},
		{
			func = function()
				GameObject.SendCommand(
					GameObject.GetGameObjectId(s10086_enemy.FAKE_TARGET1_NAME),
					{ id = "SetHostage2Flag", flag = "silent", on = true }
				)
			end,
		},
	}
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation1End")] = {
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyName = s10086_enemy.INTERROGATOR_NAME,
			routeId = "rts_interpreter_to_fake_target2_0000",
			cautionRouteId = "rts_interpreter_to_fake_target2_c_0000",
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyName = s10086_enemy.INTERPRETER_NAME,
		...
		{
			enemyName = s10086_enemy.GUARD1_NAME,
			routeId = "rts_guard1_to_fake_target3_0000",
			cautionRouteId = "rts_guard1_to_fake_target3_0000",
		},
		{
			func = function()
				GameObject.SendCommand(
					GameObject.GetGameObjectId(s10086_enemy.FAKE_TARGET1_NAME),
					{ id = "SetFollowed", enable = true }
				)
				s10086_enemy.ChangeHostageRoute(
					s10086_enemy.FAKE_TARGET1_NAME,
					"rts_guard1_to_fake_target3_0000",
					s10086_enemy.GUARD1_NAME
				)
			end,
		},
		...
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			func = function()
				s10086_sequence.StartTimer("Timer_WaitInterpreter", 300)
			end,
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			func = function()
				s10086_sequence.StartTimer("Timer_WaitInterrogator", 300)
			end,
		},
		{
			func = function()
				s10086_sequence.StopTimer("Timer_Interrogation1TimeOut")
			end,
		},
		{
			func = function()
				GameObject.SendCommand(
					GameObject.GetGameObjectId(s10086_enemy.FAKE_TARGET1_NAME),
					{ id = "SetHostage2Flag", flag = "silent", on = false }
				)
			end,
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("StartToFakeTarget2")] = {
		{
			func = function()
				svars.reservedNumber0000 = 47
			end,
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("radio0000")] = {
		{
			enemyNameOnTheRoute = s10086_enemy.INTERPRETER_NAME,
			func = function()
				s10086_radio.WarnHostageKilled()
			end,
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("radio0001")] = {
		{
			enemyNameOnTheRoute = s10086_enemy.INTERPRETER_NAME,
			func = function()
				s10086_radio.AboutInterrogation()
			end,
		},
	}
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("ArriveAtFakeTarget2")] = {
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyNameOnTheRoute = s10086_enemy.INTERROGATOR_NAME,
			enemyName = s10086_enemy.INTERROGATOR_NAME,
			routeId = "rts_interrogator_interrogation2_0000",
			cautionRouteId = "rts_interrogator_interrogation2_0000",
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyNameOnTheRoute = s10086_enemy.INTERPRETER_NAME,
			enemyName = s10086_enemy.INTERPRETER_NAME,
			routeId = "rts_interpreter_interrogation2_0000",
			cautionRouteId = "rts_interpreter_interrogation2_0000",
		},
		{
			enemyNameOnTheRoute = s10086_enemy.INTERPRETER_NAME,
			enemyName = s10086_enemy.GUARD2_NAME,
			routeId = "rts_guard2_interrogation2_0000",
			cautionRouteId = "rts_guard2_interrogation2_0000",
		},
	}
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation2Ready")] = {
		{
			func = function()
				s10086_sequence.StartTimer("Timer_Interrogation2TimeOut", 120)
			end,
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation2Start")] = {
		...
		{
			func = function()
				s10086_sequence.CallConversation(s10086_sequence.CONVERSATION_TYPE.SWAMP_WEST)
			end,
		},
		{
			func = function()
				GameObject.SendCommand(
					GameObject.GetGameObjectId(s10086_enemy.FAKE_TARGET2_NAME),
					{ id = "SetHostage2Flag", flag = "silent", on = true }
				)
			end,
		},
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation2End")] = {
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyName = s10086_enemy.INTERROGATOR_NAME,
			routeId = "rts_interpreter_to_fake_target3_0000",
			cautionRouteId = "rts_interpreter_to_fake_target3_c_0000",
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyName = s10086_enemy.INTERPRETER_NAME,
		...
		{
			enemyName = s10086_enemy.GUARD2_NAME,
			routeId = "rts_guard2_execute2_0000",
			cautionRouteId = "rts_guard2_execute2_0000",
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			func = function()
				s10086_sequence.StartTimer("Timer_WaitInterpreter", 700)
			end,
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			func = function()
				s10086_sequence.StartTimer("Timer_WaitInterrogator", 700)
			end,
		},
		{
			func = function()
				s10086_radio.OnFakeTargetInterrogationFinished(s10086_enemy.FAKE_TARGET2_NAME)
			end,
		},
		{
			func = function()
				s10086_sequence.StopTimer("Timer_Interrogation2TimeOut")
			end,
		},
		{
			func = function()
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("WaitToExecute2End")] = {
		{
			func = function()
				TppEnemy.UnsetSneakRoute(s10086_enemy.GUARD2_NAME)
			end,
		},
		{
			func = function()
				TppEnemy.UnsetCautionRoute(s10086_enemy.GUARD2_NAME)
			end,
		},
		{
			func = function()
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("ArriveAtFakeTarget3")] = {
		{
			...
			enemyNameOnTheRoute = s10086_enemy.INTERPRETER_NAME,
			enemyName = s10086_enemy.INTERPRETER_NAME,
			routeId = "rts_interpreter_interrogation3_0000",
			cautionRouteId = "rts_interpreter_interrogation3_0000",
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyNameOnTheRoute = s10086_enemy.INTERROGATOR_NAME,
			enemyName = s10086_enemy.INTERROGATOR_NAME,
			routeId = "rts_interrogator_interrogation3_0000",
			cautionRouteId = "rts_interrogator_interrogation3_0000",
		},
		{
			func = function()
				s10086_enemy.ChangeHostageRoute(s10086_enemy.FAKE_TARGET1_NAME, "rts_fake_target1_interrogation3_0000")
			end,
		},
		{
			func = function()
				s10086_enemy.ChangeHostageRoute(s10086_enemy.FAKE_TARGET3_NAME, "rts_fake_target3_interrogation3_0000")
			end,
		},
		{
			enemyNameOnTheRoute = s10086_enemy.INTERPRETER_NAME,
			enemyName = s10086_enemy.GUARD1_NAME,
			routeId = "rts_guard1_interrogation3_0000",
			cautionRouteId = "rts_guard1_interrogation3_0000",
		},
		{
			enemyNameOnTheRoute = s10086_enemy.INTERPRETER_NAME,
			enemyName = s10086_enemy.GUARD3_NAME,
			routeId = "rts_guard3_before_interrogation3_0000",
			cautionRouteId = "rts_guard3_before_interrogation3_0000",
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("end_of_rts_guard3_before_interrogation3_0000")] = {
		{
			enemyName = s10086_enemy.GUARD3_NAME,
			routeId = "rts_guard3_interrogation3_0000",
			cautionRouteId = "rts_guard3_interrogation3_0000",
		},
	}
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("mid_of_rts_fake_target1_interrogation3_0000")] = {
		{
			enemyName = s10086_enemy.GUARD1_NAME,
			routeId = "rts_guard1_interrogation3_0001",
			cautionRouteId = "rts_guard1_interrogation3_0001",
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("end_of_rts_fake_target1_interrogation3_0000")] = {
		{
			func = function()
				s10086_enemy.ChangeHostageRoute(s10086_enemy.FAKE_TARGET1_NAME, "")
			end,
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("mid_of_rts_fake_target3_interrogation3_0000")] = {
		{
			enemyName = s10086_enemy.GUARD3_NAME,
			routeId = "rts_guard3_interrogation3_0001",
			cautionRouteId = "rts_guard3_interrogation3_0001",
		},
	}
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("end_of_rts_fake_target3_interrogation3_0000")] = {
		{
			func = function()
				s10086_enemy.ChangeHostageRoute(s10086_enemy.FAKE_TARGET3_NAME, "")
			end,
		},
	}
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation3Ready")] = {
		{
			func = function()
				s10086_sequence.StartTimer("Timer_Interrogation3TimeOut", 180)
			end,
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation3Start")] = {
		...
		{
			func = function()
				s10086_sequence.OnInterrogation3Ready()
			end,
		},
		{
			func = function()
		...
		},
		{
			func = function()
				GameObject.SendCommand(
					GameObject.GetGameObjectId(s10086_enemy.FAKE_TARGET3_NAME),
					{ id = "SetHostage2Flag", flag = "silent", on = true }
				)
			end,
		},
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation3End")] = {
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyName = s10086_enemy.INTERPRETER_NAME,
			routeId = "rts_interpreter_wait_0000",
			cautionRouteId = "rts_interpreter_wait_0000",
		},
		{
			checkFunc = s10086_sequence.DoesNotBecomeAtNight,
			enemyName = s10086_enemy.INTERROGATOR_NAME,
		...
		{
			enemyName = s10086_enemy.GUARD1_NAME,
			routeId = "rts_guard1_execute3_0000",
			cautionRouteId = "rts_guard1_execute3_0000",
		},
		{
			enemyName = s10086_enemy.GUARD3_NAME,
			routeId = "rts_guard3_execute3_0000",
			cautionRouteId = "rts_guard3_execute3_0000",
		},
		{
			func = function()
				s10086_radio.OnFakeTargetInterrogationFinished(s10086_enemy.FAKE_TARGET1_NAME)
			end,
		},
		{
			func = function()
				s10086_radio.OnFakeTargetInterrogationFinished(s10086_enemy.FAKE_TARGET3_NAME)
			end,
		},
		{
			func = function()
		...
		{
			func = function()
				s10086_sequence.StopTimer("Timer_Interrogation3TimeOut")
			end,
		},
		{
			func = function()
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("WaitToExecute3End")] = {
		...
		{
			func = function()
				TppEnemy.UnsetSneakRoute(s10086_enemy.GUARD1_NAME)
			end,
		},
		{
			func = function()
				TppEnemy.UnsetCautionRoute(s10086_enemy.GUARD1_NAME)
			end,
		},
		{
			func = function()
				TppEnemy.UnsetSneakRoute(s10086_enemy.GUARD3_NAME)
			end,
		},
		{
			func = function()
				TppEnemy.UnsetCautionRoute(s10086_enemy.GUARD3_NAME)
			end,
		},
	}
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("ArriveAtTarget")] = {
		{
			enemyNameOnTheRoute = s10086_enemy.INTERPRETER_NAME,
			enemyName = s10086_enemy.INTERPRETER_NAME,
			routeId = "rts_interpreter_interrogation4_0000",
			cautionRouteId = "rts_interpreter_interrogation4_0000",
		},
		{
			enemyNameOnTheRoute = s10086_enemy.INTERROGATOR_NAME,
			enemyName = s10086_enemy.INTERROGATOR_NAME,
			routeId = "rts_interrogator_interrogation4_0000",
			cautionRouteId = "rts_interrogator_interrogation4_0000",
		},
	}
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("MoveTargetEnd")] = {
		{
			...
			routeId = "rts_guard4_interrogation4_0000",
			cautionRouteId = "rts_guard4_interrogation4_0000",
		},
		{
			enemyNameOnTheRoute = s10086_enemy.TARGET_NAME,
			func = function()
				GameObject.SendCommand(
					GameObject.GetGameObjectId(s10086_enemy.TARGET_NAME),
					{ id = "SetFollowed", enable = false }
				)
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation4Ready")] = {
		{
			func = function()
				s10086_sequence.StartTimer("Timer_Interrogation4TimeOut", 180)
			end,
		},
	}
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("Interrogation4End")] = {
		{
			enemyName = s10086_enemy.GUARD4_NAME,
			routeId = "rts_guard4_execute4_0000",
			cautionRouteId = "rts_guard4_execute4_0000",
		},
		{
			func = function()
				TppEnemy.UnsetSneakRoute(s10086_enemy.INTERPRETER_NAME)
			end,
		},
		{
			func = function()
				TppEnemy.UnsetCautionRoute(s10086_enemy.INTERPRETER_NAME)
			end,
		},
		{
			func = function()
				TppEnemy.UnsetSneakRoute(s10086_enemy.INTERROGATOR_NAME)
			end,
		},
		{
			func = function()
				TppEnemy.UnsetCautionRoute(s10086_enemy.INTERROGATOR_NAME)
			end,
		},
		{
			func = function()
				s10086_sequence.StopTimer("Timer_Interrogation4TimeOut")
			end,
		},
		{
			func = function()
	...
	s10086_sequence.routeChangeTableRoot[Fox.StrCode32("WaitToExecute4End")] = {
		...
		{
			func = function()
				TppEnemy.UnsetSneakRoute(s10086_enemy.GUARD4_NAME)
			end,
		},
		{
			func = function()
				TppEnemy.UnsetCautionRoute(s10086_enemy.GUARD4_NAME)
			end,
		},
	}
	...
	return StrCode32Table({
		GameObject = {
			...
			},
			{
				...
				func = function()
					Fox.Log(
						"s10086_sequence.Messages(): GameObject: Dead: sender: "
							.. tostring(s10086_enemy.INTERPRETER_NAME)
					)
			...
			},
			{
				...
				func = function(gameObjectId, containerName)
					Fox.Log(
						"s10086_sequence.Messages(): GameObject: Fulton: gameObjectId:"
					...
					if Tpp.IsFultonContainer(gameObjectId) then
						for i, gimmickName in pairs(MISSION_TASK_CONTAINER_LIST) do
							...
							if targetGameObjectId == GameObject.NULL_ID then
								Fox.Warning(
									"s10086_sequence.Messages(): targetGameObjectId is invalid value:"
			...
			},
			{
				...
				func = function()
					Fox.Log(
						"s10086_sequence.Messages(): GameObject: Fulton: sender: "
							.. tostring(s10086_enemy.INTERPRETER_NAME)
					)
					if not s10086_sequence.IsRecognized(s10086_enemy.INTERPRETER_NAME) then
						TppSoundDaemon.PostEvent("sfx_s_enemytag_main_tgt")
			...
			},
			{
				...
				func = function()
					Fox.Log(
						"s10086_sequence.Messages(): GameObject: FultonFailed: sender: "
							.. tostring(s10086_enemy.INTERPRETER_NAME)
					)
					if not s10086_sequence.IsRecognized(s10086_enemy.INTERPRETER_NAME) then
						TppSoundDaemon.PostEvent("sfx_s_enemytag_main_tgt")
			...
			},
			{
				...
				func = function(gameObjectId, speechLabel, isSuccess)
					Fox.Log(
						"s10086_sequence.Messages(): ConversationEnd Message Received. gameObjectId:"
							.. tostring(gameObjectId)
							.. ", speechLabel:"
							.. tostring(speechLabel)
							.. ", isSuccess:"
							.. isSuccess
					)

					local conversationType, nextSpeechLabel, currentSpeechLabel, speakerId =
						s10086_sequence.GetNextSpeechLabel(speechLabel)

					if isSuccess == 1 then
						Fox.Log(
							"s10086_sequence.Messages(): ConversationEnd Message Received. conversationType:"
								.. tostring(conversationType)
								.. ", nextSpeechLabel:"
								.. tostring(nextSpeechLabel)
								.. ", currentSpeechLabel:"
								.. tostring(currentSpeechLabel)
								.. ", speakerId:"
								.. tostring(speakerId)
						)

						if
							speakerId and gameObjectId == GameObject.GetGameObjectId(speakerId)
							or (
								mvars.SPECIAL_MONOLOGUE_TABLE[currentSpeechLabel]
								and gameObjectId
									== GameObject.GetGameObjectId(
										mvars.SPECIAL_MONOLOGUE_TABLE[currentSpeechLabel].speaker
									)
							)
						then
							if conversationType and nextSpeechLabel then
								...
								s10086_sequence.OnRoutePoint(
									s10086_enemy.INTERPRETER_NAME,
									nil,
									nil,
									SPEECH_MESSAGE_MAP[speechLabel]
								)
							end
					...
					elseif SPEECH_TABLE[conversationType] then
						s10086_sequence.OnRoutePoint(
							...
							nil,
							nil,
							Fox.StrCode32(SPEECH_TABLE[conversationType].message)
						)
					end
				end,
			},
			...
			},
			{
				...
				func = function(gameObjectId)
					...
					if mvars.currentMonologueTable[gameObjectId] then
						...
						local conversationType, nextSpeechLabel, currentSpeechLabel, speakerId =
							s10086_sequence.GetNextSpeechLabel(Fox.StrCode32(speechLabel))
						Fox.Log(
							"s10086_sequence.Messages(): MonologueEnd: speechLabel:"
								.. tostring(speechLabel)
								.. ", conversationType:"
								.. tostring(conversationType)
								.. ", nextSpeechLabel:"
						...
						if conversationType and nextSpeechLabel then
							...
							s10086_sequence.OnRoutePoint(
								...
								nil,
								nil,
								Fox.StrCode32(SPEECH_MESSAGE_MAP[speechLabel])
							)
						end
		...
		Weather = {
			...
			},
			{
				...
				func = function(sender, time)
					Fox.Log(
						"Received Message: Weather: Clock: sender:" .. tostring(sender) .. ", time" .. tostring(time)
					)
					...
					if not svars.reservedBoolean0001 then
						...
						Fox.Log(
							"Received Message: Weather: Clock: ignore operation because the operation is already done."
						)
					end
				end,
			},
		...
		Trap = {
			{
				...
				func = function()
					...
					if svars.isTargetInRoom and svars.isTargetDead then
						local soldiers =
							{ s10086_enemy.INTERPRETER_NAME, s10086_enemy.INTERROGATOR_NAME, s10086_enemy.GUARD4_NAME }
		...
		Player = {
			{
				...
				func = function(intelNameHash)
					Fox.Log(
						"s10086_sequence.Messages(): GetIntel: Intel_swamp: intelNameHash:" .. tostring(intelNameHash)
					)
			...
			},
			{
				...
				func = function(equipId, equipTypeId, isFlashLight, isShield)
					Fox.Log(
						"s10086_sequence.Messages(): Player: PlayerHoldWeapon: equipId:"
							.. tostring(equipId)
							.. "equipTypeId"
							.. tostring(equipTypeId)
					)
		...
		Subtitles = {
			{
				...
				func = function(speechLabel, status)
					Fox.Log(
						"s10086_sequence.Messages(): Subtitles: SubtitlesEndEventMessage: speechLabel:"
							.. tostring(speechLabel)
							.. ", status:"
							.. tostring(status)
					)
					...
					if speechLabel == SubtitlesCommand:ConvertToSubtitlesId("stpf2000_1u1010_0_enea_af") then
						Fox.Log(
							"s10086_sequence.Messages(): Subtitles: SubtitlesEndEventMessage: this speechLabel is English Subtitles."
						)
...
function s10086_sequence.OnMarked(s_locatorName, markerType, targetGameObjectId, s_sourceLocatorName)
	Fox.Log(
		"s10086_sequence.OnMarked(): s_locatorName:"
			.. tostring(s_locatorName)
			.. ", markerType:"
			.. tostring(markerType)
			.. ", targetGameObjectId:"
			.. tostring(targetGameObjectId)
			.. ", s_sourceLocatorName:"
			.. tostring(s_sourceLocatorName)
	)

	if
		s_sourceLocatorName == Fox.StrCode32("Player")
		and targetGameObjectId == GameObject.GetGameObjectId(s10086_enemy.INTERPRETER_NAME)
	then
...
s10086_sequence.OnRoutePoint = function(gameObjectId, routeId, routeNodeIndex, messageId)
	Fox.Log(
		"s10086_sequence.OnRoutePoint( gameObjectId:"
			.. tostring(gameObjectId)
			.. ", routeId:"
			.. tostring(routeId)
			.. ", routeNodeIndex:"
	...
	if routeChangeTables then
		for i, routeChangeTable in ipairs(routeChangeTables) do
			...
			local routeCheck = not routeChangeTable.enemyNameOnTheRoute
				or GameObject.GetGameObjectId(routeChangeTable.enemyNameOnTheRoute) == gameObjectId
...
s10086_sequence.IsRecovered = function(inGameObjectId)
	...
	Fox.Log(
		"s10086_sequence.IsRecovered(): locatorName:"
...
s10086_sequence.OnRecovered = function(inGameObjectId)
	...
	Fox.Log(
		"s10086_sequence.OnRecovered(): locatorName:"
			.. tostring(locatorName)
			.. ", gameObjectId:"
			.. tostring(gameObjectId)
	)
...
s10086_sequence.OnInterpreterRecognized = function(messageName, gameObjectId)
	Fox.Log(
		"s10086_sequence.OnInterpreterRecognized(): messageName:"
...
s10086_sequence.OnTargetRecognized = function(messageName, gameObjectId)
	Fox.Log(
		"s10086_sequence.OnTargetRecognized(): messageName:"
			.. tostring(messageName)
			.. ", gameObjectId:"
			.. tostring(gameObjectId)
	)
...
s10086_sequence.OnFakeTargetRecognized = function(messageName, gameObjectId)
	Fox.Log(
		"s10086_sequence.OnFakeTargetRecognized(): messageName:"
			.. tostring(messageName)
			.. ", gameObjectId:"
			.. tostring(gameObjectId)
	)
...
s10086_sequence.OnRecognized = function(messageName, gameObjectId)
	Fox.Log(
		"s10086_sequence.OnRecognized(): messageName:"
			.. tostring(messageName)
			.. ", gameObjectId:"
			.. tostring(gameObjectId)
	)
...
s10086_sequence.OnChangePahse = function(gameObjectId, newPhase, prePhase)
	Fox.Log(
		"s10086_sequence.OnChangePahse(): gameObjectId:"
			.. tostring(gameObjectId)
			.. ", newPhase:"
			.. tostring(newPhase)
			.. ", prePhase:"
	...
	local isAlert = (prePhase == TppGameObject.PHASE_ALERT or prePhase == TppGameObject.PHASE_EVASION)
		and (newPhase == TppGameObject.PHASE_CAUTION or newPhase == TppGameObject.PHASE_SNEAK)
	...
	if newPhase == TppGameObject.PHASE_CAUTION then
		GameObject.SendCommand(
			GameObject.GetGameObjectId("TppSoldier2", s10086_enemy.INTERPRETER_NAME),
			{ id = "SetRestrictNotice", enabled = true }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("TppSoldier2", s10086_enemy.INTERROGATOR_NAME),
			{ id = "SetRestrictNotice", enabled = true }
		)
	end
end
...
s10086_sequence.IsConversationReady = function(conversationType)
	...
	for i, enemyAndRouteTable in pairs(enemyList) do
		...
		if routeName or cautionRouteName then
			isOnRoute = (
				s10086_enemy.IsEnemyOnRoute(enemyName, routeName)
				or s10086_enemy.IsEnemyOnRoute(enemyName, cautionRouteName)
			)
		else
			isOnRoute = true
		end
		...
		if identifierName and key then
			...
			isInRange = GameObject.SendCommand(
				GameObject.GetGameObjectId(enemyName),
				{ id = "IsInRange", range = 5, target = { position[1], position[2], position[3] } }
			)
		else
			isInRange = true
		end
		...
		Fox.Log(
			"s10086_sequence.IsConversationReady(): enemyName:"
				.. tostring(enemyName)
				.. ", isEnemyNormal:"
				.. tostring(isEnemyNormal)
				.. ", isOnRoute:"
				.. tostring(isOnRoute)
				.. ", isInRange:"
				.. tostring(isInRange)
...
s10086_sequence.CallConversation = function(conversationType, targetSpeechLabel)
	...
	if not s10086_sequence.IsConversationReady(conversationType) then
		Fox.Log(
			"s10086_sequence.CallConversation(): ignore operation because s10086_sequence.IsConversationReady() is false."
		)
		return
	end
	...
	if
		conversationType ~= s10086_sequence.CONVERSATION_TYPE.SWAMP_WEST_NEAR
		and s10086_enemy.IsFakeTarget(friendName)
		and targetSpeechLabel == nil
	then
...
sequences.Seq_Game_SearchTarget = {
		...
		return StrCode32Table({
			GameObject = {
				...
				},
				{
					...
					func = function(passengerId, vehicleId)
						Fox.Log(
							"sequences.Seq_Game_SearchTarget.Messages(): passengerId"
								.. tostring(passengerId)
								.. ", vehicleId"
								.. tostring(vehicleId)
						)

						if
							vehicleId == GameObject.GetGameObjectId("SupportHeli")
							and passengerId == GameObject.GetGameObjectId(s10086_enemy.TARGET_NAME)
						then
			...
			Timer = {
					...
					func = function()
						...
						then
							...
							s10086_sequence.OnRoutePoint(
								...
								nil,
								nil,
								Fox.StrCode32("Interrogation1End")
							)
				...
				},
				{
					...
					func = function()
						Fox.Log(
							"sequences.Seq_Game_SearchTarget.Messages(): Timer: Finish: Timer_Interrogation1TimeOut"
						)
						s10086_sequence.OnRoutePoint(
							s10086_enemy.GUARD1_NAME,
							nil,
				...
				},
				{
					...
					func = function()
						s10086_sequence.OnRoutePoint(
							...
							nil,
							nil,
							Fox.StrCode32("Interrogation2End")
						)
					end,
				},
				{
					...
					func = function()
						s10086_sequence.OnRoutePoint(
							...
							nil,
							nil,
							Fox.StrCode32("Interrogation3End")
						)
					end,
				},
				{
			...
			Sound = {
				{
					...
					func = function(bgmPhase)
						Fox.Log(
							"sequences.Seq_Game_SearchTarget.Messages(): Sound: ChangeBgmPhase: bgmPhase:"
								.. tostring(bgmPhase)
						)

						if
							bgmPhase == TppSystem.BGM_PHASE_SNEAK_1
							or bgmPhase == TppSystem.BGM_PHASE_SNEAK_2
							or bgmPhase == TppSystem.BGM_PHASE_SNEAK_3
						then
							local position, rotY = GameObject.SendCommand(
								GameObject.GetGameObjectId(s10086_enemy.INTERPRETER_NAME),
								{ id = "GetPosition" }
							)
							local distance = math.sqrt(
								TppMath.FindDistance(TppMath.Vector3toTable(position), TppPlayer.GetPosition())
							)
	...
	OnFakeTargetKilled = function(gameObjectId, killerId)
		Fox.Log(
			"s10086_sequence.sequences.Seq_Game_SearchTarget.OnFakeTargetDead(): gameObjectId:"
				.. tostring(gameObjectId)
				.. ", killerId:"
				.. tostring(killerId)
		)
