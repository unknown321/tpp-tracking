...
function s10086_radio.OnInterpreterMarked()
	...
	if
		not s10086_sequence.IsRecognized(s10086_enemy.TARGET_NAME)
		and not TppEnemy.IsRecovered(s10086_enemy.TARGET_NAME)
	then
	end
end
...
function s10086_radio.AfterInterpreterRecovered()
	if s10086_sequence.IsRecognized(s10086_enemy.TARGET_NAME) or TppEnemy.IsRecovered(s10086_enemy.TARGET_NAME) then
		return
	end
...
function s10086_radio.GetTargetRecoveredRadio()
	...
	if
		TppMotherBaseManagement.IsExistStaff({ skill = "TranslateAfrikaans" })
		or s10086_sequence.IsInterpreterDead()
		or TppEnemy.IsRecovered(s10086_enemy.INTERPRETER_NAME)
	then
...
function s10086_radio.OnFakeTarget1TakenAway()
	...
	if
		not s10086_sequence.IsRecognized(s10086_enemy.FAKE_TARGET1_NAME)
		and not s10086_sequence.IsRecognized(s10086_enemy.TARGET_NAME)
		and not TppEnemy.IsRecovered(s10086_enemy.TARGET_NAME)
	then
...
s10086_radio.OnFakeTargetInterrogationStarted = function(fakeTargetName)
	...
	if
		not s10086_sequence.IsRecognized(fakeTargetName)
		and not s10086_sequence.IsRecognized(s10086_enemy.TARGET_NAME)
		and not TppEnemy.IsRecovered(s10086_enemy.TARGET_NAME)
	then
...
s10086_radio.OnIntelFileGotten = function()
	...
	if
		TppEnemy.IsRecovered(s10086_enemy.TARGET_NAME)
		and (TppEnemy.IsRecovered(s10086_enemy.FAKE_TARGET1_NAME) or TppEnemy.GetLifeStatus(
			s10086_enemy.FAKE_TARGET1_NAME
		) == TppGameObject.NPC_LIFE_STATE_DEAD)
		and (TppEnemy.IsRecovered(s10086_enemy.FAKE_TARGET2_NAME) or TppEnemy.GetLifeStatus(
			s10086_enemy.FAKE_TARGET2_NAME
		) == TppGameObject.NPC_LIFE_STATE_DEAD)
		and (
			TppEnemy.IsRecovered(s10086_enemy.FAKE_TARGET3_NAME)
			or TppEnemy.GetLifeStatus(s10086_enemy.FAKE_TARGET1_NAME) == TppGameObject.NPC_LIFE_STATE_DEAD
		)
	then
...
s10086_radio.OnPlayerHoldActiveWeapon = function()
	...
	if
		not s10086_sequence.IsRecognized(s10086_enemy.TARGET_NAME)
		and not TppEnemy.IsRecovered(s10086_enemy.TARGET_NAME)
		and Player.GetEquipTypeIdBySlot(vars.currentInventorySlot, vars.currentSupportWeaponIndex)
...
s10086_radio.OnEnglishSubtitlesShown = function()
	...
	if
		not s10086_sequence.IsRecognized(s10086_enemy.TARGET_NAME)
		and not TppEnemy.IsRecovered(s10086_enemy.TARGET_NAME)
		and not s10086_sequence.IsRecognized(s10086_enemy.INTERPRETER_NAME)
	then
