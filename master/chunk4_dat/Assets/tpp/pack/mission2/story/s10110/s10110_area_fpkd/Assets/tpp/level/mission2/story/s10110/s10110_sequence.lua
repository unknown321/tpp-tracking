...
this.npcScriptPackList = {
	Bear = {
		TppDefine.MISSION_COMMON_PACK.LYCAON,
...
this.missionObjectiveDefine = {
	...
	default_area_factory = {
		gameObjectName = "10110_marker_factory",
		goalType = "moving",
		viewType = "all",
		visibleArea = 5,
		randomRange = 5,
	...
	rv_fake = {
		gameObjectName = "10110_marker_fake_rv",
		goalType = "moving",
		viewType = "all",
		announceLog = "updateMap",
	},
		...
		GameObject = {
...

			{
				...
				func = function(gameObjectId, routeId, routeNode, messageId)
					...
					if messageId == StrCode32("route_factorySouth") then
						...
						if
							TppEnemy.GetPhase("mafr_factorySouth_ob") > TppEnemy.PHASE.SNEAK
							or svars.flag3 == true
							or lifeStatus ~= TppGameObject.NPC_LIFE_STATE_NORMAL
						then
					...
					elseif messageId == StrCode32("route_factory_gate") then
						...
						if
							TppEnemy.GetPhase("mafr_factoryWest_ob") > TppEnemy.PHASE.SNEAK
							or svars.flag4 == true
							or lifeStatus ~= TppGameObject.NPC_LIFE_STATE_NORMAL
						then
...

			{
				...
				func = function(gameObjectId, routeId, routeNode, messageId)
					...
					if messageId == StrCode32("BeforeFire") then
						...
						if
							lifeStatus1 == TppEnemy.LIFE_STATUS.NORMAL
							and lifeStatus2 == TppEnemy.LIFE_STATUS.NORMAL
						then
							Fox.Log("")
						else
							TppEnemy.UnsetSneakRoute(enemy_fW_fire1)
			...
			},
			{
				...
				func = function(gameObjectId, routeId, failureType)
					...
					elseif
						svars.ConversationEnd_factorySouth == false
						and failureType == TppGameObject.ROUTE_EVENT_FAILED_TYPE_VEHICLE_GET_IN
						and gameObjectId == GameObject.GetGameObjectId("sol_vip_lrrp_0000")
					then
			...
			},
			{
				...
				func = function(gameObjectId, damageType)
					if mvars.isBreakFrame == true then
						...
						if
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_BULLET_NORMAL
							and mvars.DAMAGED_TYPE_BULLET_NORMAL == false
						then
							s10110_radio.PlayVolginDamaged_NormalRadio()
							mvars.DAMAGED_TYPE_BULLET_NORMAL = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_STAGGER
							and mvars.DAMAGED_TYPE_BULLET_STAGGER == false
						then
							s10110_radio.PlayVolginDamaged_StrongRadio()
							mvars.DAMAGED_TYPE_BULLET_STAGGER = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_BLOW and mvars.DAMAGED_TYPE_BLOW == false
						then
							s10110_radio.PlayVolginDamaged_BlastRadio()
							mvars.DAMAGED_TYPE_BLOW = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_BLAST_ABSORB
							and mvars.DAMAGED_TYPE_BLAST_ABSORB == false
						then
							s10110_radio.PlayVolginDamaged_ABSORBRadio()
							mvars.DAMAGED_TYPE_BLAST_ABSORB = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_VEHICLE
							and mvars.DAMAGED_TYPE_VEHICLE == false
						then
							mvars.DAMAGED_TYPE_VEHICLE = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_SHOCK and mvars.DAMAGED_TYPE_SHOCK == false
						then
							s10110_radio.PlayVolginDamaged_FAINTRadio()
							mvars.DAMAGED_TYPE_SHOCK = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_LIGHTNING
							and mvars.DAMAGED_TYPE_LIGHTNING == false
						then
							s10110_radio.PlayVolginDamaged_LIGHTNINGRadio()
							mvars.DAMAGED_TYPE_LIGHTNING = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_SMOKE and mvars.DAMAGED_TYPE_SMOKE == false
						then
							mvars.DAMAGED_TYPE_SMOKE = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_SLEEP and mvars.DAMAGED_TYPE_SLEEP == false
						then
							mvars.DAMAGED_TYPE_SLEEP = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_FAINT and mvars.DAMAGED_TYPE_FAINT == false
						then
							mvars.DAMAGED_TYPE_FAINT = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_WATER and mvars.DAMAGED_TYPE_WATER == false
						then
							s10110_radio.PlayVolginDamaged_WaterRadio()
							mvars.DAMAGED_TYPE_WATER = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_RAIN and mvars.DAMAGED_TYPE_RAIN == false
						then
							s10110_radio.PlayVolginDamaged_RainRadio()
							mvars.DAMAGED_TYPE_RAIN = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_PUDDLE
							and mvars.DAMAGED_TYPE_PUDDLE == false
						then
							mvars.DAMAGED_TYPE_PUDDLE = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_LAKE and mvars.DAMAGED_TYPE_LAKE == false
						then
							mvars.DAMAGED_TYPE_LAKE = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_STEEL_FRAME
							and mvars.DAMAGED_TYPE_STEEL_FRAME == false
						then
							mvars.DAMAGED_TYPE_STEEL_FRAME = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_MANTIS_DODGED
							and mvars.DAMAGED_TYPE_MANTIS_DODGED == false
						then
							s10110_radio.PlayMANTIS_DODGEDRadio()
							mvars.DAMAGED_TYPE_MANTIS_DODGED = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_MANTIS_DAMAGED
							and mvars.DAMAGED_TYPE_MANTIS_DAMAGED == false
							and TppSequence.GetCurrentSequenceName() == "Seq_Game_Escape"
						then
						...
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_MANTIS_DAMAGED
							and mvars.DAMAGED_TYPE_MANTIS_DAMAGED2 == false
							and TppSequence.GetCurrentSequenceName() == "Seq_Game_Escape2"
						then
							s10110_radio.PlayMANTIS_DAMAGEDRadio()
						...
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_WATER_GUN_1
							and mvars.DAMAGED_TYPE_WATER_GUN_1 == false
							and TppSequence.GetCurrentSequenceName() == "Seq_Game_Escape2"
						then
							s10110_radio.PlayVolginDamaged_WATER_GUN_LowRadio()
							mvars.DAMAGED_TYPE_WATER_GUN_1 = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_WATER_GUN_2
							and mvars.DAMAGED_TYPE_WATER_GUN_2 == false
							and TppSequence.GetCurrentSequenceName() == "Seq_Game_Escape2"
						then
							s10110_radio.PlayVolginDamaged_WATER_GUN_HighRadio()
							mvars.DAMAGED_TYPE_WATER_GUN_2 = true
						elseif
							damageType == TppVolgin2.VOLGIN_DAMAGED_TYPE_WATER_GUN_3
							and mvars.DAMAGED_TYPE_WATER_GUN_3 == false
							and TppSequence.GetCurrentSequenceName() == "Seq_Game_Escape2"
						then
							s10110_radio.PlayVolginDamaged_WATER_GUN_HighRadio()
		...
		Trap = {
			...
			},
			{
				...
				func = function()
					...
					GameObject.SendCommand(
						GameObject.GetGameObjectId("sol_vip_lrrp_0000"),
			...
			},
			{
				...
				func = function()
					...
					TppWeather.RequestWeather(
						TppDefine.WEATHER.FOGGY,
						10,
						{ fogDensity = 0.00, fogType = WeatherManager.FOG_TYPE_EERIE }
					)
					svars.flag15 = true
					svars.flag16 = false
			...
			},
			{
				...
				func = function()
					...
					TppWeather.RequestWeather(
						TppDefine.WEATHER.FOGGY,
						5,
						{ fogDensity = 0.03, fogType = WeatherManager.FOG_TYPE_EERIE }
					)
					svars.flag16 = true
					svars.flag15 = false
				end,
...

			{
				...
				func = function(trapName, gameObjectId)
					Fox.Log(
						"s10100_sequence.Messages(): trapName:"
							.. tostring(trapName)
							.. ", gameObjectId:"
		...
		Timer = {
			{
				...
				func = function()
					...
					if
						...
						and phase_hill == TppEnemy.PHASE.SNEAK
					then
...
function this.CheckNpcScriptBlockLoad()
	if
		TppSequence.GetMissionStartSequenceName() == "Seq_Game_Escape"
		or TppSequence.GetMissionStartSequenceName() == "Seq_Game_Escape2"
		or TppSequence.GetMissionStartSequenceName() == "Seq_Demo_Volgin"
		or TppSequence.GetMissionStartSequenceName() == "Seq_Game_SearchTarget"
	then
...
sequences.Seq_Game_GoToFactory = {
			...
			GameObject = {
				...
				},
				{
					...
					func = function(gameObjectId, attackId, attackGameObjectId)
						...
						if
							gameObjectId == GameObject.GetGameObjectId("TppHostage2GameObjectLocator0000")
							and TppDamage.IsActiveByAttackId(attackId) == true
						then
			...
			Trap = {
				...
				},
				{
					...
					func = function()
						...
						Gimmick.PushGimmick(
							-1,
							"gntn_crto001_vrtn001_gim_n0007|srt_gntn_crto001_vrtn001",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							Vector3(0.5, 0.5, 0.5),
							1
						)
					end,
				},
				{
					...
					func = function()
						Gimmick.BreakGimmick(
							...
							"mafr_gnsc003_vrtn001_gim_n0000|srt_mafr_gnsc003_vrtn001",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
					end,
	...
	OnEnter = function()
		...
		TppMission.UpdateObjective({
			radio = { radioGroups = { "s0110_rtrg0010" } },
			objectives = {
				"default_area_factory",
			},
		})
			...
			Demo = {
				{
					...
					func = function()
						Gimmick.InvisibleGimmick(
							-1,
							"mafr_mdeq001_vrtn001_gim_n0023|srt_mafr_mdeq001_vrtn001",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							true
						)
					end,
			...
			GameObject = {
				{
					...
					func = function(cpGameObjectId, gameObjectName)
						...
						elseif gameObjectName == StrCode32("mafr_stfr001_gim_n0002|srt_mafr_stfr001") then
							Gimmick.BreakGimmick(
								TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
								"mafr_stfr001_vrtn002_gim_n0001|srt_mafr_stfr001_vrtn002",
								"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
								0
							)
						else
				...
				},
				{
					...
					func = function(gameObjectId, attackId, attackGameObjectId)
						Fox.Log("gameObjectId = " .. gameObjectId .. " !!")
						if
							gameObjectId == GameObject.GetGameObjectId("TppHostage2GameObjectLocator")
							and TppDamage.IsActiveByAttackId(attackId) == true
						then
			...
			Trap = {
				{
					...
					func = function()
						...
						Gimmick.PushGimmick(
							-1,
							"mafr_bckt001_gim_n0075|srt_mafr_bckt001",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							Vector3(-1.5, 1.5, 1.5),
							2
						)
			...
			Demo = {
				{
					...
					func = function()
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_gim_n0010|srt_mafr_crtn002",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_gim_n0014|srt_mafr_crtn002",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_gim_n0015|srt_mafr_crtn002",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn002_gim_n0003|srt_mafr_crtn002_vrtn002",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn002_gim_n0004|srt_mafr_crtn002_vrtn002",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn003_gim_n0016|srt_mafr_crtn002_vrtn003",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn003_gim_n0018|srt_mafr_crtn002_vrtn003",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
...
sequences.Seq_Game_Escape = {
			...
			GameObject = {
					...
					func = function(cpGameObjectId, gameObjectName)
						...
						elseif gameObjectName == StrCode32("gntn_hydr001_gim_n0001|srt_gntn_hydr001") then
							Gimmick.BreakGimmick(
								...
								"mafr_stfr001_gim_n0002|srt_mafr_stfr001",
								"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
								0
							)
				...
				},
				{
					...
					func = function(gameObjectId, newLifeStatus)
						if newLifeStatus == TppVolgin2.VOLGIN_LIFE_STATUS_VANISHED_FOREVER then
							if
								mvars.DAMAGED_TYPE_LIGHTNING == true
								or mvars.DAMAGED_TYPE_RAIN == true
								or mvars.VolginFultonFinished == true
							then
								Fox.Log("OtherRadio")
							else
...

				{
					...
					func = function()
						...
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
							"mafr_fctr001_wall008_gim_n0001|srt_mafr_fctr001_wall008",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
				...
				},
				{
					...
					func = function()
						...
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
							"mafr_tnnl001_gim_n0001|srt_mafr_tnnl001",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						...
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_tnnl001_frct001_gim_n0000|srt_mafr_tnnl001_frct001",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
				...
				},
				{
					...
					func = function(gameObjectId, locatorName, locatorNameUpper, failureType)
						...
						if
							(gameObjectId == GameObject.GetGameObjectId("vol_factory_0000"))
							and (failureType == TppGameObject.FULTON_FAILED_TYPE_ON_FINISHED_RISE)
						then
			...
			Timer = {
				...
				},
				{
					...
					func = function()
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_fctr001_rbbl002_gim_n0000|srt_mafr_fctr001_rbbl002",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
				...
				},
				{
					...
					func = function()
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
							"mafr_stfr001_gim_n0001|srt_mafr_stfr001",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)

						Gimmick.ChangeSequentialEventAnimation(
							"mafr_stfr001_vrtn002_ex_gim_n0002|srt_mafr_stfr001_vrtn002_ex",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0,
							0.0,
							false,
			...
			Trap = {
				{
					...
					func = function()
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn003_gim_n0007|srt_mafr_crtn002_vrtn003",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn003_gim_n0006|srt_mafr_crtn002_vrtn003",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn003_gim_n0005|srt_mafr_crtn002_vrtn003",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn002_gim_n0002|srt_mafr_crtn002_vrtn002",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn003_gim_n0004|srt_mafr_crtn002_vrtn003",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_vrtn001_gim_n0001|srt_mafr_crtn002_vrtn001",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
						...
						Gimmick.BreakGimmick(
							TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,
							"mafr_crtn002_gim_n0016|srt_mafr_crtn002",
							"/Assets/tpp/level/location/mafr/block_large/factory/mafr_factory_asset.fox2",
							0
						)
					end,
	...
	OnEnter = function()
		...
		GameObject.SendCommand(
			GameObject.GetGameObjectId("TppHeli2", "SupportHeli"),
			{ id = "CallToLandingZoneAtName", name = "s10110_lz0000" }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("TppHeli2", "SupportHeli"),
...
sequences.Seq_Game_Escape2 = {
			...
			GameObject = {
				...
				},
				{
					...
					func = function(gameObject, state, attackerId)
						if
							attackerId == GameObject.GetGameObjectId("vol_factory_0000")
							and state == StrCode32("End")
						then
							if
								GameObject.SendCommand(gameObjectId, { id = "GetPassengerIds" })
	...
	OnEnter = function()
		...
		GameObject.SendCommand(
			...
			{ id = "SetLandingZnoeDoorFlag", name = "lz_Escape1", leftDoor = "Open", rightDoor = "Close" }
		)
		GameObject.SendCommand(
			{ type = "TppHeli2", index = 0 },
			{ id = "SetLandingZnoeDoorFlag", name = "lz_Escape2", leftDoor = "Close", rightDoor = "Open" }
		)
		GameObject.SendCommand(
			{ type = "TppHeli2", index = 0 },
			{ id = "SetLandingZnoeDoorFlag", name = "lz_Escape3", leftDoor = "Close", rightDoor = "Open" }
		)
		if mvars.isBreakFrame ~= true then
			...
			GameObject.SendCommand(
				{ type = "TppHeli2", index = 0 },
				{ id = "SetAutoWithdrawalEnabled", enabled = false }
			)
