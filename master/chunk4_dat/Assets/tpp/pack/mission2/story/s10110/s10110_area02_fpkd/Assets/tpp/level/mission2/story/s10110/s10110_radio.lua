...
this.PlayGetIntelRadio = function()
	...
	if
		TppSequence.GetCurrentSequenceName() == "Seq_Game_GoToFactory"
		or TppSequence.GetCurrentSequenceName() == "Seq_Game_SearchTarget"
	then
...
this.PlayRunRadio = function()
	if
		TppSequence.GetCurrentSequenceName() == "Seq_Game_Escape"
		or TppSequence.GetCurrentSequenceName() == "Seq_Game_Escape2"
	then
