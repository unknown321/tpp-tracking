...
this.missionObjectiveDefine = {
	...
	default_missionObjective_Hostage = {
		gameObjectName = "10200_marker_HostageArea",
		mapRadioName = "s0200_mprg0020",
		visibleArea = 3,
		randomRange = 0,
		viewType = "all",
		setNew = false,
	...
	default_viewPoint = {
		gameObjectName = "10200_marker_viewpoint",
		mapRadioName = "f1000_mprg0180",
		visibleArea = 2,
		randomRange = 0,
	...
	default_itemArea = {
		gameObjectName = "10200_marker_item",
		visibleArea = 1,
		randomRange = 0,
		viewType = "map_only_icon",
		setNew = false,
	...
	default_photo_target_10 = {
		photoId = 10,
		addFirst = true,
		photoRadioName = "s0200_mirg0030",
	},

	default_photo_target_20 = {
		photoId = 20,
		addFirst = true,
		photoRadioName = "s0200_mirg0020",
	},
...
this.OffHighInterrogation = function()
	...
	TppInterrogation.RemoveHighInterrogation(GameObject.GetGameObjectId("mafr_hillNorth_ob"), {
...
this.OnRoutePoint = {
	...
	ALL = function(gameObjectId, routeId, routeNode, messageId)
		local messageIdList = {
			[Fox.StrCode32("rts_lrrp_Unit01_Gather_0002_01_Last")] = {
				soldierList = { "sol_hillNorth_0006" },
				enemyName = "sol_hillNorth_0006",
				group = "groupE",
			},
			[Fox.StrCode32("rts_lrrp_Unit01_Gather_0002_03_Last")] = {
				soldierList = { "sol_hillNorth_0007" },
				enemyName = "sol_hillNorth_0007",
				group = "groupF",
			},
			[Fox.StrCode32("rts_lrrp_Unit01_Gather_0001_01_Last")] = {
				soldierList = { "sol_hillNorth_0004" },
				enemyName = "sol_hillNorth_0004",
				group = "groupG",
			},
			[Fox.StrCode32("rts_lrrp_Unit01_Gather_0001_02_Last")] = {
				soldierList = { "sol_hillNorth_0005" },
				enemyName = "sol_hillNorth_0005",
				group = "groupH",
			},

			[Fox.StrCode32("rts_lrrp_Unit02_Gather_0001_01_Last")] = {
				soldierList = { "sol_hillNorth_0008" },
				enemyName = "sol_hillNorth_0008",
				group = "groupI",
			},
			[Fox.StrCode32("rts_lrrp_Unit02_Gather_0001_02_Last")] = {
				soldierList = { "sol_hillNorth_0009" },
				enemyName = "sol_hillNorth_0009",
				group = "groupJ",
			},
			[Fox.StrCode32("rts_lrrp_Unit02_Gather_0002_01_Last")] = {
				soldierList = { "sol_hillNorth_0010" },
				enemyName = "sol_hillNorth_0010",
				group = "groupK",
			},
			[Fox.StrCode32("rts_lrrp_Unit02_Gather_0002_02_Last")] = {
				soldierList = { "sol_hillNorth_0011" },
				enemyName = "sol_hillNorth_0011",
				group = "groupL",
			},

			[Fox.StrCode32("talk_01_End")] = {
				soldierList = { "sol_hillNorth_0000" },
				enemyName = "sol_hillNorth_0000",
				group = "groupA",
			},
			[Fox.StrCode32("talk_02_End")] = {
				soldierList = { "sol_hillNorth_0000" },
				enemyName = "sol_hillNorth_0000",
				group = "groupA",
			},
	...
	[Fox.StrCode32("lrrp_Unit01_0000_End")] = function(gameObjectId, routeId, routeNode, messageId)
		...
		this.SetReturnUnitRoute(
			RETURN_UNIT01_MEM_01,
			"rts_lrrp_Unit01_Gather_0001_00",
			"rts_lrrp_Unit01_Gather_0001_00"
		)
		this.SetReturnUnitRoute(
			RETURN_UNIT01_MEM_02,
			"rts_lrrp_Unit01_Gather_0001_00",
			"rts_lrrp_Unit01_Gather_0001_00"
		)
		this.SetReturnUnitRoute(
			RETURN_UNIT01_MEM_03,
			"rts_lrrp_Unit01_Gather_0002_01",
			"rts_lrrp_Unit01_Gather_0002_01"
		)
		this.SetReturnUnitRoute(
			RETURN_UNIT01_MEM_04,
			"rts_lrrp_Unit01_Gather_0002_02",
			"rts_lrrp_Unit01_Gather_0002_02"
		)
	end,
	...
	[Fox.StrCode32("rts_lrrp_Unit01_Gather_0001_00_END")] = function(gameObjectId, routeId, routeNode, messageId)
		this.SetReturnUnitRoute(
			RETURN_UNIT01_MEM_01,
			"rts_lrrp_Unit01_Gather_0001_01",
			"rts_lrrp_Unit01_Gather_0001_01"
		)
		this.SetReturnUnitRoute(
			RETURN_UNIT01_MEM_02,
			"rts_lrrp_Unit01_Gather_0001_02",
			"rts_lrrp_Unit01_Gather_0001_02"
		)
	end,
	...
	[Fox.StrCode32("rts_lrrp_Unit01_Gather_0002_02_End")] = function(gameObjectId, routeId, routeNode, messageId)
		this.SetReturnUnitRoute(
			RETURN_UNIT01_MEM_04,
			"rts_lrrp_Unit01_Gather_0002_03",
			"rts_lrrp_Unit01_Gather_0002_03"
		)
	end,
	...
	[Fox.StrCode32("rts_lrrp_Unit02_0000_End")] = function(gameObjectId, routeId, routeNode, messageId)
		...
		this.SetReturnUnitRoute(
			RETURN_UNIT02_MEM_01,
			"rts_lrrp_Unit02_Gather_0001_00",
			"rts_lrrp_Unit02_Gather_0001_00"
		)
		this.SetReturnUnitRoute(
			RETURN_UNIT02_MEM_02,
			"rts_lrrp_Unit02_Gather_0001_00",
			"rts_lrrp_Unit02_Gather_0001_00"
		)
		this.SetReturnUnitRoute(
			RETURN_UNIT02_MEM_03,
			"rts_lrrp_Unit02_Gather_0002_00",
			"rts_lrrp_Unit02_Gather_0002_00"
		)
		this.SetReturnUnitRoute(
			RETURN_UNIT02_MEM_04,
			"rts_lrrp_Unit02_Gather_0002_00",
			"rts_lrrp_Unit02_Gather_0002_00"
		)
	end,
	...
	[Fox.StrCode32("to_rts_lrrp_Unit02_Gather_0001_01")] = function(gameObjectId, routeId, routeNode, messageId)
		this.SetReturnUnitRoute(
			RETURN_UNIT02_MEM_01,
			"rts_lrrp_Unit02_Gather_0001_01",
			"rts_lrrp_Unit02_Gather_0001_01"
		)
	end,
	...
	[Fox.StrCode32("to_rts_lrrp_Unit02_Gather_0001_02")] = function(gameObjectId, routeId, routeNode, messageId)
		this.SetReturnUnitRoute(
			RETURN_UNIT02_MEM_02,
			"rts_lrrp_Unit02_Gather_0001_02",
			"rts_lrrp_Unit02_Gather_0001_02"
		)
	end,
	...
	[Fox.StrCode32("rts_lrrp_Unit02_Gather_0002_00_End")] = function(gameObjectId, routeId, routeNode, messageId)
		this.SetReturnUnitRoute(
			RETURN_UNIT02_MEM_03,
			"rts_lrrp_Unit02_Gather_0002_01",
			"rts_lrrp_Unit02_Gather_0002_01"
		)
		this.SetReturnUnitRoute(
			RETURN_UNIT02_MEM_04,
			"rts_lrrp_Unit02_Gather_0002_02",
			"rts_lrrp_Unit02_Gather_0002_02"
		)
	end,
}
		...
		Player = {

			{
				...
				func = function(playerGameObjectId, collectionUniqueId, collectionTypeId)
					...
					if
						collectionUniqueId == TppCollection.GetUniqueIdByLocatorName("col_herb_l_s10200_0000")
						or collectionUniqueId == TppCollection.GetUniqueIdByLocatorName("col_herb_l_s10200_0001")
						or collectionUniqueId == TppCollection.GetUniqueIdByLocatorName("col_herb_l_s10200_0002")
					then
				...
				func = function()
					...
					if svars.isUnit01Started == false then
						GkEventTimerManager.Start(
							"Unit01Start_EnterTrap",
							this.counterList.UNIT01_START_COUNT_ENTER_TRAP
						)
					end
					if svars.isUnit02Started == false then
						GkEventTimerManager.Start(
							"Unit02Start_EnterTrap",
							this.counterList.UNIT02_START_COUNT_ENTER_TRAP
						)
					end
				end,
			},
...

			{
				...
				func = function(arg0, arg1)
					...
					if arg1 == GameObject.GetGameObjectId("Player") then
						svars.isKilledBonusHostage = true, s10200_radio.BonusHostageKilled()
					end
				end,
			},
