...
this.blackTelephoneDisplaySetting = {
	f6000_rtrg0190 = {
		Japanese = {
			{
				"sub_1",
				"/Assets/tpp/ui/texture/Photo/tpp/10200/mb_photo_10200_010_1.ftex",
				3.75,
				"cast_militants_no.2",
			},
			{
				"sub_2",
				"/Assets/tpp/ui/texture/Photo/tpp/10200/mb_photo_10200_020_1.ftex",
				9.82,
...
this.ContinueRadio = function()
	if
		svars.isStatusHostage == s10200_sequence.TARGET_STATUS.FOUND
		and svars.isStatusLeader ~= s10200_sequence.TARGET_STATUS.FOUND
	then
		TppRadio.Play("s0200_oprg0040")
	elseif
		svars.isStatusHostage == s10200_sequence.TARGET_STATUS.CAPTURED
		and svars.isStatusLeader == s10200_sequence.TARGET_STATUS.NONE
	then
	...
	elseif
		svars.isStatusHostage ~= s10200_sequence.TARGET_STATUS.CAPTURED
		and svars.isStatusLeader == s10200_sequence.TARGET_STATUS.CAPTURED
	then
