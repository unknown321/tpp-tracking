...
this.SetUpEnemy = function()
	...
	this.driverVehicleMatchIdTable[GameObject.GetGameObjectId(this.ENEMY_TANK1_SOLDIER)] =
		GameObject.GetGameObjectId("TppVehicle2", this.ENEMY_TANK1)
	this.driverVehicleMatchIdTable[GameObject.GetGameObjectId(this.ENEMY_TANK2_SOLDIER)] =
		GameObject.GetGameObjectId("TppVehicle2", this.ENEMY_TANK2)
	this.driverVehicleMatchIdTable[GameObject.GetGameObjectId(this.ENEMY_WAV_SOLDIER)] =
		GameObject.GetGameObjectId("TppVehicle2", this.ENEMY_WAV)

	TppEnemy.InitialRouteSetGroup({
		cpName = "mafr_pfCamp_cp",
		soldierList = { "sol_pfCamp_0000", "sol_pfCamp_0001", "sol_pfCamp_0002", "sol_pfCamp_0003" },
...
this.SetEnemyVehicle = function(soldierNameTable, vehicleName, isRideFromBegin)
	...
	for i, soldierName in pairs(soldierNameTable) do
		...
		local command =
			{ id = "SetRelativeVehicle", targetId = vehicleId, rideFromBeginning = isRideFromBegin, isVigilance = true }
