...
this.PlayContactCodetalkerDemo = function(func)
	...
	if svars.isAllKillParasite == false then
		TppDemo.Play("ContactCodetalkerDemo", { onEnd = func }, { useDemoBlock = true })
	else
		TppDemo.Play("ContactCodetalkerDemo", { onEnd = func }, {
			useDemoBlock = true,
			finishFadeOut = true,
		})
	end
...
this.PlayCemeteryCodetalkerDemo = function(func)
	...
	TppDemo.Play("CemeteryCodetalkerDemo", { onEnd = func }, { useDemoBlock = true, isSnakeOnly = false })
end
...
this.ArrivalParasiteDemo = function(func)
	...
	TppDemo.Play("ArrivalParasiteDemo", {
		onInit = funcOnInit,
		onEnd = func,
...
this.PlayClearDemo = function(func)
	...
	TppDemo.Play("ClearDemo", { onEnd = func }, {
