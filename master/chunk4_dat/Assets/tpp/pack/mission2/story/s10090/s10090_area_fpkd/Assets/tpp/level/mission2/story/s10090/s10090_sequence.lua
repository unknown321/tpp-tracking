...
this.missionObjectiveDefine = {
	...
	default_area_pfCampNorth = {
		gameObjectName = MARKER_NAME.AREA_PFCAMPNORTH,
		visibleArea = 4,
		randomRange = 0,
		viewType = "all",
		langId = "marker_information",
		mapRadioName = "s0090_mprg0010",
		setNew = true,
	...
	arrival_at_pfCampNorth = {
		...
		viewType = "all",
		langId = "marker_information",
		mapRadioName = "s0090_mprg0020",
		setNew = false,
	},

	default_photo_targetVehicle = {
		photoId = 10,
		photoRadioName = "s0090_mirg0010",
	},
	default_photo_escortVehicle = {
		photoId = 20,
		photoRadioName = "s0090_mirg0020",
	},
	...
	area_Interrogation_pfCamp = {
		gameObjectName = MARKER_NAME.AREA_PFCAMP,
		visibleArea = 4,
		randomRange = 0,
		viewType = "all",
	...
	showEnemyRoute_01 = {
		showEnemyRoutePoints = {
			...
			points = {
				Vector3(796.8, 0.0, 1232.7),
				Vector3(895.3, 0.0, 1295.6),
				Vector3(896.8, 0.0, 1518.6),
				Vector3(1180.7, 0.0, 1506.3),
				Vector3(1367.8, 0.0, 1466.5),
				Vector3(1386.0, 0.0, 1287.7),
				Vector3(1496.8, 0.0, 1186.8),
				Vector3(1507.6, 0.0, 1026.0),
				Vector3(1329.2, 0.0, 878.7),
				Vector3(1237.3, 0.0, 774.7),
				Vector3(1121.5, 0.0, 634.3),
				Vector3(1223.6, 0.0, 517.3),
			},
		},
		announceLog = "updateMap",
	},
	showEnemyRoute_02 = {
		showEnemyRoutePoints = {
			...
			langId = "marker_target_forecast_path",
			points = {
				Vector3(341.2, 0.0, 367.1),
				Vector3(398.0, 0.0, 424.2),
				Vector3(416.2, 0.0, 484.1),
				Vector3(424.7, 0.0, 559.7),
				Vector3(456.0, 0.0, 616.2),
				Vector3(504.6, 0.0, 678.9),
				Vector3(519.5, 0.0, 735.5),
				Vector3(543.8, 0.0, 778.4),
				Vector3(577.6, 0.0, 825.2),
				Vector3(617.2, 0.0, 850.2),
				Vector3(585.5, 0.0, 989.4),
				Vector3(589.9, 0.0, 1090.7),
				Vector3(607.7, 0.0, 1146.8),
				Vector3(615.9, 0.0, 1212.3),
				Vector3(650.0, 0.0, 1261.8),
				Vector3(725.7, 0.0, 1319.7),
				Vector3(799.9, 0.0, 1357.5),
				Vector3(851.1, 0.0, 1392.6),
			},
		},
	},
	showEnemyRoute_03 = {
		showEnemyRoutePoints = {
			...
			langId = "marker_target_forecast_path",
			points = {
				Vector3(-90.9, 0.0, 66.6),
				Vector3(-25.1, 0.0, 34.0),
				Vector3(74.4, 0.0, 39.9),
				Vector3(79.9, 0.0, 166.3),
				Vector3(69.6, 0.0, 245.0),
				Vector3(94.2, 0.0, 327.3),
				Vector3(177.9, 0.0, 360.4),
				Vector3(325.7, 0.0, 361.3),
			},
		},
	},
	showEnemyRoute_04 = {
		showEnemyRoutePoints = {
			...
			langId = "marker_target_forecast_path",
			points = {
				Vector3(-1235.0, 0.0, 65.0),
				Vector3(-1215.7, 0.0, -32.9),
				Vector3(-1045.5, 0.0, -133.3),
				Vector3(-1005.1, 0.0, -291.7),
				Vector3(-875.9, 0.0, -391.2),
				Vector3(-684.3, 0.0, -378.4),
				Vector3(-529.8, 0.0, -200.4),
				Vector3(-373.2, 0.0, -121.7),
				Vector3(-234.8, 0.0, 15.4),
			},
		},
	},

	on_target_area_swamp = {
		gameObjectName = MARKER_NAME.AREA_SWAMP,
		visibleArea = 4,
		randomRange = 0,
		viewType = "all",
		langId = "marker_info_mission_targetArea",
		mapRadioName = "s0090_mprg0040",
		setNew = true,
		announceLog = "updateMap",
	},
	...
	default_subTask_intel = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SUB_INTEL,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
	...
	default_subTask_conversation_ghost = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SUB_CONVERSATION_GHOST,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
	...
	default_subTask_recovered_zrs = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SUB_RECOVERED_ZRS,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
	...
	on_target_vehicle = {
		...
		mapRadioName = "s0090_mprg0030",
	},

	on_escort_vehicle_01 = {
		gameObjectName = "veh_wav_0000",
		goalType = "attack",
		viewType = "map_and_world_only_icon",
		setNew = true,
		setImportant = true,
	...
	default_subTask_skulls = {
		missionTask = {
			taskNo = this.MISSIONTASK_LIST.SPECIALBONUS_ELIMINATE_SKULLS,
			isNew = false,
			isComplete = false,
			isFirstHide = true,
		},
...
if DEBUG then
	function this.SetUpDebugMissionStartTable()
		this.dbgMissionStartSettingTable[5] = {
			vehicle = {
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV01,
					pos = Vector3(764.267395, -11.906753, 1249.067993),
					rotY = 1.0507769584656,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV02,
					pos = Vector3(767.497803, -11.907064, 1220.879272),
					rotY = -2.1702251434326,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.VEHICLE_01,
					pos = Vector3(622.792297, -11.115735, 836.524353),
					rotY = -1.2815088033676,
				},
			},
			func = {

				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_PFCAMP_GUARD01),
							dbgEnemyIdTable = {
				...
				},
				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_PFCAMP_GUARD02),
							dbgEnemyIdTable = {
...

				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_ESCORT_VEHICLE_01),
							dbgEnemyIdTable = {
		...
		this.dbgMissionStartSettingTable[10] = {
			vehicle = {
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV01,
					pos = Vector3(762.038025, -11.864416, 1249.272827),
					rotY = 1.0493788719177,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV02,
					pos = Vector3(767.497803, -11.907064, 1220.879272),
			...
			func = {
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_DRIVE_PFCAMP
					end,
				},
			},
		}
		...
		this.dbgMissionStartSettingTable[15] = {
			vehicle = {
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV01,
					pos = Vector3(300.881897, -6.433638, 350.944427),
					rotY = -1.8211283683777,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.TRUCK_TARGET,
					pos = Vector3(323.328918, -6.780036, 357.718719),
					rotY = -1.9797695875168,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV02,
					pos = Vector3(349.431732, -8.884431, 373.202087),
					rotY = -2.2112121582031,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.VEHICLE_01,
					pos = Vector3(327.965607, -6.235871, 343.300598),
					rotY = -1.7605882883072,
				},
			},
			func = {

				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_SWAMPSOUTH_GUARD01),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT01,
							},
						})
				...
				},
				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_SWAMPSOUTH_TARGET),
							dbgEnemyIdTable = {
				...
				},
				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_SWAMPSOUTH_GUARD02),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT02,
							},
						})
...

				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_ESCORT_VEHICLE_02),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT_VEHICLE_01,
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT_VEHICLE_02,
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT_VEHICLE_03,
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_STOP_SWAMPSOUTH
					end,
				},
			},
		}
		...
		this.dbgMissionStartSettingTable[20] = {
			...
			func = {
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_DRIVE_SWAMPSOUTH
					end,
				},
			},
		}
		...
		this.dbgMissionStartSettingTable[25] = {
			vehicle = {
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV01,
					pos = Vector3(-124.719315, -4.777594, 27.820532),
					rotY = -2.6546440124512,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.TRUCK_TARGET,
					pos = Vector3(-89.963425, -4.726182, 59.074959),
					rotY = -1.7438348531723,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV02,
					pos = Vector3(-48.110550, -4.598232, 45.896687),
					rotY = -1.0895439386368,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.VEHICLE_01,
					pos = Vector3(93.108734, -6.367922, -51.525677),
					rotY = 1.4641401767731,
				},
			},
			func = {

				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_SWAMP_GUARD01),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT01,
							},
						})
				...
				},
				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_SWAMP_TARGET),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_PFCAMP01,
							},
						})
				...
				},
				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_SWAMP_GUARD02),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT02,
							},
						})
...

				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_ESCORT_VEHICLE_03),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT_VEHICLE_01,
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT_VEHICLE_02,
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT_VEHICLE_03,
		...
		this.dbgMissionStartSettingTable[30] = {
			...
			func = {
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_DRIVE_SWAMP
					end,
				},
			},
		}
		...
		this.dbgMissionStartSettingTable[50] = {
			vehicle = {
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV01,
					pos = Vector3(-1216.381714, -20.711853, 99.890167),
					rotY = 0.0053758518770337,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.TRUCK_TARGET,
					pos = Vector3(-1247.686768, -20.185724, 102.716545),
					rotY = -1.0661635398865,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.WEST_WAV02,
					pos = Vector3(-1215.166748, -20.292364, 75.945778),
					rotY = 0.1592875868082,
				},
				{
					gameObjectName = s10090_enemy.VEHICLE_NAME.VEHICLE_01,
					pos = Vector3(93.108734, -6.367922, -51.525677),
			...
			func = {

				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_TRANSPORTPOINT_GUARD01),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT01,
							},
						})
				...
				},
				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_TRANSPORTPOINT_TARGET),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_PFCAMP01,
							},
						})
				...
				},
				{
					func = function()
						this.OnCommonFunc({
							messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_VE_TRANSPORTPOINT_GUARD02),
							dbgEnemyIdTable = {
								s10090_enemy.ENEMY_NAME.ZRS_ESCORT02,
							},
						})
				...
				{
					func = function()
						s10090_enemy.SetRelativeVehicle(
							s10090_enemy.ENEMY_NAME.ZRS_PFCAMP01,
							s10090_enemy.VEHICLE_NAME.TRUCK_TARGET,
							true
						)
					end,
				},
		...
		this.dbgMissionStartSettingTable[60] = {
			...
			func = {
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_PARASITES
					end,
				},
			},
		}
		...
		param = {
			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.START
					end,
				},

				{
					func = function()
						svars.reserveCount_01 = this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.STOP_ESCORT01
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.E_INIT_PFCAMPEAST)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_PFCAMPEAST
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.T_VS_PFCAMPEAST)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_PFCAMPEAST01
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_U_GUARD_VIGILANCE)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_PFCAMPEAST02
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VE_PFCAMP_GUARD01)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_PFCAMP
					end,
				},
		...
		param = {
			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.CONVERSATION_PFCAMP
					end,
				},
			},
		},
...

			{
...

				{
					beforeRouteIdTable = {
						...
						"rts_pfCamp_ene01_d_0001",
						"rts_pfCamp_ene01_d_0002",
					},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VS_PFCAMP_TRUCK)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_PFCAMP01
					end,
				},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VS_PFCAMP_MOTORCADE)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_PFCAMP02
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VE_SWAMPSOUTH_GUARD01)] = {
		...
		param = {
...

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_SWAMPSOUTH
					end,
				},
			},
		},
...

			{

				{
					beforeRouteIdTable = {
						...
						"rts_swampSouth_ene03_d_0000",
						"rts_swampSouth_ene04_d_0000",
						"rts_swampSouth_ene05_d_0000",
						"rts_swampSouth_ene06_d_0000",
					},
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.CONVERSATION_SWAMPSOUTH
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VE_SWAMP_GUARD01)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_SWAMP
					end,
				},
			},

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_SWAMP
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VE_SWAMP_TARGET)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.isCheckPointAllDisable = true
					end,
				},
				{
					func = function()
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_SWAMP_ACT_MOVE01)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.CONVERSATION_SWAMP
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VE_TRANSPORTPOINT_TARGET)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_TRANSPORTPOINT
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_TRANSPORTPOINT_TARGET_WAIT)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.WAIT_TRANSPORTPOINT
					end,
				},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_TRANSPORTPOINT_TARGET_DEMO)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEMO_TRANSPORTPOINT
					end,
				},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_F_PFCAMP_EXIT)] = {
		...
		param = {

			{
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.EXIT_PFCAMP
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_F_SWAMP_ENTER)] = {
		...
		param = {

			{
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.ENTER_SWAMP
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_F_FLOWSTATION_ENTER)] = {
		...
		param = {

			{
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.ENTER_FLOWSTATION
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_F_FLOWSTATION_EXIT)] = {
		...
		param = {

			{
				{
					func = function()
						svars.eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.EXIT_FLOWSTATION
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_R_SWAMPWEST)] = {
		...
		param = {

			{
				{
					func = function()
						this.OnArrivalAtTargetswampWest()
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.T_VS_ESCORT_VEHICLE_01)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.reserveCount_01 = this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.DRIVE_ESCORT01
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VE_ESCORT_VEHICLE_01)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.reserveCount_01 = this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.STOP_ESCORT02
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VW_ESCORT_VEHICLE_01)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.reserveCount_01 = this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.WAIT_ESCORT02
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VS_ESCORT_VEHICLE_01)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.reserveCount_01 = this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.DRIVE_ESCORT02
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VE_ESCORT_VEHICLE_02)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.reserveCount_01 = this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.STOP_SWAMPSOUTH
					end,
				},
			},

			{
				...
				{
					func = function()
						svars.reserveCount_01 = this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.DRIVE_SWAMPSOUTH
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.T_VW_ESCORT_VEHICLE_01)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.reserveCount_01 = this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.WAIT_SWAMPSOUTH
					end,
				},
			},
		},
	...
	this.commonFuncTable[StrCode32(this.COMMON_MESSAGE_LIST.R_VE_ESCORT_VEHICLE_03)] = {
		...
		param = {

			{
				...
				{
					func = function()
						svars.reserveCount_01 = this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.STOP_ESCORT03
					end,
				},
			},
		},
...
function this.SetUpTrapTable()
	...
	this.trapSettingTable[StrCode32(TRAP_NAME.INTEL_SAVANNAH)] = {
		areaIndex = this.ENUM_AREA.INTEL_SAVANNAH,
		intelName = INTEL_SENDER_NAME.SAVANNAH,
		func = s10090_demo.GetIntel_savannah,
	}
	this.trapSettingTable[StrCode32(TRAP_NAME.INTEL_PFCAMPNORTH)] = {
		areaIndex = this.ENUM_AREA.INTEL_PFCAMPNORTH,
		intelName = INTEL_SENDER_NAME.PFCAMPNORTH,
		func = s10090_demo.GetIntel_pfCampNorth,
	}
	this.trapSettingTable[StrCode32(TRAP_NAME.INTEL_PFCAMPEAST)] = {
		areaIndex = this.ENUM_AREA.INTEL_PFCAMPEAST,
		intelName = INTEL_SENDER_NAME.PFCAMPEAST,
		func = s10090_demo.GetIntel_pfCampEast,
	}
	this.trapSettingTable[StrCode32(TRAP_NAME.INTEL_SWAMPEAST)] = {
		areaIndex = this.ENUM_AREA.INTEL_SWAMPEAST,
		intelName = INTEL_SENDER_NAME.SWAMPEAST,
		func = s10090_demo.GetIntel_swampEast,
	}
...
function this.SetUpTimerTable()
	...
	this.timerSettingTable[this.ENUM_EVENT_VEHICLE_SEQUENCE.ALL_TIMER] = {
		timerTable = {
			...
			{
				func = function()
					this.SetTimerEscortWavStart()
				end,
			},

			{
				func = function()
					this.SetTimerEscortVehicleStartpfCamp()
				end,
			},

			{
				func = function()
					this.SetTimerEscortVehicleStartswampSouth()
				end,
			},
		},
	}
...
function this.SetUpCheckTable()
	this.checkSettingTable = {
		...
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.START,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_01,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_PFCAMPEAST,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_01,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		...
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_PFCAMPEAST01,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_01,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_PFCAMPEAST02,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_01,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.ENTER_PFCAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_01,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_PFCAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_01,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.CONVERSATION_PFCAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_01,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_PFCAMP01,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_01,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_PFCAMP02,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_02,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.EXIT_PFCAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},

		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_SWAMPSOUTH,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.CONVERSATION_SWAMPSOUTH,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_SWAMPSOUTH,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		...
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.ENTER_SWAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_SWAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.CONVERSATION_SWAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_SWAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		...
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.ENTER_FLOWSTATION,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_FLOWSTATION,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DRIVE_FLOWSTATION,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		...
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_TRANSPORTPOINT,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.WAIT_TRANSPORTPOINT,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEMO_TRANSPORTPOINT,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		...
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_DRIVE_PFCAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_PFCAMP_01,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_STOP_SWAMPSOUTH,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_DRIVE_SWAMPSOUTH,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_DRIVE_SWAMP,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.DRIVE,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
		{
			eventSequenceIndex = this.ENUM_EVENT_VEHICLE_SEQUENCE.DEBUG_PARASITES,
			isCheckAction = this.ENUM_VEHICLE_CHECK_ACTION.STOP,
			inRange = this.RANGE_LIST.IN_PARASITES_TO_TRANSPORTPOINT,
			outRange = this.RANGE_LIST.OUT_PARASITES,
		},
...
function this.TargetSetting()
	...
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId("veh_trc_0000"),
		langId = "marker_info_mission_target",
	})
end
...
function this.targetGuard_Setting()
	...
	if
		svars.isAppearanceParasites == false
		and svars.eventSequenceIndex >= 9
		and GameObject.SendCommand(targetTruck, { id = "IsAlive" })
	then
...
function this.Messages()
	return StrCode32Table({
						...
						if isAppearance == false then
							...
							if
								this.GetVehicleValue(
									this.ENUM_VEHICLE_VALUE_TYPE.MARKINGFLAG,
									s10090_enemy.VEHICLE_NAME.TRUCK_TARGET
								) == true
							then
								local gameObjectId = GetGameObjectId(s10090_enemy.VEHICLE_NAME.TRUCK_TARGET)
		...
		GameObject = {
			...
			},
			{
				...
				func = function(gameObjectId, locatorName, locatorNameUpper, failureType)
					if
						failureType == TppGameObject.FULTON_FAILED_TYPE_ON_FINISHED_RISE
						and Tpp.IsVehicle(gameObjectId)
					then
					...
					if neutralizeType == NeutralizeType.DEAD then
						if Tpp.IsVehicle(neutralizedGameObjectId) then
							this.OnVehicleAction({
								gameObjectId = neutralizedGameObjectId,
								actionType = "Broken",
			...
			},
			{
				...
				func = function(gameObjectId, observations)
					if
						bit.band(observations, Vehicle.observation.PLAYER_WILL_BREAK_VEHICLE)
						== Vehicle.observation.PLAYER_WILL_BREAK_VEHICLE
					then
						this.OnEnemyVehicleAction({
							vehicleGameObjectId = gameObjectId,
							actionType = "VehicleHalfBroken",
						})
					elseif
						bit.band(observations, Vehicle.observation.PLAYER_WILL_HARM_VEHICLE)
						== Vehicle.observation.PLAYER_WILL_HARM_VEHICLE
					then
						this.OnEnemyVehicleAction({ vehicleGameObjectId = gameObjectId, actionType = "VehicleDamage" })
					elseif
						bit.band(observations, Vehicle.observation.PLAYER_WILL_HARM_VEHICLE)
						== Vehicle.observation.PLAYER_STOPS_VEHICLE_BY_BREAKING_WHEELS
					then
		...
		Timer = {
				...
				func = function()
					if svars.isReserveFlag_08 == false then
						if svars.reserveCount_01 == this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.STOP_ESCORT01 then
							...
							this.OnCommonFunc({
								messageId = Fox.StrCode32(this.COMMON_MESSAGE_LIST.T_VS_ESCORT_VEHICLE_01),
							})
				...
				func = function()
					if svars.isReserveFlag_09 == false then
						if svars.reserveCount_01 == this.ENUM_EVENT_ESCORT_VEHICLE_SEQUENCE.STOP_SWAMPSOUTH then
							...
							this.OnCommonFunc({
								messageId = Fox.StrCode32(this.COMMON_MESSAGE_LIST.T_VW_ESCORT_VEHICLE_01),
							})
						else
							svars.isReserveFlag_09 = true
						end
			...
			},
			{
				...
				func = function()
					if svars.eventSequenceIndex == this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_SWAMPSOUTH then
						this.CheckMotorcadeStart({
							areaIndex = this.ENUM_AREA.EVENT_SWAMPSOUTH,
							isCheckEventStart = true,
						})
					end
				end,
			},
...

			{
				...
				func = function()
					if svars.eventSequenceIndex == this.ENUM_EVENT_VEHICLE_SEQUENCE.STOP_SWAMPSOUTH then
						this.OnCommonFunc({
							messageId = Fox.StrCode32(this.COMMON_MESSAGE_LIST.T_SWAMPSOUTH_ACT_MOVE_START),
						})
					elseif DEBUG then
		...
		UI = {
			{
				msg = "EndFadeOut",
				sender = "TargetEscapeDemoFade",
				func = function()
					TppMission.ReserveGameOver(
						TppDefine.GAME_OVER_TYPE.S10090_TARGET_ESCAPE,
						TppDefine.GAME_OVER_RADIO.OTHERS
					)
				end,
			},
		},
		Subtitles = {
			{
				...
				func = function(speechLabel, status)
					...
					if
						(speechLabel == SubtitlesCommand:ConvertToSubtitlesId("stpf1000_094079_0_enec_af"))
						or (speechLabel == SubtitlesCommand:ConvertToSubtitlesId("stpf1000_094105_0_enec_af"))
						or (speechLabel == SubtitlesCommand:ConvertToSubtitlesId("stpf1000_095211_0_cpa_af"))
					then
...
function this.SetEndParasites()
	...
	local isFound =
		this.GetVehicleValue(this.ENUM_VEHICLE_VALUE_TYPE.FULTONFLAG, s10090_enemy.VEHICLE_NAME.TRUCK_TARGET)
		...
		if trapSetting.eventSequenceIndexTable then
				...
				if svars.eventSequenceIndex == eventSequenceIndex then
					...
					elseif eventSequenceIndex == this.ENUM_EVENT_VEHICLE_SEQUENCE.WAIT_TRANSPORTPOINT then
						if svars.isArrivalAtTransport == true then
							this.OnCommonFunc({
								messageId = StrCode32(this.COMMON_MESSAGE_LIST.R_TRANSPORTPOINT_TARGET_CON),
							})
						end
						isDemo = true
			...
			if isDemo == false then
				if
					...
					and svars.isAppearanceParasites == false
					and svars.isFultonVehicle01 == false
				then
...
function this.SetDemoLoad(demoName)
	...
	if loadDemoName == nil then
		if
			(svars.isLoadDemoIntelArea == false and svars.isOnGetIntel == false)
			or (svars.isLoadDemoIntelArea == false and svars.isOnGetIntel == true)
			or (svars.isLoadDemoIntelArea == true and svars.isOnGetIntel == true)
		then
			if svars.isAppearanceParasites == false then
...
this.OnCommonFunc = function(params)
	...
	local function _OnCommonFunc_SetRelativeVehicle(commonFunc, enemyId)
		...
		if commonFunc.rideVehicleName and commonFunc.isSetRelativeVehicle == true then
			if not this.GetVehicleValue(this.ENUM_VEHICLE_VALUE_TYPE.PRESENCE, commonFunc.rideVehicleName) then
				s10090_enemy.SetRelativeVehicle(
					enemyId,
					commonFunc.rideVehicleName,
					commonFunc.isrideFromBeginning,
					commonFunc.isVigilance
				)
				return true
			end
		end
	...
	local function _OnCommonFunc_SetRouteEnemyId(commonFunc, enemyId, routeNum, setEnemyIdTable, setRouteCount)
		...
		if
			s10090_enemy.GetStatus(enemyId) == true
			and _OnCommonFunc_CheckSetEnemyId(setEnemyIdTable, enemyId) == true
			and setRouteCount < setCount
		then
	...
	local function _OnCommonFunc_SetRouteId(commonFunc, routeId, routeNum, setEnemyIdTable, setRouteCount)
		...
		for i, enemyId in ipairs(gameObjectIdTable) do
			if
				...
				and _OnCommonFunc_CheckSetEnemyId(setEnemyIdTable, enemyId) == true
			then
				routeNum, setEnemyIdTable, setRouteCount =
					_OnCommonFunc_SetRouteEnemyId(commonFunc, enemyId, routeNum, setEnemyIdTable, setRouteCount)
			end
		end
		return routeNum, setEnemyIdTable, setRouteCount
	end
		...
		for i, commonFunc in ipairs(commonFuncTable) do
				...
				if commonFunc.isMessageChangePhase then
					if commonFunc.messageEventSequenceIndex then
						if svars.eventSequenceIndex >= commonFunc.messageEventSequenceIndex then
							s10090_enemy.SetEnemyMessage(
								commonFunc.enemyId,
								"ChangePhase",
								commonFunc.isMessageChangePhase
							)
						end
					else
				...
				if params.dbgEnemyIdTable then
					if IsTypeTable(params.dbgEnemyIdTable) then
						for i, enemyId in ipairs(params.dbgEnemyIdTable) do
							routeNum, setEnemyIdTable, setRouteCount = _OnCommonFunc_SetRouteEnemyId(
								commonFunc,
								enemyId,
								routeNum,
								setEnemyIdTable,
					...
					if IsTypeTable(commonFunc.beforeRouteIdTable) then
						for i, routeId in ipairs(commonFunc.beforeRouteIdTable) do
							routeNum, setEnemyIdTable, setRouteCount =
								_OnCommonFunc_SetRouteId(commonFunc, routeId, routeNum, setEnemyIdTable, setRouteCount)
						end
					else
						Fox.Error("Parameters support table only")
					end
						...
						for j, enemyId in ipairs(gameObjectIdTable) do
							...
							then
								...
								GameObject.SendCommand(
									...
									{
										id = "StartTravel",
										travelPlan = commonFunc.travelPlanName,
										keepInAlert = iskeepInAlert,
									}
								)
			...
			if commonFunc.speechLabel then
				...
				if isCallRadio == false then
					s10090_enemy.RouteCallConversation(
						commonFunc.speakerRouteNameTable,
						commonFunc.friendRouteNameTable,
						commonFunc.speechLabel,
						isMonologue
					)
				else
					s10090_enemy.RouteCallRadio(
						commonFunc.speakerRouteNameTable,
						commonFunc.speechLabel,
						commonFunc.stane
					)
			...
			if commonFunc.registerConvoy == true then
				if #convoyIdTable > 1 then
					GameObject.SendCommand(
						{ type = "TppVehicle2" },
						{ id = "RegisterConvoy", convoyId = convoyIdTable }
					)
			...
			if commonFunc.unRegisterConvoy == true then
				if svars.vehicleConvoyIndex ~= 0 then
					GameObject.SendCommand(
						{ type = "TppVehicle2" },
						{ id = "UnregisterConvoy", convoyId = svars.vehicleConvoyIndex }
					)
...
this.OnIntelDemo = function(intelNameHash)
	local demoEndfunction = function()
		...
		if this.IsMainSequence() == true then
			local isFound01 =
				this.GetVehicleValue(this.ENUM_VEHICLE_VALUE_TYPE.PRESENCE, s10090_enemy.VEHICLE_NAME.WEST_WAV01)
			local isFound02 =
				this.GetVehicleValue(this.ENUM_VEHICLE_VALUE_TYPE.PRESENCE, s10090_enemy.VEHICLE_NAME.WEST_WAV02)
			if isFound01 == true and isFound02 == true then
				s10090_radio.TrapAfterGetIntel()
			else
		...
		if s10090_enemy.IsZRS(gameObjectId) == true then
			if phaseName == TppGameObject.PHASE_ALERT then
				if mvars.isNoStopConvoy == false then
					...
					local isFound = this.GetVehicleValue(
						this.ENUM_VEHICLE_VALUE_TYPE.MARKINGFLAG,
						s10090_enemy.VEHICLE_NAME.TRUCK_TARGET
					)
	...
	if identificationCode == Fox.StrCode32("Player") then
		...
		elseif Tpp.IsVehicle(s_gameObjectId) then
			if s_gameObjectId == GameObject.GetGameObjectId(s10090_enemy.VEHICLE_NAME.WEST_WAV01) then
				...
				if
					svars.eventSequenceIndex < s10090_sequence.ENUM_EVENT_VEHICLE_SEQUENCE.ENTER_PFCAMP
					and svars.isAppearanceParasites == false
				then
...
this.OnArrivalAtTargetswamp = function()
	local isFound =
		this.GetVehicleValue(this.ENUM_VEHICLE_VALUE_TYPE.MARKINGFLAG, s10090_enemy.VEHICLE_NAME.TRUCK_TARGET)
	...
	if isSuccess > 0 then
		...
		if isFinish == false then
			...
			if conversationSetting.areaIndex then
				this.CheckMotorcadeStart({
					areaIndex = conversationSetting.areaIndex,
					isEventEnd = true,
					isConversationSucces = true,
				})
			else
				if conversationSetting.succesMessage then
					this.OnCommonFunc({ messageId = conversationSetting.succesMessage })
...
function this.CheckMotorcadeStart(params)
	local function _CheckEnemyGetLifeStatus(motorcadeData)
		...
		if svars.isDyingAllParasites == false then
			...
			if
				lifeStatus == TppGameObject.NPC_LIFE_STATE_NORMAL
				or lifeStatus == TppGameObject.NPC_LIFE_STATE_FAINT
			then
				blRetcode = true
			end
		end
...
function this.OnVehicleBroken(vehicleSetting, attackerGameObjectId)
	...
	elseif
		gameObjectName == s10090_enemy.VEHICLE_NAME.WEST_WAV01
		or gameObjectName == s10090_enemy.VEHICLE_NAME.WEST_WAV02
	then
...
this.OnEnemyVehicleAction = function(params)
	...
	if vehicleSetting then
		if vehicleSetting.isTarget == true then
			...
			elseif
				params.actionType == TppGameObject.VEHICLE_ACTION_TYPE_GOT_OUT_VEHICLE
				or params.actionType == TppGameObject.VEHICLE_ACTION_TYPE_FELL_OFF_VEHICLE
			then
				isStop = true
			...
			if isStop == false then
				if
					this.IsSequenceEnemyVehicleAction(this.ENUM_VEHICLE_CHECK_ACTION.DRIVE) == true
					or svars.isDyingAllParasites == true
				then
