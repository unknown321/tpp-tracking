...
local spawnList = {
	...
	{
		id = "Spawn",
		locator = "veh_Search_0000",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "veh_Surround_01",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "veh_Execute_0000",
		type = Vehicle.type.WESTERN_LIGHT_VEHICLE,
		paintType = Vehicle.paintType.FOVA_0,
	},
	{
		id = "Spawn",
		locator = "veh_Truck_0001",
...
this.SetUpExecuteUnitFova = function()
	...
	local command =
		{ id = "ChangeSpecialFova", faceIndex = 0, bodyIndex = 0, balaclavaFaceId = TppEnemyFaceId.pfs_balaclava }
...
this.TravelPlanFinal = function()
	...
	GameObject.SendCommand(
		...
		{ id = "StartTravel", travelPlan = "Travel_Final_GetBack" }
	)
	GameObject.SendCommand(
