...
this.SetEscapePoint = function()
	...
	local EscapePosList = {
		...
		{
			idx = EscapeIdx.DownTree,
			pos = downTreePos,
			link = { EscapeIdx.DownHut, EscapeIdx.DownTip, EscapeIdx.HillPlane },
		},
		{
			idx = EscapeIdx.HillPlane,
			pos = hillPlanePos,
			link = { EscapeIdx.HillTip, EscapeIdx.HillTree, EscapeIdx.DownTree },
		},
