	...
	enemyList = {
		{
			...
			bodyId = TppDefine.QUEST_BODY_ID_LIST.MSF_03,
			uniqueTypeId = TppDefine.UNIQUE_STAFF_TYPE_ID.QUEST_MSF_03,
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		OnActivate = function()
			...
			local command = { id = "SetMsfCombatLevel", level = 2 }
...
this.SetEscapePoint = function()
	...
	local identifierName = "identifier_q80100_esc_pos"
