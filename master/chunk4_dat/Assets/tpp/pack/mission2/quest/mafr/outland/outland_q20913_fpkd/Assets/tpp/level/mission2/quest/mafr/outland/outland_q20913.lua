	...
	hostageList = {
		{
			...
			bodyId = TppDefine.QUEST_BODY_ID_LIST.Q20913,
		},
	},
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnTerminate = function()
			...
			this.SwitchEnableQuestHighIntTable(false, "mafr_flowStation_cp", this.questCpInterrogation)
...
quest_step.QStep_Start = {
	OnEnter = function()
		this.SwitchEnableQuestHighIntTable(true, "mafr_flowStation_cp", this.questCpInterrogation)
