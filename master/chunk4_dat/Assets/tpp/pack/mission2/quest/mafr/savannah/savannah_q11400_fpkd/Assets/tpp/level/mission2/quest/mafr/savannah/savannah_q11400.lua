...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1199.607,
			cpPosition_y = 11.063,
			cpPosition_z = 78.163,
			cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1199.607,
			cpPosition_y = 11.063,
			cpPosition_z = 78.163,
			cpPosition_r = 50.0,
		},
	...
	enemyList = {
		...
		},
		{
			...
			route_d = "rt_savannahEast_d_0000_sub",
			route_c = "rt_savannahEast_c_0000_sub",
			soldierSubType = "PF_A",
		...
		},
		{
			...
			route_d = "rt_savannahEast_d_0001_sub",
			route_c = "rt_savannahEast_c_0001_sub",
			soldierSubType = "PF_A",
			powerSetting = { "QUEST_ARMOR", "MG" },
		},
	},
