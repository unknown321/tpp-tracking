...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 712.199,
			cpPosition_y = 33.304,
			cpPosition_z = -911.492,
			cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 712.199,
			cpPosition_y = 33.304,
			cpPosition_z = -911.492,
			cpPosition_r = 50.0,
		},
	...
	enemyList = {
		...
		{
			setCp = "mafr_savannahNorth_ob",
			isDisable = true,
		},
		{
			enemyName = "sol_quest_0000",
			route_d = "rt_savannahNorth_d_0000_sub",
			route_c = "rt_savannahNorth_d_0000_sub",
