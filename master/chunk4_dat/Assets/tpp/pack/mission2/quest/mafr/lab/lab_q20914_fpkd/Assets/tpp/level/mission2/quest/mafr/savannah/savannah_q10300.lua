...
quest_step.QStep_Start = {
	OnEnter = function()
		TppUiCommand.RegisterIconUniqueInformation({
			markerId = GameObject.GetGameObjectId("sol_quest_0004"),
			...
			GameObject = {
				...
				},
				{
					...
					func = function(gameObjectId, routeId, routeNode, messageId)
						if messageId == StrCode32("Greeting") then
							TppEnemy.SetSneakRoute("sol_quest_0000", "rt_quest_d_0004")
							TppEnemy.SetSneakRoute("sol_quest_0001", "rt_quest_d_0005")
							TppEnemy.SetSneakRoute("sol_quest_0002", "rt_quest_d_0006")
						elseif messageId == StrCode32("Stand") then
							TppEnemy.SetSneakRoute("sol_quest_0000", "rt_quest_d_0000")
							TppEnemy.SetSneakRoute("sol_quest_0001", "rt_quest_d_0001")
							TppEnemy.SetSneakRoute("sol_quest_0002", "rt_quest_d_0002")
						end
					end,
				},
			},
