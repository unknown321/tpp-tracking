	...
	enemyList = {
		{
			...
			bodyId = TppDefine.QUEST_BODY_ID_LIST.MSF_06,
			uniqueTypeId = TppDefine.UNIQUE_STAFF_TYPE_ID.QUEST_MSF_06,
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		OnActivate = function()
			...
			local command = { id = "SetMsfCombatLevel", level = 5 }
...
this.SetEscapePoint = function()
	...
	local identifierName = "identifier_q80400_esc_pos"
	...
	local EscapePosList = {
		{ idx = EscapeIdx.West, pos = westPos, link = { EscapeIdx.North, EscapeIdx.South, EscapeIdx.East } },
		{ idx = EscapeIdx.North, pos = northPos, link = { EscapeIdx.West, EscapeIdx.East, EscapeIdx.South } },
		{ idx = EscapeIdx.East, pos = eastPos, link = { EscapeIdx.North, EscapeIdx.South, EscapeIdx.West } },
		{ idx = EscapeIdx.South, pos = southPos, link = { EscapeIdx.West, EscapeIdx.East, EscapeIdx.North } },
	}
