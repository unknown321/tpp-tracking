...
local VISIBLE_ANIMALS = {
	...
	{
		{ TppMotherBaseManagementConst.ANIMAL_1400, TppMotherBaseManagementConst.ANIMAL_1403 },
		"TppRat",
		"anml_rat_00",
		0,
		animalKey = "Rat",
	...
	{
		{ TppMotherBaseManagementConst.ANIMAL_1900, TppMotherBaseManagementConst.ANIMAL_1913 },
		"TppGoat",
		"anml_goat_00",
		1,
		animalKey = "Goat",
	...
	{
		{ TppMotherBaseManagementConst.ANIMAL_1920, TppMotherBaseManagementConst.ANIMAL_1933 },
		"TppGoat",
		"anml_goat_01",
		0,
		animalKey = "Goat",
	...
	{
		{ TppMotherBaseManagementConst.ANIMAL_1940, TppMotherBaseManagementConst.ANIMAL_1957 },
		"TppNubian",
		"anml_nubian_00",
		1,
		animalKey = "Nubian",
	...
	{
		{ TppMotherBaseManagementConst.ANIMAL_1960, TppMotherBaseManagementConst.ANIMAL_1977 },
		"TppNubian",
		"anml_nubian_01",
		0,
		animalKey = "Nubian",
					...
					for animalTypeName, animalSetting in pairs(DAY_NIGHT_ROUTE_ANIMALS) do
						if animalTypeName == animalType then
							if dayNightRouteAlreadySetList[animalTypeName] == false then
								...
								Fox.Log(
									"#RegisterClockMessages animalType: "
										.. animalType
										.. ", animalSetting.Group: "
										.. animalSetting.groupNumber
								)
...
function this._AddClockMessage(animalType, animalGroupCount, changeRouteFunc)
	...
	DAY_NIGHT_ROUTE_ANIMALS[animalType].nightMsg = TppAnimalBlock._RegisterClockMessage(
		TppAnimalBlock.CLOCK_MESSAGE_AT_NIGHT_FORMAT,
		nightStartClock,
		timeLagClock,
		true,
		animalGroupCount,
	...
	DAY_NIGHT_ROUTE_ANIMALS[animalType].morningMsg = TppAnimalBlock._RegisterClockMessage(
		TppAnimalBlock.CLOCK_MESSAGE_AT_MORNING_FORMAT,
		nightEndClock,
		timeLagClock,
		false,
		animalGroupCount,
...
function this._ChangeRouteAtTime(senderName, time)
	Fox.Log(
		"_ChangeRouteAtTime: " .. tostring(senderName) .. ": Current time is " .. TppClock.FormalizeTime(time, "string")
	)
		...
		if isNeedChangeRouteAnimal then
			...
			for selectIndex = 0, (currentAnimalGroupCount - 1) do
				if currentAnimalType == "Bear" then
					if isNight then
						TppAnimalBlock._SetRoute(
							animalSetupTable.type,
							animalSetupTable.locatorFormat,
							animalSetupTable.nightRouteFormat,
							selectIndex
						)
					else
						TppAnimalBlock._SetRoute(
							animalSetupTable.type,
							animalSetupTable.locatorFormat,
							animalSetupTable.routeFormat,
							selectIndex
						)
					end
				else
					if isNight then
						TppAnimalBlock._SetHerdRoute(
							animalSetupTable.type,
							animalSetupTable.locatorFormat,
							animalSetupTable.nightRouteFormat,
							selectIndex
				...
				Fox.Log(
					"ChangeRoute animal["
						.. tostring(animalSetupTable.type)
						.. "] locatorIndex["
