...
this.SetOptionalRadioFromSituation = function() end

this.InsertToActiveOptionalRadio = function(targetRadio) end

this.RemoveToActiveOptionalRadio = function(targetRadio) end
