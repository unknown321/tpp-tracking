...
this.SetAllEnabled = function()
	if this.IsHostage() == false then
		local mbStaffIds = TppMotherBaseManagement.GetOutOnMotherBaseStaffs({
...
function this.SetParasiteResourceCount()
	...
	mvars.parasiteFogCount = TppMotherBaseManagement.GetResourceUsableCount({
		resourceId = TppMotherBaseManagementConst.RESOURCE_ID_PARASITE_FOG,
	})
	mvars.parasiteCamoflaCount = TppMotherBaseManagement.GetResourceUsableCount({
		resourceId = TppMotherBaseManagementConst.RESOURCE_ID_PARASITE_CAMOFLA,
	})
	mvars.parasiteCuringCount = TppMotherBaseManagement.GetResourceUsableCount({
		resourceId = TppMotherBaseManagementConst.RESOURCE_ID_PARASITE_CURING,
	})
