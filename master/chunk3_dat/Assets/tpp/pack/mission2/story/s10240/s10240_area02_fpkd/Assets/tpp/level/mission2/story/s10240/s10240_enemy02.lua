...
this.DownEnemyList = {
	...
	{
		name = "sol_mbqf_1000",
		motion = this.MOTION_TABLE.DYING.IDLE_P,
		obie = this.MOTION_TABLE.OBIE.D2S_B,
		loop = this.MOTION_TABLE.OBIE.IDLE_B,
		dead = this.MOTION_TABLE.OBIE.DEAD_B,
		obieVoice = "DD_221",
	},
	{
		name = "sol_mbqf_1001",
		motion = this.MOTION_TABLE.DYING.IDLE_B,
		obie = this.MOTION_TABLE.OBIE.D2S_B,
		loop = this.MOTION_TABLE.OBIE.IDLE_B,
		dead = this.MOTION_TABLE.OBIE.DEAD_B,
		obieVoice = "DD_232",
	...
	{
		name = "sol_mbqf_1002",
		motion = this.MOTION_TABLE.DYING.IDLE_D,
		obie = this.MOTION_TABLE.OBIE.D2S_D,
		loop = this.MOTION_TABLE.OBIE.IDLE_D,
		dead = this.MOTION_TABLE.OBIE.DEAD_D,
		obieVoice = "DD_251",
	},
	{
		name = "sol_mbqf_1003",
		motion = this.MOTION_TABLE.DYING.IDLE_C,
		obie = this.MOTION_TABLE.OBIE.D2S_C,
		loop = this.MOTION_TABLE.OBIE.IDLE_C,
		dead = this.MOTION_TABLE.OBIE.DEAD_C,
		obieVoice = "DD_262",
	},
	{
		name = "sol_mbqf_1004",
		motion = this.MOTION_TABLE.DYING.IDLE_A,
		obie = this.MOTION_TABLE.OBIE.D2S_A,
		loop = this.MOTION_TABLE.OBIE.IDLE_A,
		dead = this.MOTION_TABLE.OBIE.DEAD_A,
		obieVoice = "DD_290",
	},
	{
		name = "sol_mbqf_1005",
		motion = this.MOTION_TABLE.EVENT.E2F_STEP_IDLE,
		obie = nil,
		dead = this.MOTION_TABLE.EVENT.E2F_STEP_B,
		obieVoice = nil,
	},
	{
		name = "sol_mbqf_1006",
	...
	{
		name = "sol_mbqf_1009",
		motion = this.MOTION_TABLE.OBIE.IDLE_C,
		obie = this.MOTION_TABLE.OBIE.D2S_C,
		loop = this.MOTION_TABLE.OBIE.IDLE_C,
		dead = this.MOTION_TABLE.OBIE.DEAD_C,
		obieVoice = nil,
...
this._EnableEnemy = function(enemyId)
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", enemyId),
...
this.DisableCorpseRoof = function()
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0001"),
		{ id = "SetForceUnreal", enabled = true }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0006"),
		{ id = "SetForceUnreal", enabled = true }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0008"),
		{ id = "SetForceUnreal", enabled = true }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0012"),
		{ id = "SetForceUnreal", enabled = true }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0013"),
		{ id = "SetForceUnreal", enabled = true }
	)

	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0014"),
		{ id = "SetForceUnreal", enabled = true }
	)

	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0015"),
		{ id = "SetForceUnreal", enabled = true }
	)

	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0016"),
		{ id = "SetForceUnreal", enabled = true }
	)
end
...
this.DisableCorpseForDemo = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0002"),
		{ id = "SetForceUnreal", enabled = true }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0003"),
		{ id = "SetForceUnreal", enabled = true }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0000"),
		{ id = "SetForceUnreal", enabled = true }
	)
end
...
this.EnableCorpseRoof = function()
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0001"),
		{ id = "SetForceUnreal", enabled = false }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_0006"),
		{ id = "SetForceUnreal", enabled = false }
...
local GAMEOBJECT_INFO_LIST = {
	...
	{
		locatorName = "sol_mbqf_0003",
		id = "ChangeFova",
		balaclavaFaceId = TppEnemyFaceId.dds_balaclava6,
		bodyId = BODY_ID_SOLDIER,
	},
	{
		locatorName = "crp_mbqf_0007",
		id = "ChangeFovaCorpse",
		balaclavaFaceId = TppEnemyFaceId.dds_balaclava6,
		bodyId = BODY_ID_SOLDIER_BLOOD,
	},
	{
		locatorName = "sol_mbqf_0017",
		id = "ChangeFova",
		balaclavaFaceId = TppEnemyFaceId.dds_balaclava6,
		bodyId = BODY_ID_SOLDIER_BLOOD,
	},
	...
	{
		locatorName = "sol_mbqf_0009",
		id = "ChangeFova",
		balaclavaFaceId = TppEnemyFaceId.dds_balaclava2,
		bodyId = BODY_ID_RESCUE,
	},
	{
		locatorName = "sol_mbqf_0011",
		id = "ChangeFova",
		balaclavaFaceId = TppEnemyFaceId.dds_balaclava2,
		bodyId = BODY_ID_RESCUE,
	},
	...
	{
		locatorName = "crp_mbqf_0012",
		id = "ChangeFovaCorpse",
		balaclavaFaceId = TppEnemyFaceId.dds_balaclava2,
		bodyId = BODY_ID_RESCUE,
	},
	{
		locatorName = "crp_mbqf_0013",
		id = "ChangeFovaCorpse",
		balaclavaFaceId = TppEnemyFaceId.dds_balaclava2,
		bodyId = BODY_ID_RESCUE,
	},
...
this.SetFova = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("crp_mbqf_0006"),
		{ id = "ChangeFovaCorpse", faceId = 623, bodyId = BODY_ID_WORKER_DEMO }
	)
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("crp_mbqf_0015"),
		{
			id = "ChangeFovaCorpse",
			faceId = faceId,
			bodyId = BODY_ID_SOLDIER_BLOOD,
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("crp_mbqf_0014"),
		{
			id = "ChangeFovaCorpse",
			faceId = faceId2,
			bodyId = BODY_ID_RESCUE_BLOOD,
			balaclavaFaceId = EnemyFova.INVALID_FOVA_VALUE,
		}
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("crp_mbqf_0016"),
		{
			id = "ChangeFovaCorpse",
			faceId = faceId3,
			bodyId = BODY_ID_WORKER_BLOOD,
			balaclavaFaceId = EnemyFova.INVALID_FOVA_VALUE,
		}
	)
end
...
this.AssignStaffIdAndFaceId = function(staffIdList, index, isFemale)
	for i, staffId in ipairs(staffIdList) do
		...
		GameObject.SendCommand(
			gameObjectId,
			{ id = gameObjectInfo.id, faceId = faceId, bodyId = bodyId, balaclavaFaceId = balaclavaFaceId }
		)
	end
	return index
end
...
this.SetBloodFace = function()
	...
	for i, name in pairs(enemyTalbe) do
		GameObject.SendCommand(
			GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_" .. name),
			{ id = "SetBloodFaceMode", enabled = true }
		)
	end
	local enemyTalbe = {
		"0002",
	...
	for i, name in pairs(enemyTalbe) do
		GameObject.SendCommand(
			GameObject.GetGameObjectId("TppCorpse", "crp_mbqf_" .. name),
			{ id = "SetBloodFaceMode", enabled = true }
		)
	end
end
...
this._SetSpecialActionForEvent = function(enemyId, path, noMessage, message, startFrame, unarmed)
	...
	GameObject.SendCommand(gameObjectId, {
		...
		autoFinish = false,
		commandId = Fox.StrCode32(commandId),
...
this.SetInitMotionBody = function()
	...
	for i, table in pairs(bodyMotionList) do
		GameObject.SendCommand(
			GameObject.GetGameObjectId("TppCorpse", table.name),
			{ id = "SetInitMotion", path = table.motion }
		)
		GameObject.SendCommand(
			GameObject.GetGameObjectId("TppCorpse", table.name),
			{ id = "KeepInitMotion", enabled = true }
		)
	end
end
...
this.CallVoice = function(enemyId, voiceType, maleLabel, femaleLabel)
	...
	if voiceType == nil then
		Fox.Error("voiceType is nil")
		return
	end
	if maleLabel == nil then
...
this.SetForceRealize = function(enemyId, flag)
	...
	if Tpp.IsTypeString(enemyId) then
		...
		GameObject.SendCommand(
			{ type = "TppCorpse" },
			{ id = "SetForceRealize", name = enemyId, forceRealize = enable }
		)
	else
		gameObjectId = enemyId
	end
...
this.AddEnemyRoute = function(enemyId, routeId, point)
	...
	GameObject.SendCommand(
		gameObjectId,
		{ id = "SetAlertRoute", enabled = true, route = routeId, point = routePointNum }
	)
end
...
this.ChangeRoute = function(beforeRoute, afterRoute, point)
	...
	if #soldiers > 0 then
		for i, soldier in ipairs(soldiers) do
			...
			GameObject.SendCommand(
				soldier,
				{ id = "SetAlertRoute", enabled = true, route = afterRoute, point = routePointNum }
			)
...
this.SetObieMotion = function(gameObjectId)
	...
	for i = 1, #this.DownEnemyList do
		if gameObjectId == GameObject.GetGameObjectId("TppSoldier2", this.DownEnemyList[i].name) then
			...
			elseif
				gameObjectId == GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0010") and svars.numEvent2F3 > 0
			then
				return
			else
				if s10240_sequence.CheckObieFlag(i) == false then
					Fox.Log("obie play" .. i)
					this._SetSpecialActionForEvent(
						this.DownEnemyList[i].name,
						this.DownEnemyList[i].obie,
						false,
						"ObieLoop"
					)
...
this.StartEvent2F1 = function()
	...
	this._SetSpecialActionForEvent(
		"sol_mbqf_0019",
		this.MOTION_TABLE.EVENT.E2F1_TURN,
		false,
		"E2F_Turn_End",
		nil,
		false
...
this.StartEvent2F1HandGun = function()
	...
	this._SetSpecialActionForEvent(
		"sol_mbqf_0019",
		this.MOTION_TABLE.EVENT.E2F1_HANDGUN,
		false,
		"E2F_HandGun_End",
		nil,
		false
...
this._EnemySong = function(enemyId, songId)
	...
	GameObject.SendCommand(
		gameObjectId,
		{ id = "CallSoundEffect", sound = songId, isCheckShield = true, isFollow = true }
	)
end
...
this.StartEventB1Room = function()
	...
	if
		TppEnemy.GetLifeStatus("sol_mbqf_0013") ~= TppEnemy.LIFE_STATUS.DEAD
		and TppEnemy.GetLifeStatus("sol_mbqf_0000") ~= TppEnemy.LIFE_STATUS.DEAD
	then
	...
	local ignoreFlag = 0
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0012"),
		{ id = "SetIgnoreDamageAction", flag = ignoreFlag }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0013"),
		{ id = "SetIgnoreDamageAction", flag = ignoreFlag }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0000"),
		{ id = "SetIgnoreDamageAction", flag = ignoreFlag }
	)
end
...
this.WaitEventB1Room = function()
	...
	local ignoreFlag = 0
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0001"),
		{ id = "SetIgnoreDamageAction", flag = ignoreFlag }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0018"),
		{ id = "SetIgnoreDamageAction", flag = ignoreFlag }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0022"),
		{ id = "SetIgnoreDamageAction", flag = ignoreFlag }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0023"),
		{ id = "SetIgnoreDamageAction", flag = ignoreFlag }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0024"),
		{ id = "SetIgnoreDamageAction", flag = ignoreFlag }
	)
end
...
this.Set2FUnarmed = function()
	...
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0021"),
		{ id = "SetUnarmed", enabled = true }
	)
	GameObject.SendCommand(
		GameObject.GetGameObjectId("TppSoldier2", "sol_mbqf_0026"),
		{ id = "SetUnarmed", enabled = true }
	)
end
