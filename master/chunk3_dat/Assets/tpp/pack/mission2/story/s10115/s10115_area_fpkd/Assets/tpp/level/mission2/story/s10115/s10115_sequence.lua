	...
	this.CLST_PARAM = {
		{
			...
			CBTSET_NAME = string.format(
				"ly%03d_cl%02d_combat0000|cl%02dpl%01d_uq_%04d_cbtlct|TppCombatLocatorSetData",
				numLayout,
				clstId,
				clstId,
				0,
			...
			HELI_ROUTE_ON_CLEAR = {
				HELI_0 = string.format(
					"ly%03d_cl%02d_10115_heli0000|cl%02dpl%01d_uq_%04d_heli_10115|rts_apr_clear_0000",
					numLayout,
					clstId,
					clstId,
					0,
				...
				HELI_1 = string.format(
					"ly%03d_cl%02d_10115_heli0000|cl%02dpl%01d_uq_%04d_heli_10115|rts_apr_clear_0001",
					numLayout,
					clstId,
					clstId,
					0,
				...
				HELI_2 = string.format(
					"ly%03d_cl%02d_10115_heli0000|cl%02dpl%01d_uq_%04d_heli_10115|rts_apr_clear_0002",
					numLayout,
					clstId,
					clstId,
					0,
...
this.missionObjectiveDefine = {
	...
	default_area_develop = {
		...
		mapRadioName = "s0115_mprg1010",
	},

	default_area_hostage = {
		gameObjectName = "hos_s10115_0000",
		viewType = "map",
		visibleArea = 1,
		randomRange = 1,
		setImportant = false,
	...
	target_area = {
		gameObjectName = "ly003_cl02_10115_npc0000|cl02pl0_uq_0020_npc|sol_plnt0_0000",
		goalType = "attack",
	...
	bonus_Hostage = {
		...
		setNew = false,
		announceLog = "updateMap",
		langId = "marker_staff_hostage",
	},

	bonus_Hostage_plant2 = {
		gameObjectName = "hos_s10115_0003",
		viewType = "map",
		visibleArea = 1,
		randomRange = 0,
		setImportant = false,
	...
	bonus_Hostage_1 = {
		gameObjectName = "hos_s10115_0001",
		goalType = "defend",
		viewType = "map_and_world_only_icon",
		setNew = false,
		announceLog = "updateMap",
	...
	bonus_Hostage_2 = {
		gameObjectName = "hos_s10115_0002",
		goalType = "defend",
		viewType = "map_and_world_only_icon",
		setNew = false,
		announceLog = "updateMap",
	...
	bonus_Hostage_4 = {
		gameObjectName = "hos_s10115_0004",
		goalType = "defend",
		viewType = "map_and_world_only_icon",
		setNew = false,
		announceLog = "updateMap",
	...
	bonus_Hostage_5 = {
		gameObjectName = "hos_s10115_0005",
		goalType = "defend",
		viewType = "map_and_world_only_icon",
		setNew = false,
		announceLog = "updateMap",
		...
		GameObject = {
			...
			},
			{
				...
				func = function(gameObjectId, carriedState)
					...
					if
						gameObjectId == HOSTAGE_A
						and carriedState == TppGameObject.NPC_CARRIED_STATE_START
						and svars.isMonologue_A == false
					then
						svars.isMonologue_A = true
						GameObject.SendCommand(HOSTAGE_A, monologue_A)
					elseif
						gameObjectId == HOSTAGE_B
						and carriedState == TppGameObject.NPC_CARRIED_STATE_START
						and svars.isMonologue_B == false
					then
						svars.isMonologue_B = true
						GameObject.SendCommand(HOSTAGE_B, monologue_B)
					elseif
						gameObjectId == HOSTAGE_C
						and carriedState == TppGameObject.NPC_CARRIED_STATE_START
						and svars.isMonologue_C == false
					then
						svars.isMonologue_C = true
						GameObject.SendCommand(HOSTAGE_C, monologue_C)
					elseif
						gameObjectId == HOSTAGE_D
						and carriedState == TppGameObject.NPC_CARRIED_STATE_START
						and svars.isMonologue_D == false
					then
						svars.isMonologue_D = true
						GameObject.SendCommand(HOSTAGE_D, monologue_D)
					elseif
						gameObjectId == HOSTAGE_E
						and carriedState == TppGameObject.NPC_CARRIED_STATE_START
						and svars.isMonologue_E == false
					then
						svars.isMonologue_E = true
						GameObject.SendCommand(HOSTAGE_E, monologue_E)
					elseif
						gameObjectId == HOSTAGE_F
						and carriedState == TppGameObject.NPC_CARRIED_STATE_START
						and svars.isMonologue_F == false
					then
...
this.AddUniqueMapIconText = function()
	...
	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(MARKER_TARGET_AREA),
		langId = "marker_info_mission_targetArea",
	})

	TppUiCommand.RegisterIconUniqueInformation({
		markerId = GameObject.GetGameObjectId(s10115_enemy.TARGET_ENEMY.NAME),
		langId = "marker_info_mission_target",
	})

	for idx = 1, table.getn(s10115_enemy.HOSTAGELIST) do
		TppUiCommand.RegisterIconUniqueInformation({
			markerId = GameObject.GetGameObjectId(s10115_enemy.HOSTAGELIST[idx]),
			langId = "marker_staff_hostage",
		})
	end
end
...
sequences.Seq_Game_MainGame = {
	Messages = function(self)
		return StrCode32Table({
			...
			Marker = {
				{
					msg = "ChangeToEnable",
					sender = s10115_enemy.TARGET_ENEMY.NAME,
					func = function()
				...
				{
					msg = "ChangeToEnable",
					sender = s10115_enemy.HOSTAGELIST,
					func = function()
			...
			Radio = {
				...
				{
					msg = "Finish",
					sender = "s0115_esrg1010",
					func = function()
						s10115_radio.ChangeIntelRadio_gunMountInvalid()
					end,
				},
				{
					msg = "Finish",
					sender = "s0115_esrg1020",
					func = function()
						s10115_radio.ChangeIntelRadio_mortarInvalid()
					end,
				},
				{
					msg = "Finish",
					sender = "s0115_esrg1030",
					func = function()
						s10115_radio.ChangeIntelRadio_antiAirGunInvalid()
					end,
				},
				{
					msg = "Finish",
					sender = "s0115_esrg1080",
					func = function()
						s10115_radio.ChangeIntelRadio_eleGeneratorInvalid()
					end,
				},
				{
					msg = "Finish",
					sender = "s0115_esrg1070",
					func = function()
						s10115_radio.ChangeIntelRadio_allPipeInvalid()
					end,
				},
				{
					msg = "Finish",
					sender = "s0115_esrg1090",
					func = function()
						s10115_radio.ChangeIntelRadio_enemy2nd()
					end,
				},
				{
					msg = "Finish",
					sender = "s0115_esrg1100",
					func = function()
				...
				{
					msg = "Finish",
					sender = "s0115_esrg1040",
					func = function()
						s10115_radio.ChangeIntelRadio_hostage2nd()
					end,
				},
				{
					msg = "Finish",
					sender = "s0115_esrg1050",
					func = function()
						s10115_radio.ChangeIntelRadio_hostage3rd()
					end,
				},
				{
					msg = "Finish",
					sender = "s0115_esrg1060",
					func = function()
				...
				{
					msg = "Finish",
					sender = "s0115_esrg2010",
					func = function()
						s10115_radio.ChangeIntelRadio_targetInvalid()
					end,
				},
			},
			GameObject = {
				{
					...
					func = function()
						...
						if
							s10115_enemy.isEmiliatedAllEnemy(mtbs_enemy.soldierDefine[mtbs_enemy.cpNameDefine]) == true
						then
				...
				{
					msg = "ChangePhase",
					sender = this.currentClusterSetting.currentCpName,
	...
	MissionStart = function()
		...
		if mvars.numCurrentClusterGrade > 2 then
			...
			TppInterrogation.AddHighInterrogation(GameObject.GetGameObjectId(mtbs_enemy.cpNameDefine), {
				s10115_enemy.INTER_HOSTAGE_PLNT2,
				s10115_enemy.INTER_BOSS,
			})
