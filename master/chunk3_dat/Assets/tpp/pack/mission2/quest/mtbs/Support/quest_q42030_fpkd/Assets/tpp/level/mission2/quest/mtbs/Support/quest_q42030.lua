...
local START_TRAP_NAME = "ly003_cl03_npc0000|cl03pl0_uq_0030_npc2|trap_shootingPractice_start"
	...
	gimmickMarkList = {
		{
			...
			dataSetName = "/Assets/tpp/level/mission2/quest/mtbs/Support/quest_q42030.fox2",
			setIndex = 0,
		},
		{
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		OnActivate = function()
			...
			local startUiPosition = { -1.67, 0.01, 25.156 }
...
function this.UpdateRankingInSupport()
	if mvars.needToUpdateRankingInSupport == true then
			...
			GameObject = {
				{
					...
					func = function(gameObjectId, locatorNameHash, dataSetNameHash)
						...
						if isClearType == TppDefine.QUEST_CLEAR_TYPE.SHOOTING_CLEAR then
							mvars.needToUpdateRankingInSupport = true
						end
					end,
				},
			},
