...
local START_TRAP_NAME = "ly003_cl02_npc0000|cl02pl0_uq_0020_npc2|trap_shootingPractice_start"
	...
	gimmickMarkList = {
		{
			...
			dataSetName = "/Assets/tpp/level/mission2/quest/mtbs/Develop/quest_q42020.fox2",
			setIndex = 0,
		},
		{
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		OnActivate = function()
			...
			local startUiPosition = { -16.88646, 32.01, -6.623045 }
...
function this.UpdateRankingInDevelop()
	if mvars.needToUpdateRankingInDevelop == true then
			...
			GameObject = {
				{
					...
					func = function(gameObjectId, locatorNameHash, dataSetNameHash)
						...
						if isClearType == TppDefine.QUEST_CLEAR_TYPE.SHOOTING_CLEAR then
							mvars.needToUpdateRankingInDevelop = true
						end
					end,
				},
			},
