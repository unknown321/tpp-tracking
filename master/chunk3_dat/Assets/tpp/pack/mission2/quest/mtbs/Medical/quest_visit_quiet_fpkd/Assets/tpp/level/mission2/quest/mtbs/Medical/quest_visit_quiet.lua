	...
	OnEnter = function()
		...
		local funcs = {
			onInit = function()
				local gameObjectId = { type = "TppOcelot2", index = 0 }
				local command =
					{ id = "SetSneakRoute", route = "ly003_cl04_route0000|cl04pl0_uq_0040_free|OcelotDemoEnd" }
				GameObject.SendCommand(gameObjectId, command)
			end,
			onEnd = function()
...
function this.StartLookOcelotInDemo()
	...
	local gameObjectId =
		GameObject.GetGameObjectId("ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|TppOcelot2GameObjectLocator")
