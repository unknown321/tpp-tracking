...
local START_TRAP_NAME = "ly003_cl06_npc0000|cl06pl0_uq_0060_npc2|trap_shootingPractice_start"
	...
	gimmickMarkList = {
		{
			...
			dataSetName = "/Assets/tpp/level/mission2/quest/mtbs/BaseDev/quest_q42040.fox2",
			setIndex = 0,
		},
		{
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		OnActivate = function()
			...
			local startUiPosition = { -14.55897, 12.01, 11.32341 }
...
function this.UpdateRankingInBaseDev()
	if mvars.needToUpdateRankingInBaseDev == true then
			...
			GameObject = {
				{
					...
					func = function(gameObjectId, locatorNameHash, dataSetNameHash)
						...
						if isClearType == TppDefine.QUEST_CLEAR_TYPE.SHOOTING_CLEAR then
							mvars.needToUpdateRankingInBaseDev = true
						end
					end,
				},
			},
