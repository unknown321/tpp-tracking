...
this.RouteSets = {
	...
	Support = {
		plnt0 = {
			day = {
				"ly003_cl03_route0000|cl03pl0_uq_0030_free|rt_q101210_0000",
				"ly003_cl03_route0000|cl03pl0_uq_0030_free|rt_q101210_0001",
			},
			night = {
				"ly003_cl03_route0000|cl03pl0_uq_0030_free|rt_q101210_0000",
				"ly003_cl03_route0000|cl03pl0_uq_0030_free|rt_q101210_0001",
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		...
		OnDeactivate = function()
			Fox.Log("quest_q101210 OnDeactivate")
		end,
		OnOutOfAcitveArea = function()
			Fox.Log("quest_q101210 OnOutOfAcitveArea")
		end,
		OnTerminate = function()
			Fox.Log("quest_q101210 OnTerminate")
		end,
	})
end
...
function this.OnActivate()
	Fox.Log("quest_q101210 activate")
	...
	Messages = function(self)
		return StrCode32Table({
			Trap = {
				{
					msg = "Enter",
					sender = "ly003_cl03_route0000|cl03pl0_uq_0030_free|trap_q101210",
					func = function()
						if mvars.qst_canGetFemaleSoldier then
							this.SpeechStart()
						else
							Fox.Log("Cannot Get Female")
						end
					end,
				},
			},
...
this.SpeechStart = function()
	if mvars.qst_spch_soldierList then
		if #mvars.qst_spch_soldierList >= 2 then
			...
			this.SetConversation(SPEAKER, FRIEND, "MB_story_18")
		end
	end
end
