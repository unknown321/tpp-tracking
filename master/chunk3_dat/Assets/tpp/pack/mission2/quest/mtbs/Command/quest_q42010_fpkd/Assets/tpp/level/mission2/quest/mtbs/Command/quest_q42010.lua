...
local START_TRAP_NAME = "ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|trap_shootingPractice_start"
	...
	gimmickMarkList = {
		{
			...
			dataSetName = "/Assets/tpp/level/mission2/quest/mtbs/Command/quest_q42010.fox2",
			setIndex = 0,
		},
		{
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		OnActivate = function()
			...
			local startUiPosition = { 15.408, 0.01, -27.006 }
...
function this.UpdateRankingInCommand()
	if mvars.needToUpdateRankingInCommand == true then
			...
			GameObject = {
				{
					...
					func = function(gameObjectId, locatorNameHash, dataSetNameHash)
						...
						if isClearType == TppDefine.QUEST_CLEAR_TYPE.SHOOTING_CLEAR then
							mvars.needToUpdateRankingInCommand = true
						end
					end,
				},
			},
