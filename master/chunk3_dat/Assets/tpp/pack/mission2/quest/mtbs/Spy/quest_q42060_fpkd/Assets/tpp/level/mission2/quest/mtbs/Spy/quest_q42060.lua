...
local START_TRAP_NAME = "ly003_cl05_npc0000|cl05pl0_uq_0050_npc2|trap_shootingPractice_start"
	...
	gimmickMarkList = {
		{
			...
			dataSetName = "/Assets/tpp/level/mission2/quest/mtbs/Spy/quest_q42060.fox2",
			setIndex = 0,
		},
		{
...
function this.OnAllocate()
	...
	TppQuest.RegisterQuestSystemCallbacks({
		OnActivate = function()
			...
			local startUiPosition = { -6.919701, 26.99437, 1.134691 }
...
function this.UpdateRankingInSpy()
	if mvars.needToUpdateRankingInSpy == true then
			...
			GameObject = {
				{
					...
					func = function(gameObjectId, locatorNameHash, dataSetNameHash)
						...
						if isClearType == TppDefine.QUEST_CLEAR_TYPE.SHOOTING_CLEAR then
							mvars.needToUpdateRankingInSpy = true
						end
					end,
				},
			},
